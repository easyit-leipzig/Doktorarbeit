...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 15. Jul 2026 um 19:20
...
(78, 70, 'Historische Primärquelle zur Ablösung des Funktionsbegriffs von einer einheitlichen analytischen Formel.', 'Begründet den Übergang zum abstrakten Zuordnungsbegriff in Abschnitt 3.2.3.', 'Belegt die wissenschaftshistorische Erweiterung des Funktionsbegriffs.', 'Eine Funktion wird durch die eindeutige Zuordnung von Argumenten zu Werten bestimmt.', 'Historische Darstellung ohne moderne mengentheoretische Formalisierung.', 'Die formale Präzisierung erfolgt mit Lang [29] und Rudin [30].', 'reviewed', '2026-07-15 08:07:06'),
(79, 81, 'Historische Primärquelle zur gruppentheoretischen Analyse der Lösbarkeit algebraischer Gleichungen.', 'Begründet den historischen Übergang von Rechenverfahren zu abstrakten Symmetriestrukturen.', 'Erstnennung zur Entstehung der Gruppentheorie.', 'Symmetrien der Nullstellen bestimmen die Lösbarkeit durch Radikale.', 'Historische Primärquelle in älterer Terminologie.', 'Wird durch moderne algebraische Standardwerke formal präzisiert.', 'reviewed', '2026-07-15 08:07:07'),
(80, 82, 'Begründet die abstrakte Ideal- und Ringtheorie in axiomatischer Form.', 'Zentrale Quelle für den strukturellen Paradigmenwechsel der Algebra.', 'Belegt die systematische Ablösung algebraischer Aussagen von konkreten Zahlbereichen.', 'Ring- und Idealstrukturen können allgemein axiomatisch untersucht werden.', 'Fokussiert auf Ringbereiche und Idealtheorie.', 'Wird mit van der Waerden [63] systematisch eingeordnet.', 'reviewed', '2026-07-15 08:07:07'),
(81, 83, 'Systematisiert Gruppen, Ringe, Körper und weitere algebraische Strukturen.', 'Formale Hauptreferenz für die Definitionen in Abschnitt 3.2.4.', 'Belegt die axiomatische Strukturhierarchie der abstrakten Algebra.', 'Algebraische Strukturen werden durch Trägermengen, Operationen und Axiome bestimmt.', 'Historisches Standardwerk; moderne Terminologie kann abweichen.', 'Wird durch Mac Lane/Birkhoff [64] ergänzt.', 'reviewed', '2026-07-15 08:07:07'),
(82, 84, 'Stellt Gruppen, Homomorphismen und Isomorphismen in moderner struktureller Form dar.', 'Referenz für Gruppen, Untergruppen und strukturerhaltende Abbildungen.', 'Belegt die strukturelle Gleichwertigkeit isomorpher algebraischer Objekte.', 'Homomorphismen erhalten Verknüpfungsstrukturen.', 'Lehrbuchdarstellung statt Primärquelle.', 'Ergänzt die historischen Primärquellen.', 'reviewed', '2026-07-15 08:07:07'),
(83, 85, 'Beweist den Zusammenhang kontinuierlicher Symmetrien mit Erhaltungssätzen.', 'Belegt die wissenschaftliche Bedeutung von Gruppen als Symmetriemodelle.', 'Primärquelle zur Verbindung von Algebra und theoretischer Physik.', 'Kontinuierliche Symmetrien führen zu Erhaltungsgrößen.', 'Setzt variationsanalytische Voraussetzungen voraus.', 'Dient als Anwendungsbezug der Gruppentheorie.', 'reviewed', '2026-07-15 08:07:07'),
(84, 100, 'Systematische Theorie linearer Integralgleichungen und Integraloperatoren.', 'Historische Grundlage der Operatorentheorie in 3.2.5.', 'Belegt den Übergang von konkreten Integralgleichungen zur Untersuchung von Operatoren auf Funktionenräumen.', 'Operatoren können als eigenständige mathematische Transformationsobjekte behandelt werden.', 'Historische Darstellung vor der vollständigen Banachraumtheorie.', 'Wird durch Banachs allgemeinen funktionalanalytischen Rahmen ergänzt.', 'reviewed', '2026-07-15 08:07:07'),
(85, 101, 'Allgemeine Theorie linearer Operationen auf normierten und vollständigen Räumen.', 'Zentrale Primärquelle für lineare Operatoren, Kern, Bild und Operatoralgebra.', 'Belegt die funktionalanalytische Fundierung der Operatorentheorie.', 'Lineare Operatoren werden durch Raumstruktur, Linearität und Abbildungseigenschaften charakterisiert.', 'Schwerpunkt auf linearer Theorie.', 'Nichtlineare Entwicklungen werden in späteren Abschnitten getrennt behandelt.', 'reviewed', '2026-07-15 08:07:07'),
(86, 102, 'Formalisierung linearer dynamischer Systeme durch Zustandsvektoren und Zustandsraumdarstellungen.', 'Zentrale Primärquelle für den modernen Zustandsraumbegriff in 3.2.6.', 'Belegt die vollständige interne Zustandsbeschreibung als Grundlage weiterer Systementwicklung.', 'Der Zustand enthält die für die weitere Entwicklung relevanten Systeminformationen.', 'Schwerpunkt auf linearen endlichdimensionalen Systemen.', 'Wird durch allgemeine dynamische Systemtheorie und nichtlineare Modelle ergänzt.', 'reviewed', '2026-07-15 08:07:08'),
(87, 103, 'Allgemeine Theorie gewöhnlicher Differentialgleichungen, Flüsse und Trajektorien.', 'Grundlage für die kontinuierliche Zustandsentwicklung in 3.2.6.', 'Belegt die mathematische Beschreibung autonomer und nichtautonomer Dynamik im Zustandsraum.', 'Kontinuierliche Systementwicklung kann durch Anfangswertprobleme und Flüsse dargestellt werden.', 'Behandelt primär gewöhnliche Differentialgleichungen.', 'Unendlichdimensionale und stochastische Entwicklungen werden später gesondert betrachtet.', 'reviewed', '2026-07-15 08:07:08'),
(88, 107, 'Systematische Klassifikation lokaler Bifurkationen und ihrer Normalformen.', 'Zentrale Referenz für Definitionen, kritische Parameterwerte und lokale Bifurkationstypen in 3.2.8.', 'Belegt die mathematische Struktur von Sattel-Knoten-, transkritischer, Pitchfork- und Hopf-Bifurkation.', 'Bifurkationen beschreiben qualitative Strukturänderungen parameterabhängiger Dynamik.', 'Schwerpunkt auf etablierter lokaler Bifurkationstheorie.', 'Die Quelle wird mit globalen nichtlinearen Perspektiven aus [74] ergänzt.', 'reviewed', '2026-07-15 08:53:11'),
(89, 108, 'Verbindung nichtlinearer Schwingungen, lokaler Bifurkationen und globaler dynamischer Strukturen.', 'Ergänzende Standardreferenz für Nichtlinearität, Linearisierung und Hopf-Dynamik.', 'Belegt die Rolle nichtlinearer Terme und lokaler Normalformen für qualitative Dynamikwechsel.', 'Nichtlinearität ermöglicht qualitative Strukturübergänge, die in linearen Systemen nicht auftreten.', 'Konzentriert sich auf klassische glatte dynamische Systeme.', 'Die emergenztheoretische Interpretation bleibt eine wissenschaftliche Einordnung des Abschnitts.', 'reviewed', '2026-07-15 08:53:11'),
(90, 109, 'Mathematische Quantifizierung von Selbstinformation, Entropie, bedingter Entropie und Informationsübertragung.', 'Zentrale Primärquelle für sämtliche informationstheoretischen Definitionen in Abschnitt 3.2.9.', 'Belegt die probabilistische Definition von Information unabhängig von Semantik.', 'Information wird als Verringerung probabilistischer Unbestimmtheit quantifiziert.', 'Die semantische Bedeutung von Nachrichten wird bewusst ausgeklammert.', 'Diese Begrenzung ist für die spätere FRZK-Forschungslücke ausdrücklich relevant.', 'reviewed', '2026-07-15 09:11:32'),
(91, 110, 'Verknüpfung von Information, Kommunikation, Steuerung und Rückkopplung.', 'Erweitert die rein probabilistische Perspektive um die funktionale Rolle von Information in dynamischen Systemen.', 'Belegt die Bedeutung von Information innerhalb regulierter Prozesse.', 'Information ist für Steuerung und Rückkopplung funktional wirksam.', 'Keine allgemeine mathematische Genese semantischer oder funktionaler Raum-Zeit-Strukturen.', 'Wieners funktionale Perspektive ergänzt Shannons quantitative Theorie.', 'reviewed', '2026-07-15 09:11:32'),
(96, 118, 'Einführung einer rein relationalen Problembeschreibung unabhängig von geometrischen Längen und Winkeln.', 'Historischer Ausgangspunkt der Graphentheorie in Abschnitt 3.2.10.', 'Belegt die Entstehung eines strukturellen, nichtmetrischen Zugangs zu Verbindungsproblemen.', 'Die relationale Struktur kann unabhängig von geometrischer Einbettung untersucht werden.', 'Die Arbeit enthält noch keine moderne abstrakte Graphentheorie.', 'Wird durch Diestels moderne Darstellung ergänzt.', 'reviewed', '2026-07-15 14:28:51'),
(97, 119, 'Systematische moderne Darstellung von Graphen, Wegen, Zusammenhang, Matrizen und gewichteten Strukturen.', 'Zentrale Referenz für alle mathematischen Definitionen von Abschnitt 3.2.10.', 'Belegt die formale Graphstruktur und ihre elementaren Eigenschaften.', 'Graphen modellieren relationale Systeme unabhängig von der konkreten Bedeutung ihrer Knoten und Kanten.', 'Funktionale Genese und semantische Bedeutung der Relationen sind nicht Gegenstand der Theorie.', 'Diese Grenze wird als Übergang zur FRZK-Forschungslücke verwendet.', 'reviewed', '2026-07-15 14:28:51'),
(98, 120, 'Einführung des Small-World-Modells mit hoher Clusterung und kurzen Wegen.', 'Zentrale Primärquelle für Gleichung (3.273) und die globale Netzwerkeinordnung.', 'Belegt die Kombination lokaler Clusterung mit global effizienter Erreichbarkeit.', 'Reale Netzwerke können zugleich stark geclustert und global kurzwegig sein.', 'Das Modell erklärt nicht die funktionale Genese konkreter Relationen.', 'Wird als Beispiel emergenter globaler Organisation aus lokalen Verknüpfungen verwendet.', 'reviewed', '2026-07-15 18:07:29'),
(99, 121, 'Einführung skalenfreier Netzwerke durch Wachstum und bevorzugte Anlagerung.', 'Zentrale Primärquelle für Gleichung (3.274) und die Hub-Struktur.', 'Belegt potenzgesetzartige Gradverteilungen in wachsenden Netzwerken.', 'Wenige Hubs und viele schwach vernetzte Knoten können aus lokaler Wachstumsdynamik entstehen.', 'Das ursprüngliche Modell bildet nicht alle realen Netzwerkmechanismen ab.', 'Dient als Beispiel für makroskopische Strukturentstehung aus lokalen Regeln.', 'reviewed', '2026-07-15 18:07:29'),
(100, 122, 'Systematische Klärung verschiedener Zentralitätskonzepte.', 'Primärquelle für Grad-, Closeness- und Betweenness-Zentralität.', 'Belegt die unterschiedlichen mathematischen Bedeutungen struktureller Zentralität.', 'Zentralität ist mehrdimensional und hängt vom gewählten Strukturkriterium ab.', 'Eigenvektor-Zentralität wird in späteren Arbeiten vertieft.', 'Ergänzt die modernen Netzwerkmodelle durch klassische Zentralitätsmaße.', 'reviewed', '2026-07-15 18:07:29');
...
(158, 'Def. 3.2.1.1', 9, 'Menge', 'Eine Menge ist im axiomatischen Rahmen ein primitiver mathematischer Gegenstand, dessen Bedeutung durch die Elementrelation und die Axiome der Mengenlehre bestimmt wird.', NULL, NULL, 'literature', 23, 'Die verwendeten Begriffe werden im Rahmen der axiomatischen Mengenlehre interpretiert.', 'Definition für den Forschungsstandsabschnitt 3.2.1.', 'checked', 24),
(159, 'Def. 3.2.1.2', 9, 'Elementzugehörigkeit', 'Die Aussage x∈M bezeichnet die Zugehörigkeit des Objekts x zur Menge M.', 'x\\in M', 'x\\in M', 'literature', 23, 'Die verwendeten Begriffe werden im Rahmen der axiomatischen Mengenlehre interpretiert.', 'Definition für den Forschungsstandsabschnitt 3.2.1.', 'checked', 24),
(160, 'Def. 3.2.1.3', 9, 'Leere Menge', 'Die leere Menge ist die eindeutig bestimmte Menge, die kein Element enthält.', '\\emptyset', '\\emptyset', 'literature', 24, 'Die verwendeten Begriffe werden im Rahmen der axiomatischen Mengenlehre interpretiert.', 'Definition für den Forschungsstandsabschnitt 3.2.1.', 'checked', 24),
(161, 'Def. 3.2.1.4', 9, 'Teilmenge', 'A ist Teilmenge von B, wenn jedes Element von A zugleich Element von B ist.', 'A\\subseteq B\\Longleftrightarrow\\forall x\\left(x\\in A\\Longrightarrow x\\in B\\right)', 'A\\subseteq B\\Longleftrightarrow\\forall x\\left(x\\in A\\Longrightarrow x\\in B\\right)', 'literature', 24, 'Die verwendeten Begriffe werden im Rahmen der axiomatischen Mengenlehre interpretiert.', 'Definition für den Forschungsstandsabschnitt 3.2.1.', 'checked', 24),
(162, 'Def. 3.2.1.5', 9, 'Kartesisches Produkt', 'Das kartesische Produkt A×B ist die Menge aller geordneten Paare (a,b) mit a∈A und b∈B.', 'A\\times B=\\{(a,b)\\mid a\\in A,\\;b\\in B\\}', 'A\\times B=\\{(a,b)\\mid a\\in A,\\;b\\in B\\}', 'literature', 23, 'Die verwendeten Begriffe werden im Rahmen der axiomatischen Mengenlehre interpretiert.', 'Definition für den Forschungsstandsabschnitt 3.2.1.', 'checked', 24),
(163, 'Def. 3.2.1.6', 9, 'Potenzmenge', 'Die Potenzmenge P(A) ist die Menge aller Teilmengen von A.', '\\mathcal P(A)=\\{X\\mid X\\subseteq A\\}', '\\mathcal P(A)=\\{X\\mid X\\subseteq A\\}', 'literature', 23, 'Die verwendeten Begriffe werden im Rahmen der axiomatischen Mengenlehre interpretiert.', 'Definition für den Forschungsstandsabschnitt 3.2.1.', 'checked', 24),
(164, 'Def. 3.2.2.1', 10, 'Geordnetes Paar', 'Ein geordnetes Paar ist ein Paar mathematischer Objekte, bei dem die Reihenfolge der Komponenten wesentlich ist.', '(a,b)', '(a,b)', 'literature', 27, NULL, 'Neufassung 3.2.2 V2.', 'checked', 25),
(165, 'Def. 3.2.2.2', 10, 'Binäre Relation', 'Eine binäre Relation zwischen A und B ist eine Teilmenge des kartesischen Produkts A	imes B.', 'Rsubseteq A	imes B', 'Rsubseteq A	imes B', 'literature', 27, NULL, 'Neufassung 3.2.2 V2.', 'checked', 25),
(166, 'Def. 3.2.2.3', 10, 'Inverse Relation', 'Die inverse Relation entsteht durch Vertauschung der Komponenten aller Paare einer Relation.', 'R^{-1}={(b,a)mid(a,b)in R}', 'R^{-1}={(b,a)mid(a,b)in R}', 'literature', 27, NULL, 'Neufassung 3.2.2 V2.', 'checked', 25),
(167, 'Def. 3.2.2.4', 10, 'Äquivalenzrelation', 'Eine Äquivalenzrelation ist reflexiv, symmetrisch und transitiv.', NULL, NULL, 'literature', 27, NULL, 'Neufassung 3.2.2 V2.', 'checked', 25),
(168, 'Def. 3.2.2.5', 10, 'Äquivalenzklasse', 'Die Äquivalenzklasse eines Elements enthält alle Elemente, die bezüglich der Relation zu ihm äquivalent sind.', '[a]_R={xin Amid xRa}', '[a]_R={xin Amid xRa}', 'literature', 27, NULL, 'Neufassung 3.2.2 V2.', 'checked', 25),
(169, 'Def. 3.2.2.6', 10, 'Halbordnung', 'Eine Halbordnung ist reflexiv, antisymmetrisch und transitiv.', NULL, NULL, 'literature', 28, NULL, 'Neufassung 3.2.2 V2.', 'checked', 25),
(170, 'Def. 3.2.2.7', 10, 'Totalordnung', 'Eine Totalordnung ist eine Halbordnung, in der je zwei Elemente vergleichbar sind.', NULL, NULL, 'literature', 28, NULL, 'Neufassung 3.2.2 V2.', 'checked', 25),
(171, 'Def. 3.2.2.8', 10, 'Relationskomposition', 'Die Komposition zweier Relationen beschreibt mittelbare Beziehungen über ein Zwischenelement.', 'Scirc R={(a,c)midexists b:aRbland bSc}', 'Scirc R={(a,c)midexists b:aRbland bSc}', 'literature', 69, NULL, 'Neufassung 3.2.2 V2.', 'checked', 25),
(172, 'Def. 3.2.3.1', 11, 'Funktion', 'Eine Funktion von A nach B ist eine Relation, die jedem Element von A genau ein Element von B zuordnet.', 'f:A\\longrightarrow B', 'f:A\\longrightarrow B', 'literature', 29, NULL, 'Neufassung 3.2.3 V2.', 'checked', 26),
(173, 'Def. 3.2.3.2', 11, 'Bildmenge', 'Die Bildmenge enthält alle Werte, die durch die Funktion tatsächlich erreicht werden.', 'f(A)=\\{f(x)\\mid x\\in A\\}', 'f(A)=\\{f(x)\\mid x\\in A\\}', 'literature', 29, NULL, 'Neufassung 3.2.3 V2.', 'checked', 26),
(174, 'Def. 3.2.3.3', 11, 'Urbild', 'Das Urbild einer Teilmenge N enthält alle Elemente des Definitionsbereichs, deren Bilder in N liegen.', 'f^{-1}(N)=\\{x\\in A\\mid f(x)\\in N\\}', 'f^{-1}(N)=\\{x\\in A\\mid f(x)\\in N\\}', 'literature', 29, NULL, 'Neufassung 3.2.3 V2.', 'checked', 26),
(175, 'Def. 3.2.3.4', 11, 'Injektive Funktion', 'Eine Funktion ist injektiv, wenn verschiedene Ausgangselemente verschiedene Bilder besitzen.', NULL, NULL, 'literature', 30, NULL, 'Neufassung 3.2.3 V2.', 'checked', 26),
(176, 'Def. 3.2.3.5', 11, 'Surjektive Funktion', 'Eine Funktion ist surjektiv, wenn jedes Element der Zielmenge erreicht wird.', NULL, NULL, 'literature', 30, NULL, 'Neufassung 3.2.3 V2.', 'checked', 26),
(177, 'Def. 3.2.3.6', 11, 'Bijektive Funktion', 'Eine Funktion ist bijektiv, wenn sie injektiv und surjektiv ist.', NULL, NULL, 'literature', 30, NULL, 'Neufassung 3.2.3 V2.', 'checked', 26),
(178, 'Def. 3.2.3.7', 11, 'Umkehrfunktion', 'Die Umkehrfunktion einer bijektiven Funktion ordnet jedem Zielwert sein eindeutiges Urbild zu.', 'f^{-1}:B\\longrightarrow A', 'f^{-1}:B\\longrightarrow A', 'literature', 30, NULL, 'Neufassung 3.2.3 V2.', 'checked', 26),
(179, 'Def. 3.2.3.8', 11, 'Funktionskomposition', 'Die Komposition zweier Funktionen wendet die zweite Abbildung auf das Ergebnis der ersten an.', '(g\\circ f)(x)=g(f(x))', '(g\\circ f)(x)=g(f(x))', 'literature', 30, NULL, 'Neufassung 3.2.3 V2.', 'checked', 26),
(180, 'Def. 3.2.3.9', 11, 'Identitätsabbildung', 'Die Identitätsabbildung auf A ordnet jedem Element sich selbst zu.', '\\operatorname{id}_A(x)=x', '\\operatorname{id}_A(x)=x', 'literature', 30, NULL, 'Neufassung 3.2.3 V2.', 'checked', 26),
(181, 'Def. 3.2.4.1', 12, 'Innere binäre Verknüpfung', 'Eine innere binäre Verknüpfung auf A ordnet jedem Paar aus A×A eindeutig ein Element aus A zu.', 'star:A	imes Alongrightarrow A', 'star:A	imes Alongrightarrow A', 'literature', 83, NULL, NULL, 'checked', 29),
(182, 'Def. 3.2.4.2', 12, 'Magma', 'Ein Magma ist eine nichtleere Menge mit einer abgeschlossenen inneren binären Verknüpfung.', 'left(A,star\right)', 'left(A,star\right)', 'literature', 83, NULL, NULL, 'checked', 29),
(183, 'Def. 3.2.4.3', 12, 'Halbgruppe', 'Eine Halbgruppe ist ein Magma mit assoziativer Verknüpfung.', 'left(A,star\right)', 'left(A,star\right)', 'literature', 83, NULL, NULL, 'checked', 29),
(184, 'Def. 3.2.4.4', 12, 'Neutrales Element', 'Ein neutrales Element lässt jedes Element bei links- und rechtsseitiger Verknüpfung unverändert.', 'estar a=astar e=a', 'estar a=astar e=a', 'literature', 83, NULL, NULL, 'checked', 29),
(185, 'Def. 3.2.4.5', 12, 'Monoid', 'Ein Monoid ist eine Halbgruppe mit neutralem Element.', 'left(A,star,e\right)', 'left(A,star,e\right)', 'literature', 83, NULL, NULL, 'checked', 29),
(186, 'Def. 3.2.4.6', 12, 'Gruppe', 'Eine Gruppe ist ein Monoid, in dem jedes Element ein inverses Element besitzt.', 'left(A,star\right)', 'left(A,star\right)', 'literature', 84, NULL, NULL, 'checked', 29),
(187, 'Def. 3.2.4.7', 12, 'Abelsche Gruppe', 'Eine abelsche Gruppe ist eine Gruppe mit kommutativer Verknüpfung.', 'astar b=bstar a', 'astar b=bstar a', 'literature', 84, NULL, NULL, 'checked', 29),
(188, 'Def. 3.2.4.8', 12, 'Untergruppe', 'Eine Untergruppe ist eine Teilmenge einer Gruppe, die bezüglich derselben Verknüpfung selbst eine Gruppe bildet.', 'Hsubseteq G', 'Hsubseteq G', 'literature', 84, NULL, NULL, 'checked', 29),
(189, 'Def. 3.2.4.9', 12, 'Homomorphismus', 'Ein Homomorphismus ist eine Abbildung, die die algebraische Verknüpfung erhält.', 'varphi(astar b)=varphi(a)circvarphi(b)', 'varphi(astar b)=varphi(a)circvarphi(b)', 'literature', 84, NULL, NULL, 'checked', 29),
(190, 'Def. 3.2.4.10', 12, 'Isomorphismus', 'Ein Isomorphismus ist ein bijektiver Homomorphismus.', 'Gcong H', 'Gcong H', 'literature', 84, NULL, NULL, 'checked', 29),
(191, 'Def. 3.2.4.11', 12, 'Ring', 'Ein Ring ist eine Menge mit additiver abelscher Gruppenstruktur und einer assoziativen Multiplikation, die distributiv miteinander verknüpft sind.', 'left(R,+,cdot\right)', 'left(R,+,cdot\right)', 'literature', 82, NULL, NULL, 'checked', 29),
(192, 'Def. 3.2.4.12', 12, 'Körper', 'Ein Körper ist ein kommutativer Ring mit Eins, in dem jedes von null verschiedene Element multiplikativ invertierbar ist.', NULL, NULL, 'literature', 83, NULL, NULL, 'checked', 29),
(193, 'Def. 3.2.4.13', 12, 'Vektorraum', 'Ein Vektorraum über K ist eine abelsche Gruppe mit kompatibler Skalarmultiplikation.', 'K	imes Vlongrightarrow V', 'K	imes Vlongrightarrow V', 'literature', 83, NULL, NULL, 'checked', 29),
(194, 'Def. 3.2.5.1', 13, 'Operator', 'Ein Operator ist eine Abbildung zwischen mathematisch strukturierten Räumen.', 'T:X\\longrightarrow Y', 'T:X\\longrightarrow Y', 'literature', 35, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(195, 'Def. 3.2.5.2', 13, 'Endomorpher Operator', 'Ein Operator auf X bildet den Raum X in sich selbst ab.', 'T:X\\longrightarrow X', 'T:X\\longrightarrow X', 'literature', 35, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(196, 'Def. 3.2.5.3', 13, 'Definitionsbereich eines Operators', 'Der Definitionsbereich enthält alle Elemente, auf denen der Operator tatsächlich definiert ist.', '\\mathcal{D}(T)\\subseteq X', '\\mathcal{D}(T)\\subseteq X', 'literature', 36, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(197, 'Def. 3.2.5.4', 13, 'Wertebereich eines Operators', 'Der Wertebereich enthält alle durch den Operator tatsächlich erzeugten Bilder.', '\\mathcal{R}(T)=\\{T(x)\\mid x\\in\\mathcal{D}(T)\\}', '\\mathcal{R}(T)=\\{T(x)\\mid x\\in\\mathcal{D}(T)\\}', 'literature', 36, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(198, 'Def. 3.2.5.5', 13, 'Linearer Operator', 'Ein Operator ist linear, wenn er Addition und Skalarmultiplikation erhält.', 'T(\\alpha x+\\beta y)=\\alpha T(x)+\\beta T(y)', 'T(\\alpha x+\\beta y)=\\alpha T(x)+\\beta T(y)', 'literature', 101, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(199, 'Def. 3.2.5.6', 13, 'Kern eines linearen Operators', 'Der Kern enthält alle Elemente, die auf den Nullvektor abgebildet werden.', '\\ker(T)=\\{x\\in X\\mid T(x)=0\\}', '\\ker(T)=\\{x\\in X\\mid T(x)=0\\}', 'literature', 101, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(200, 'Def. 3.2.5.7', 13, 'Bild eines linearen Operators', 'Das Bild enthält alle durch den Operator erreichbaren Elemente des Zielraums.', '\\operatorname{im}(T)=\\{T(x)\\mid x\\in X\\}', '\\operatorname{im}(T)=\\{T(x)\\mid x\\in X\\}', 'literature', 101, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(201, 'Def. 3.2.5.8', 13, 'Invertierbarer Operator', 'Ein Operator ist invertierbar, wenn eine beidseitige Umkehrabbildung existiert.', 'T^{-1}\\circ T=I_X,\\quad T\\circ T^{-1}=I_Y', 'T^{-1}\\circ T=I_X,\\quad T\\circ T^{-1}=I_Y', 'literature', 35, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(202, 'Def. 3.2.5.9', 13, 'Endomorphismenring', 'Die Menge aller linearen Endomorphismen eines Vektorraums bildet unter Addition und Komposition eine Operatoralgebra.', '\\operatorname{End}(V)=\\{T:V\\longrightarrow V\\mid T\\text{ linear}\\}', '\\operatorname{End}(V)=\\{T:V\\longrightarrow V\\mid T\\text{ linear}\\}', 'literature', 36, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(203, 'Def. 3.2.5.10', 13, 'Spektrum eines Operators', 'Das Spektrum besteht aus allen komplexen Zahlen, für die T minus Lambda mal I nicht invertierbar ist.', '\\sigma(T)=\\{\\lambda\\in\\mathbb C\\mid T-\\lambda I\\text{ ist nicht invertierbar}\\}', '\\sigma(T)=\\{\\lambda\\in\\mathbb C\\mid T-\\lambda I\\text{ ist nicht invertierbar}\\}', 'literature', 11, NULL, 'Stand der Forschung; keine FRZK-Eigenleistung.', 'checked', 31),
(204, 'Def. 3.2.6.1', 14, 'Zustand', 'Ein Zustand eines Systems ist ein Element des Zustandsraumes und enthält die für die weitere Modellentwicklung relevanten Angaben.', 'x\\in X', 'x\\in X', 'literature', 102, NULL, 'Neufassung 3.2.6 V2.', 'checked', 38),
(205, 'Def. 3.2.6.2', 14, 'Zustandsraum', 'Der Zustandsraum ist die Menge aller im Modell zulässigen Zustände eines Systems.', 'X', 'X', 'literature', 102, NULL, 'Neufassung 3.2.6 V2.', 'checked', 38),
(206, 'Def. 3.2.6.3', 14, 'Vollständige Zustandsbeschreibung', 'Eine Zustandsbeschreibung ist vollständig, wenn der aktuelle Zustand zusammen mit der Übergangsregel die weitere Entwicklung bestimmt.', 'x_{k+1}=F(x_k)', 'x_{k+1}=F(x_k)', 'literature', 102, NULL, 'Neufassung 3.2.6 V2.', 'checked', 38),
(207, 'Def. 3.2.6.4', 14, 'Zulässiger Zustandsraum', 'Der zulässige Zustandsraum ist die Teilmenge aller Zustände, welche die Modellnebenbedingungen erfüllen.', 'X_{\\mathrm{zul}}\\subseteq X', 'X_{\\mathrm{zul}}\\subseteq X', 'literature', 38, NULL, 'Neufassung 3.2.6 V2.', 'checked', 38),
(208, 'Def. 3.2.6.5', 14, 'Diskrete Zustandsentwicklung', 'Eine diskrete Zustandsentwicklung ist eine durch Iteration einer Übergangsabbildung erzeugte Zustandsfolge.', 'x_{k+1}=F(x_k)', 'x_{k+1}=F(x_k)', 'literature', 40, NULL, 'Neufassung 3.2.6 V2.', 'checked', 38),
(209, 'Def. 3.2.6.6', 14, 'Zeitabhängige Zustandsfunktion', 'Eine zeitabhängige Zustandsfunktion ordnet jedem Zeitpunkt eines Intervalls genau einen Zustand zu.', 'x:I\\longrightarrow X', 'x:I\\longrightarrow X', 'literature', 103, NULL, 'Neufassung 3.2.6 V2.', 'checked', 38),
(210, 'Def. 3.2.6.7', 14, 'Fluss', 'Ein Fluss ist eine zeitparametrisierte Familie von Zustandsabbildungen mit Identitäts- und Kompositionseigenschaft.', '\\Phi:\\mathbb{R}\\times X\\longrightarrow X', '\\Phi:\\mathbb{R}\\times X\\longrightarrow X', 'literature', 103, NULL, 'Neufassung 3.2.6 V2.', 'checked', 38),
(211, 'Def. 3.2.6.8', 14, 'Trajektorie', 'Eine Trajektorie ist die Menge aller Zustände, die aus einem Anfangszustand entlang eines Flusses erreicht werden.', '\\gamma(x_0)=\\{\\Phi(t,x_0)\\mid t\\in I\\}', '\\gamma(x_0)=\\{\\Phi(t,x_0)\\mid t\\in I\\}', 'literature', 40, NULL, 'Neufassung 3.2.6 V2.', 'checked', 38),
(212, 'Def. 3.2.6.9', 14, 'Gleichgewichtspunkt', 'Ein Gleichgewichtspunkt ist ein Zustand, dessen zeitliche Entwicklung unverändert bleibt.', 'F(x^\\ast)=0', 'F(x^\\ast)=0', 'literature', 39, NULL, 'Neufassung 3.2.6 V2.', 'checked', 38),
(213, 'Def. 3.2.7.1', 15, 'Positiv invariante Menge', 'Eine Teilmenge ist positiv invariant, wenn jede in ihr beginnende Trajektorie für alle zukünftigen Zeiten in ihr verbleibt.', 'x_0\\in M\\Longrightarrow\\Phi(t,x_0)\\in M\\qquad\\forall t\\geq0', 'x_0\\in M\\Longrightarrow\\Phi(t,x_0)\\in M\\qquad\\forall t\\geq0', 'literature', 105, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(214, 'Def. 3.2.7.2', 15, 'Invariante Menge', 'Eine Teilmenge ist invariant, wenn sie unter der gesamten definierten Dynamik erhalten bleibt.', 'x_0\\in M\\Longrightarrow\\Phi(t,x_0)\\in M\\qquad\\forall t\\in\\mathbb{R}', 'x_0\\in M\\Longrightarrow\\Phi(t,x_0)\\in M\\qquad\\forall t\\in\\mathbb{R}', 'literature', 105, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(215, 'Def. 3.2.7.3', 15, 'Lyapunov-Stabilität', 'Ein Gleichgewichtspunkt ist stabil, wenn hinreichend kleine Anfangsabweichungen dauerhaft klein bleiben.', '\\forall\\varepsilon>0\\;\\exists\\delta>0:\\left\\|x_0-x^\\ast\\right\\|<\\delta\\Longrightarrow\\left\\|\\Phi(t,x_0)-x^\\ast\\right\\|<\\varepsilon\\quad\\forall t\\geq0', '\\forall\\varepsilon>0\\;\\exists\\delta>0:\\left\\|x_0-x^\\ast\\right\\|<\\delta\\Longrightarrow\\left\\|\\Phi(t,x_0)-x^\\ast\\right\\|<\\varepsilon\\quad\\forall t\\geq0', 'literature', 104, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(216, 'Def. 3.2.7.4', 15, 'Attraktivität', 'Ein Gleichgewichtspunkt ist attraktiv, wenn benachbarte Trajektorien langfristig gegen ihn konvergieren.', '\\exists r>0:\\left\\|x_0-x^\\ast\\right\\|<r\\Longrightarrow\\lim_{t\\rightarrow\\infty}\\Phi(t,x_0)=x^\\ast', '\\exists r>0:\\left\\|x_0-x^\\ast\\right\\|<r\\Longrightarrow\\lim_{t\\rightarrow\\infty}\\Phi(t,x_0)=x^\\ast', 'literature', 104, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(217, 'Def. 3.2.7.5', 15, 'Asymptotische Stabilität', 'Asymptotische Stabilität verbindet Stabilität und Attraktivität.', 'x^\\ast\\text{ ist asymptotisch stabil}\\Longleftrightarrow x^\\ast\\text{ ist stabil und attraktiv}', 'x^\\ast\\text{ ist asymptotisch stabil}\\Longleftrightarrow x^\\ast\\text{ ist stabil und attraktiv}', 'literature', 104, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(218, 'Def. 3.2.7.6', 15, 'Lyapunov-Funktion', 'Eine Lyapunov-Funktion ist eine skalare Funktion, die am Gleichgewicht verschwindet und entlang der Dynamik nicht zunimmt.', 'V:X\\longrightarrow\\mathbb{R}', 'V:X\\longrightarrow\\mathbb{R}', 'literature', 104, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(219, 'Def. 3.2.7.7', 15, 'Attraktor', 'Ein Attraktor ist eine kompakte invariante Menge, die ein Einzugsgebiet anzieht und bezüglich dieser Eigenschaften minimal ist.', '\\Phi(t,A)=A\\qquad\\forall t\\geq0', '\\Phi(t,A)=A\\qquad\\forall t\\geq0', 'literature', 106, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(220, 'Def. 3.2.7.8', 15, 'Einzugsgebiet', 'Das Einzugsgebiet eines Attraktors enthält alle Anfangszustände, deren Trajektorien sich dem Attraktor annähern.', 'B(A)=\\{x_0\\in X\\mid\\operatorname{dist}(\\Phi(t,x_0),A)\\rightarrow0\\}', 'B(A)=\\{x_0\\in X\\mid\\operatorname{dist}(\\Phi(t,x_0),A)\\rightarrow0\\}', 'literature', 106, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(221, 'Def. 3.2.7.9', 15, 'Punktattraktor', 'Ein Punktattraktor besteht aus einem asymptotisch stabilen Gleichgewichtspunkt.', 'A=\\{x^\\ast\\}', 'A=\\{x^\\ast\\}', 'literature', 106, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(222, 'Def. 3.2.7.10', 15, 'Periodischer Attraktor', 'Ein periodischer Attraktor ist eine geschlossene, anziehende periodische Bahn.', 'x(t+T)=x(t)', 'x(t+T)=x(t)', 'literature', 40, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(223, 'Def. 3.2.7.11', 15, 'Omega-Grenzmenge', 'Die Omega-Grenzmenge enthält alle Häufungspunkte einer Trajektorie für gegen unendlich strebende Zeiten.', '\\omega(x_0)=\\{y\\in X\\mid\\exists t_n\\rightarrow\\infty:\\Phi(t_n,x_0)\\rightarrow y\\}', '\\omega(x_0)=\\{y\\in X\\mid\\exists t_n\\rightarrow\\infty:\\Phi(t_n,x_0)\\rightarrow y\\}', 'literature', 40, NULL, 'Neufassung 3.2.7 V2.', 'checked', 39),
(224, 'Def. 3.2.8.1', 16, 'Nichtlineares dynamisches System', 'Ein dynamisches System ist nichtlinear, wenn sein Entwicklungsgesetz das Superpositionsprinzip nicht erfüllt.', 'F(\\alpha x_1+\\beta x_2,\\mu)\\neq\\alpha F(x_1,\\mu)+\\beta F(x_2,\\mu)', 'F(\\alpha x_1+\\beta x_2,\\mu)\\neq\\alpha F(x_1,\\mu)+\\beta F(x_2,\\mu)', 'literature', 108, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(225, 'Def. 3.2.8.2', 16, 'Kontrollparameter', 'Ein Kontrollparameter ist eine äußere oder innere Modellgröße, deren Variation die qualitative Dynamik verändern kann.', '\\mu\\in\\mathbb{R}^p', '\\mu\\in\\mathbb{R}^p', 'literature', 107, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(226, 'Def. 3.2.8.3', 16, 'Linearisierung', 'Die Linearisierung ist die Approximation eines nichtlinearen Systems durch die erste Ableitung seines Vektorfeldes in der Umgebung eines Gleichgewichtspunktes.', '\\dot{\\xi}=J(x^\\ast,\\mu)\\xi', '\\dot{\\xi}=J(x^\\ast,\\mu)\\xi', 'literature', 107, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(227, 'Def. 3.2.8.4', 16, 'Jacobi-Matrix', 'Die Jacobi-Matrix ist die Ableitung des Vektorfeldes bezüglich der Zustandsvariablen.', 'J(x^\\ast,\\mu)=D_xF(x^\\ast,\\mu)', 'J(x^\\ast,\\mu)=D_xF(x^\\ast,\\mu)', 'literature', 107, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(228, 'Def. 3.2.8.5', 16, 'Kritischer Parameterwert', 'Ein Parameterwert ist kritisch, wenn mindestens ein Eigenwert der linearisierten Dynamik einen verschwindenden Realteil besitzt.', '\\exists i:\\operatorname{Re}(\\lambda_i(\\mu_c))=0', '\\exists i:\\operatorname{Re}(\\lambda_i(\\mu_c))=0', 'literature', 107, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(229, 'Def. 3.2.8.6', 16, 'Bifurkation', 'Eine Bifurkation ist eine qualitative Änderung der Dynamik bei Variation eines Parameters, sodass die Systeme beiderseits des kritischen Wertes nicht topologisch äquivalent sind.', '\\Phi_{\\mu_c-\\varepsilon}\\not\\sim\\Phi_{\\mu_c+\\varepsilon}', '\\Phi_{\\mu_c-\\varepsilon}\\not\\sim\\Phi_{\\mu_c+\\varepsilon}', 'literature', 107, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(230, 'Def. 3.2.8.7', 16, 'Sattel-Knoten-Bifurkation', 'Eine Sattel-Knoten-Bifurkation erzeugt oder vernichtet lokal zwei Gleichgewichtspunkte.', '\\dot{x}=\\mu-x^2', '\\dot{x}=\\mu-x^2', 'literature', 107, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(231, 'Def. 3.2.8.8', 16, 'Transkritische Bifurkation', 'Bei einer transkritischen Bifurkation tauschen zwei Gleichgewichtszweige ihre Stabilität.', '\\dot{x}=\\mu x-x^2', '\\dot{x}=\\mu x-x^2', 'literature', 107, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(232, 'Def. 3.2.8.9', 16, 'Pitchfork-Bifurkation', 'Eine Pitchfork-Bifurkation beschreibt die symmetrische Aufspaltung eines Gleichgewichtszweiges.', '\\dot{x}=\\mu x-x^3', '\\dot{x}=\\mu x-x^3', 'literature', 107, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(233, 'Def. 3.2.8.10', 16, 'Hopf-Bifurkation', 'Eine Hopf-Bifurkation ist ein Übergang von einem Gleichgewicht zu einer periodischen Lösung durch ein komplex konjugiertes Eigenwertpaar.', '\\dot{z}=(\\mu+i\\omega)z-|z|^2z', '\\dot{z}=(\\mu+i\\omega)z-|z|^2z', 'literature', 108, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(234, 'Def. 3.2.8.11', 16, 'Emergenter Strukturwechsel', 'Ein emergenter Strukturwechsel liegt vor, wenn durch eine Parameteränderung eine qualitativ neue asymptotische Organisationsform entsteht.', 'A(\\mu^-)\\neq A(\\mu^+)', 'A(\\mu^-)\\neq A(\\mu^+)', 'literature', 106, NULL, 'Neufassung 3.2.8 V2.', 'checked', 40),
(235, 'Def. 3.2.9.1', 17, 'Diskrete Zufallsvariable', 'Eine diskrete Zufallsvariable ordnet elementaren Ergebnissen Werte aus einem endlichen oder abzählbaren Alphabet zu.', 'X:\\Omega\\to\\mathcal X', 'X:\\Omega\\to\\mathcal X', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(236, 'Def. 3.2.9.2', 17, 'Selbstinformation', 'Die Selbstinformation eines Ereignisses ist der negative Logarithmus seiner Wahrscheinlichkeit.', 'I(x_i)=-\\log_b p_i', 'I(x_i)=-\\log_b p_i', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(237, 'Def. 3.2.9.3', 17, 'Shannon-Entropie', 'Die Shannon-Entropie ist der Erwartungswert der Selbstinformation einer Zufallsvariablen.', 'H(X)=-\\sum_i p_i\\log_b p_i', 'H(X)=-\\sum_i p_i\\log_b p_i', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(238, 'Def. 3.2.9.4', 17, 'Gemeinsame Entropie', 'Die gemeinsame Entropie quantifiziert die gesamte Unbestimmtheit zweier Zufallsvariablen.', 'H(X,Y)=-\\sum_i\\sum_jp(x_i,y_j)\\log p(x_i,y_j)', 'H(X,Y)=-\\sum_i\\sum_jp(x_i,y_j)\\log p(x_i,y_j)', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(239, 'Def. 3.2.9.5', 17, 'Bedingte Entropie', 'Die bedingte Entropie misst die verbleibende Unsicherheit einer Variablen bei Kenntnis einer anderen.', 'H(X|Y)', 'H(X|Y)', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(240, 'Def. 3.2.9.6', 17, 'Gegenseitige Information', 'Die gegenseitige Information misst die Reduktion der Unsicherheit einer Variablen durch Kenntnis einer anderen.', 'I(X;Y)=H(X)-H(X|Y)', 'I(X;Y)=H(X)-H(X|Y)', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(241, 'Def. 3.2.9.7', 17, 'Kullback-Leibler-Divergenz', 'Die Kullback-Leibler-Divergenz quantifiziert den gerichteten Informationsverlust bei Approximation einer Verteilung P durch Q.', 'D_{KL}(P||Q)=\\sum_iP(x_i)\\log\\frac{P(x_i)}{Q(x_i)}', 'D_{KL}(P||Q)=\\sum_iP(x_i)\\log\\frac{P(x_i)}{Q(x_i)}', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(242, 'Def. 3.2.9.8', 17, 'Jensen-Shannon-Divergenz', 'Die Jensen-Shannon-Divergenz ist eine symmetrische Divergenz auf Grundlage zweier Kullback-Leibler-Divergenzen zur Mischverteilung.', 'D_{JS}(P,Q)=\\frac12D_{KL}(P||M)+\\frac12D_{KL}(Q||M)', 'D_{JS}(P,Q)=\\frac12D_{KL}(P||M)+\\frac12D_{KL}(Q||M)', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(243, 'Def. 3.2.9.9', 17, 'Informationsabhängigkeit', 'Informationsabhängigkeit liegt vor, wenn die gegenseitige Information zweier Variablen positiv ist.', 'I(X;Y)>0', 'I(X;Y)>0', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(244, 'Def. 3.2.9.10', 17, 'Informationsunabhängigkeit', 'Zwei Zufallsvariablen sind informationsunabhängig, wenn ihre gegenseitige Information verschwindet.', 'I(X;Y)=0', 'I(X;Y)=0', 'literature', 109, NULL, 'Vollständige Neufassung 3.2.9 V3.', 'checked', 41),
(265, 'Def. 3.2.10.1', 18, 'Graph', 'Ein Graph ist ein geordnetes Paar aus einer Knotenmenge und einer Kantenmenge.', 'G=(V,E)', 'G=(V,E)', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(266, 'Def. 3.2.10.2', 18, 'Gerichteter Graph', 'Ein gerichteter Graph besitzt Kanten als geordnete Paare von Knoten.', 'E\\subseteq V\\times V', 'E\\subseteq V\\times V', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(267, 'Def. 3.2.10.3', 18, 'Ungerichteter Graph', 'Ein ungerichteter Graph besitzt Kanten als ungeordnete Zweiermengen von Knoten.', '\\{v_i,v_j\\}\\in E', '\\{v_i,v_j\\}\\in E', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(268, 'Def. 3.2.10.4', 18, 'Einfacher Graph', 'Ein einfacher Graph enthält keine Schleifen und höchstens eine Kante zwischen zwei Knoten.', '(v_i,v_i)\\notin E', '(v_i,v_i)\\notin E', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(269, 'Def. 3.2.10.5', 18, 'Adjazenzmatrix', 'Die Adjazenzmatrix kodiert die Kantenstruktur eines endlichen Graphen in Matrixform.', 'A=(a_{ij})', 'A=(a_{ij})', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(270, 'Def. 3.2.10.6', 18, 'Knotengrad', 'Der Knotengrad ist die Anzahl der an einen Knoten angrenzenden Kanten.', '\\deg(v_i)=\\sum_j a_{ij}', '\\deg(v_i)=\\sum_j a_{ij}', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(271, 'Def. 3.2.10.7', 18, 'Weg', 'Ein Weg ist eine Knotenfolge, in der je zwei aufeinanderfolgende Knoten durch eine Kante verbunden sind.', '(v_i,v_{i+1})\\in E', '(v_i,v_{i+1})\\in E', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(272, 'Def. 3.2.10.8', 18, 'Graphendistanz', 'Die Graphendistanz ist die Länge eines kürzesten Pfades zwischen zwei Knoten.', 'd(v_i,v_j)=\\min_{P\\in\\mathcal P(v_i,v_j)}|P|', 'd(v_i,v_j)=\\min_{P\\in\\mathcal P(v_i,v_j)}|P|', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(273, 'Def. 3.2.10.9', 18, 'Zusammenhängender Graph', 'Ein Graph ist zusammenhängend, wenn zwischen jedem Knotenpaar mindestens ein Pfad existiert.', '\\forall v_i,v_j\\in V\\;\\exists P\\in\\mathcal P(v_i,v_j)', '\\forall v_i,v_j\\in V\\;\\exists P\\in\\mathcal P(v_i,v_j)', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(274, 'Def. 3.2.10.10', 18, 'Gewichteter Graph', 'Ein gewichteter Graph besitzt eine Gewichtsfunktion auf seiner Kantenmenge.', 'w:E\\to\\mathbb R', 'w:E\\to\\mathbb R', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(275, 'Def. 3.2.10.11', 18, 'Knotenstärke', 'Die Knotenstärke ist die Summe der Gewichte aller an einem Knoten anliegenden Kanten.', 's(v_i)=\\sum_j w_{ij}', 's(v_i)=\\sum_j w_{ij}', 'literature', 119, NULL, 'Masterstandard V5 für Abschnitt 3.2.10.', 'checked', 47),
(276, 'Def. 3.2.11.1', 19, 'Gradzentralität', 'Die Gradzentralität misst den normierten Anteil der direkten Nachbarn eines Knotens.', 'C_D(v_i)=\\frac{\\deg(v_i)}{n-1}', 'C_D(v_i)=\\frac{\\deg(v_i)}{n-1}', 'literature', 122, NULL, 'Masterstandard V5 für Abschnitt 3.2.11.', 'checked', 45),
(277, 'Def. 3.2.11.2', 19, 'Closeness-Zentralität', 'Die Closeness-Zentralität misst die globale Erreichbarkeit eines Knotens über die Summe kürzester Distanzen.', 'C_C(v_i)=\\frac{n-1}{\\sum_j d(v_i,v_j)}', 'C_C(v_i)=\\frac{n-1}{\\sum_j d(v_i,v_j)}', 'literature', 122, NULL, 'Masterstandard V5 für Abschnitt 3.2.11.', 'checked', 45),
(278, 'Def. 3.2.11.3', 19, 'Betweenness-Zentralität', 'Die Betweenness-Zentralität misst die Vermittlungsfunktion eines Knotens auf kürzesten Wegen.', 'C_B(v)=\\sum_{s\\neq v\\neq t}\\frac{\\sigma_{st}(v)}{\\sigma_{st}}', 'C_B(v)=\\sum_{s\\neq v\\neq t}\\frac{\\sigma_{st}(v)}{\\sigma_{st}}', 'literature', 122, NULL, 'Masterstandard V5 für Abschnitt 3.2.11.', 'checked', 45),
(279, 'Def. 3.2.11.4', 19, 'Eigenvektor-Zentralität', 'Die Eigenvektor-Zentralität bewertet einen Knoten höher, wenn er mit bereits zentralen Knoten verbunden ist.', 'Ax=\\lambda x', 'Ax=\\lambda x', 'literature', 122, NULL, 'Masterstandard V5 für Abschnitt 3.2.11.', 'checked', 45),
(280, 'Def. 3.2.11.5', 19, 'Lokaler Clusterkoeffizient', 'Der lokale Clusterkoeffizient quantifiziert die Vernetzung innerhalb der Nachbarschaft eines Knotens.', 'C(v_i)=\\frac{2m_i}{k_i(k_i-1)}', 'C(v_i)=\\frac{2m_i}{k_i(k_i-1)}', 'literature', 120, NULL, 'Masterstandard V5 für Abschnitt 3.2.11.', 'checked', 45),
(281, 'Def. 3.2.11.6', 19, 'Mittlere Weglänge', 'Die mittlere Weglänge ist der Durchschnitt der kürzesten Distanzen zwischen allen erreichbaren Knotenpaaren.', 'L=\\frac{1}{n(n-1)}\\sum_{i\\neq j}d(v_i,v_j)', 'L=\\frac{1}{n(n-1)}\\sum_{i\\neq j}d(v_i,v_j)', 'literature', 120, NULL, 'Masterstandard V5 für Abschnitt 3.2.11.', 'checked', 45),
(282, 'Def. 3.2.11.7', 19, 'Small-World-Netzwerk', 'Ein Small-World-Netzwerk verbindet hohe lokale Clusterung mit einer mittleren Weglänge nahe der eines Zufallsgraphen.', 'C\\gg C_{\\mathrm{random}},\\;L\\approx L_{\\mathrm{random}}', 'C\\gg C_{\\mathrm{random}},\\;L\\approx L_{\\mathrm{random}}', 'literature', 120, NULL, 'Masterstandard V5 für Abschnitt 3.2.11.', 'checked', 45),
(283, 'Def. 3.2.11.8', 19, 'Skalenfreies Netzwerk', 'Ein skalenfreies Netzwerk besitzt näherungsweise eine potenzgesetzartige Knotengradverteilung.', 'P(k)\\sim k^{-\\gamma}', 'P(k)\\sim k^{-\\gamma}', 'literature', 121, NULL, 'Masterstandard V5 für Abschnitt 3.2.11.', 'checked', 45),
(284, 'Def. 3.2.11.9', 19, 'Hub', 'Ein Hub ist ein Knoten mit im Verhältnis zum Gesamtnetzwerk außergewöhnlich hohem Grad oder hoher Zentralität.', 'k\\gg\\langle k\\rangle', 'k\\gg\\langle k\\rangle', 'literature', 121, NULL, 'Masterstandard V5 für Abschnitt 3.2.11.', 'checked', 45),
(285, 'Def. 3.2.12.1', 20, 'Systematische Forschungslücke', 'Die systematische Forschungslücke bezeichnet das Fehlen eines formalen Systems, das die Entstehung, Veränderung und Stabilisierung funktionaler Relationen sowie die daraus hervorgehende Rekonstruktion von Raum und Zeit erklärt.', NULL, NULL, '', NULL, 'Die etablierten mathematischen Theorien beschreiben bereits definierte Träger, Relationen, Zustandsräume oder Wahrscheinlichkeitsräume.', 'Zusammenfassende Eigenanalyse des Forschungsstandes ohne neue mathematische Gleichung.', 'checked', 49),
(286, 'Def. 3.2.12.2', 20, 'Anforderung funktionaler Strukturgenese', 'Ein gesuchtes formales System muss funktionale Relationen nicht nur als gegeben behandeln, sondern Regeln ihrer Entstehung, Veränderung, Stabilisierung und übergeordneten Organisation bereitstellen.', NULL, NULL, '', NULL, 'Raum und Zeit sollen nicht als primitive externe Strukturen vorausgesetzt werden.', 'Methodische Anforderung für die Axiomatik in Kapitel 3.3.', 'checked', 49),
(287, 'Def. 3.2.12.3', 20, 'Axiomatische Anschlussanforderung', 'Die axiomatische Anschlussanforderung verlangt, dass alle späteren mathematischen Rekonstruktionen aus einer kleinen Menge expliziter und voneinander abgegrenzter Grundannahmen ableitbar sind.', NULL, NULL, '', NULL, 'Kapitel 3.3 formuliert qualitative Grundannahmen; Kapitel 3.4 rekonstruiert daraus mathematische Strukturen.', 'Übergangsdefinition zwischen Kapitel 3.2 und Kapitel 3.3.', 'checked', 49);
...
(14, 7, '3.2.6', 'Zustandsräume als mathematische Grundlage funktionaler Dynamik', 3, 3.2600, 'review', 0, 'Vollständige Neufassung V2 mit Quellen [68]–[69] und Gleichungen (3.136)–(3.158).', '2026-07-12 11:14:28', '2026-07-15 06:07:08'),
(15, 7, '3.2.7', 'Stabilität, Invarianz und Attraktoren als mathematische Beschreibung langfristiger Organisation', 3, 3.2700, 'review', 0, 'Neufassung V2 mit Quellen [70]–[72] und Gleichungen (3.159)–(3.183).', '2026-07-12 11:14:28', '2026-07-15 06:33:13'),
(16, 7, '3.2.8', 'Nichtlinearität, Bifurkationen und Emergenz als mathematische Grundlagen qualitativer Strukturveränderungen', 3, 3.2800, 'review', 0, 'Neufassung V2 mit Quellen [73]–[74] und Gleichungen (3.184)–(3.211).', '2026-07-12 11:14:28', '2026-07-15 06:53:11'),
(17, 7, '3.2.9', 'Informationstheorie als mathematische Grundlage funktionaler Informationsprozesse', 3, 3.2900, 'review', 0, 'Vollständige Neufassung V3 mit Quellen [75]–[76] und Gleichungen (3.212)–(3.244).', '2026-07-12 11:14:28', '2026-07-15 07:11:32'),
(18, 7, '3.2.10', 'Graphen- und Netzwerktheorie als mathematische Grundlage relationaler Strukturen', 3, 3.3000, 'review', 0, 'Masterstandard V5 mit Quellen [77]–[78] und Gleichungen (3.245)–(3.266).', '2026-07-12 11:14:28', '2026-07-15 12:28:51'),
(19, 7, '3.2.11', 'Netzwerkeigenschaften, Zentralitätsmaße und globale Organisationsstrukturen', 3, 3.3100, 'review', 0, 'Masterstandard V5 mit Quellen [79]–[81] und Gleichungen (3.267)–(3.274).', '2026-07-12 11:14:28', '2026-07-15 16:07:29'),
(20, 7, '3.2.12', 'Zusammenfassung der mathematischen Grundlagen und Identifikation der Forschungslücke', 3, 3.3200, '', 0, 'Abschluss von Kapitel 3.2 im Masterstandard V5; keine neuen Gleichungen oder Literaturquellen.', '2026-07-12 11:14:28', '2026-07-15 17:08:11'),
...
(448, '3.3', 9, 'Elementzugehörigkeit', 'x\\in M', 'x\\in M', 'Das Objekt x ist Element der Menge M.', 'definition', 'literature', 23, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(449, '3.4', 9, 'Nichtzugehörigkeit', 'x\\notin M', 'x\\notin M', 'Das Objekt x ist kein Element der Menge M.', 'definition', 'literature', 23, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(450, '3.5', 9, 'Leere Menge', '\\emptyset', '\\emptyset', 'Bezeichnung der eindeutig bestimmten Menge ohne Elemente.', 'definition', 'literature', 24, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(451, '3.6', 9, 'Extensionalitätsaxiom', 'A=B\\Longleftrightarrow\\forall x\\left(x\\in A\\Longleftrightarrow x\\in B\\right)', 'A=B\\Longleftrightarrow\\forall x\\left(x\\in A\\Longleftrightarrow x\\in B\\right)', 'Zwei Mengen sind genau dann identisch, wenn sie dieselben Elemente besitzen.', 'axiom', 'literature', 24, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(452, '3.7', 9, 'Teilmengenrelation', 'A\\subseteq B\\Longleftrightarrow\\forall x\\left(x\\in A\\Longrightarrow x\\in B\\right)', 'A\\subseteq B\\Longleftrightarrow\\forall x\\left(x\\in A\\Longrightarrow x\\in B\\right)', 'A ist genau dann Teilmenge von B, wenn jedes Element von A auch Element von B ist.', 'definition', 'literature', 24, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(453, '3.8', 9, 'Aussonderungsmenge', 'A_P=\\left\\{x\\in A\\mid P(x)\\right\\}', 'A_P=\\left\\{x\\in A\\mid P(x)\\right\\}', 'Teilmenge von A, deren Elemente die Eigenschaft P erfüllen.', 'definition', 'literature', 63, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(454, '3.9', 9, 'Vereinigung', 'A\\cup B=\\{x\\mid x\\in A\\lor x\\in B\\}', 'A\\cup B=\\{x\\mid x\\in A\\lor x\\in B\\}', 'Vereinigung der Mengen A und B.', 'definition', 'literature', 24, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(455, '3.10', 9, 'Durchschnitt', 'A\\cap B=\\{x\\mid x\\in A\\land x\\in B\\}', 'A\\cap B=\\{x\\mid x\\in A\\land x\\in B\\}', 'Durchschnitt der Mengen A und B.', 'definition', 'literature', 24, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(456, '3.11', 9, 'Differenzmenge', 'A\\setminus B=\\{x\\mid x\\in A\\land x\\notin B\\}', 'A\\setminus B=\\{x\\mid x\\in A\\land x\\notin B\\}', 'Differenzmenge von A bezüglich B.', 'definition', 'literature', 24, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(457, '3.12', 9, 'Komplement', 'A^{c}=U\\setminus A', 'A^{c}=U\\setminus A', 'Komplement von A relativ zur Grundmenge U.', 'definition', 'literature', 24, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(458, '3.13', 9, 'Kartesisches Produkt', 'A\\times B=\\{(a,b)\\mid a\\in A,\\;b\\in B\\}', 'A\\times B=\\{(a,b)\\mid a\\in A,\\;b\\in B\\}', 'Menge aller geordneten Paare aus A und B.', 'definition', 'literature', 23, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(459, '3.14', 9, 'Potenzmenge', '\\mathcal P(A)=\\{X\\mid X\\subseteq A\\}', '\\mathcal P(A)=\\{X\\mid X\\subseteq A\\}', 'Menge aller Teilmengen von A.', 'definition', 'literature', 23, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(460, '3.15', 9, 'Satz von Cantor', '|\\mathcal P(A)|>|A|', '|\\mathcal P(A)|>|A|', 'Die Potenzmenge besitzt eine strikt größere Mächtigkeit als ihre Ausgangsmenge.', 'theorem', 'literature', 23, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(461, '3.16', 9, 'Schema mengenbildender Operationen', '\\Omega:\\mathcal P(M)\\longrightarrow\\mathcal P(M)', '\\Omega:\\mathcal P(M)\\longrightarrow\\mathcal P(M)', 'Schematische Darstellung einer Operation auf Teilmengen einer Grundmenge.', 'schema', 'adapted', 63, NULL, 'Gültig im Rahmen der axiomatischen Mengenlehre und der im Abschnitt angegebenen Grundmengen.', 'checked', 24),
(462, '3.17', 10, 'Geordnetes Paar', '(a,b)', '(a,b)', 'Geordnetes Paar aus den Komponenten a und b.', 'definition', 'literature', 27, NULL, 'a und b sind Elemente geeigneter Mengen.', 'checked', 25),
(463, '3.18', 10, 'Identität geordneter Paare', '(a,b)=(c,d)Longleftrightarrow a=cland b=d', '(a,b)=(c,d)Longleftrightarrow a=cland b=d', 'Zwei geordnete Paare sind genau dann gleich, wenn ihre jeweiligen Komponenten übereinstimmen.', 'definition', 'literature', 27, NULL, 'a,b,c,d sind mathematische Objekte.', 'checked', 25),
(464, '3.19', 10, 'Reihenfolge geordneter Paare', '(a,b)\neq(b,a)', '(a,b)\neq(b,a)', 'Bei verschiedenen Komponenten ist die Reihenfolge eines geordneten Paares wesentlich.', 'derived', 'literature', 27, NULL, 'a\neq b.', 'checked', 25),
(465, '3.20', 10, 'Kartesisches Produkt', 'A	imes B=left{(a,b)mid ain Aland bin B\right}', 'A	imes B=left{(a,b)mid ain Aland bin B\right}', 'Das kartesische Produkt enthält alle geordneten Paare aus A und B.', 'definition', 'literature', 27, NULL, 'A und B sind Mengen.', 'checked', 25),
(466, '3.21', 10, 'Binäre Relation', 'Rsubseteq A	imes B', 'Rsubseteq A	imes B', 'Eine binäre Relation zwischen A und B ist eine Teilmenge ihres kartesischen Produkts.', 'definition', 'literature', 27, NULL, 'A und B sind Mengen.', 'checked', 25),
(467, '3.22', 10, 'Relationsnotation', 'aRbLongleftrightarrow(a,b)in R', 'aRbLongleftrightarrow(a,b)in R', 'Die Schreibweise aRb bedeutet, dass das geordnete Paar (a,b) zur Relation R gehört.', 'definition', 'literature', 27, NULL, 'Rsubseteq A	imes B.', 'checked', 25),
(468, '3.23', 10, 'Relation auf einer Menge', 'Rsubseteq A	imes A', 'Rsubseteq A	imes A', 'Eine Relation auf A ist eine Teilmenge von A mal A.', 'definition', 'literature', 27, NULL, 'A ist eine Menge.', 'checked', 25),
(469, '3.24', 10, 'Definitionsbereich einer Relation', 'operatorname{dom}(R)=left{ain Amidexists bin B:(a,b)in R\right}', 'operatorname{dom}(R)=left{ain Amidexists bin B:(a,b)in R\right}', 'Der Definitionsbereich enthält alle ersten Komponenten, die in mindestens einem Relationspaar auftreten.', 'definition', 'literature', 27, NULL, 'Rsubseteq A	imes B.', 'checked', 25),
(470, '3.25', 10, 'Wertebereich einer Relation', 'operatorname{ran}(R)=left{bin Bmidexists ain A:(a,b)in R\right}', 'operatorname{ran}(R)=left{bin Bmidexists ain A:(a,b)in R\right}', 'Der Wertebereich enthält alle zweiten Komponenten, die in mindestens einem Relationspaar auftreten.', 'definition', 'literature', 27, NULL, 'Rsubseteq A	imes B.', 'checked', 25),
(471, '3.26', 10, 'Inverse Relation', 'R^{-1}=left{(b,a)mid(a,b)in R\right}', 'R^{-1}=left{(b,a)mid(a,b)in R\right}', 'Die inverse Relation entsteht durch Vertauschung der Komponenten aller Relationspaare.', 'definition', 'literature', 27, NULL, 'R ist eine binäre Relation.', 'checked', 25),
(472, '3.27', 10, 'Reflexivität', 'forall ain A:;aRa', 'forall ain A:;aRa', 'Eine Relation ist reflexiv, wenn jedes Element zu sich selbst in Relation steht.', 'definition', 'literature', 27, NULL, 'R ist eine Relation auf A.', 'checked', 25),
(473, '3.28', 10, 'Irreflexivität', 'forall ain A:;\neg(aRa)', 'forall ain A:;\neg(aRa)', 'Eine Relation ist irreflexiv, wenn kein Element zu sich selbst in Relation steht.', 'definition', 'literature', 27, NULL, 'R ist eine Relation auf A.', 'checked', 25),
(474, '3.29', 10, 'Symmetrie', 'forall a,bin A:;aRbLongrightarrow bRa', 'forall a,bin A:;aRbLongrightarrow bRa', 'Eine Relation ist symmetrisch, wenn jede Beziehung auch in der Gegenrichtung gilt.', 'definition', 'literature', 27, NULL, 'R ist eine Relation auf A.', 'checked', 25),
(475, '3.30', 10, 'Antisymmetrie', 'forall a,bin A:;left(aRbland bRa\right)Longrightarrow a=b', 'forall a,bin A:;left(aRbland bRa\right)Longrightarrow a=b', 'Eine Relation ist antisymmetrisch, wenn wechselseitige Relation Identität erzwingt.', 'definition', 'literature', 28, NULL, 'R ist eine Relation auf A.', 'checked', 25),
(476, '3.31', 10, 'Asymmetrie', 'forall a,bin A:;aRbLongrightarrow\neg(bRa)', 'forall a,bin A:;aRbLongrightarrow\neg(bRa)', 'Eine Relation ist asymmetrisch, wenn aus aRb die Nichtgeltung von bRa folgt.', 'definition', 'literature', 28, NULL, 'R ist eine Relation auf A.', 'checked', 25),
(477, '3.32', 10, 'Transitivität', 'forall a,b,cin A:;left(aRbland bRc\right)Longrightarrow aRc', 'forall a,b,cin A:;left(aRbland bRc\right)Longrightarrow aRc', 'Eine Relation ist transitiv, wenn verkettete Beziehungen wieder eine Beziehung ergeben.', 'definition', 'literature', 27, NULL, 'R ist eine Relation auf A.', 'checked', 25),
(478, '3.33', 10, 'Äquivalenzrelation', 'R	ext{ ist Äquivalenzrelation}Longleftrightarrow R	ext{ ist reflexiv, symmetrisch und transitiv}', 'R	ext{ ist Äquivalenzrelation}Longleftrightarrow R	ext{ ist reflexiv, symmetrisch und transitiv}', 'Eine Äquivalenzrelation ist reflexiv, symmetrisch und transitiv.', 'definition', 'literature', 27, NULL, 'R ist eine Relation auf A.', 'checked', 25),
(479, '3.34', 10, 'Äquivalenzklasse', '[a]_R=left{xin Amid xRa\right}', '[a]_R=left{xin Amid xRa\right}', 'Die Äquivalenzklasse eines Elements enthält alle zu ihm äquivalenten Elemente.', 'definition', 'literature', 27, NULL, 'R ist eine Äquivalenzrelation auf A.', 'checked', 25),
(480, '3.35', 10, 'Quotientenmenge', 'A/R=left{[a]_Rmid ain A\right}', 'A/R=left{[a]_Rmid ain A\right}', 'Die Quotientenmenge besteht aus allen Äquivalenzklassen von A bezüglich R.', 'definition', 'literature', 27, NULL, 'R ist eine Äquivalenzrelation auf A.', 'checked', 25),
(481, '3.36', 10, 'Halbordnung', 'R	ext{ ist Halbordnung}Longleftrightarrow R	ext{ ist reflexiv, antisymmetrisch und transitiv}', 'R	ext{ ist Halbordnung}Longleftrightarrow R	ext{ ist reflexiv, antisymmetrisch und transitiv}', 'Eine Halbordnung ist reflexiv, antisymmetrisch und transitiv.', 'definition', 'literature', 28, NULL, 'R ist eine Relation auf A.', 'checked', 25),
(482, '3.37', 10, 'Partiell geordnete Menge', 'left(A,preceq\right)', 'left(A,preceq\right)', 'Ein Paar aus einer Menge A und einer Halbordnung bildet eine partiell geordnete Menge.', 'definition', 'literature', 28, NULL, 'preceq ist eine Halbordnung auf A.', 'checked', 25),
(483, '3.38', 10, 'Totalordnung', 'forall a,bin A:;apreceq blor bpreceq a', 'forall a,bin A:;apreceq blor bpreceq a', 'In einer Totalordnung sind je zwei Elemente vergleichbar.', 'definition', 'literature', 28, NULL, 'preceq ist eine Halbordnung auf A.', 'checked', 25),
(484, '3.39', 10, 'Komposition von Relationen', 'Scirc R=left{(a,c)in A	imes Cmidexists bin B:;aRbland bSc\right}', 'Scirc R=left{(a,c)in A	imes Cmidexists bin B:;aRbland bSc\right}', 'Die Komposition erfasst Beziehungen, die über ein Zwischenelement vermittelt werden.', 'definition', 'literature', 69, NULL, 'Rsubseteq A	imes B und Ssubseteq B	imes C.', 'checked', 25),
(485, '3.40', 10, 'Transitivität als Selbstkomposition', 'Rcirc Rsubseteq R', 'Rcirc Rsubseteq R', 'Eine Relation ist transitiv, wenn ihre Selbstkomposition in ihr enthalten ist.', 'derived', 'literature', 69, NULL, 'R ist eine Relation auf A.', 'checked', 25),
(486, '3.41', 10, 'Graph einer Relation', 'G_R=left(A,R\right)', 'G_R=left(A,R\right)', 'Eine binäre Relation auf A kann als gerichteter Graph mit Knotenmenge A und Kantenmenge R interpretiert werden.', 'model', 'literature', 27, NULL, 'Rsubseteq A	imes A.', 'checked', 25),
(487, '3.42', 11, 'Funktion als Abbildung', 'f:A\\longrightarrow B', 'f:A\\longrightarrow B', 'Eine Funktion f bildet die Definitionsmenge A in die Zielmenge B ab.', 'definition', 'literature', 29, NULL, 'A und B sind Mengen.', 'checked', 26),
(488, '3.43', 11, 'Existenz und Eindeutigkeit', '\\forall x\\in A\\;\\exists!\\,y\\in B:\\;f(x)=y', '\\forall x\\in A\\;\\exists!\\,y\\in B:\\;f(x)=y', 'Jedem Element des Definitionsbereichs wird genau ein Element des Zielbereichs zugeordnet.', 'definition', 'literature', 29, NULL, 'f ist eine Funktion von A nach B.', 'checked', 26),
(489, '3.44', 11, 'Existenzbedingung', '\\forall x\\in A\\;\\exists y\\in B:\\;f(x)=y', '\\forall x\\in A\\;\\exists y\\in B:\\;f(x)=y', 'Für jedes Element des Definitionsbereichs existiert mindestens ein Funktionswert.', 'definition', 'literature', 29, NULL, 'f ist eine totale Funktion auf A.', 'checked', 26),
(490, '3.45', 11, 'Eindeutigkeitsbedingung', '\\forall x\\in A\\;\\forall y_1,y_2\\in B:\\;\\left(f(x)=y_1\\land f(x)=y_2\\right)\\Longrightarrow y_1=y_2', '\\forall x\\in A\\;\\forall y_1,y_2\\in B:\\;\\left(f(x)=y_1\\land f(x)=y_2\\right)\\Longrightarrow y_1=y_2', 'Zu einem Ausgangselement können nicht zwei verschiedene Funktionswerte gehören.', 'definition', 'literature', 29, NULL, 'x liegt in A; y_1 und y_2 liegen in B.', 'checked', 26),
(491, '3.46', 11, 'Funktion als spezielle Relation', 'f\\subseteq A\\times B', 'f\\subseteq A\\times B', 'Eine Funktion ist eine spezielle Relation zwischen A und B.', 'definition', 'literature', 29, NULL, 'Zusätzlich gilt die Existenz- und Eindeutigkeitsbedingung.', 'checked', 26),
(492, '3.47', 11, 'Funktionswert und Relationspaar', 'f(x)=y\\Longleftrightarrow(x,y)\\in f', 'f(x)=y\\Longleftrightarrow(x,y)\\in f', 'Der Funktionswert y entspricht dem eindeutig zugeordneten Relationspaar.', 'definition', 'literature', 29, NULL, 'f ist mengentheoretisch als Relation aufgefasst.', 'checked', 26),
(493, '3.48', 11, 'Bild einer Menge', 'f(A)=\\left\\{f(x)\\mid x\\in A\\right\\}', 'f(A)=\\left\\{f(x)\\mid x\\in A\\right\\}', 'Das Bild von A enthält alle tatsächlich auftretenden Funktionswerte.', 'definition', 'literature', 29, NULL, 'f ist auf A definiert.', 'checked', 26),
(494, '3.49', 11, 'Bildmenge als Teilmenge', 'f(A)\\subseteq B', 'f(A)\\subseteq B', 'Das Bild einer Funktion ist Teilmenge ihrer Zielmenge.', 'derived', 'literature', 29, NULL, 'f bildet A nach B ab.', 'checked', 26),
(495, '3.50', 11, 'Bild einer Teilmenge', 'f(M)=\\left\\{f(x)\\mid x\\in M\\right\\}', 'f(M)=\\left\\{f(x)\\mid x\\in M\\right\\}', 'Bild einer Teilmenge M des Definitionsbereichs.', 'definition', 'literature', 29, NULL, 'M ist Teilmenge von A.', 'checked', 26),
(496, '3.51', 11, 'Urbild einer Teilmenge', 'f^{-1}(N)=\\left\\{x\\in A\\mid f(x)\\in N\\right\\}', 'f^{-1}(N)=\\left\\{x\\in A\\mid f(x)\\in N\\right\\}', 'Das Urbild enthält alle Ausgangselemente, deren Bilder in N liegen.', 'definition', 'literature', 29, NULL, 'N ist Teilmenge von B; keine inverse Funktion erforderlich.', 'checked', 26),
(497, '3.52', 11, 'Injektivität', '\\forall x_1,x_2\\in A:\\;f(x_1)=f(x_2)\\Longrightarrow x_1=x_2', '\\forall x_1,x_2\\in A:\\;f(x_1)=f(x_2)\\Longrightarrow x_1=x_2', 'Eine Funktion ist injektiv, wenn gleiche Bilder nur von gleichen Urbildern stammen.', 'definition', 'literature', 30, NULL, 'f ist eine Funktion von A nach B.', 'checked', 26),
(498, '3.53', 11, 'Äquivalente Injektivitätsbedingung', 'x_1\\neq x_2\\Longrightarrow f(x_1)\\neq f(x_2)', 'x_1\\neq x_2\\Longrightarrow f(x_1)\\neq f(x_2)', 'Verschiedene Ausgangselemente besitzen bei einer injektiven Funktion verschiedene Bilder.', 'derived', 'literature', 30, NULL, 'f ist injektiv.', 'checked', 26),
(499, '3.54', 11, 'Surjektivität', '\\forall y\\in B\\;\\exists x\\in A:\\;f(x)=y', '\\forall y\\in B\\;\\exists x\\in A:\\;f(x)=y', 'Eine Funktion ist surjektiv, wenn jedes Element der Zielmenge erreicht wird.', 'definition', 'literature', 30, NULL, 'f ist eine Funktion von A nach B.', 'checked', 26),
(500, '3.55', 11, 'Bildmenge einer surjektiven Funktion', 'f(A)=B', 'f(A)=B', 'Bei einer surjektiven Funktion stimmen Bild- und Zielmenge überein.', 'derived', 'literature', 30, NULL, 'f ist surjektiv.', 'checked', 26),
...
(502, '3.57', 11, 'Umkehrfunktion', 'f^{-1}:B\\longrightarrow A', 'f^{-1}:B\\longrightarrow A', 'Eine bijektive Funktion besitzt eine Umkehrfunktion von B nach A.', 'definition', 'literature', 30, NULL, 'f ist bijektiv.', 'checked', 26),
(503, '3.58', 11, 'Linke Umkehrbeziehung', 'f^{-1}(f(x))=x', 'f^{-1}(f(x))=x', 'Die Umkehrfunktion hebt die Wirkung von f auf Elementen aus A auf.', 'derived', 'literature', 30, NULL, 'x liegt in A und f ist bijektiv.', 'checked', 26),
(504, '3.59', 11, 'Rechte Umkehrbeziehung', 'f(f^{-1}(y))=y', 'f(f^{-1}(y))=y', 'Die Funktion hebt die Wirkung ihrer Umkehrfunktion auf Elementen aus B auf.', 'derived', 'literature', 30, NULL, 'y liegt in B und f ist bijektiv.', 'checked', 26),
(505, '3.60', 11, 'Komposition von Funktionen', '(g\\circ f)(x)=g(f(x))', '(g\\circ f)(x)=g(f(x))', 'Die Komposition wendet zunächst f und anschließend g an.', 'definition', 'literature', 30, NULL, 'f:A nach B und g:B nach C.', 'checked', 26),
(506, '3.61', 11, 'Assoziativität der Komposition', 'h\\circ(g\\circ f)=(h\\circ g)\\circ f', 'h\\circ(g\\circ f)=(h\\circ g)\\circ f', 'Die Komposition von Funktionen ist assoziativ.', 'derived', 'literature', 30, NULL, 'Definitions- und Zielmengen sind kompositionsverträglich.', 'checked', 26),
(507, '3.62', 11, 'Identitätsabbildung', '\\operatorname{id}_A:A\\longrightarrow A', '\\operatorname{id}_A:A\\longrightarrow A', 'Die Identitätsabbildung ist eine Funktion von A nach A.', 'definition', 'literature', 30, NULL, 'A ist eine Menge.', 'checked', 26),
(508, '3.63', 11, 'Wirkung der Identitätsabbildung', '\\operatorname{id}_A(x)=x', '\\operatorname{id}_A(x)=x', 'Die Identitätsabbildung lässt jedes Element unverändert.', 'definition', 'literature', 30, NULL, 'x liegt in A.', 'checked', 26),
(509, '3.64', 11, 'Identität als neutrales Element', 'f\\circ\\operatorname{id}_A=f=\\operatorname{id}_B\\circ f', 'f\\circ\\operatorname{id}_A=f=\\operatorname{id}_B\\circ f', 'Identitätsabbildungen sind neutrale Elemente der Funktionskomposition.', 'derived', 'literature', 30, NULL, 'f bildet A nach B ab.', 'checked', 26),
(510, '3.65', 12, 'Innere binäre Verknüpfung', 'star:A	imes Alongrightarrow A', 'star:A	imes Alongrightarrow A', 'Eine innere Verknüpfung bildet Paare aus A wieder nach A ab.', 'definition', 'literature', 83, NULL, 'A ist eine nichtleere Menge.', 'checked', 29),
(511, '3.66', 12, 'Abgeschlossenheit', 'forall a,bin A:;astar bin A', 'forall a,bin A:;astar bin A', 'Das Ergebnis der Verknüpfung liegt wieder in A.', 'definition', 'literature', 83, NULL, 'a,b liegen in A.', 'checked', 29),
(512, '3.67', 12, 'Magma', 'left(A,star\right)', 'left(A,star\right)', 'Paar aus Trägermenge und innerer Verknüpfung.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(513, '3.68', 12, 'Linke Klammerung', 'left(astar b\right)star c', 'left(astar b\right)star c', 'Erste Klammerung einer dreifachen Verknüpfung.', 'other', 'literature', 83, NULL, '', 'checked', 29),
(514, '3.69', 12, 'Rechte Klammerung', 'astarleft(bstar c\right)', 'astarleft(bstar c\right)', 'Zweite Klammerung einer dreifachen Verknüpfung.', 'other', 'literature', 83, NULL, '', 'checked', 29),
(515, '3.70', 12, 'Assoziativität', 'forall a,b,cin A:;left(astar b\right)star c=astarleft(bstar c\right)', 'forall a,b,cin A:;left(astar b\right)star c=astarleft(bstar c\right)', 'Assoziativgesetz.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(516, '3.71', 12, 'Halbgruppe', 'left(A,star\right)	ext{ ist Halbgruppe}Longleftrightarrowstar	ext{ ist abgeschlossen und assoziativ}', 'left(A,star\right)	ext{ ist Halbgruppe}Longleftrightarrowstar	ext{ ist abgeschlossen und assoziativ}', 'Charakterisierung einer Halbgruppe.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(517, '3.72', 12, 'Verknüpfungsfolge', 'a_1star a_2starcdotsstar a_n', 'a_1star a_2starcdotsstar a_n', 'Assoziativ interpretierbare endliche Verknüpfungsfolge.', 'schema', 'literature', 83, NULL, '', 'checked', 29),
(518, '3.73', 12, 'Linksneutrales Element', 'forall ain A:;estar a=a', 'forall ain A:;estar a=a', 'Linke Neutralität.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(519, '3.74', 12, 'Rechtsneutrales Element', 'forall ain A:;astar e=a', 'forall ain A:;astar e=a', 'Rechte Neutralität.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(520, '3.75', 12, 'Eindeutigkeit des neutralen Elements', 'e_1=e_1star e_2=e_2', 'e_1=e_1star e_2=e_2', 'Nachweis der Eindeutigkeit eines neutralen Elements.', 'derived', 'literature', 83, NULL, '', 'checked', 29),
(521, '3.76', 12, 'Monoid', 'left(A,star,e\right)	ext{ ist Monoid}Longleftrightarrowleft{egin{array}{l}star	ext{ ist assoziativ}\\e	ext{ ist neutrales Element}end{array}\right.', 'left(A,star,e\right)	ext{ ist Monoid}Longleftrightarrowleft{egin{array}{l}star	ext{ ist assoziativ}\\e	ext{ ist neutrales Element}end{array}\right.', 'Charakterisierung eines Monoids.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(522, '3.77', 12, 'Positive Potenz', 'a^n=underbrace{astar astarcdotsstar a}_{n	ext{ Faktoren}}', 'a^n=underbrace{astar astarcdotsstar a}_{n	ext{ Faktoren}}', 'Wiederholte Verknüpfung eines Elements.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(523, '3.78', 12, 'Nullte Potenz', 'a^0=e', 'a^0=e', 'Die nullte Potenz entspricht dem neutralen Element.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(524, '3.79', 12, 'Freies Wortmonoid', 'left(Sigma^ast,cdot,varepsilon\right)', 'left(Sigma^ast,cdot,varepsilon\right)', 'Monoid endlicher Wörter unter Konkatenation.', 'model', 'literature', 83, NULL, '', 'checked', 29),
(525, '3.80', 12, 'Rechtsinverses', 'astar a^{-1}=e', 'astar a^{-1}=e', 'Rechtsseitige Inversenbedingung.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(526, '3.81', 12, 'Linksinverses', 'a^{-1}star a=e', 'a^{-1}star a=e', 'Linksseitige Inversenbedingung.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(527, '3.82', 12, 'Gruppe', 'left(A,star\right)	ext{ ist Gruppe}Longleftrightarrowleft{egin{array}{l}star	ext{ ist assoziativ}\\e	ext{ existiert}\\forall ain A;exists a^{-1}in Aend{array}\right.', 'left(A,star\right)	ext{ ist Gruppe}Longleftrightarrowleft{egin{array}{l}star	ext{ ist assoziativ}\\e	ext{ existiert}\\forall ain A;exists a^{-1}in Aend{array}\right.', 'Charakterisierung einer Gruppe.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(528, '3.83', 12, 'Eindeutigkeit inverser Elemente', 'b=bstar e=bstarleft(astar c\right)=left(bstar a\right)star c=estar c=c', 'b=bstar e=bstarleft(astar c\right)=left(bstar a\right)star c=estar c=c', 'Herleitung der Eindeutigkeit des Inversen.', 'derived', 'literature', 84, NULL, '', 'checked', 29),
(529, '3.84', 12, 'Kommutativität', 'forall a,bin A:;astar b=bstar a', 'forall a,bin A:;astar b=bstar a', 'Kommutativgesetz einer abelschen Gruppe.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(530, '3.85', 12, 'Untergruppenkriterium', 'forall a,bin H:;astar b^{-1}in H', 'forall a,bin H:;astar b^{-1}in H', 'Praktisches Kriterium für eine Untergruppe.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(531, '3.86', 12, 'Gruppenhomomorphismus', 'varphileft(astar b\right)=varphi(a)circvarphi(b)', 'varphileft(astar b\right)=varphi(a)circvarphi(b)', 'Erhaltung der Gruppenverknüpfung.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(532, '3.87', 12, 'Isomorphie', 'Gcong H', 'Gcong H', 'Kennzeichnung strukturgleicher Gruppen.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(533, '3.88', 12, 'Ringstruktur', 'left(R,+,cdot\right)', 'left(R,+,cdot\right)', 'Ring mit zwei inneren Operationen.', 'definition', 'literature', 82, NULL, '', 'checked', 29),
(534, '3.89', 12, 'Assoziativität der Addition', 'forall a,b,cin R:;left(a+b\right)+c=a+left(b+c\right)', 'forall a,b,cin R:;left(a+b\right)+c=a+left(b+c\right)', 'Assoziativgesetz der Addition.', 'definition', 'literature', 82, NULL, '', 'checked', 29),
(535, '3.90', 12, 'Additives neutrales Element', 'a+0=a', 'a+0=a', 'Additive Neutralität.', 'definition', 'literature', 82, NULL, '', 'checked', 29),
(536, '3.91', 12, 'Additives Inverses', 'a+left(-a\right)=0', 'a+left(-a\right)=0', 'Additive Inversenbedingung.', 'definition', 'literature', 82, NULL, '', 'checked', 29),
(537, '3.92', 12, 'Assoziativität der Multiplikation', 'left(acdot b\right)cdot c=acdotleft(bcdot c\right)', 'left(acdot b\right)cdot c=acdotleft(bcdot c\right)', 'Assoziativgesetz der Multiplikation.', 'definition', 'literature', 82, NULL, '', 'checked', 29),
(538, '3.93', 12, 'Linkes Distributivgesetz', 'acdotleft(b+c\right)=acdot b+acdot c', 'acdotleft(b+c\right)=acdot b+acdot c', 'Linke Distributivität.', 'definition', 'literature', 82, NULL, '', 'checked', 29),
(539, '3.94', 12, 'Rechtes Distributivgesetz', 'left(a+b\right)cdot c=acdot c+bcdot c', 'left(a+b\right)cdot c=acdot c+bcdot c', 'Rechte Distributivität.', 'definition', 'literature', 82, NULL, '', 'checked', 29),
(540, '3.95', 12, 'Kommutative Multiplikation', 'acdot b=bcdot a', 'acdot b=bcdot a', 'Kommutativität in einem kommutativen Ring.', 'definition', 'literature', 82, NULL, '', 'checked', 29),
(541, '3.96', 12, 'Multiplikatives neutrales Element', '1cdot a=a=acdot 1', '1cdot a=a=acdot 1', 'Multiplikative Neutralität.', 'definition', 'literature', 82, NULL, '', 'checked', 29),
(542, '3.97', 12, 'Multiplikatives Inverses im Körper', 'forall a\neq0;exists a^{-1}:;acdot a^{-1}=1', 'forall a\neq0;exists a^{-1}:;acdot a^{-1}=1', 'Inverseigenschaft von Körperelementen.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(543, '3.98', 12, 'Grundkörper', 'mathbb{Q},;mathbb{R},;mathbb{C}', 'mathbb{Q},;mathbb{R},;mathbb{C}', 'Beispiele wichtiger Körper.', 'schema', 'literature', 83, NULL, '', 'checked', 29),
(544, '3.99', 12, 'Skalarmultiplikation', 'K	imes Vlongrightarrow V', 'K	imes Vlongrightarrow V', 'Skalarmultiplikation eines Vektorraums.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(545, '3.100', 12, 'Distributivität über Vektoraddition', 'lambdaleft(u+v\right)=lambda u+lambda v', 'lambdaleft(u+v\right)=lambda u+lambda v', 'Erstes Distributivgesetz des Vektorraums.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(546, '3.101', 12, 'Distributivität über Skalaraddition', 'left(lambda+mu\right)v=lambda v+mu v', 'left(lambda+mu\right)v=lambda v+mu v', 'Zweites Distributivgesetz des Vektorraums.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(547, '3.102', 12, 'Assoziativität der Skalarmultiplikation', 'left(lambdamu\right)v=lambdaleft(mu v\right)', 'left(lambdamu\right)v=lambdaleft(mu v\right)', 'Verträglichkeit der Skalarmultiplikation.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(548, '3.103', 12, 'Skalare Identität', '1v=v', '1v=v', 'Wirkung der skalaren Eins.', 'definition', 'literature', 83, NULL, '', 'checked', 29),
(549, '3.104', 12, 'Homomorphismus', 'varphileft(astar b\right)=varphi(a)starvarphi(b)', 'varphileft(astar b\right)=varphi(a)starvarphi(b)', 'Allgemeine Erhaltung einer algebraischen Verknüpfung.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(550, '3.105', 12, 'Additive Strukturerhaltung', 'varphileft(a+b\right)=varphi(a)+varphi(b)', 'varphileft(a+b\right)=varphi(a)+varphi(b)', 'Erhaltung der Ringaddition.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(551, '3.106', 12, 'Multiplikative Strukturerhaltung', 'varphileft(acdot b\right)=varphi(a)cdotvarphi(b)', 'varphileft(acdot b\right)=varphi(a)cdotvarphi(b)', 'Erhaltung der Ringmultiplikation.', 'definition', 'literature', 84, NULL, '', 'checked', 29),
(552, '3.107', 13, 'Allgemeiner Operator', 'T:X\\longrightarrow Y', 'T:X\\longrightarrow Y', 'Operator als Abbildung zwischen mathematisch strukturierten Räumen.', 'definition', 'literature', 35, NULL, 'X und Y sind geeignete mathematische Räume.', 'checked', 31),
(553, '3.108', 13, 'Operatorbild eines Elements', 'T(x)\\in Y', 'T(x)\\in Y', 'Bild eines Elements unter dem Operator.', 'derived', 'literature', 35, NULL, 'x\\in X.', 'checked', 31),
(554, '3.109', 13, 'Operator auf einem Raum', 'T:X\\longrightarrow X', 'T:X\\longrightarrow X', 'Endomorpher Operator auf X.', 'definition', 'literature', 35, NULL, 'Definitions- und Zielraum stimmen überein.', 'checked', 31),
(555, '3.110', 13, 'Rekursive Operatorwirkung', 'x_{n+1}=T(x_n)', 'x_{n+1}=T(x_n)', 'Ein Folgezustand entsteht durch Operatoranwendung.', 'model', 'literature', 35, NULL, 'x_n\\in X.', 'checked', 31),
(556, '3.111', 13, 'Iterierte Operatorwirkung', 'x_n=T^n(x_0)', 'x_n=T^n(x_0)', 'n-fache Komposition eines Operators.', 'derived', 'literature', 35, NULL, 'n\\in\\mathbb N.', 'checked', 31),
(557, '3.112', 13, 'Definitionsbereich', '\\mathcal{D}(T)\\subseteq X', '\\mathcal{D}(T)\\subseteq X', 'Tatsächlicher Definitionsbereich eines Operators.', 'definition', 'literature', 36, NULL, 'T ist möglicherweise nicht auf ganz X definiert.', 'checked', 31),
(558, '3.113', 13, 'Operator mit explizitem Definitionsbereich', 'T:\\mathcal{D}(T)\\longrightarrow Y', 'T:\\mathcal{D}(T)\\longrightarrow Y', 'Operatorabbildung mit eingeschränkter Domäne.', 'definition', 'literature', 36, NULL, '\\mathcal{D}(T)\\subseteq X.', 'checked', 31),
(559, '3.114', 13, 'Wertebereich eines Operators', '\\mathcal{R}(T)=\\{T(x)\\mid x\\in\\mathcal{D}(T)\\}\\subseteq Y', '\\mathcal{R}(T)=\\{T(x)\\mid x\\in\\mathcal{D}(T)\\}\\subseteq Y', 'Menge aller tatsächlich erzeugten Operatorbilder.', 'definition', 'literature', 36, NULL, NULL, 'checked', 31),
(560, '3.115', 13, 'Linearitätsbedingung', 'T(\\alpha x+\\beta y)=\\alpha T(x)+\\beta T(y)', 'T(\\alpha x+\\beta y)=\\alpha T(x)+\\beta T(y)', 'Erhalt von Linearkombinationen.', 'definition', 'literature', 101, NULL, 'X und Y sind Vektorräume über demselben Körper.', 'checked', 31),
(561, '3.116', 13, 'Additivität', 'T(x+y)=T(x)+T(y)', 'T(x+y)=T(x)+T(y)', 'Erhalt der Vektoraddition.', 'derived', 'literature', 101, NULL, 'T ist linear.', 'checked', 31),
(562, '3.117', 13, 'Homogenität', 'T(\\alpha x)=\\alpha T(x)', 'T(\\alpha x)=\\alpha T(x)', 'Erhalt der Skalarmultiplikation.', 'derived', 'literature', 101, NULL, 'T ist linear.', 'checked', 31),
(563, '3.118', 13, 'Kern eines Operators', '\\ker(T)=\\{x\\in X\\mid T(x)=0\\}', '\\ker(T)=\\{x\\in X\\mid T(x)=0\\}', 'Menge aller auf Null abgebildeten Elemente.', 'definition', 'literature', 101, NULL, 'T ist linear.', 'checked', 31),
(564, '3.119', 13, 'Bild eines Operators', '\\operatorname{im}(T)=\\{T(x)\\mid x\\in X\\}', '\\operatorname{im}(T)=\\{T(x)\\mid x\\in X\\}', 'Menge aller erreichbaren Operatorbilder.', 'definition', 'literature', 101, NULL, 'T ist linear.', 'checked', 31),
(565, '3.120', 13, 'Kern und Bild als Unterräume', '\\ker(T)\\leq X\\qquad\\text{und}\\qquad\\operatorname{im}(T)\\leq Y', '\\ker(T)\\leq X\\qquad\\text{und}\\qquad\\operatorname{im}(T)\\leq Y', 'Kern und Bild linearer Operatoren sind Unterräume.', 'theorem', 'literature', 101, NULL, 'T ist linear.', 'checked', 31),
(566, '3.121', 13, 'Injektivitätskriterium', '\\ker(T)=\\{0\\}', '\\ker(T)=\\{0\\}', 'Ein linearer Operator ist genau dann injektiv, wenn sein Kern trivial ist.', 'theorem', 'literature', 101, NULL, 'T ist linear.', 'checked', 31),
(567, '3.122', 13, 'Surjektivitätskriterium', '\\operatorname{im}(T)=Y', '\\operatorname{im}(T)=Y', 'Ein Operator ist surjektiv, wenn sein Bild dem Zielraum entspricht.', 'definition', 'literature', 101, NULL, NULL, 'checked', 31),
(568, '3.123', 13, 'Operatorenkomposition', '(S\\circ T)(x)=S(T(x))', '(S\\circ T)(x)=S(T(x))', 'Aufeinanderfolgende Anwendung zweier Operatoren.', 'definition', 'literature', 35, NULL, 'T:X\\to Y und S:Y\\to Z.', 'checked', 31),
(569, '3.124', 13, 'Abbildungstyp der Komposition', 'S\\circ T:X\\longrightarrow Z', 'S\\circ T:X\\longrightarrow Z', 'Komposition als Operator von X nach Z.', 'derived', 'literature', 35, NULL, 'Kompatible Definitions- und Zielräume.', 'checked', 31),
(570, '3.125', 13, 'Assoziativität der Komposition', 'R\\circ(S\\circ T)=(R\\circ S)\\circ T', 'R\\circ(S\\circ T)=(R\\circ S)\\circ T', 'Assoziativität der Operatorverkettung.', 'theorem', 'literature', 35, NULL, 'Kompositionen sind definiert.', 'checked', 31),
(571, '3.126', 13, 'Nichtkommutativität', 'S\\circ T\\neq T\\circ S', 'S\\circ T\\neq T\\circ S', 'Operatorenkomposition ist im Allgemeinen nicht kommutativ.', 'other', 'literature', 35, NULL, 'Beide Kompositionen sind definiert.', 'checked', 31),
(572, '3.127', 13, 'Identitätsoperator', 'I_X:X\\longrightarrow X', 'I_X:X\\longrightarrow X', 'Identitätsoperator auf X.', 'definition', 'literature', 35, NULL, NULL, 'checked', 31),
(573, '3.128', 13, 'Wirkung des Identitätsoperators', 'I_X(x)=x', 'I_X(x)=x', 'Der Identitätsoperator lässt jedes Element unverändert.', 'definition', 'literature', 35, NULL, 'x\\in X.', 'checked', 31),
(574, '3.129', 13, 'Neutralität des Identitätsoperators', 'T\\circ I_X=T=I_Y\\circ T', 'T\\circ I_X=T=I_Y\\circ T', 'Identitätsoperator als neutrales Element der Komposition.', 'theorem', 'literature', 35, NULL, 'T:X\\to Y.', 'checked', 31),
(575, '3.130', 13, 'Linksinverse', 'T^{-1}\\circ T=I_X', 'T^{-1}\\circ T=I_X', 'Linksinverse hebt T auf X auf.', 'definition', 'literature', 35, NULL, 'T ist invertierbar.', 'checked', 31),
(576, '3.131', 13, 'Rechtsinverse', 'T\\circ T^{-1}=I_Y', 'T\\circ T^{-1}=I_Y', 'Rechtsinverse hebt T auf Y auf.', 'definition', 'literature', 35, NULL, 'T ist invertierbar.', 'checked', 31),
(577, '3.132', 13, 'Endomorphismenmenge', '\\operatorname{End}(V)=\\{T:V\\longrightarrow V\\mid T\\text{ linear}\\}', '\\operatorname{End}(V)=\\{T:V\\longrightarrow V\\mid T\\text{ linear}\\}', 'Menge aller linearen Endomorphismen von V.', 'definition', 'literature', 36, NULL, 'V ist ein Vektorraum.', 'checked', 31),
(578, '3.133', 13, 'Addition von Operatoren', '(S+T)(x)=S(x)+T(x)', '(S+T)(x)=S(x)+T(x)', 'Punktweise Addition linearer Operatoren.', 'definition', 'literature', 36, NULL, 'S und T sind lineare Operatoren V nach V.', 'checked', 31),
(579, '3.134', 13, 'Skalarmultiplikation von Operatoren', '(\\lambda T)(x)=\\lambda T(x)', '(\\lambda T)(x)=\\lambda T(x)', 'Punktweise Skalarmultiplikation eines Operators.', 'definition', 'literature', 36, NULL, '\\lambda liegt im Skalarkörper.', 'checked', 31),
(580, '3.135', 13, 'Spektrum eines Operators', '\\sigma(T)=\\{\\lambda\\in\\mathbb C\\mid T-\\lambda I\\text{ ist nicht invertierbar}\\}', '\\sigma(T)=\\{\\lambda\\in\\mathbb C\\mid T-\\lambda I\\text{ ist nicht invertierbar}\\}', 'Spektrum als Menge der Nichtinvertierbarkeitswerte.', 'definition', 'literature', 11, NULL, 'T ist ein geeigneter linearer Operator.', 'checked', 31),
(581, '3.136', 14, 'Zustand im Zustandsraum', 'x\\in X', 'x\\in X', 'Ein Zustand x ist Element des Zustandsraumes X.', 'definition', 'literature', 102, NULL, 'X ist ein nichtleerer Zustandsraum.', 'checked', 38),
(582, '3.137', 14, 'Zustandsvektor', 'x=\\begin{pmatrix}x_1\\\\x_2\\\\\\vdots\\\\x_n\\\\\\end{pmatrix}', 'x=\\begin{pmatrix}x_1\\\\x_2\\\\\\vdots\\\\x_n\\\\\\end{pmatrix}', 'Darstellung eines n-dimensionalen Zustandes als Spaltenvektor.', 'definition', 'literature', 102, NULL, 'Das System besitzt n Zustandsgrößen.', 'checked', 38),
(583, '3.138', 14, 'Endlichdimensionaler Zustandsraum', 'X\\subseteq\\mathbb{R}^{n}', 'X\\subseteq\\mathbb{R}^{n}', 'Zulässiger Zustandsraum als Teilmenge des reellen n-dimensionalen Raumes.', 'definition', 'literature', 102, NULL, 'Endlichdimensionale reelle Zustandsbeschreibung.', 'checked', 38),
(584, '3.139', 14, 'Übergangsabbildung', 'F:X\\longrightarrow X', 'F:X\\longrightarrow X', 'Abbildung eines Zustandes auf einen Folgezustand desselben Zustandsraumes.', 'definition', 'literature', 38, NULL, 'Vollständige Zustandsbeschreibung und deterministische Übergangsregel.', 'checked', 38),
(585, '3.140', 14, 'Diskreter Zustandsübergang', 'x_{k+1}=F(x_k)', 'x_{k+1}=F(x_k)', 'Rekursive Erzeugung des Folgezustandes aus dem aktuellen Zustand.', 'model', 'literature', 38, NULL, 'Diskrete deterministische Dynamik.', 'checked', 38),
(586, '3.141', 14, 'Zulässige Zustände mit Gleichungsnebenbedingung', 'X_{\\mathrm{zul}}=\\left\\{x\\in X\\mid g(x)=0\\right\\}', 'X_{\\mathrm{zul}}=\\left\\{x\\in X\\mid g(x)=0\\right\\}', 'Zulässige Zustände unter einer Gleichungsnebenbedingung.', 'definition', 'literature', 38, NULL, 'g ist eine geeignete Nebenbedingungsabbildung.', 'checked', 38),
(587, '3.142', 14, 'Zulässige Zustände mit Ungleichungsnebenbedingung', 'X_{\\mathrm{zul}}=\\left\\{x\\in X\\mid g(x)\\leq0\\right\\}', 'X_{\\mathrm{zul}}=\\left\\{x\\in X\\mid g(x)\\leq0\\right\\}', 'Zulässige Zustände unter einer Ungleichungsnebenbedingung.', 'definition', 'literature', 38, NULL, 'g ist eine geeignete Nebenbedingungsabbildung.', 'checked', 38),
(588, '3.143', 14, 'Diskrete Zustandsfolge', 'x_0,x_1,x_2,\\ldots', 'x_0,x_1,x_2,\\ldots', 'Geordnete Folge diskreter Zustände.', 'schema', 'literature', 40, NULL, 'Diskrete Zeitindizes k∈N.', 'checked', 38),
(589, '3.144', 14, 'Rekursive diskrete Dynamik', 'x_{k+1}=F(x_k)', 'x_{k+1}=F(x_k)', 'Erneute Darstellung der rekursiven Zustandsentwicklung im Kontext diskreter Systeme.', 'model', 'literature', 40, NULL, 'Diskrete deterministische Dynamik.', 'checked', 38),
(590, '3.145', 14, 'Iterierte Zustandsentwicklung', 'x_k=F^{\\,k}(x_0)', 'x_k=F^{\\,k}(x_0)', 'Zustand nach k-facher Iteration der Übergangsabbildung.', 'derived', 'literature', 40, NULL, 'F ist k-fach kompositionsfähig.', 'checked', 38),
(591, '3.146', 14, 'Zeitabhängige Zustandsfunktion', 'x:I\\longrightarrow X', 'x:I\\longrightarrow X', 'Zuordnung eines Zustandes zu jedem Zeitpunkt eines Intervalls I.', 'definition', 'literature', 103, NULL, 'I ist ein reelles Zeitintervall.', 'checked', 38),
(592, '3.147', 14, 'Zeitliche Ableitung des Zustandes', '\\dot{x}(t)=\\frac{dx(t)}{dt}', '\\dot{x}(t)=\\frac{dx(t)}{dt}', 'Ableitung der Zustandsfunktion nach der Zeit.', 'definition', 'literature', 103, NULL, 'x ist differenzierbar.', 'checked', 38),
(593, '3.148', 14, 'Nichtautonome Zustandsgleichung', '\\dot{x}(t)=F(x(t),t)', '\\dot{x}(t)=F(x(t),t)', 'Allgemeines zeitabhängiges Entwicklungsgesetz.', 'model', 'literature', 103, NULL, 'F ist hinreichend regulär.', 'checked', 38),
(594, '3.149', 14, 'Autonome Zustandsgleichung', '\\dot{x}=F(x)', '\\dot{x}=F(x)', 'Zeitinvariante kontinuierliche Zustandsentwicklung.', 'model', 'literature', 103, NULL, 'F hängt nicht explizit von t ab.', 'checked', 38),
(595, '3.150', 14, 'Anfangsbedingung', 'x(t_0)=x_0', 'x(t_0)=x_0', 'Festlegung des Anfangszustandes zum Zeitpunkt t0.', 'definition', 'literature', 103, NULL, 'x0 liegt im Zustandsraum.', 'checked', 38),
(596, '3.151', 14, 'Anfangswertproblem', '\\left\\{\\begin{array}{l}\\dot{x}=F(x,t)\\\\x(t_0)=x_0\\end{array}\\right.', '\\left\\{\\begin{array}{l}\\dot{x}=F(x,t)\\\\x(t_0)=x_0\\end{array}\\right.', 'Kombination aus Entwicklungsgleichung und Anfangsbedingung.', 'model', 'literature', 103, NULL, 'Existenz- und Eindeutigkeitsbedingungen sind gesondert zu prüfen.', 'checked', 38),
(597, '3.152', 14, 'Flussabbildung', '\\Phi:\\mathbb{R}\\times X\\longrightarrow X', '\\Phi:\\mathbb{R}\\times X\\longrightarrow X', 'Fluss als zeitparametrisierte Zustandsabbildung.', 'definition', 'literature', 103, NULL, 'Globale Definition des Flusses vorausgesetzt.', 'checked', 38),
(598, '3.153', 14, 'Fluss und Lösung', '\\Phi(t,x_0)=x(t)', '\\Phi(t,x_0)=x(t)', 'Zuordnung der Lösungskurve zum Anfangszustand.', 'definition', 'literature', 103, NULL, 'x(t) ist Lösung des Anfangswertproblems.', 'checked', 38),
(599, '3.154', 14, 'Identität des Flusses', '\\Phi(0,x)=x', '\\Phi(0,x)=x', 'Der Fluss lässt den Zustand bei Zeitparameter Null unverändert.', 'definition', 'literature', 103, NULL, 'Flussstruktur.', 'checked', 38),
(600, '3.155', 14, 'Flusseigenschaft', '\\Phi(t+s,x)=\\Phi\\left(t,\\Phi(s,x)\\right)', '\\Phi(t+s,x)=\\Phi\\left(t,\\Phi(s,x)\\right)', 'Kompositionsgesetz zeitlicher Entwicklungen.', 'definition', 'literature', 103, NULL, 'Kompatible Existenzintervalle.', 'checked', 38),
(601, '3.156', 14, 'Trajektorie', '\\gamma(x_0)=\\left\\{\\Phi(t,x_0)\\mid t\\in I\\right\\}', '\\gamma(x_0)=\\left\\{\\Phi(t,x_0)\\mid t\\in I\\right\\}', 'Menge aller entlang des Flusses erreichten Zustände.', 'definition', 'literature', 40, NULL, 'I ist das betrachtete Zeitintervall.', 'checked', 38),
(602, '3.157', 14, 'Gleichgewichtspunkt', 'F(x^\\ast)=0', 'F(x^\\ast)=0', 'Ein Gleichgewichtspunkt ist eine Nullstelle des Vektorfeldes.', 'definition', 'literature', 39, NULL, 'Autonomes dynamisches System.', 'checked', 38),
(603, '3.158', 14, 'Invarianz eines Gleichgewichtspunktes', '\\Phi(t,x^\\ast)=x^\\ast', '\\Phi(t,x^\\ast)=x^\\ast', 'Ein Gleichgewichtspunkt bleibt unter dem Fluss unverändert.', 'derived', 'literature', 39, NULL, 'x* ist Gleichgewichtspunkt.', 'checked', 38),
(604, '3.159', 15, 'Positive Invarianz', 'x_0\\in M\\Longrightarrow\\Phi(t,x_0)\\in M\\qquad\\forall t\\geq0', 'x_0\\in M\\Longrightarrow\\Phi(t,x_0)\\in M\\qquad\\forall t\\geq0', 'Positive Invarianz.', 'definition', 'literature', 105, NULL, NULL, 'checked', 39),
(605, '3.160', 15, 'Invarianz', 'x_0\\in M\\Longrightarrow\\Phi(t,x_0)\\in M\\qquad\\forall t\\in\\mathbb{R}', 'x_0\\in M\\Longrightarrow\\Phi(t,x_0)\\in M\\qquad\\forall t\\in\\mathbb{R}', 'Invarianz.', 'definition', 'literature', 105, NULL, NULL, 'checked', 39),
(606, '3.161', 15, 'Invarianz eines Gleichgewichtspunktes', '\\Phi(t,x^\\ast)=x^\\ast\\qquad\\forall t', '\\Phi(t,x^\\ast)=x^\\ast\\qquad\\forall t', 'Invarianz eines Gleichgewichtspunktes.', 'derived', 'literature', 103, NULL, NULL, 'checked', 39),
(607, '3.162', 15, 'Einelementige invariante Menge', '\\left\\{x^\\ast\\right\\}', '\\left\\{x^\\ast\\right\\}', 'Einelementige invariante Menge.', 'definition', 'literature', 103, NULL, NULL, 'checked', 39),
(608, '3.163', 15, 'Lyapunov-Stabilität', '\\forall\\varepsilon>0\\;\\exists\\delta>0:\\left\\|x_0-x^\\ast\\right\\|<\\delta\\Longrightarrow\\left\\|\\Phi(t,x_0)-x^\\ast\\right\\|<\\varepsilon\\quad\\forall t\\geq0', '\\forall\\varepsilon>0\\;\\exists\\delta>0:\\left\\|x_0-x^\\ast\\right\\|<\\delta\\Longrightarrow\\left\\|\\Phi(t,x_0)-x^\\ast\\right\\|<\\varepsilon\\quad\\forall t\\geq0', 'Lyapunov-Stabilität.', 'definition', 'literature', 104, NULL, NULL, 'checked', 39),
(609, '3.164', 15, 'Attraktivität', '\\exists r>0:\\left\\|x_0-x^\\ast\\right\\|<r\\Longrightarrow\\lim_{t\\rightarrow\\infty}\\Phi(t,x_0)=x^\\ast', '\\exists r>0:\\left\\|x_0-x^\\ast\\right\\|<r\\Longrightarrow\\lim_{t\\rightarrow\\infty}\\Phi(t,x_0)=x^\\ast', 'Attraktivität.', 'definition', 'literature', 104, NULL, NULL, 'checked', 39),
(610, '3.165', 15, 'Asymptotische Stabilität', 'x^\\ast\\text{ ist asymptotisch stabil}\\Longleftrightarrow x^\\ast\\text{ ist stabil und attraktiv}', 'x^\\ast\\text{ ist asymptotisch stabil}\\Longleftrightarrow x^\\ast\\text{ ist stabil und attraktiv}', 'Asymptotische Stabilität.', 'definition', 'literature', 104, NULL, NULL, 'checked', 39),
(611, '3.166', 15, 'Globale asymptotische Stabilität', '\\forall x_0\\in X:\\lim_{t\\rightarrow\\infty}\\Phi(t,x_0)=x^\\ast', '\\forall x_0\\in X:\\lim_{t\\rightarrow\\infty}\\Phi(t,x_0)=x^\\ast', 'Globale asymptotische Stabilität.', 'definition', 'literature', 104, NULL, NULL, 'checked', 39),
(612, '3.167', 15, 'Lyapunov-Funktion', 'V:X\\longrightarrow\\mathbb{R}', 'V:X\\longrightarrow\\mathbb{R}', 'Lyapunov-Funktion.', 'definition', 'literature', 104, NULL, NULL, 'checked', 39),
(613, '3.168', 15, 'Nullwert der Lyapunov-Funktion', 'V(x^\\ast)=0', 'V(x^\\ast)=0', 'Nullwert der Lyapunov-Funktion.', 'definition', 'literature', 104, NULL, NULL, 'checked', 39),
(614, '3.169', 15, 'Positive Definitheit', 'V(x)>0\\qquad\\forall x\\neq x^\\ast', 'V(x)>0\\qquad\\forall x\\neq x^\\ast', 'Positive Definitheit.', 'definition', 'literature', 104, NULL, NULL, 'checked', 39),
(615, '3.170', 15, 'Ableitung der Lyapunov-Funktion', '\\dot{V}(x)=\\nabla V(x)^{T}F(x)', '\\dot{V}(x)=\\nabla V(x)^{T}F(x)', 'Ableitung der Lyapunov-Funktion.', 'derived', 'literature', 104, NULL, NULL, 'checked', 39),
(616, '3.171', 15, 'Nichtzunahme der Lyapunov-Funktion', '\\dot{V}(x)\\leq0', '\\dot{V}(x)\\leq0', 'Nichtzunahme der Lyapunov-Funktion.', 'theorem', 'literature', 104, NULL, NULL, 'checked', 39),
(617, '3.172', 15, 'Strikte Abnahme der Lyapunov-Funktion', '\\dot{V}(x)<0\\qquad\\forall x\\neq x^\\ast', '\\dot{V}(x)<0\\qquad\\forall x\\neq x^\\ast', 'Strikte Abnahme der Lyapunov-Funktion.', 'theorem', 'literature', 104, NULL, NULL, 'checked', 39),
(618, '3.173', 15, 'Invarianz eines Attraktors', '\\Phi(t,A)=A\\qquad\\forall t\\geq0', '\\Phi(t,A)=A\\qquad\\forall t\\geq0', 'Invarianz eines Attraktors.', 'definition', 'literature', 106, NULL, NULL, 'checked', 39),
(619, '3.174', 15, 'Attraktion zum Attraktor', '\\forall x_0\\in B(A):\\operatorname{dist}(\\Phi(t,x_0),A)\\longrightarrow0\\quad(t\\rightarrow\\infty)', '\\forall x_0\\in B(A):\\operatorname{dist}(\\Phi(t,x_0),A)\\longrightarrow0\\quad(t\\rightarrow\\infty)', 'Attraktion zum Attraktor.', 'definition', 'literature', 106, NULL, NULL, 'checked', 39),
(620, '3.175', 15, 'Einzugsgebiet', 'B(A)=\\{x_0\\in X\\mid\\operatorname{dist}(\\Phi(t,x_0),A)\\rightarrow0\\}', 'B(A)=\\{x_0\\in X\\mid\\operatorname{dist}(\\Phi(t,x_0),A)\\rightarrow0\\}', 'Einzugsgebiet.', 'definition', 'literature', 106, NULL, NULL, 'checked', 39),
(621, '3.176', 15, 'Punktattraktor', 'A=\\{x^\\ast\\}', 'A=\\{x^\\ast\\}', 'Punktattraktor.', 'definition', 'literature', 106, NULL, NULL, 'checked', 39),
(622, '3.177', 15, 'Periodische Lösung', 'x(t+T)=x(t)', 'x(t+T)=x(t)', 'Periodische Lösung.', 'definition', 'literature', 40, NULL, NULL, 'checked', 39),
(623, '3.178', 15, 'Torusattraktor', '\\mathbb{T}^{n}', '\\mathbb{T}^{n}', 'Torusattraktor.', 'definition', 'literature', 40, NULL, NULL, 'checked', 39),
(624, '3.179', 15, 'Exponentielle Störungsentwicklung', '\\|\\delta x(t)\\|\\approx\\|\\delta x(0)\\|e^{\\lambda t}', '\\|\\delta x(t)\\|\\approx\\|\\delta x(0)\\|e^{\\lambda t}', 'Exponentielle Störungsentwicklung.', 'model', 'literature', 106, NULL, NULL, 'checked', 39),
(625, '3.180', 15, 'Positiver Lyapunov-Exponent', '\\lambda>0', '\\lambda>0', 'Positiver Lyapunov-Exponent.', 'definition', 'literature', 106, NULL, NULL, 'checked', 39),
(626, '3.181', 15, 'Omega-Grenzmenge', '\\omega(x_0)=\\{y\\in X\\mid\\exists t_n\\rightarrow\\infty:\\Phi(t_n,x_0)\\rightarrow y\\}', '\\omega(x_0)=\\{y\\in X\\mid\\exists t_n\\rightarrow\\infty:\\Phi(t_n,x_0)\\rightarrow y\\}', 'Omega-Grenzmenge.', 'definition', 'literature', 40, NULL, NULL, 'checked', 39),
(627, '3.182', 15, 'LaSalle-Bedingung', '\\dot V\\le0', '\\dot V\\le0', 'LaSalle-Bedingung.', 'theorem', 'literature', 105, NULL, NULL, 'checked', 39),
(628, '3.183', 15, 'LaSalle-Nullmengenbedingung', '\\{x\\mid\\dot V(x)=0\\}', '\\{x\\mid\\dot V(x)=0\\}', 'LaSalle-Nullmengenbedingung.', 'theorem', 'literature', 105, NULL, NULL, 'checked', 39),
(629, '3.184', 16, 'Parameterabhängiges nichtlineares System', '\\dot{x}=F(x,\\mu)', '\\dot{x}=F(x,\\mu)', 'Allgemeines kontinuierliches dynamisches System mit Kontrollparameter.', 'model', 'literature', 107, NULL, NULL, 'checked', 40),
(630, '3.185', 16, 'Lineares parameterabhängiges System', '\\dot{x}=A(\\mu)x', '\\dot{x}=A(\\mu)x', 'Lineare Dynamik mit parameterabhängiger Systemmatrix.', 'model', 'literature', 107, NULL, NULL, 'checked', 40),
(631, '3.186', 16, 'Zerlegung in linearen und nichtlinearen Anteil', '\\dot{x}=A(\\mu)x+N(x,\\mu)', '\\dot{x}=A(\\mu)x+N(x,\\mu)', 'Darstellung eines nichtlinearen Systems als linearer Anteil plus Nichtlinearität.', 'model', 'literature', 108, NULL, NULL, 'checked', 40),
(632, '3.187', 16, 'Verletzung des Superpositionsprinzips', 'F(\\alpha x_1+\\beta x_2,\\mu)\\neq\\alpha F(x_1,\\mu)+\\beta F(x_2,\\mu)', 'F(\\alpha x_1+\\beta x_2,\\mu)\\neq\\alpha F(x_1,\\mu)+\\beta F(x_2,\\mu)', 'Kennzeichen eines nichtlinearen Entwicklungsgesetzes.', 'definition', 'literature', 108, NULL, NULL, 'checked', 40),
(633, '3.188', 16, 'Parameterabhängiger Gleichgewichtspunkt', 'F(x^\\ast,\\mu)=0', 'F(x^\\ast,\\mu)=0', 'Gleichgewichtsbedingung eines parameterabhängigen Systems.', 'definition', 'literature', 107, NULL, NULL, 'checked', 40);
INSERT INTO `equations` (`equation_id`, `equation_number`, `section_id`, `title`, `equation_latex`, `word_latex`, `plain_description`, `equation_type`, `provenance`, `source_id`, `derivation`, `assumptions`, `validation_status`, `created_revision_id`) VALUES
(634, '3.189', 16, 'Gleichgewichtsverzweigung', 'x^\\ast=x^\\ast(\\mu)', 'x^\\ast=x^\\ast(\\mu)', 'Abhängigkeit eines Gleichgewichtspunktes vom Kontrollparameter.', 'model', 'literature', 107, NULL, NULL, 'checked', 40),
(635, '3.190', 16, 'Lokale Abweichung vom Gleichgewicht', '\\xi=x-x^\\ast', '\\xi=x-x^\\ast', 'Lokale Koordinate relativ zum Gleichgewichtspunkt.', 'definition', 'literature', 107, NULL, NULL, 'checked', 40),
(636, '3.191', 16, 'Taylorentwicklung des Vektorfeldes', 'F(x^\\ast+\\xi,\\mu)=F(x^\\ast,\\mu)+D_xF(x^\\ast,\\mu)\\xi+\\mathcal{O}\\!\\left(\\|\\xi\\|^2\\right)', 'F(x^\\ast+\\xi,\\mu)=F(x^\\ast,\\mu)+D_xF(x^\\ast,\\mu)\\xi+\\mathcal{O}\\!\\left(\\|\\xi\\|^2\\right)', 'Lokale Taylorentwicklung des nichtlinearen Vektorfeldes.', 'derived', 'literature', 107, NULL, NULL, 'checked', 40),
(637, '3.192', 16, 'Linearisierte Dynamik', '\\dot{\\xi}=J(x^\\ast,\\mu)\\xi', '\\dot{\\xi}=J(x^\\ast,\\mu)\\xi', 'Linearisierung in der Umgebung eines Gleichgewichtspunktes.', 'model', 'literature', 107, NULL, NULL, 'checked', 40),
(638, '3.193', 16, 'Jacobi-Matrix', 'J(x^\\ast,\\mu)=D_xF(x^\\ast,\\mu)', 'J(x^\\ast,\\mu)=D_xF(x^\\ast,\\mu)', 'Definition der Jacobi-Matrix des Vektorfeldes.', 'definition', 'literature', 107, NULL, NULL, 'checked', 40),
(639, '3.194', 16, 'Lokale asymptotische Stabilitätsbedingung', '\\operatorname{Re}(\\lambda_i)<0\\qquad\\forall i', '\\operatorname{Re}(\\lambda_i)<0\\qquad\\forall i', 'Negativer Realteil aller Eigenwerte als lokale Stabilitätsbedingung.', 'theorem', 'literature', 108, NULL, NULL, 'checked', 40),
(640, '3.195', 16, 'Lokale Instabilitätsbedingung', '\\exists i:\\operatorname{Re}(\\lambda_i)>0', '\\exists i:\\operatorname{Re}(\\lambda_i)>0', 'Positiver Realteil mindestens eines Eigenwertes als Instabilitätskriterium.', 'theorem', 'literature', 108, NULL, NULL, 'checked', 40),
(641, '3.196', 16, 'Kritischer Parameterwert', '\\exists i:\\operatorname{Re}\\left(\\lambda_i(\\mu_c)\\right)=0', '\\exists i:\\operatorname{Re}\\left(\\lambda_i(\\mu_c)\\right)=0', 'Spektrale Bedingung eines kritischen Parameterwertes.', 'definition', 'literature', 107, NULL, NULL, 'checked', 40),
(642, '3.197', 16, 'Qualitative Änderung der Dynamik', '\\Phi_{\\mu_c-\\varepsilon}\\not\\sim\\Phi_{\\mu_c+\\varepsilon}\\qquad\\text{für hinreichend kleines }\\varepsilon>0', '\\Phi_{\\mu_c-\\varepsilon}\\not\\sim\\Phi_{\\mu_c+\\varepsilon}\\qquad\\text{für hinreichend kleines }\\varepsilon>0', 'Nichtäquivalenz der Dynamiken beiderseits eines Bifurkationswertes.', 'definition', 'literature', 107, NULL, NULL, 'checked', 40),
(643, '3.198', 16, 'Normalform der Sattel-Knoten-Bifurkation', '\\dot{x}=\\mu-x^2', '\\dot{x}=\\mu-x^2', 'Normalform einer Sattel-Knoten-Bifurkation.', 'model', 'literature', 107, NULL, NULL, 'checked', 40),
(644, '3.199', 16, 'Gleichgewichtsbedingung der Sattel-Knoten-Bifurkation', '\\mu-x^2=0', '\\mu-x^2=0', 'Stationäre Bedingung der Sattel-Knoten-Normalform.', 'derived', 'literature', 107, NULL, NULL, 'checked', 40),
(645, '3.200', 16, 'Gleichgewichte der Sattel-Knoten-Bifurkation', 'x^\\ast=\\pm\\sqrt{\\mu}', 'x^\\ast=\\pm\\sqrt{\\mu}', 'Gleichgewichtslösungen der Sattel-Knoten-Normalform.', 'derived', 'literature', 107, NULL, NULL, 'checked', 40),
(646, '3.201', 16, 'Normalform der transkritischen Bifurkation', '\\dot{x}=\\mu x-x^2', '\\dot{x}=\\mu x-x^2', 'Normalform einer transkritischen Bifurkation.', 'model', 'literature', 107, NULL, NULL, 'checked', 40),
(647, '3.202', 16, 'Erstes transkritisches Gleichgewicht', 'x^\\ast=0', 'x^\\ast=0', 'Trivialer Gleichgewichtszweig der transkritischen Bifurkation.', 'derived', 'literature', 107, NULL, NULL, 'checked', 40),
(648, '3.203', 16, 'Zweites transkritisches Gleichgewicht', 'x^\\ast=\\mu', 'x^\\ast=\\mu', 'Nichttrivialer Gleichgewichtszweig der transkritischen Bifurkation.', 'derived', 'literature', 107, NULL, NULL, 'checked', 40),
(649, '3.204', 16, 'Normalform der Pitchfork-Bifurkation', '\\dot{x}=\\mu x-x^3', '\\dot{x}=\\mu x-x^3', 'Überkritische Pitchfork-Normalform.', 'model', 'literature', 107, NULL, NULL, 'checked', 40),
(650, '3.205', 16, 'Faktorisierte Gleichgewichtsbedingung der Pitchfork-Bifurkation', 'x\\left(\\mu-x^2\\right)=0', 'x\\left(\\mu-x^2\\right)=0', 'Faktorisierte stationäre Bedingung der Pitchfork-Normalform.', 'derived', 'literature', 107, NULL, NULL, 'checked', 40),
(651, '3.206', 16, 'Zentrales Pitchfork-Gleichgewicht', 'x^\\ast=0', 'x^\\ast=0', 'Zentraler Gleichgewichtszweig der Pitchfork-Bifurkation.', 'derived', 'literature', 107, NULL, NULL, 'checked', 40),
(652, '3.207', 16, 'Symmetriegebrochene Pitchfork-Gleichgewichte', 'x^\\ast=\\pm\\sqrt{\\mu}', 'x^\\ast=\\pm\\sqrt{\\mu}', 'Neue Gleichgewichtszweige nach der Symmetriebrechung.', 'derived', 'literature', 107, NULL, NULL, 'checked', 40),
(653, '3.208', 16, 'Normalform der Hopf-Bifurkation', '\\dot{z}=(\\mu+i\\omega)z-|z|^2z', '\\dot{z}=(\\mu+i\\omega)z-|z|^2z', 'Komplexe Normalform einer überkritischen Hopf-Bifurkation.', 'model', 'literature', 108, NULL, NULL, 'checked', 40),
(654, '3.209', 16, 'Kritischer Parameter', '\\mu_c', '\\mu_c', 'Bezeichnung des kritischen Parameterwertes.', 'definition', 'literature', 107, NULL, NULL, 'checked', 40),
(655, '3.210', 16, 'Spektrale Bifurkationsbedingung', '\\operatorname{Re}\\left(\\lambda(\\mu_c)\\right)=0', '\\operatorname{Re}\\left(\\lambda(\\mu_c)\\right)=0', 'Eigenwertbedingung am Bifurkationspunkt.', 'definition', 'literature', 107, NULL, NULL, 'checked', 40),
(656, '3.211', 16, 'Wechsel der Attraktormenge', 'A(\\mu^-)\\neq A(\\mu^+)', 'A(\\mu^-)\\neq A(\\mu^+)', 'Qualitative Änderung der asymptotischen Organisationsform.', 'model', 'literature', 106, NULL, NULL, 'checked', 40),
(657, '3.212', 17, 'Alphabet der Zufallsvariablen', '\\mathcal{X}=\\left\\{x_1,x_2,\\ldots,x_n\\right\\}', '\\mathcal{X}=\\left\\{x_1,x_2,\\ldots,x_n\\right\\}', 'Menge möglicher Werte einer diskreten Zufallsvariablen.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(658, '3.213', 17, 'Ereigniswahrscheinlichkeit', 'p_i=P(X=x_i)', 'p_i=P(X=x_i)', 'Wahrscheinlichkeit des Ereignisses X=x_i.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(659, '3.214', 17, 'Nichtnegativität der Wahrscheinlichkeiten', 'p_i\\geq0\\qquad\\forall i', 'p_i\\geq0\\qquad\\forall i', 'Nichtnegativitätsbedingung diskreter Wahrscheinlichkeiten.', 'axiom', 'literature', 109, NULL, NULL, 'checked', 41),
(660, '3.215', 17, 'Normierung der Wahrscheinlichkeitsverteilung', '\\sum_{i=1}^{n}p_i=1', '\\sum_{i=1}^{n}p_i=1', 'Normierungsbedingung einer diskreten Wahrscheinlichkeitsverteilung.', 'axiom', 'literature', 109, NULL, NULL, 'checked', 41),
(661, '3.216', 17, 'Selbstinformation', 'I(x_i)=-\\log_b p_i', 'I(x_i)=-\\log_b p_i', 'Informationsgehalt eines Ereignisses mit Wahrscheinlichkeit p_i.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(662, '3.217', 17, 'Bit als Informationseinheit', 'b=2', 'b=2', 'Logarithmusbasis zwei definiert die Einheit Bit.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(663, '3.218', 17, 'Information eines sicheren Ereignisses', 'P(X=x_i)=1\\Longrightarrow I(x_i)=0', 'P(X=x_i)=1\\Longrightarrow I(x_i)=0', 'Ein sicheres Ereignis liefert keinen zusätzlichen Informationsgewinn.', 'derived', 'literature', 109, NULL, NULL, 'checked', 41),
(664, '3.219', 17, 'Monotonie der Selbstinformation', 'p_i<p_j\\Longrightarrow I(x_i)>I(x_j)', 'p_i<p_j\\Longrightarrow I(x_i)>I(x_j)', 'Seltenere Ereignisse besitzen einen höheren Selbstinformationswert.', 'derived', 'literature', 109, NULL, NULL, 'checked', 41),
(665, '3.220', 17, 'Unabhängigkeit zweier Ereignisse', 'P(x_i,y_j)=P(x_i)P(y_j)', 'P(x_i,y_j)=P(x_i)P(y_j)', 'Faktorisierung der gemeinsamen Wahrscheinlichkeit unabhängiger Ereignisse.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(666, '3.221', 17, 'Additivität unabhängiger Informationen', 'I(x_i,y_j)=I(x_i)+I(y_j)', 'I(x_i,y_j)=I(x_i)+I(y_j)', 'Informationsgehalte unabhängiger Ereignisse addieren sich.', 'derived', 'literature', 109, NULL, NULL, 'checked', 41),
(667, '3.222', 17, 'Entropie als Erwartungswert', 'H(X)=\\mathbb{E}\\left[I(X)\\right]', 'H(X)=\\mathbb{E}\\left[I(X)\\right]', 'Shannon-Entropie als Erwartungswert der Selbstinformation.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(668, '3.223', 17, 'Diskrete Shannon-Entropie', 'H(X)=-\\sum_{i=1}^{n}p_i\\log_b p_i', 'H(X)=-\\sum_{i=1}^{n}p_i\\log_b p_i', 'Mittlere Unbestimmtheit einer diskreten Zufallsvariablen.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(669, '3.224', 17, 'Entropie eines sicheren Ereignisses', 'H(X)=0', 'H(X)=0', 'Eine deterministische Zufallsvariable besitzt keine Shannon-Entropie.', 'derived', 'literature', 109, NULL, NULL, 'checked', 41),
(670, '3.225', 17, 'Gleichverteilung', 'p_i=\\frac{1}{n}\\qquad\\forall i', 'p_i=\\frac{1}{n}\\qquad\\forall i', 'Gleichverteilung über n mögliche Zustände.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(671, '3.226', 17, 'Maximale Entropie der Gleichverteilung', 'H(X)=\\log_b n', 'H(X)=\\log_b n', 'Maximale Entropie einer diskreten Zufallsvariablen mit n Zuständen.', 'theorem', 'literature', 109, NULL, NULL, 'checked', 41),
(672, '3.227', 17, 'Gemeinsame Wahrscheinlichkeitsverteilung', 'p(x_i,y_j)=P(X=x_i,Y=y_j)', 'p(x_i,y_j)=P(X=x_i,Y=y_j)', 'Gemeinsame Wahrscheinlichkeit zweier diskreter Zufallsvariablen.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(673, '3.228', 17, 'Randverteilung von X', 'p(x_i)=\\sum_j p(x_i,y_j)', 'p(x_i)=\\sum_j p(x_i,y_j)', 'Marginalisierung der gemeinsamen Verteilung über Y.', 'derived', 'literature', 109, NULL, NULL, 'checked', 41),
(674, '3.229', 17, 'Randverteilung von Y', 'p(y_j)=\\sum_i p(x_i,y_j)', 'p(y_j)=\\sum_i p(x_i,y_j)', 'Marginalisierung der gemeinsamen Verteilung über X.', 'derived', 'literature', 109, NULL, NULL, 'checked', 41),
(675, '3.230', 17, 'Gemeinsame Entropie', 'H(X,Y)=-\\sum_i\\sum_j p(x_i,y_j)\\log p(x_i,y_j)', 'H(X,Y)=-\\sum_i\\sum_j p(x_i,y_j)\\log p(x_i,y_j)', 'Gemeinsame Unbestimmtheit zweier Zufallsvariablen.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(676, '3.231', 17, 'Additivität der Entropie bei Unabhängigkeit', 'H(X,Y)=H(X)+H(Y)', 'H(X,Y)=H(X)+H(Y)', 'Gemeinsame Entropie unabhängiger Zufallsvariablen.', 'theorem', 'literature', 109, NULL, NULL, 'checked', 41),
(677, '3.232', 17, 'Bedingte Entropie', 'H(X|Y)', 'H(X|Y)', 'Verbleibende Unsicherheit von X bei Kenntnis von Y.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(678, '3.233', 17, 'Formel der bedingten Entropie', 'H(X|Y)=-\\sum_i\\sum_j p(x_i,y_j)\\log p(x_i|y_j)', 'H(X|Y)=-\\sum_i\\sum_j p(x_i,y_j)\\log p(x_i|y_j)', 'Erwartete bedingte Selbstinformation.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(679, '3.234', 17, 'Kettenregel der Entropie I', 'H(X,Y)=H(Y)+H(X|Y)', 'H(X,Y)=H(Y)+H(X|Y)', 'Zerlegung der gemeinsamen Entropie.', 'theorem', 'literature', 109, NULL, NULL, 'checked', 41),
(680, '3.235', 17, 'Kettenregel der Entropie II', 'H(X,Y)=H(X)+H(Y|X)', 'H(X,Y)=H(X)+H(Y|X)', 'Symmetrische Zerlegung der gemeinsamen Entropie.', 'theorem', 'literature', 109, NULL, NULL, 'checked', 41),
(681, '3.236', 17, 'Gegenseitige Information', 'I(X;Y)=H(X)-H(X|Y)', 'I(X;Y)=H(X)-H(X|Y)', 'Reduktion der Unsicherheit über X durch Kenntnis von Y.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(682, '3.237', 17, 'Symmetrische Darstellung der gegenseitigen Information', 'I(X;Y)=H(X)+H(Y)-H(X,Y)', 'I(X;Y)=H(X)+H(Y)-H(X,Y)', 'Darstellung durch Einzel- und gemeinsame Entropie.', 'derived', 'literature', 109, NULL, NULL, 'checked', 41),
(683, '3.238', 17, 'Symmetrie der gegenseitigen Information', 'I(X;Y)=I(Y;X)', 'I(X;Y)=I(Y;X)', 'Mutual Information ist symmetrisch.', 'theorem', 'literature', 109, NULL, NULL, 'checked', 41),
(684, '3.239', 17, 'Kullback-Leibler-Divergenz', 'D_{KL}(P||Q)=\\sum_i P(x_i)\\log\\frac{P(x_i)}{Q(x_i)}', 'D_{KL}(P||Q)=\\sum_i P(x_i)\\log\\frac{P(x_i)}{Q(x_i)}', 'Gerichtetes Divergenzmaß zwischen zwei Wahrscheinlichkeitsverteilungen.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(685, '3.240', 17, 'Nichtnegativität der Kullback-Leibler-Divergenz', 'D_{KL}(P||Q)\\geq0', 'D_{KL}(P||Q)\\geq0', 'Gibbs-Ungleichung.', 'theorem', 'literature', 109, NULL, NULL, 'checked', 41),
(686, '3.241', 17, 'Nullbedingung der Kullback-Leibler-Divergenz', 'D_{KL}(P||Q)=0\\Longleftrightarrow P=Q', 'D_{KL}(P||Q)=0\\Longleftrightarrow P=Q', 'Die Divergenz verschwindet genau bei identischen Verteilungen.', 'theorem', 'literature', 109, NULL, NULL, 'checked', 41),
(687, '3.242', 17, 'Mischverteilung', 'M=\\frac12(P+Q)', 'M=\\frac12(P+Q)', 'Mittlere Verteilung für die Jensen-Shannon-Divergenz.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(688, '3.243', 17, 'Jensen-Shannon-Divergenz', 'D_{JS}(P,Q)=\\frac12D_{KL}(P||M)+\\frac12D_{KL}(Q||M)', 'D_{JS}(P,Q)=\\frac12D_{KL}(P||M)+\\frac12D_{KL}(Q||M)', 'Symmetrisierte und geglättete Divergenz zwischen P und Q.', 'definition', 'literature', 109, NULL, NULL, 'checked', 41),
(689, '3.244', 17, 'Symmetrie der Jensen-Shannon-Divergenz', 'D_{JS}(P,Q)=D_{JS}(Q,P)', 'D_{JS}(P,Q)=D_{JS}(Q,P)', 'Die Jensen-Shannon-Divergenz ist symmetrisch.', 'theorem', 'literature', 109, NULL, NULL, 'checked', 41),
(706, '3.245', 18, 'Definition eines Graphen', 'G=(V,E)', 'G=(V,E)', 'Graph als geordnetes Paar aus Knoten- und Kantenmenge.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(707, '3.246', 18, 'Kantenmenge eines gerichteten Graphen', 'E\\subseteq V\\times V', 'E\\subseteq V\\times V', 'Gerichtete Kanten als geordnete Paare von Knoten.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(708, '3.247', 18, 'Gerichtete Kante', '(v_i,v_j)\\in E', '(v_i,v_j)\\in E', 'Gerichtete Relation vom Knoten vi zum Knoten vj.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(709, '3.248', 18, 'Ungerichtete Kante', '\\{v_i,v_j\\}\\in E', '\\{v_i,v_j\\}\\in E', 'Ungerichtete Verbindung zweier Knoten.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(710, '3.249', 18, 'Schleifenfreiheit eines einfachen Graphen', '(v_i,v_i)\\notin E', '(v_i,v_i)\\notin E', 'Ausschluss von Selbstkanten in einfachen Graphen.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(711, '3.250', 18, 'Schleife', '(v_i,v_i)\\in E', '(v_i,v_i)\\in E', 'Selbstkante eines Knotens.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(712, '3.251', 18, 'Adjazenzmatrix', 'A=(a_{ij})\\in\\{0,1\\}^{n\\times n}', 'A=(a_{ij})\\in\\{0,1\\}^{n\\times n}', 'Binäre Matrixdarstellung eines endlichen Graphen.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(713, '3.252', 18, 'Elemente der Adjazenzmatrix', 'a_{ij}=\\begin{cases}1,&(v_i,v_j)\\in E,\\\\0,&\\text{sonst}.\\end{cases}', 'a_{ij}=\\begin{cases}1,&(v_i,v_j)\\in E,\\\\0,&\\text{sonst}.\\end{cases}', 'Definition der Matrixeinträge durch das Vorliegen einer Kante.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(714, '3.253', 18, 'Potenzen der Adjazenzmatrix', '(A^k)_{ij}', '(A^k)_{ij}', 'Anzahl gerichteter Wege der Länge k von vi nach vj.', 'derived', 'literature', 119, NULL, NULL, 'checked', 47),
(715, '3.254', 18, 'Knotengrad im ungerichteten Graphen', '\\deg(v_i)=\\sum_{j=1}^{n}a_{ij}', '\\deg(v_i)=\\sum_{j=1}^{n}a_{ij}', 'Anzahl der an vi inzidenten Kanten.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(716, '3.255', 18, 'Eingangsgrad', '\\deg^{-}(v_i)=\\sum_{j=1}^{n}a_{ji}', '\\deg^{-}(v_i)=\\sum_{j=1}^{n}a_{ji}', 'Anzahl eingehender Kanten eines Knotens.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(717, '3.256', 18, 'Ausgangsgrad', '\\deg^{+}(v_i)=\\sum_{j=1}^{n}a_{ij}', '\\deg^{+}(v_i)=\\sum_{j=1}^{n}a_{ij}', 'Anzahl ausgehender Kanten eines Knotens.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(718, '3.257', 18, 'Knotenfolge eines Weges', 'v_0,v_1,\\ldots,v_k', 'v_0,v_1,\\ldots,v_k', 'Geordnete Knotenfolge eines Weges.', 'schema', 'literature', 119, NULL, NULL, 'checked', 47),
(719, '3.258', 18, 'Kantenbedingung eines Weges', '(v_i,v_{i+1})\\in E\\qquad\\forall i\\in\\{0,\\ldots,k-1\\}', '(v_i,v_{i+1})\\in E\\qquad\\forall i\\in\\{0,\\ldots,k-1\\}', 'Aufeinanderfolgende Knoten eines Weges sind durch Kanten verbunden.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(720, '3.259', 18, 'Länge eines Weges', 'k', 'k', 'Anzahl der Kanten eines Weges.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(721, '3.260', 18, 'Zyklusbedingung', 'v_0=v_k', 'v_0=v_k', 'Identität von Anfangs- und Endknoten eines Zyklus.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(722, '3.261', 18, 'Graphendistanz', 'd(v_i,v_j)=\\min_{P\\in\\mathcal{P}(v_i,v_j)}|P|', 'd(v_i,v_j)=\\min_{P\\in\\mathcal{P}(v_i,v_j)}|P|', 'Länge eines kürzesten Pfades zwischen zwei Knoten.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(723, '3.262', 18, 'Unendliche Distanz', 'd(v_i,v_j)=\\infty', 'd(v_i,v_j)=\\infty', 'Distanz nicht verbundener Knoten.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(724, '3.263', 18, 'Zusammenhang eines Graphen', '\\forall v_i,v_j\\in V\\;\\exists P\\in\\mathcal{P}(v_i,v_j)', '\\forall v_i,v_j\\in V\\;\\exists P\\in\\mathcal{P}(v_i,v_j)', 'Existenz eines Pfades zwischen jedem Knotenpaar.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(725, '3.264', 18, 'Gewichtsfunktion', 'w:E\\longrightarrow\\mathbb{R}', 'w:E\\longrightarrow\\mathbb{R}', 'Zuordnung numerischer Kantengewichte.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(726, '3.265', 18, 'Gewichtete Adjazenzmatrix', 'W=(w_{ij})', 'W=(w_{ij})', 'Matrixdarstellung eines gewichteten Graphen.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(727, '3.266', 18, 'Knotenstärke', 's(v_i)=\\sum_{j=1}^{n}w_{ij}', 's(v_i)=\\sum_{j=1}^{n}w_{ij}', 'Summe der Kantengewichte eines Knotens.', 'definition', 'literature', 119, NULL, NULL, 'checked', 47),
(728, '3.267', 19, 'Gradzentralität', 'C_D(v_i)=\\frac{\\deg(v_i)}{n-1}', 'C_D(v_i)=\\frac{\\deg(v_i)}{n-1}', 'Normierter Anteil unmittelbar erreichbarer Nachbarn eines Knotens.', 'definition', 'literature', 122, NULL, NULL, 'checked', 45),
(729, '3.268', 19, 'Closeness-Zentralität', 'C_C(v_i)=\\frac{n-1}{\\sum_{j=1}^{n}d(v_i,v_j)}', 'C_C(v_i)=\\frac{n-1}{\\sum_{j=1}^{n}d(v_i,v_j)}', 'Inverse mittlere Entfernung eines Knotens zu allen übrigen Knoten.', 'definition', 'literature', 122, NULL, NULL, 'checked', 45),
(730, '3.269', 19, 'Betweenness-Zentralität', 'C_B(v)=\\sum_{s\\neq v\\neq t}\\frac{\\sigma_{st}(v)}{\\sigma_{st}}', 'C_B(v)=\\sum_{s\\neq v\\neq t}\\frac{\\sigma_{st}(v)}{\\sigma_{st}}', 'Anteil kürzester Wege, die über einen Knoten verlaufen.', 'definition', 'literature', 122, NULL, NULL, 'checked', 45),
(731, '3.270', 19, 'Eigenvektor-Zentralität', 'Ax=\\lambda x', 'Ax=\\lambda x', 'Zentralität eines Knotens in Abhängigkeit von der Zentralität seiner Nachbarn.', 'definition', 'literature', 122, NULL, NULL, 'checked', 45),
(732, '3.271', 19, 'Lokaler Clusterkoeffizient', 'C(v_i)=\\frac{2m_i}{k_i(k_i-1)}', 'C(v_i)=\\frac{2m_i}{k_i(k_i-1)}', 'Anteil tatsächlich vorhandener Verbindungen zwischen den Nachbarn eines Knotens.', 'definition', 'literature', 120, NULL, NULL, 'checked', 45),
(733, '3.272', 19, 'Mittlere Weglänge', 'L=\\frac{1}{n(n-1)}\\sum_{i\\neq j}d(v_i,v_j)', 'L=\\frac{1}{n(n-1)}\\sum_{i\\neq j}d(v_i,v_j)', 'Mittlere kürzeste Distanz zwischen allen geordneten Knotenpaaren.', 'definition', 'literature', 120, NULL, NULL, 'checked', 45),
(734, '3.273', 19, 'Small-World-Bedingung', 'C\\gg C_{\\mathrm{random}},\\qquad L\\approx L_{\\mathrm{random}}', 'C\\gg C_{\\mathrm{random}},\\qquad L\\approx L_{\\mathrm{random}}', 'Kombination hoher Clusterung mit kurzer mittlerer Weglänge.', 'model', 'literature', 120, NULL, NULL, 'checked', 45),
(735, '3.274', 19, 'Skalenfreie Gradverteilung', 'P(k)\\sim k^{-\\gamma}', 'P(k)\\sim k^{-\\gamma}', 'Potenzgesetzartige Verteilung der Knotengrade.', 'model', 'literature', 121, NULL, NULL, 'checked', 45);
...
(211, 448, 'x', 'Element', 'Beliebiges mathematisches Objekt.', NULL, 'Objekt', 1),
(212, 448, 'M', 'Menge', 'Menge, deren Elementzugehörigkeit geprüft wird.', NULL, 'Menge', 2),
(213, 449, 'x', 'Element', 'Beliebiges mathematisches Objekt.', NULL, 'Objekt', 1),
(214, 449, 'M', 'Menge', 'Menge, zu der x nicht gehört.', NULL, 'Menge', 2),
(215, 450, '\\emptyset', 'Leere Menge', 'Eindeutig bestimmte Menge ohne Elemente.', NULL, 'Menge', 1),
(216, 451, 'A', 'Menge A', 'Erste Vergleichsmenge.', NULL, 'Menge', 1),
(217, 451, 'B', 'Menge B', 'Zweite Vergleichsmenge.', NULL, 'Menge', 2),
(218, 451, 'x', 'Element', 'Beliebiges Prüfelement.', NULL, 'Objekt', 3),
(219, 452, 'A', 'Teilmenge', 'Mögliche Teilmenge von B.', NULL, 'Menge', 1),
(220, 452, 'B', 'Obermenge', 'Menge, die alle Elemente von A enthält.', NULL, 'Menge', 2),
(221, 452, 'x', 'Element', 'Beliebiges Element.', NULL, 'Objekt', 3),
(222, 453, 'A_P', 'Aussonderungsmenge', 'Teilmenge der Elemente von A mit Eigenschaft P.', NULL, 'Menge', 1),
(223, 453, 'A', 'Grundmenge', 'Bereits vorhandene Menge.', NULL, 'Menge', 2),
(224, 453, 'P(x)', 'Prädikat', 'Auswahlbedingung für x.', NULL, 'Aussage', 3),
(225, 454, 'A', 'Menge A', 'Erste Vereinigungsmenge.', NULL, 'Menge', 1),
(226, 454, 'B', 'Menge B', 'Zweite Vereinigungsmenge.', NULL, 'Menge', 2),
(227, 454, 'x', 'Element', 'Element mindestens einer Ausgangsmenge.', NULL, 'Objekt', 3),
(228, 455, 'A', 'Menge A', 'Erste Schnittmenge.', NULL, 'Menge', 1),
(229, 455, 'B', 'Menge B', 'Zweite Schnittmenge.', NULL, 'Menge', 2),
(230, 455, 'x', 'Element', 'Gemeinsames Element beider Mengen.', NULL, 'Objekt', 3),
(231, 456, 'A', 'Menge A', 'Ausgangsmenge.', NULL, 'Menge', 1),
(232, 456, 'B', 'Menge B', 'Auszuschließende Menge.', NULL, 'Menge', 2),
(233, 456, 'x', 'Element', 'Element von A, das nicht in B liegt.', NULL, 'Objekt', 3),
(234, 457, 'A^c', 'Komplement', 'Komplement von A relativ zu U.', NULL, 'Menge', 1),
(235, 457, 'U', 'Grundmenge', 'Bezugsuniversum des Komplements.', NULL, 'Menge', 2),
(236, 457, 'A', 'Teilmenge', 'Zu komplementierende Teilmenge.', NULL, 'Menge', 3),
(237, 458, 'A', 'Menge A', 'Erste Faktormenge.', NULL, 'Menge', 1),
(238, 458, 'B', 'Menge B', 'Zweite Faktormenge.', NULL, 'Menge', 2),
(239, 458, '(a,b)', 'Geordnetes Paar', 'Paar mit erster Komponente aus A und zweiter aus B.', NULL, 'Geordnetes Paar', 3),
(240, 459, '\\mathcal P(A)', 'Potenzmenge', 'Menge aller Teilmengen von A.', NULL, 'Menge', 1),
(241, 459, 'X', 'Teilmenge', 'Beliebige Teilmenge von A.', NULL, 'Menge', 2),
(242, 459, 'A', 'Ausgangsmenge', 'Menge, deren Potenzmenge gebildet wird.', NULL, 'Menge', 3),
(243, 460, '|\\mathcal P(A)|', 'Mächtigkeit der Potenzmenge', 'Kardinalität der Potenzmenge von A.', NULL, 'Kardinalzahl', 1),
(244, 460, '|A|', 'Mächtigkeit von A', 'Kardinalität der Ausgangsmenge A.', NULL, 'Kardinalzahl', 2),
(245, 461, '\\Omega', 'Mengenoperation', 'Allgemeine Operation auf Teilmengen von M.', NULL, 'Operator', 1),
(246, 461, '\\mathcal P(M)', 'Potenzmenge', 'Definitions- und Zielbereich der Operation.', NULL, 'Menge', 2),
(247, 461, 'M', 'Grundmenge', 'Zugrunde liegende Menge.', NULL, 'Menge', 3),
(248, 465, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 1),
(249, 465, 'B', 'Zielmenge', 'Ziel- oder Vergleichsmenge.', NULL, 'Menge', 2),
(250, 466, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(251, 466, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(252, 466, 'B', 'Zielmenge', 'Ziel- oder Vergleichsmenge.', NULL, 'Menge', 3),
(253, 467, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(254, 468, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(255, 468, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(256, 469, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(257, 469, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(258, 469, 'B', 'Zielmenge', 'Ziel- oder Vergleichsmenge.', NULL, 'Menge', 3),
(259, 470, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(260, 470, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(261, 470, 'B', 'Zielmenge', 'Ziel- oder Vergleichsmenge.', NULL, 'Menge', 3),
(262, 471, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(263, 472, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(264, 472, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(265, 473, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(266, 473, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(267, 474, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(268, 474, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(269, 475, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(270, 475, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(271, 476, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(272, 476, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(273, 477, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(274, 477, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(275, 478, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(276, 479, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(277, 479, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(278, 480, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(279, 480, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(280, 481, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(281, 482, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 1),
(282, 482, 'preceq', 'Ordnungsrelation', 'Halb- oder Totalordnung.', NULL, 'Relation auf A', 2),
(283, 483, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 1),
(284, 483, 'preceq', 'Ordnungsrelation', 'Halb- oder Totalordnung.', NULL, 'Relation auf A', 2),
(285, 484, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(286, 484, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(287, 484, 'B', 'Zielmenge', 'Ziel- oder Vergleichsmenge.', NULL, 'Menge', 3),
(288, 484, 'circ', 'Relationskomposition', 'Komposition zweier Relationen.', NULL, 'Relationsoperation', 4),
(289, 485, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(290, 485, 'circ', 'Relationskomposition', 'Komposition zweier Relationen.', NULL, 'Relationsoperation', 2),
(291, 486, 'R', 'Relation', 'Binäre Relation.', NULL, 'Relation', 1),
(292, 486, 'A', 'Grundmenge', 'Ausgangs- oder Grundmenge.', NULL, 'Menge', 2),
(293, 487, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(294, 487, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(295, 487, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(296, 488, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(297, 488, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(298, 488, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(299, 489, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(300, 489, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(301, 489, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(302, 490, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(303, 490, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(304, 490, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(305, 491, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(306, 491, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(307, 491, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(308, 492, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(309, 493, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(310, 493, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(311, 494, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(312, 494, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(313, 494, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(314, 495, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(315, 496, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(316, 496, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(317, 497, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(318, 497, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(319, 498, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(320, 499, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(321, 499, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(322, 499, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(323, 500, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(324, 500, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(325, 500, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(326, 501, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(327, 502, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(328, 502, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(329, 502, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(330, 503, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(331, 504, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(332, 505, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(333, 505, 'g', 'zweite Funktion', 'zweite Funktion.', NULL, 'Abbildung', 2),
(334, 506, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(335, 506, 'g', 'zweite Funktion', 'zweite Funktion.', NULL, 'Abbildung', 2),
(336, 507, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 1),
(337, 507, '\\operatorname{id}', 'Identitätsabbildung', 'Identitätsabbildung.', NULL, 'Abbildung', 3),
(338, 508, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 1),
(339, 508, '\\operatorname{id}', 'Identitätsabbildung', 'Identitätsabbildung.', NULL, 'Abbildung', 2),
(340, 509, 'f', 'Funktion', 'Funktion.', NULL, 'Abbildung', 1),
(341, 509, 'A', 'Definitionsmenge', 'Definitionsmenge.', NULL, 'Menge', 2),
(342, 509, 'B', 'Zielmenge', 'Zielmenge.', NULL, 'Menge', 3),
(343, 509, '\\operatorname{id}', 'Identitätsabbildung', 'Identitätsabbildung.', NULL, 'Abbildung', 4),
(344, 510, 'star', 'binäre Verknüpfung', 'Innere Verknüpfung auf A.', NULL, 'A×A→A', 1),
(345, 510, 'A', 'Trägermenge', 'Grundmenge der algebraischen Struktur.', NULL, 'Menge', 2),
(346, 518, 'e', 'neutrales Element', 'Element ohne verändernde Wirkung.', NULL, 'A', 1),
(347, 525, 'a^{-1}', 'inverses Element', 'Inverse zu a.', NULL, 'A', 1),
(348, 531, 'varphi', 'Homomorphismus', 'Strukturerhaltende Abbildung.', NULL, 'Abbildung', 1),
(349, 533, 'R', 'Ring', 'Trägermenge des Ringes.', NULL, 'Ring', 1),
(350, 544, 'K', 'Skalarkörper', 'Körper der Skalare.', NULL, 'Körper', 1),
(351, 544, 'V', 'Vektorraum', 'Träger der Vektoren.', NULL, 'Vektorraum', 2),
(352, 545, 'lambda', 'Skalar', 'Element des Körpers K.', NULL, 'K', 1),
(353, 545, 'u', 'Vektor', 'Element von V.', NULL, 'V', 2),
(354, 545, 'v', 'Vektor', 'Element von V.', NULL, 'V', 3),
(355, 552, 'T', 'Operator', 'Abbildung zwischen mathematischen Räumen.', NULL, 'X\\to Y', 1),
(356, 552, 'X', 'Definitionsraum', 'Mathematischer Ausgangsraum.', NULL, 'Raum', 2),
(357, 552, 'Y', 'Zielraum', 'Mathematischer Zielraum.', NULL, 'Raum', 3),
(358, 555, 'x_n', 'Zustand', 'Zustand nach n Operatoranwendungen.', NULL, 'X', 1),
(359, 556, 'T^n', 'Operatoriteration', 'n-fache Komposition von T.', NULL, 'X\\to X', 1),
(360, 557, '\\mathcal{D}(T)', 'Definitionsbereich', 'Tatsächliche Domäne des Operators.', NULL, 'Teilmenge von X', 1),
(361, 559, '\\mathcal{R}(T)', 'Wertebereich', 'Menge der tatsächlich erzeugten Bilder.', NULL, 'Teilmenge von Y', 1),
(362, 560, '\\alpha,\\beta', 'Skalare', 'Skalare des zugrunde liegenden Körpers.', NULL, 'K', 1),
(363, 563, '\\ker(T)', 'Kern', 'Nullraum des linearen Operators.', NULL, 'Unterraum von X', 1),
(364, 564, '\\operatorname{im}(T)', 'Bild', 'Bildraum des linearen Operators.', NULL, 'Unterraum von Y', 1),
(365, 568, 'S\\circ T', 'Operatorenkomposition', 'Verkettung der Operatoren T und S.', NULL, 'X\\to Z', 1),
(366, 572, 'I_X', 'Identitätsoperator', 'Neutrale Transformation auf X.', NULL, 'X\\to X', 1),
(367, 575, 'T^{-1}', 'Inverser Operator', 'Umkehrabbildung eines invertierbaren Operators.', NULL, 'Y\\to X', 1),
(368, 577, '\\operatorname{End}(V)', 'Endomorphismenmenge', 'Menge aller linearen Endomorphismen von V.', NULL, 'Operatorraum', 1),
(369, 580, '\\sigma(T)', 'Spektrum', 'Menge der Nichtinvertierbarkeitswerte.', NULL, 'Teilmenge von \\mathbb C', 1),
(370, 580, '\\lambda', 'Spektralparameter', 'Komplexer Skalar im Spektrum.', NULL, '\\mathbb C', 2),
(371, 581, 'x', 'Zustandsraum', 'Menge aller zulässigen Zustände.', NULL, 'Menge oder Raum', 2),
(373, 582, 'x_i', 'Zustandskomponente', 'i-te Komponente des Zustandsvektors.', NULL, '\\mathbb R', 1),
(374, 584, 'F', 'Übergangsabbildung', 'Abbildung eines Zustandes auf den Folgezustand.', NULL, 'X\\to X', 1),
(375, 585, 'k', 'diskreter Index', 'Index des diskreten Entwicklungsschrittes.', NULL, '\\mathbb N', 1),
(376, 586, 'X_{\\mathrm{zul}}', 'zulässiger Zustandsraum', 'Menge aller nebenbedingungskonformen Zustände.', NULL, 'Teilmenge von X', 1),
(377, 591, 'I', 'Zeitintervall', 'Definitionsintervall der Zustandsfunktion.', NULL, 'Teilmenge von \\mathbb R', 1),
(378, 592, '\\dot{x}(t)', 'Zustandsableitung', 'Zeitliche Änderungsrate des Zustandes.', NULL, 'Tangentialraum', 1),
(379, 597, '\\Phi', 'Fluss', 'Zeitparametrisierte Zustandsabbildung.', NULL, '\\mathbb R\\times X\\to X', 1),
(380, 601, '\\gamma(x_0)', 'Trajektorie', 'Bahn des Anfangszustandes im Zustandsraum.', NULL, 'Teilmenge von X', 1),
(381, 602, 'x^\\ast', 'Gleichgewichtspunkt', 'Zustand mit verschwindendem Vektorfeld.', NULL, 'X', 1),
(382, 604, 'M', 'invariante Menge', 'Erhaltene Teilmenge des Zustandsraumes.', NULL, NULL, 1),
(383, 604, 'Phi', 'Fluss', 'Dynamische Entwicklung auf X.', NULL, NULL, 2),
(384, 608, 'varepsilon', 'Toleranz', 'Vorgegebene maximale Abweichung.', NULL, NULL, 1),
(385, 608, 'delta', 'Anfangsradius', 'Hinreichend kleine Anfangsabweichung.', NULL, NULL, 2),
(386, 612, 'V', 'Lyapunov-Funktion', 'Skalare Stabilitätsfunktion.', NULL, NULL, 1),
(387, 615, 'dot V', 'Ableitung der Lyapunov-Funktion', 'Änderung von V entlang der Dynamik.', NULL, NULL, 1),
(388, 618, 'A', 'Attraktor', 'Invariante anziehende Menge.', NULL, NULL, 1),
(389, 620, 'B(A)', 'Einzugsgebiet', 'Menge der zu A konvergierenden Anfangszustände.', NULL, NULL, 1),
(390, 624, 'lambda', 'Lyapunov-Exponent', 'Exponentielle Wachstumsrate infinitesimaler Störungen.', NULL, NULL, 1),
(391, 626, 'omega(x_0)', 'Omega-Grenzmenge', 'Asymptotische Häufungsmenge einer Trajektorie.', NULL, NULL, 1),
(392, 629, '\\mu', 'Kontrollparameter', 'Parameter der dynamischen Systemfamilie.', NULL, '\\mathbb{R}^p', 1),
(393, 629, 'F', 'Vektorfeld', 'Parameterabhängiges Entwicklungsgesetz.', NULL, 'X\\times\\mathbb{R}^p\\to TX', 2),
(394, 630, 'A(\\mu)', 'Systemmatrix', 'Parameterabhängige lineare Systemmatrix.', NULL, '\\mathbb{R}^{n\\times n}', 1),
(395, 631, 'N', 'nichtlinearer Anteil', 'Nichtlinearer Anteil des Entwicklungsgesetzes.', NULL, NULL, 1),
(396, 635, '\\xi', 'lokale Abweichung', 'Abweichung vom Gleichgewichtspunkt.', NULL, '\\mathbb{R}^n', 1),
(397, 638, 'J', 'Jacobi-Matrix', 'Ableitung des Vektorfeldes bezüglich des Zustandes.', NULL, '\\mathbb{R}^{n\\times n}', 1),
(398, 639, '\\lambda_i', 'Eigenwert', 'i-ter Eigenwert der Jacobi-Matrix.', NULL, '\\mathbb{C}', 1),
(399, 641, '\\mu_c', 'kritischer Parameter', 'Parameterwert mit verschwindendem Eigenwertrealteil.', NULL, '\\mathbb{R}', 1),
(400, 642, '\\Phi_\\mu', 'parameterabhängiger Fluss', 'Fluss des Systems beim Parameterwert mu.', NULL, NULL, 1),
(401, 653, 'z', 'komplexe Zustandsvariable', 'Lokale komplexe Koordinate der Hopf-Normalform.', NULL, '\\mathbb{C}', 1),
(402, 653, '\\omega', 'Eigenkreisfrequenz', 'Imaginärteil des kritischen Eigenwertpaares.', NULL, '\\mathbb{R}_{>0}', 2),
(403, 656, 'A(\\mu)', 'Attraktormenge', 'Parameterabhängige asymptotische Organisationsform.', NULL, NULL, 1),
(404, 657, '\\mathcal X', 'Alphabet', 'Menge möglicher Werte der Zufallsvariablen.', NULL, '\\{x_1,\\ldots,x_n\\}', 1),
(405, 658, 'p_i', 'Ereigniswahrscheinlichkeit', 'Wahrscheinlichkeit des Ereignisses X=x_i.', NULL, '[0,1]', 1),
(406, 661, 'I', 'Selbstinformation', 'Informationsgehalt eines Ereignisses.', NULL, '\\mathbb R_{\\ge0}', 1),
(407, 661, 'b', 'Logarithmusbasis', 'Basis des Informationsmaßes.', NULL, '\\mathbb R_{>1}', 2),
(408, 668, 'H', 'Shannon-Entropie', 'Mittlere Unbestimmtheit einer Zufallsvariablen.', NULL, '\\mathbb R_{\\ge0}', 1),
(409, 672, 'p(x_i,y_j)', 'gemeinsame Wahrscheinlichkeit', 'Gemeinsame Wahrscheinlichkeit zweier Ereignisse.', NULL, '[0,1]', 1),
(410, 677, 'H(X|Y)', 'bedingte Entropie', 'Verbleibende Unsicherheit von X bei Kenntnis von Y.', NULL, '\\mathbb R_{\\ge0}', 1),
(411, 681, 'I(X;Y)', 'gegenseitige Information', 'Statistische Informationsabhängigkeit zwischen X und Y.', NULL, '\\mathbb R_{\\ge0}', 1),
(412, 684, 'D_{KL}', 'Kullback-Leibler-Divergenz', 'Gerichtetes Divergenzmaß zweier Verteilungen.', NULL, '\\mathbb R_{\\ge0}', 1),
(413, 687, 'M', 'Mischverteilung', 'Arithmetisches Mittel der Verteilungen P und Q.', NULL, NULL, 1),
(414, 688, 'D_{JS}', 'Jensen-Shannon-Divergenz', 'Symmetrisches Divergenzmaß.', NULL, '\\mathbb R_{\\ge0}', 1),
(425, 706, 'G', 'Graph', 'Geordnetes Paar aus Knoten- und Kantenmenge.', NULL, NULL, 1),
(426, 706, 'V', 'Knotenmenge', 'Menge aller Knoten des Graphen.', NULL, NULL, 2),
(427, 706, 'E', 'Kantenmenge', 'Menge aller Kanten des Graphen.', NULL, NULL, 3),
(428, 712, 'A', 'Adjazenzmatrix', 'Binäre Matrixdarstellung des Graphen.', NULL, '\\{0,1\\}^{n\\times n}', 1),
(429, 713, 'a_{ij}', 'Adjazenzeintrag', 'Kantenindikator zwischen vi und vj.', NULL, '\\{0,1\\}', 1),
(430, 715, '\\deg(v_i)', 'Knotengrad', 'Anzahl der Nachbarn von vi.', NULL, '\\mathbb N_0', 1),
(431, 722, 'd', 'Graphendistanz', 'Länge eines kürzesten Pfades.', NULL, '\\mathbb N_0\\cup\\{\\infty\\}', 1),
(432, 725, 'w', 'Gewichtsfunktion', 'Zuordnung eines Wertes zu jeder Kante.', NULL, '\\mathbb R', 1),
(433, 726, 'W', 'gewichtete Adjazenzmatrix', 'Matrix der Kantengewichte.', NULL, '\\mathbb R^{n\\times n}', 1),
(434, 727, 's(v_i)', 'Knotenstärke', 'Summe der Kantengewichte eines Knotens.', NULL, '\\mathbb R', 1),
(435, 728, 'C_D', 'Gradzentralität', 'Normierter Grad eines Knotens.', NULL, '[0,1]', 1),
(436, 729, 'C_C', 'Closeness-Zentralität', 'Inverse Summe der Distanzen zu allen Knoten.', NULL, '\\mathbb R_{\\ge0}', 1),
(437, 730, 'C_B', 'Betweenness-Zentralität', 'Vermittlungsanteil auf kürzesten Wegen.', NULL, '\\mathbb R_{\\ge0}', 1),
(438, 730, '\\sigma_{st}', 'Anzahl kürzester Wege', 'Anzahl kürzester Wege zwischen s und t.', NULL, '\\mathbb N', 2),
(439, 731, 'x', 'Zentralitätsvektor', 'Eigenvektorbasierte Zentralitätswerte.', NULL, '\\mathbb R^n', 1),
(440, 731, '\\lambda', 'größter Eigenwert', 'Dominanter Eigenwert der Adjazenzmatrix.', NULL, '\\mathbb R', 2),
(441, 732, 'C(v_i)', 'Clusterkoeffizient', 'Lokaler Grad der Nachbarschaftsvernetzung.', NULL, '[0,1]', 1),
(442, 733, 'L', 'mittlere Weglänge', 'Durchschnitt kürzester Distanzen.', NULL, '\\mathbb R_{\\ge0}', 1),
(443, 735, 'P(k)', 'Gradverteilung', 'Wahrscheinlichkeit eines Knotengrades k.', NULL, '[0,1]', 1),
(444, 735, '\\gamma', 'Skalierungsexponent', 'Exponent der potenzgesetzartigen Gradverteilung.', NULL, '\\mathbb R_{>0}', 2);
...
('last_edited_section', '3.2.12', '2026-07-15 17:08:11'),
('last_repository_revision', 'RKB-2026-07-15-K3.2.12-NEUFASSUNG-V5', '2026-07-15 17:08:11'),
('next_citation_number', '82', '2026-07-15 16:07:29'),
('next_equation_number', '3.275', '2026-07-15 16:07:29');
...
(24, 'RKB-2026-07-14-K3.2.1-NEUFASSUNG-V2', '2026-07-15 08:07:05', 'section', '3.2.1', '2.0', 'Vollständige Neufassung von Abschnitt 3.2.1 mit Mengenbegriff, Axiomatik, Mengenoperationen, kartesischem Produkt, Potenzmenge und Forschungsgrenze.', 'Olaf Thiele / ChatGPT', 21),
(25, 'RKB-2026-07-14-K3.2.2-NEUFASSUNG-V2', '2026-07-15 08:07:06', 'section', '3.2.2', '2.0', 'Vollständige Neufassung von Abschnitt 3.2.2 mit Relationseigenschaften, Äquivalenz- und Ordnungsrelationen, Relationskomposition und Graphinterpretation.', 'Olaf Thiele / ChatGPT', 24),
(26, 'RKB-2026-07-14-K3.2.3-NEUFASSUNG-V2', '2026-07-15 08:07:06', 'section', '3.2.3', '2.0', 'Vollständige Neufassung von Abschnitt 3.2.3 mit modernem Funktionsbegriff, Bild und Urbild, Injektivität, Surjektivität, Bijektivität, Umkehrfunktion, Komposition und Identitätsabbildung.', 'Olaf Thiele / ChatGPT', 25),
(29, 'RKB-2026-07-14-K3.2.4-NEUFASSUNG-V2', '2026-07-15 08:07:07', 'section', '3.2.4', '2.0', 'Vollständige Neufassung von Abschnitt 3.2.4 mit Magmen, Halbgruppen, Monoiden, Gruppen, Ringen, Körpern, Vektorräumen, Homomorphismen und Symmetriebezug.', 'Olaf Thiele / ChatGPT', 26),
(31, 'RKB-2026-07-15-K3.2.5-NEUFASSUNG-V2', '2026-07-15 08:07:07', 'section', '3.2.5', '2.0', 'Vollständige Neufassung von Abschnitt 3.2.5 mit allgemeinem Operatorbegriff, Definitions- und Wertebereich, linearen Operatoren, Kern und Bild, Operatoralgebra, Invertierbarkeit und Spektrum.', 'Olaf Thiele / ChatGPT', 29),
(38, 'RKB-2026-07-15-K3.2.6-NEUFASSUNG-V2', '2026-07-15 08:07:08', 'section', '3.2.6', '2.0', 'Vollständige Neufassung von Abschnitt 3.2.6 mit Zustandsraumbegriff, vollständiger Zustandsbeschreibung, diskreten und kontinuierlichen Zustandsentwicklungen, Flüssen, Trajektorien und Gleichgewichtspunkten.', 'Olaf Thiele / ChatGPT', 31),
(39, 'RKB-2026-07-15-K3.2.7-NEUFASSUNG-V2', '2026-07-15 08:33:13', 'section', '3.2.7', '2.0', 'Neufassung von Abschnitt 3.2.7 zu Invarianz, Stabilität, Lyapunov-Funktionen und Attraktoren.', 'Olaf Thiele / ChatGPT', 38),
(40, 'RKB-2026-07-15-K3.2.8-NEUFASSUNG-V2', '2026-07-15 08:53:11', 'section', '3.2.8', '2.0', 'Neufassung von Abschnitt 3.2.8 zu Nichtlinearität, Linearisierung, lokalen Bifurkationen und emergenten Strukturwechseln.', 'Olaf Thiele / ChatGPT', 39),
(41, 'RKB-2026-07-15-K3.2.9-NEUFASSUNG-V3', '2026-07-15 09:11:32', 'section', '3.2.9', '3.0', 'Vollständige Repository-Neufassung von Abschnitt 3.2.9 mit Shannon-Entropie, bedingter Entropie, gegenseitiger Information und Divergenzmaßen.', 'Olaf Thiele / ChatGPT', 40),
...
(45, 'RKB-2026-07-15-K3.2.11-NEUFASSUNG-V5', '2026-07-15 18:07:29', 'section', '3.2.11', '5.0', 'Vollständige Neufassung von Abschnitt 3.2.11 mit Zentralitätsmaßen, Clusterkoeffizient, mittlerer Weglänge, Small-World- und skalenfreien Netzwerken.', 'Olaf Thiele / ChatGPT', 47),
(47, 'RKB-2026-07-15-K3.2.10-NEUFASSUNG-V5', '2026-07-15 14:28:51', 'section', '3.2.10', '5.0', 'Vollständige Neufassung von Abschnitt 3.2.10 mit Graphen, Adjazenzmatrizen, Graden, Wegen, Distanzen, Zusammenhang und gewichteten Netzwerken.', 'Olaf Thiele / ChatGPT', 41),
(49, 'RKB-2026-07-15-K3.2.12-NEUFASSUNG-V5', '2026-07-15 19:08:11', 'section', '3.2.12', '5.0', 'Zusammenfassung der mathematischen Grundlagen und systematische Identifikation der Forschungslücke als Übergang zur FRZK-Axiomatik.', 'Olaf Thiele / ChatGPT', 45);
...
(111, 24, 9, 'rewritten', 'section', '3.2.1', 'Abschnitt 3.2.1 vollständig neu gefasst.', 'Frühere Arbeitsfassung.', 'Dissertationsfähige Neufassung mit historischem Forschungsstand, Axiomatik, Mengenoperationen und expliziter Forschungsgrenze.', '2026-07-15 06:07:06'),
(112, 24, 9, 'source_added', 'source', '[58]', 'Fraenkel, Bar-Hillel und Levy als neue Referenzquelle aufgenommen.', NULL, 'Foundations of Set Theory.', '2026-07-15 06:07:06'),
(113, 24, 9, 'source_reused', 'source', '[23], [24]', 'Cantor und Zermelo mit bestehenden Literaturnummern wiederverwendet.', NULL, 'Primärquellen zur Mengenlehre.', '2026-07-15 06:07:06'),
(114, 24, 9, 'equation_changed', 'equation', '(3.3)–(3.16)', 'Gleichungsbestand des Abschnitts vollständig neu aufgebaut.', NULL, '14 Gleichungen mit Word-LaTeX und Symbolzuordnungen.', '2026-07-15 06:07:06'),
(115, 24, 9, 'definition_added', 'definition', 'Def. 3.2.1.1–3.2.1.6', 'Sechs zentrale Definitionen registriert.', NULL, 'Menge, Element, leere Menge, Teilmenge, kartesisches Produkt und Potenzmenge.', '2026-07-15 06:07:06'),
(116, 25, 10, 'rewritten', 'section', '3.2.2', 'Abschnitt 3.2.2 wurde vollständig neu gefasst.', 'Vorheriger Repository-Stand.', 'Neufassung V2 mit 25 Gleichungen.', '2026-07-15 06:07:06'),
(117, 25, 10, 'source_added', 'source', '[59]', 'Tarskis Primärquelle zur Relationsalgebra wurde aufgenommen.', NULL, 'On the Calculus of Relations.', '2026-07-15 06:07:06'),
(118, 25, 10, 'source_reused', 'sources', '[27], [28]', 'Enderton sowie Davey und Priestley wurden wiederverwendet.', NULL, 'Drei Quellenverwendungen insgesamt.', '2026-07-15 06:07:06'),
(119, 25, 10, 'equation_added', 'equations', '(3.17)–(3.41)', 'Relationen, Eigenschaften, Klassen, Ordnungen, Komposition und Graphmodell wurden registriert.', NULL, '25 Gleichungen.', '2026-07-15 06:07:06'),
(120, 25, 10, 'definition_added', 'definitions', 'Def. 3.2.2.1–3.2.2.8', 'Acht Definitionen wurden registriert.', NULL, '8 Definitionen.', '2026-07-15 06:07:06'),
(121, 25, 10, 'status_changed', 'section', '3.2.2', 'Abschnitt auf review gesetzt.', 'planned', 'review', '2026-07-15 06:07:06'),
(122, 26, 11, 'rewritten', 'section', '3.2.3', 'Abschnitt 3.2.3 wurde vollständig neu gefasst.', 'Bisheriger oder geplanter Abschnittsstand.', 'Neufassung mit Funktionen, Abbildungseigenschaften, Komposition und Identität.', '2026-07-15 06:07:07'),
(123, 26, 11, 'source_added', 'sources', '[60]', 'Dirichlet [60] wurde als neue Primärquelle registriert.', NULL, '1 neue Quelle.', '2026-07-15 06:07:07'),
(124, 26, 11, 'source_reused', 'sources', '[29], [30]', 'Die bestehenden Quellen [29] und [30] wurden wiederverwendet.', NULL, '2 Quellenwiederverwendungen.', '2026-07-15 06:07:07'),
(125, 26, 11, 'equation_added', 'equations', '(3.42)–(3.64)', '23 Gleichungen wurden registriert.', NULL, '23 Gleichungen.', '2026-07-15 06:07:07'),
(126, 26, 11, 'definition_added', 'definitions', 'Def. 3.2.3.1–3.2.3.9', 'Neun Definitionen wurden registriert.', NULL, '9 Definitionen.', '2026-07-15 06:07:07'),
(127, 26, 11, 'symbol_added', 'symbols', '3.2.3', 'Zentrale Funktionssymbole wurden registriert.', NULL, '4 Abschnittssymbole.', '2026-07-15 06:07:07'),
(128, 26, 11, 'status_changed', 'section', '3.2.3', 'Der Abschnitt wurde auf review gesetzt.', NULL, 'review', '2026-07-15 06:07:07'),
(129, 29, 12, 'rewritten', 'section', '3.2.4', 'Abschnitt 3.2.4 vollständig neu gefasst.', 'Bisheriger Repository-Stand.', 'Neufassung mit fünf neuen Quellen, dreizehn Definitionen und 42 Gleichungen.', '2026-07-15 06:07:07'),
(130, 29, 12, 'source_added', 'sources', '[61]–[65]', 'Fünf neue Literaturquellen registriert.', NULL, 'Galois [61], Noether [62], van der Waerden [63], Mac Lane/Birkhoff [64], Noether [65].', '2026-07-15 06:07:07'),
(131, 29, 12, 'definition_added', 'definitions', 'Def. 3.2.4.1–Def. 3.2.4.13', 'Dreizehn algebraische Definitionen registriert.', NULL, 'Binäre Verknüpfung bis Vektorraum.', '2026-07-15 06:07:07'),
(132, 29, 12, 'equation_added', 'equations', '(3.65)–(3.106)', '42 Gleichungen registriert.', NULL, 'Algebraische Strukturen und Strukturerhaltung.', '2026-07-15 06:07:07'),
(133, 29, 12, 'symbol_added', 'symbols', 'star, e, a^{-1}, varphi, R, K, V', 'Zentrale Abschnittssymbole registriert.', NULL, 'Symbolregister 3.2.4 V2.', '2026-07-15 06:07:07'),
(134, 31, 13, 'rewritten', 'section', '3.2.5', 'Abschnitt 3.2.5 vollständig neu gefasst.', 'Bisheriger Repository-Stand.', 'Neufassung mit Operatorbegriff, linearer Struktur, Operatoralgebra und Spektrum.', '2026-07-15 06:07:08'),
(135, 31, 13, 'source_added', 'sources', '[66]–[67]', 'Zwei neue Primärquellen registriert.', NULL, 'Hilbert [66], Banach [67].', '2026-07-15 06:07:08'),
(136, 31, 13, 'source_reused', 'sources', '[11], [35], [36]', 'Drei bestehende Standardquellen wiederverwendet.', NULL, 'Rudin [11], Conway [35], Kreyszig [36].', '2026-07-15 06:07:08'),
(137, 31, 13, 'definition_added', 'definitions', 'Def. 3.2.5.1–Def. 3.2.5.10', 'Zehn Definitionen registriert.', NULL, 'Operator bis Spektrum.', '2026-07-15 06:07:08'),
(138, 31, 13, 'equation_added', 'equations', '(3.107)–(3.135)', '29 Gleichungen registriert.', NULL, 'Operatorbegriff, Linearität, Kern, Bild, Komposition, Invertierbarkeit und Spektrum.', '2026-07-15 06:07:08'),
(139, 31, 13, 'symbol_added', 'symbols', 'T, D(T), R(T), ker(T), im(T), I_X, T^{-1}, End(V), sigma(T)', 'Zentrale Operatorsymbole registriert.', NULL, 'Symbolregister 3.2.5.', '2026-07-15 06:07:08'),
(140, 38, 14, 'rewritten', 'section', '3.2.6', 'Abschnitt 3.2.6 vollständig neu gefasst.', 'Bisheriger Repository-Stand.', 'Neufassung mit Zustandsraum, diskreter und kontinuierlicher Dynamik, Fluss, Trajektorie und Gleichgewicht.', '2026-07-15 06:07:08'),
(141, 38, 14, 'source_added', 'sources', '[68]–[69]', 'Zwei neue Quellen registriert.', NULL, 'Kalman [68], Arnold [69].', '2026-07-15 06:07:08'),
(142, 38, 14, 'source_reused', 'sources', '[38]–[40]', 'Drei bestehende Standardquellen wiederverwendet.', NULL, 'Sontag [38], Khalil [39], Hirsch/Smale/Devaney [40].', '2026-07-15 06:07:08'),
(143, 38, 14, 'definition_added', 'definitions', 'Def. 3.2.6.1–Def. 3.2.6.9', 'Neun Definitionen registriert.', NULL, 'Zustand bis Gleichgewichtspunkt.', '2026-07-15 06:07:08'),
(144, 38, 14, 'equation_added', 'equations', '(3.136)–(3.158)', '23 Gleichungen registriert.', NULL, 'Zustandsraum, Übergänge, Nebenbedingungen, Fluss, Trajektorie und Gleichgewicht.', '2026-07-15 06:07:08'),
(145, 38, 14, 'symbol_added', 'symbols', 'X, x, F, X_zul, Phi, gamma(x0), x*', 'Zentrale Zustandsraumsymbole registriert.', NULL, 'Symbolregister 3.2.6.', '2026-07-15 06:07:08'),
(146, 39, 15, 'rewritten', 'section', '3.2.7', 'Abschnitt vollständig neu gefasst.', NULL, 'Invarianz, Stabilität, Lyapunov-Funktionen und Attraktoren.', '2026-07-15 06:33:14'),
(147, 39, 15, 'source_added', 'sources', '[70]–[72]', 'Drei neue Quellen registriert.', NULL, 'Lyapunov, LaSalle, Ruelle/Takens.', '2026-07-15 06:33:14'),
(148, 39, 15, 'equation_added', 'equations', '(3.159)–(3.183)', '25 Gleichungen registriert.', NULL, 'Stabilitäts- und Attraktorformalismus.', '2026-07-15 06:33:14'),
(149, 40, 16, 'rewritten', 'section', '3.2.8', 'Abschnitt vollständig neu gefasst.', NULL, 'Nichtlinearität, Linearisierung, Bifurkationen und emergente Strukturwechsel.', '2026-07-15 06:53:11'),
(150, 40, 16, 'source_added', 'sources', '[73]–[74]', 'Zwei neue Quellen registriert.', NULL, 'Kuznetsov [73], Guckenheimer/Holmes [74].', '2026-07-15 06:53:11'),
(151, 40, 16, 'definition_added', 'definitions', 'Def. 3.2.8.1–Def. 3.2.8.11', 'Elf Definitionen registriert.', NULL, 'Nichtlinearität bis emergenter Strukturwechsel.', '2026-07-15 06:53:11'),
(152, 40, 16, 'equation_added', 'equations', '(3.184)–(3.211)', '28 Gleichungen registriert.', NULL, 'Nichtlinearität, Linearisierung, Bifurkationsnormalformen und Attraktorwechsel.', '2026-07-15 06:53:11'),
(153, 41, 17, 'rewritten', 'section', '3.2.9', 'Abschnitt 3.2.9 vollständig neu gefasst.', NULL, 'Informationstheorie mit Entropie, Mutual Information und Divergenzen.', '2026-07-15 07:11:32'),
(154, 41, 17, 'source_added', 'sources', '[75]–[76]', 'Zwei Primärquellen registriert.', NULL, 'Shannon [75], Wiener [76].', '2026-07-15 07:11:32'),
(155, 41, 17, 'definition_added', 'definitions', 'Def. 3.2.9.1–Def. 3.2.9.10', 'Zehn Definitionen registriert.', NULL, 'Zufallsvariable bis Informationsunabhängigkeit.', '2026-07-15 07:11:32'),
(156, 41, 17, 'equation_added', 'equations', '(3.212)–(3.244)', '33 Gleichungen registriert.', NULL, 'Vollständiger mathematischer Formalismus des Abschnitts.', '2026-07-15 07:11:32'),
(161, 47, 18, 'rewritten', 'section', '3.2.10', 'Abschnitt 3.2.10 vollständig im Masterstandard V5 neu gefasst.', NULL, 'Graphen, Adjazenzmatrizen, Grade, Wege, Distanzen, Zusammenhang und gewichtete Netzwerke.', '2026-07-15 12:28:51'),
(162, 47, 18, 'source_added', 'sources', '[77]–[78]', 'Zwei Quellen vollständig registriert.', NULL, 'Euler [77], Diestel [78].', '2026-07-15 12:28:51'),
(163, 47, 18, 'definition_added', 'definitions', 'Def. 3.2.10.1–Def. 3.2.10.11', 'Elf Definitionen registriert.', NULL, 'Graph bis Knotenstärke.', '2026-07-15 12:28:51'),
(164, 47, 18, 'equation_added', 'equations', '(3.245)–(3.266)', '22 Gleichungen registriert.', NULL, 'Vollständiger mathematischer Formalismus des Abschnitts.', '2026-07-15 12:28:51'),
(165, 45, 19, 'rewritten', 'section', '3.2.11', 'Abschnitt 3.2.11 vollständig im Masterstandard V5 neu gefasst.', NULL, 'Zentralitätsmaße, Clusterung, Small-World- und skalenfreie Netzwerke.', '2026-07-15 16:07:29'),
(166, 45, 19, 'source_added', 'sources', '[79]–[81]', 'Drei Quellen vollständig registriert.', NULL, 'Watts/Strogatz [79], Barabási/Albert [80], Freeman [81].', '2026-07-15 16:07:29'),
(167, 45, 19, 'definition_added', 'definitions', 'Def. 3.2.11.1–Def. 3.2.11.9', 'Neun Definitionen registriert.', NULL, 'Zentralitätsmaße bis Hub.', '2026-07-15 16:07:29'),
(168, 45, 19, 'equation_added', 'equations', '(3.267)–(3.274)', 'Acht Gleichungen registriert.', NULL, 'Vollständiger mathematischer Formalismus des Abschnitts.', '2026-07-15 16:07:29'),
(169, 49, 20, 'rewritten', 'section', '3.2.12', 'Abschnitt 3.2.12 vollständig im Masterstandard V5 neu gefasst.', NULL, 'Zusammenfassung der mathematischen Grundlagen, systematische Forschungslücke und Übergang zur Axiomatik.', '2026-07-15 17:08:11'),
(170, 49, 20, 'source_reused', 'sources', '[23],[24],[29],[38],[40],[75],[78]–[80]', 'Neun zentrale Bestandsquellen synthetisch wiederverwendet.', NULL, 'Keine neue Literaturnummer vergeben.', '2026-07-15 17:08:11'),
(171, 49, 20, 'definition_added', 'definitions', 'Def. 3.2.12.1–Def. 3.2.12.3', 'Drei zusammenfassende Definitionen registriert.', NULL, 'Forschungslücke, funktionale Strukturgenese und axiomatische Anschlussanforderung.', '2026-07-15 17:08:11'),
(172, 49, 20, '', 'chapter', '3.2', 'Kapitel 3.2 fachlich und repositorytechnisch abgeschlossen.', NULL, 'Letzte Gleichung (3.274), nächste Gleichung (3.275), nächste Quelle [82].', '2026-07-15 17:08:11');
...
(63, 58, 'fraenkel_bar_hillel_levy_foundations_set_theory_1973', 'book', 'Foundations of Set Theory', NULL, 1958, 1973, NULL, 'North-Holland', 'Amsterdam', NULL, NULL, NULL, 'Second Revised Edition', NULL, NULL, NULL, 'en', 5, 'reference', 4, '', '3.2.1', 'Erstnennung in der Neufassung von Abschnitt 3.2.1.', 'Fraenkel, Abraham A.; Bar-Hillel, Yehoshua; Levy, Azriel: Foundations of Set Theory. Second Revised Edition. Amsterdam: North-Holland, 1973.', 'Fraenkel, Bar-Hillel und Levy [58]', 'Referenzwerk zur axiomatischen Mengenlehre, zu ZFC und zur Begrenzung zulässiger Mengenbildungen.', 24, '2026-07-12 12:53:53', '2026-07-15 06:07:05'),
...
(100, 66, 'hilbert_integralgleichungen_1912', 'book', 'Grundzüge einer allgemeinen Theorie der linearen Integralgleichungen', NULL, 1912, 1912, NULL, 'B. G. Teubner', 'Leipzig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'de', 5, 'primary', 5, 'partially_verified', '3.2.5', 'Historische Primärquelle zur Entwicklung der Operatorentheorie.', 'Hilbert, David: Grundzüge einer allgemeinen Theorie der linearen Integralgleichungen. Leipzig: B. G. Teubner, 1912.', 'Hilbert [66]', 'Begründet die systematische Betrachtung linearer Integraloperatoren.', 31, '2026-07-15 06:07:07', '2026-07-15 06:07:07'),
(101, 67, 'banach_operations_lineaires_1932', 'book', 'Théorie des opérations linéaires', NULL, 1932, 1932, NULL, 'Monografie Matematyczne', 'Warszawa', '1', NULL, NULL, NULL, NULL, NULL, NULL, 'fr', 5, 'primary', 5, 'partially_verified', '3.2.5', 'Primärquelle zur allgemeinen Theorie linearer Operatoren auf normierten Räumen.', 'Banach, Stefan: Théorie des opérations linéaires. Warszawa: Monografie Matematyczne, 1932.', 'Banach [67]', 'Grundlage der linearen Funktionalanalysis und der Theorie beschränkter Operatoren.', 31, '2026-07-15 06:07:07', '2026-07-15 06:07:07'),
(102, 68, 'kalman_linear_dynamical_systems_1963', 'journal_article', 'Mathematical Description of Linear Dynamical Systems', NULL, 1963, 1963, 'Journal of the Society for Industrial and Applied Mathematics, Series A: Control', NULL, NULL, '1', '2', '152–192', NULL, NULL, NULL, NULL, 'en', 5, 'primary', 5, 'partially_verified', '3.2.6', 'Primärquelle zur modernen Zustandsraumdarstellung linearer Systeme.', 'Kalman, Rudolf E.: Mathematical Description of Linear Dynamical Systems. Journal of the Society for Industrial and Applied Mathematics, Series A: Control, Bd. 1, Nr. 2, 1963, S. 152–192.', 'Kalman [68]', 'Grundlage des modernen Zustandsraumansatzes.', 38, '2026-07-15 06:07:08', '2026-07-15 06:07:08'),
(103, 69, 'arnold_ordinary_differential_equations_1973', 'book', 'Ordinary Differential Equations', NULL, 1973, 1973, NULL, 'MIT Press', 'Cambridge, Massachusetts', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'en', 5, 'reference', 5, 'partially_verified', '3.2.6', 'Standardwerk zu Flüssen, Trajektorien und Gleichgewichtspunkten.', 'Arnold, Vladimir I.: Ordinary Differential Equations. Cambridge, Massachusetts: MIT Press, 1973.', 'Arnold [69]', 'Mathematische Grundlage kontinuierlicher Zustandsentwicklungen.', 38, '2026-07-15 06:07:08', '2026-07-15 06:07:08'),
(104, 70, 'lyapunov_stability_motion_1892', 'book', 'The General Problem of the Stability of Motion', NULL, 1892, 1992, NULL, 'Taylor & Francis', 'London', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'en', 5, 'primary', 5, 'partially_verified', '3.2.7', 'Erstnennung in Abschnitt 3.2.7.', 'Lyapunov, Aleksandr M.: The General Problem of the Stability of Motion. Charkow, 1892; englische Ausgabe: London: Taylor & Francis, 1992.', 'Lyapunov [70]', 'Quelle für Abschnitt 3.2.7.', 39, '2026-07-15 06:33:13', '2026-07-15 06:33:13'),
(105, 71, 'lasalle_stability_dynamical_systems_1976', 'book', 'The Stability of Dynamical Systems', NULL, 1976, 1976, NULL, 'Society for Industrial and Applied Mathematics', 'Philadelphia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'en', 5, 'reference', 5, 'partially_verified', '3.2.7', 'Erstnennung in Abschnitt 3.2.7.', 'LaSalle, Joseph P.: The Stability of Dynamical Systems. Philadelphia: Society for Industrial and Applied Mathematics, 1976.', 'LaSalle [71]', 'Quelle für Abschnitt 3.2.7.', 39, '2026-07-15 06:33:13', '2026-07-15 06:33:13'),
(106, 72, 'ruelle_takens_nature_turbulence_1971', 'journal_article', 'On the Nature of Turbulence', NULL, 1971, 1971, 'Communications in Mathematical Physics', NULL, NULL, '20', NULL, '167–192', NULL, NULL, NULL, NULL, 'en', 5, 'primary', 5, 'partially_verified', '3.2.7', 'Erstnennung in Abschnitt 3.2.7.', 'Ruelle, David; Takens, Floris: On the Nature of Turbulence. Communications in Mathematical Physics, Bd. 20, 1971, S. 167–192.', 'Ruelle/Takens [72]', 'Quelle für Abschnitt 3.2.7.', 39, '2026-07-15 06:33:13', '2026-07-15 06:33:13'),
(107, 73, 'kuznetsov_applied_bifurcation_theory_2004', 'book', 'Elements of Applied Bifurcation Theory', NULL, 1995, 2004, NULL, 'Springer', 'New York', NULL, NULL, NULL, '3rd Edition', NULL, NULL, NULL, 'en', 5, 'reference', 5, 'partially_verified', '3.2.8', 'Erstnennung in Abschnitt 3.2.8.', 'Kuznetsov, Yuri A.: Elements of Applied Bifurcation Theory. 3. Auflage. New York: Springer, 2004.', 'Kuznetsov [73]', 'Standardwerk zur lokalen und angewandten Bifurkationstheorie.', 40, '2026-07-15 06:53:11', '2026-07-15 06:53:11'),
(108, 74, 'guckenheimer_holmes_nonlinear_oscillations_1983', 'book', 'Nonlinear Oscillations, Dynamical Systems, and Bifurcations of Vector Fields', NULL, 1983, 1983, NULL, 'Springer', 'New York', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'en', 5, 'reference', 5, 'partially_verified', '3.2.8', 'Erstnennung in Abschnitt 3.2.8.', 'Guckenheimer, John; Holmes, Philip: Nonlinear Oscillations, Dynamical Systems, and Bifurcations of Vector Fields. New York: Springer, 1983.', 'Guckenheimer/Holmes [74]', 'Standardwerk zu nichtlinearen Schwingungen, Bifurkationen und chaotischer Dynamik.', 40, '2026-07-15 06:53:11', '2026-07-15 06:53:11'),
(109, 75, 'shannon_mathematical_theory_communication_1948', 'journal_article', 'A Mathematical Theory of Communication', NULL, 1948, 1948, 'Bell System Technical Journal', NULL, NULL, '27', NULL, '379–423; 623–656', NULL, NULL, NULL, NULL, 'en', 5, 'primary', 5, 'verified', '3.2.9', 'Erstnennung zur mathematischen Definition von Information und Entropie.', 'Shannon, Claude E.: A Mathematical Theory of Communication. Bell System Technical Journal, Bd. 27, 1948, S. 379–423 und 623–656.', 'Shannon [75]', 'Primärquelle der mathematischen Informationstheorie.', 41, '2026-07-15 07:11:32', '2026-07-15 07:11:32'),
(110, 76, 'wiener_cybernetics_1948', 'book', 'Cybernetics or Control and Communication in the Animal and the Machine', NULL, 1948, 1948, NULL, 'Hermann / MIT Press', 'Paris / Cambridge, Massachusetts', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'en', 5, 'primary', 5, 'verified', '3.2.9', 'Erstnennung zur funktionalen Bedeutung von Information in Rückkopplungs- und Regelungssystemen.', 'Wiener, Norbert: Cybernetics or Control and Communication in the Animal and the Machine. Paris: Hermann; Cambridge, Massachusetts: MIT Press, 1948.', 'Wiener [76]', 'Grundlagenwerk der Kybernetik.', 41, '2026-07-15 07:11:32', '2026-07-15 07:11:32'),
(118, 77, 'euler_koenigsberger_bruecken_1736', 'journal_article', 'Solutio problematis ad geometriam situs pertinentis', NULL, 1736, 1736, 'Commentarii Academiae Scientiarum Imperialis Petropolitanae', NULL, NULL, '8', NULL, '128–140', NULL, NULL, NULL, NULL, 'la', 5, 'primary', 5, 'verified', '3.2.10', 'Erstnennung zur historischen Entstehung der Graphentheorie.', 'Euler, Leonhard: Solutio problematis ad geometriam situs pertinentis. Commentarii Academiae Scientiarum Imperialis Petropolitanae, Bd. 8, 1736, S. 128–140.', 'Euler [77]', 'Primärquelle des Königsberger Brückenproblems.', 47, '2026-07-15 12:28:51', '2026-07-15 12:28:51'),
(119, 78, 'diestel_graph_theory_2017', 'book', 'Graph Theory', NULL, 1997, 2017, NULL, 'Springer', 'Berlin', NULL, NULL, NULL, '5th Edition', NULL, NULL, NULL, 'en', 5, 'reference', 5, 'verified', '3.2.10', 'Erstnennung als modernes Standardwerk der Graphentheorie.', 'Diestel, Reinhard: Graph Theory. 5. Auflage. Berlin: Springer, 2017.', 'Diestel [78]', 'Standardwerk für Definitionen und strukturelle Eigenschaften von Graphen.', 47, '2026-07-15 12:28:51', '2026-07-15 12:28:51'),
(120, 79, 'watts_strogatz_small_world_1998', 'journal_article', 'Collective Dynamics of Small-World Networks', NULL, 1998, 1998, 'Nature', NULL, NULL, '393', NULL, '440–442', NULL, NULL, NULL, NULL, 'en', 5, 'primary', 5, 'verified', '3.2.11', 'Erstnennung zum Small-World-Modell.', 'Watts, Duncan J.; Strogatz, Steven H.: Collective Dynamics of Small-World Networks. Nature, Bd. 393, 1998, S. 440–442.', 'Watts/Strogatz [79]', 'Primärquelle des Small-World-Netzwerkmodells.', 45, '2026-07-15 16:07:29', '2026-07-15 16:07:29'),
(121, 80, 'barabasi_albert_scaling_random_networks_1999', 'journal_article', 'Emergence of Scaling in Random Networks', NULL, 1999, 1999, 'Science', NULL, NULL, '286', NULL, '509–512', NULL, NULL, NULL, NULL, 'en', 5, 'primary', 5, 'verified', '3.2.11', 'Erstnennung zu skalenfreien Netzwerken und Preferential Attachment.', 'Barabási, Albert-László; Albert, Réka: Emergence of Scaling in Random Networks. Science, Bd. 286, 1999, S. 509–512.', 'Barabási/Albert [80]', 'Primärquelle des skalenfreien Netzwerkmodells.', 45, '2026-07-15 16:07:29', '2026-07-15 16:07:29'),
(122, 81, 'freeman_centrality_social_networks_1978', 'journal_article', 'Centrality in Social Networks: Conceptual Clarification', NULL, 1978, 1978, 'Social Networks', NULL, NULL, '1', '3', '215–239', NULL, NULL, NULL, NULL, 'en', 5, 'primary', 4, 'verified', '3.2.11', 'Erstnennung als Primärquelle zur Systematisierung von Zentralitätsmaßen.', 'Freeman, Linton C.: Centrality in Social Networks: Conceptual Clarification. Social Networks, Bd. 1, Nr. 3, 1978, S. 215–239.', 'Freeman [81]', 'Primärquelle zur Konzeptualisierung von Grad-, Closeness- und Betweenness-Zentralität.', 45, '2026-07-15 16:07:29', '2026-07-15 16:07:29');
...
(257, 23, 9, 'historical_context', 'Cantors Arbeiten begründen den modernen Mengenbegriff, die transfinite Mengenlehre, die Potenzmengenbildung und den Satz über die größere Mächtigkeit der Potenzmenge.', '3.2.1: historische Entwicklung und Mengenoperationen', 0, 1, 'Bestehende Quelle [23] wird wiederverwendet.', 24),
(258, 24, 9, 'state_of_research', 'Zermelos Axiomatisierung begrenzt zulässige Mengenbildungen und fundiert Extensionalität, Aussonderung, Vereinigung und Potenzmenge.', '3.2.1: axiomatische Fundierung und Mengenoperationen', 0, 1, 'Bestehende Quelle [24] wird wiederverwendet.', 24),
(259, 63, 9, 'first_citation', 'Das Referenzwerk systematisiert die axiomatischen Grundlagen von ZFC und grenzt Konstruktion vorhandener Mengen von einer Erklärung ihrer Genese ab.', '3.2.1: axiomatische Einordnung und wissenschaftliche Grenze', 1, 1, 'Neue Erstnennung [58].', 24),
(260, 27, 10, 'state_of_research', 'Enderton fundiert den mengentheoretischen Relationsbegriff, geordnete Paare, kartesische Produkte und grundlegende Relationseigenschaften.', 'Abschnitt 3.2.2', 0, 1, 'Neufassung V2.', 25),
(261, 28, 10, 'state_of_research', 'Davey und Priestley fundieren Halbordnungen, Totalordnungen und hierarchische relationale Strukturen.', 'Abschnitt 3.2.2', 0, 1, 'Neufassung V2.', 25),
(262, 69, 10, 'first_citation', 'Tarski fundiert Relationskomposition und die algebraische Behandlung von Relationen.', 'Abschnitt 3.2.2', 1, 1, 'Neufassung V2.', 25),
(263, 70, 11, 'first_citation', 'Historische Entwicklung des modernen Funktionsbegriffs und Ablösung von einer ausschließlich analytischen Darstellung.', 'Historische Entwicklung in 3.2.3', 1, 1, 'Neufassung 3.2.3 V2.', 26),
(264, 29, 11, 'definition', 'Formale Definition einer Funktion, Bild, Urbild sowie Existenz- und Eindeutigkeitsbedingungen.', 'Definitionen in 3.2.3', 0, 1, 'Neufassung 3.2.3 V2.', 26),
(265, 30, 11, 'definition', 'Injektivität, Surjektivität, Bijektivität, Umkehrfunktion, Komposition und Identitätsabbildung.', 'Eigenschaften in 3.2.3', 0, 1, 'Neufassung 3.2.3 V2.', 26),
(266, 81, 12, 'first_citation', 'Historische Entstehung der Gruppentheorie aus der Analyse algebraischer Gleichungen.', 'Einleitung 3.2.4', 1, 1, 'Neufassung 3.2.4 V2.', 29),
(267, 82, 12, 'first_citation', 'Strukturelle Ring- und Idealtheorie als Wendepunkt der modernen Algebra.', 'Einleitung sowie Ringabschnitt 3.2.4', 1, 1, 'Neufassung 3.2.4 V2.', 29),
(268, 83, 12, 'first_citation', 'Systematische Definition algebraischer Grundstrukturen von der binären Verknüpfung bis zum Vektorraum.', 'Definitionen und Strukturhierarchie 3.2.4', 1, 1, 'Neufassung 3.2.4 V2.', 29),
(269, 84, 12, 'first_citation', 'Gruppen, Untergruppen, Homomorphismen und Isomorphismen.', 'Gruppenabschnitt 3.2.4', 1, 1, 'Neufassung 3.2.4 V2.', 29),
(270, 85, 12, 'first_citation', 'Zusammenhang von Symmetriegruppen und Erhaltungssätzen.', 'Symmetrieabschnitt 3.2.4', 1, 1, 'Neufassung 3.2.4 V2.', 29),
(271, 100, 13, 'first_citation', 'Historische Entwicklung linearer Integraloperatoren', 'Einleitender Forschungsstand zu Hilbert', 1, 1, 'Neue Erstnennung [66].', 31),
(272, 101, 13, 'first_citation', 'Allgemeine Theorie linearer Operatoren auf normierten Räumen', 'Einleitender Forschungsstand zu Banach', 1, 1, 'Neue Erstnennung [67].', 31),
(273, 35, 13, 'definition', 'Allgemeiner Operatorbegriff, Komposition und Spektrum', 'Mathematische Definitionen und Operatoralgebra', 0, 1, 'Bestehende Standardquelle wiederverwendet.', 31),
(274, 36, 13, 'definition', 'Lineare Operatoren, Kern, Bild und Invertierbarkeit', 'Abschnitte zu linearen Operatoren und Operatoralgebra', 0, 1, 'Bestehende Standardquelle wiederverwendet.', 31),
(275, 11, 13, 'background', 'Spektraltheorie und Operatoren auf Funktionenräumen', 'Abschnitt zum Spektrum', 0, 1, 'Bestehende Standardquelle wiederverwendet.', 31),
(276, 102, 14, 'first_citation', 'Moderner Zustandsraumansatz mit internem Zustandsvektor.', 'Einleitender Forschungsstand und Zustandsdefinition', 1, 1, 'Neue Erstnennung [68].', 38),
(277, 103, 14, 'first_citation', 'Kontinuierliche Zustandsentwicklung, Anfangswertproblem, Fluss und Trajektorie.', 'Kontinuierliche Zustandsentwicklung', 1, 1, 'Neue Erstnennung [69].', 38),
(278, 38, 14, 'method', 'Zustandsraumdarstellung, Nebenbedingungen und Übergangsabbildungen.', 'Vollständige Zustandsbeschreibung und zulässige Zustände', 0, 1, 'Bestehende Standardquelle wiederverwendet.', 38),
(279, 39, 14, 'definition', 'Gleichgewichtspunkte und nichtlineare Systemdarstellungen.', 'Gleichgewichtszustände', 0, 1, 'Bestehende Standardquelle wiederverwendet.', 38),
(280, 40, 14, 'state_of_research', 'Diskrete Dynamik, Trajektorien und geometrische Interpretation dynamischer Systeme.', 'Diskrete Zustandsentwicklung und Trajektorien', 0, 1, 'Bestehende Standardquelle wiederverwendet.', 38),
(281, 104, 15, 'first_citation', 'Grundlagen der Lyapunov-Stabilität und Lyapunov-Funktionen.', 'Stabilität und Lyapunov-Funktionen', 1, 1, 'Neue Erstnennung [70].', 39),
(282, 105, 15, 'first_citation', 'LaSalle-Invarianzprinzip und asymptotische Stabilitätsanalyse.', 'Invarianz und LaSalle-Prinzip', 1, 1, 'Neue Erstnennung [71].', 39),
(283, 106, 15, 'first_citation', 'Seltsame Attraktoren und komplexe Langzeitdynamik.', 'Attraktoren', 1, 1, 'Neue Erstnennung [72].', 39),
(284, 40, 15, 'state_of_research', 'Trajektorien, periodische Bahnen und Grenzmengen dynamischer Systeme.', 'Attraktorformen und Omega-Grenzmengen', 0, 1, 'Bestehende Quelle [40].', 39),
(285, 103, 15, 'background', 'Flüsse und Gleichgewichtspunkte als Grundlage der Stabilitätsanalyse.', 'Einleitung und Invarianz', 0, 1, 'Bestehende Quelle [69].', 39),
(286, 107, 16, 'first_citation', 'Lokale Bifurkationstheorie, kritische Parameter und Normalformen.', 'Einleitung, Linearisierung und elementare Bifurkationen', 1, 1, 'Neue Erstnennung [73].', 40),
(287, 108, 16, 'first_citation', 'Nichtlineare Schwingungen, Dynamik und Bifurkationen von Vektorfeldern.', 'Nichtlinearität, Hopf-Bifurkation und wissenschaftliche Einordnung', 1, 1, 'Neue Erstnennung [74].', 40),
(288, 103, 16, 'background', 'Flüsse, Gleichgewichtspunkte und gewöhnliche Differentialgleichungen.', 'Mathematischer Ausgangsrahmen', 0, 1, 'Bestehende Quelle [69].', 40),
(289, 104, 16, 'comparison', 'Stabilitätsbegriff als Voraussetzung der Analyse von Stabilitätswechseln.', 'Linearisierung und Eigenwertkriterien', 0, 1, 'Bestehende Quelle [70].', 40),
(290, 105, 16, 'comparison', 'Invarianz und asymptotische Dynamik als Bezugspunkt für Strukturwechsel.', 'Übergang zu Attraktoren und Emergenz', 0, 1, 'Bestehende Quelle [71].', 40),
(291, 106, 16, 'state_of_research', 'Attraktoren als asymptotische Organisationsformen vor und nach Bifurkationen.', 'Emergenz und Attraktorwechsel', 0, 1, 'Bestehende Quelle [72].', 40),
(292, 109, 17, 'first_citation', 'Begründung der mathematischen Informationstheorie sowie der Shannon-Entropie.', 'Einleitung und Selbstinformation', 1, 1, 'Neue Erstnennung [75].', 41),
(293, 109, 17, 'definition', 'Definitionen von Entropie, bedingter Entropie, Mutual Information und Divergenzmaßen.', 'Gesamter mathematischer Formalismus 3.2.9', 0, 1, 'Primärquelle und etablierte Weiterentwicklung.', 41),
(294, 110, 17, 'first_citation', 'Funktionale Bedeutung von Information in Kommunikation, Steuerung und Rückkopplung.', 'Einleitender Forschungsstand', 1, 1, 'Neue Erstnennung [76].', 41),
(295, 110, 17, 'comparison', 'Vergleich der quantitativen Shannon-Perspektive mit der funktionalen kybernetischen Perspektive.', 'Wissenschaftliche Einordnung', 0, 1, 'Ergänzende Primärquelle.', 41),
(307, 118, 18, 'first_citation', 'Historische Begründung der Graphentheorie durch das Königsberger Brückenproblem.', 'Einleitender Forschungsstand', 1, 1, 'Neue Erstnennung [77].', 47),
(308, 119, 18, 'first_citation', 'Moderne Definitionen und Eigenschaften von Graphen und Netzwerken.', 'Definition eines Graphen und folgende mathematische Grundlagen', 1, 1, 'Neue Erstnennung [78].', 47),
(309, 119, 18, 'definition', 'Adjazenzmatrix, Knotengrad, Wege, Distanzen, Zusammenhang und Gewichtung.', 'Gesamter mathematischer Formalismus 3.2.10', 0, 1, 'Zentrale Standardquelle.', 47),
(310, 120, 19, 'first_citation', 'Small-World-Strukturen mit hoher Clusterung und kurzen Wegen.', 'Einleitung und Small-World-Netzwerke', 1, 1, 'Neue Erstnennung [79].', 45),
(311, 121, 19, 'first_citation', 'Skalenfreie Netzwerke und potenzgesetzartige Gradverteilungen.', 'Einleitung und skalenfreie Netzwerke', 1, 1, 'Neue Erstnennung [80].', 45),
(312, 122, 19, 'first_citation', 'Systematisierung zentraler Netzwerkmaße.', 'Zentralitätsmaße', 1, 1, 'Neue Erstnennung [81].', 45),
(313, 120, 19, 'definition', 'Clusterkoeffizient und mittlere Weglänge als globale Netzwerkparameter.', 'Gleichungen (3.271)–(3.273)', 0, 1, 'Primärquelle und etablierte Netzwerktheorie.', 45),
(314, 121, 19, 'definition', 'Potenzgesetz der Knotengrade und Hub-Struktur.', 'Gleichung (3.274)', 0, 1, 'Primärquelle.', 45),
(315, 122, 19, 'definition', 'Grad-, Closeness- und Betweenness-Zentralität.', 'Gleichungen (3.267)–(3.269)', 0, 1, 'Primärquelle.', 45),
(316, 23, 20, '', 'Mengenlehre als grundlegende mathematische Sprache, die ihre Objekte voraussetzt.', 'Zusammenfassung der elementaren Grundlagen', 0, 1, 'Bestehende Quelle [23].', 49),
(317, 24, 20, '', 'Axiomatische Begrenzung zulässiger mengentheoretischer Konstruktionen.', 'Zusammenfassung der elementaren Grundlagen', 0, 1, 'Bestehende Quelle [24].', 49),
(318, 29, 20, '', 'Funktionen als eindeutige gerichtete Zuordnungen.', 'Zusammenfassung der Transformationsgrundlagen', 0, 1, 'Bestehende Quelle [29].', 49),
(319, 38, 20, '', 'Zustandsraumdarstellung und Systembeschreibung.', 'Zusammenfassung dynamischer Systeme', 0, 1, 'Bestehende Quelle [38].', 49),
(320, 40, 20, '', 'Dynamische Systeme, Trajektorien und qualitative Organisationsformen.', 'Zusammenfassung dynamischer Systeme', 0, 1, 'Bestehende Quelle [40].', 49),
(321, 109, 20, '', 'Probabilistische Quantifizierung von Information und Entropie.', 'Zusammenfassung der Informationstheorie', 0, 1, 'Bestehende Quelle [75].', 49),
(322, 119, 20, '', 'Graphen als explizit vorgegebene relationale Strukturen.', 'Zusammenfassung der Graphentheorie', 0, 1, 'Bestehende Quelle [78].', 49),
(323, 120, 20, '', 'Globale Small-World-Organisation aus lokaler Vernetzung.', 'Zusammenfassung komplexer Netzwerke', 0, 1, 'Bestehende Quelle [79].', 49),
(324, 121, 20, '', 'Emergente Gradverteilungen in wachsenden Netzwerken.', 'Zusammenfassung komplexer Netzwerke', 0, 1, 'Bestehende Quelle [80].', 49);
...
(104, 'T', 'T', 'Operator', 'Abbildung zwischen mathematisch strukturierten Räumen.', 'global', 13, 552, NULL, 'X', 'Y', 0, 0, 1, 'Zentrales Operatorsymbol.', 'checked', 31),
(118, 'R', 'R', 'Relation', 'Binäre Relation zwischen mathematischen Elementen.', 'section', 10, NULL, NULL, 'Relation', NULL, 0, 0, 0, 'Abschnitt 3.2.2 V2.', 'checked', 25),
(119, 'R^{-1}', 'R^{-1}', 'inverse Relation', 'Relation mit vertauschten Komponenten.', 'section', 10, NULL, NULL, 'Relation', NULL, 0, 0, 0, 'Abschnitt 3.2.2 V2.', 'checked', 25),
(120, 'operatorname{dom}(R)', 'operatorname{dom}(R)', 'Definitionsbereich', 'Menge aller ersten Komponenten einer Relation.', 'section', 10, NULL, NULL, 'Menge', NULL, 0, 0, 0, 'Abschnitt 3.2.2 V2.', 'checked', 25),
(121, 'operatorname{ran}(R)', 'operatorname{ran}(R)', 'Wertebereich', 'Menge aller zweiten Komponenten einer Relation.', 'section', 10, NULL, NULL, 'Menge', NULL, 0, 0, 0, 'Abschnitt 3.2.2 V2.', 'checked', 25),
(122, 'preceq', 'preceq', 'Ordnungsrelation', 'Symbol für eine Halb- oder Totalordnung.', 'section', 10, NULL, NULL, 'Relation', NULL, 0, 0, 0, 'Abschnitt 3.2.2 V2.', 'checked', 25),
(123, 'Scirc R', 'Scirc R', 'Relationskomposition', 'Komposition zweier Relationen.', 'section', 10, NULL, NULL, 'Relation', NULL, 0, 0, 0, 'Abschnitt 3.2.2 V2.', 'checked', 25),
(124, 'A/R', 'A/R', 'Quotientenmenge', 'Menge der Äquivalenzklassen von A bezüglich R.', 'section', 10, NULL, NULL, 'Menge', NULL, 0, 0, 0, 'Abschnitt 3.2.2 V2.', 'checked', 25),
(125, 'f', 'f', 'Funktion', 'Eindeutige Abbildung von A nach B.', 'section', 11, NULL, NULL, 'A', 'B', 0, 0, 0, 'Zentrales Symbol des Abschnitts 3.2.3.', 'checked', 26),
(126, 'f^{-1}', 'f^{-1}', 'Umkehrfunktion', 'Inverse Abbildung einer bijektiven Funktion.', 'section', 11, NULL, NULL, 'B', 'A', 0, 0, 0, 'Zentrales Symbol des Abschnitts 3.2.3.', 'checked', 26),
(127, 'g\\circ f', 'g\\circ f', 'Funktionskomposition', 'Verkettung zweier kompositionsverträglicher Funktionen.', 'section', 11, NULL, NULL, 'A', 'C', 0, 0, 0, 'Zentrales Symbol des Abschnitts 3.2.3.', 'checked', 26),
(128, '\\operatorname{id}_A', '\\operatorname{id}_A', 'Identitätsabbildung', 'Neutrale Abbildung auf A.', 'section', 11, NULL, NULL, 'A', 'A', 0, 0, 0, 'Zentrales Symbol des Abschnitts 3.2.3.', 'checked', 26),
(129, 'star', 'star', 'binäre Verknüpfung', 'Abgeschlossene innere binäre Verknüpfung.', 'section', 12, 510, NULL, 'A×A', 'A', 0, 0, 0, 'Neufassung 3.2.4 V2.', 'checked', 29),
(130, 'e', 'e', 'neutrales Element', 'Element, das unter der Verknüpfung keine Änderung bewirkt.', 'section', 12, 518, NULL, 'A', 'A', 0, 0, 0, 'Neufassung 3.2.4 V2.', 'checked', 29),
(131, 'a^{-1}', 'a^{-1}', 'inverses Element', 'Inverse zu a bezüglich der Gruppenverknüpfung.', 'section', 12, 525, NULL, 'A', 'A', 0, 0, 0, 'Neufassung 3.2.4 V2.', 'checked', 29),
(132, 'varphi', 'varphi', 'Homomorphismus', 'Strukturerhaltende Abbildung zwischen algebraischen Strukturen.', 'section', 12, 531, NULL, NULL, NULL, 0, 0, 0, 'Neufassung 3.2.4 V2.', 'checked', 29),
(133, 'R', 'R', 'Ring', 'Trägermenge mit additiver und multiplikativer Verknüpfung.', 'section', 12, 533, NULL, 'Ring', NULL, 0, 0, 0, 'Neufassung 3.2.4 V2.', 'checked', 29),
(134, 'K', 'K', 'Skalarkörper', 'Körper der Skalare eines Vektorraums.', 'section', 12, 544, NULL, 'Körper', NULL, 0, 0, 0, 'Neufassung 3.2.4 V2.', 'checked', 29),
(135, 'V', 'V', 'Vektorraum', 'Vektorraum über dem Körper K.', 'section', 12, 544, NULL, 'Vektorraum', NULL, 1, 0, 0, 'Neufassung 3.2.4 V2.', 'checked', 29),
(136, '\\mathcal{D}(T)', '\\mathcal{D}(T)', 'Definitionsbereich eines Operators', 'Tatsächlicher Bereich, auf dem T definiert ist.', 'section', 13, 557, NULL, 'Operator T', 'Teilmenge von X', 0, 0, 0, 'Domäne des Operators.', 'checked', 31),
(137, '\\mathcal{R}(T)', '\\mathcal{R}(T)', 'Wertebereich eines Operators', 'Menge aller von T erzeugten Bilder.', 'section', 13, 559, NULL, 'Operator T', 'Teilmenge von Y', 0, 0, 0, 'Range des Operators.', 'checked', 31),
(138, '\\ker(T)', '\\ker(T)', 'Kern eines Operators', 'Menge aller auf Null abgebildeten Elemente.', 'section', 13, 563, NULL, 'linearer Operator T', 'Unterraum von X', 0, 0, 0, 'Nullraum.', 'checked', 31),
(139, '\\operatorname{im}(T)', '\\operatorname{im}(T)', 'Bild eines Operators', 'Menge aller erreichbaren Operatorbilder.', 'section', 13, 564, NULL, 'linearer Operator T', 'Unterraum von Y', 0, 0, 0, 'Bildraum.', 'checked', 31),
(140, 'I_X', 'I_X', 'Identitätsoperator', 'Neutrale Transformation auf X.', 'section', 13, 572, NULL, 'X', 'X', 0, 0, 1, 'Neutrales Element der Komposition.', 'checked', 31),
(141, 'T^{-1}', 'T^{-1}', 'Inverser Operator', 'Umkehrabbildung eines invertierbaren Operators.', 'section', 13, 575, NULL, 'Y', 'X', 0, 0, 1, 'Existiert nur bei Invertierbarkeit.', 'checked', 31),
(142, '\\operatorname{End}(V)', '\\operatorname{End}(V)', 'Endomorphismenmenge', 'Menge aller linearen Endomorphismen von V.', 'section', 13, 577, NULL, 'Vektorraum V', 'Operatorraum', 0, 0, 0, 'Träger der Operatoralgebra.', 'checked', 31),
(143, '\\sigma(T)', '\\sigma(T)', 'Spektrum eines Operators', 'Menge der Werte, für die T minus Lambda I nicht invertierbar ist.', 'section', 13, 580, NULL, 'Operator T', 'Teilmenge von \\mathbb C', 0, 0, 0, 'Spektrale Charakterisierung.', 'checked', 31),
(145, 'X', 'x', 'Zustand', 'Einzelner Zustand eines Systems.', 'section', 14, 581, NULL, 'X', NULL, 1, 0, 0, 'Kontextabhängig skalar, Vektor oder Funktion.', 'checked', 38),
(146, 'F', 'F', 'Entwicklungs- oder Übergangsabbildung', 'Regel zur Erzeugung von Folgezuständen.', 'section', 14, 584, NULL, 'X', 'X', 0, 0, 1, 'Diskrete oder kontinuierliche Dynamik.', 'checked', 38),
(147, 'X_{mathrm{zul}}', 'X_{mathrm{zul}}', 'zulässiger Zustandsraum', 'Teilmenge aller nebenbedingungskonformen Zustände.', 'section', 14, 586, NULL, 'X', NULL, 0, 0, 0, 'Durch Modellnebenbedingungen eingeschränkt.', 'checked', 38),
(148, 'Phi', 'Phi', 'Fluss', 'Zeitparametrisierte Familie von Zustandsabbildungen.', 'section', 14, 597, NULL, 'mathbb R	imes X', 'X', 0, 0, 1, 'Kontinuierliche Zustandsentwicklung.', 'checked', 38),
(149, 'gamma(x_0)', 'gamma(x_0)', 'Trajektorie', 'Menge der aus x0 entlang des Flusses erreichten Zustände.', 'section', 14, 601, NULL, 'Zeitintervall', 'Teilmenge von X', 0, 0, 0, 'Geometrische Bahn im Zustandsraum.', 'checked', 38),
(150, 'x^ast', 'x^ast', 'Gleichgewichtspunkt', 'Zustand mit verschwindender Dynamik.', 'section', 14, 602, NULL, 'X', NULL, 0, 0, 0, 'Invarianter stationärer Zustand.', 'checked', 38),
(152, '\\mu', '\\mu', 'Kontrollparameter', 'Parameter, dessen Variation qualitative Änderungen der Dynamik auslösen kann.', 'section', 16, 629, NULL, '\\mathbb{R}^p', NULL, 0, 0, 0, 'Zentrales Symbol des Abschnitts 3.2.8.', 'checked', 40),
(153, 'F', 'F', 'nichtlineares Vektorfeld', 'Parameterabhängiges Entwicklungsgesetz des Systems.', 'section', 16, 629, NULL, 'X\\times\\mathbb{R}^p', 'TX', 0, 0, 1, 'Zentrales Symbol des Abschnitts 3.2.8.', 'checked', 40),
(154, 'N(x,\\mu)', 'N(x,\\mu)', 'nichtlinearer Anteil', 'Nichtlinearer Anteil des Entwicklungsgesetzes.', 'section', 16, 631, NULL, NULL, NULL, 0, 0, 1, 'Zentrales Symbol des Abschnitts 3.2.8.', 'checked', 40),
(155, '\\xi', '\\xi', 'lokale Abweichung', 'Lokale Abweichung vom Gleichgewichtspunkt.', 'section', 16, 635, NULL, '\\mathbb{R}^n', NULL, 1, 0, 0, 'Zentrales Symbol des Abschnitts 3.2.8.', 'checked', 40),
(156, 'J', 'J', 'Jacobi-Matrix', 'Linearisierung des Vektorfeldes am Gleichgewichtspunkt.', 'section', 16, 638, NULL, '\\mathbb{R}^{n\\times n}', '\\mathbb{R}^{n\\times n}', 0, 1, 0, 'Zentrales Symbol des Abschnitts 3.2.8.', 'checked', 40),
(157, '\\lambda_i', '\\lambda_i', 'Eigenwert', 'Eigenwert der Jacobi-Matrix.', 'section', 16, 639, NULL, '\\mathbb{C}', NULL, 0, 0, 0, 'Zentrales Symbol des Abschnitts 3.2.8.', 'checked', 40),
(158, '\\mu_c', '\\mu_c', 'kritischer Parameterwert', 'Parameterwert einer möglichen Bifurkation.', 'section', 16, 641, NULL, '\\mathbb{R}', NULL, 0, 0, 0, 'Zentrales Symbol des Abschnitts 3.2.8.', 'checked', 40),
(159, '\\Phi_\\mu', '\\Phi_\\mu', 'parameterabhängiger Fluss', 'Dynamischer Fluss für einen festen Parameterwert.', 'section', 16, 642, NULL, NULL, NULL, 0, 0, 1, 'Zentrales Symbol des Abschnitts 3.2.8.', 'checked', 40),
(160, 'A(\\mu)', 'A(\\mu)', 'parameterabhängiger Attraktor', 'Asymptotische Organisationsform des Systems beim Parameterwert mu.', 'section', 16, 656, NULL, NULL, NULL, 0, 0, 0, 'Zentrales Symbol des Abschnitts 3.2.8.', 'checked', 40),
(161, '\\mathcal X', '\\mathcal X', 'Alphabet', 'Menge möglicher Werte einer diskreten Zufallsvariablen.', 'section', 17, 657, NULL, '\\{x_1,\\ldots,x_n\\}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.9.', 'checked', 41),
(162, 'p_i', 'p_i', 'Ereigniswahrscheinlichkeit', 'Wahrscheinlichkeit des i-ten Ereignisses.', 'section', 17, 658, NULL, '[0,1]', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.9.', 'checked', 41),
(163, 'I', 'I', 'Selbstinformation', 'Informationsgehalt eines Einzelereignisses.', 'section', 17, 661, NULL, '\\mathbb R_{\\ge0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.9.', 'checked', 41),
(164, 'H', 'H', 'Shannon-Entropie', 'Mittlere probabilistische Unbestimmtheit.', 'section', 17, 668, NULL, '\\mathbb R_{\\ge0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.9.', 'checked', 41),
(165, 'H(X|Y)', 'H(X|Y)', 'bedingte Entropie', 'Verbleibende Unsicherheit von X bei Kenntnis von Y.', 'section', 17, 677, NULL, '\\mathbb R_{\\ge0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.9.', 'checked', 41),
(166, 'I(X;Y)', 'I(X;Y)', 'gegenseitige Information', 'Informationsabhängigkeit zwischen X und Y.', 'section', 17, 681, NULL, '\\mathbb R_{\\ge0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.9.', 'checked', 41),
(167, 'D_{KL}', 'D_{KL}', 'Kullback-Leibler-Divergenz', 'Gerichteter Vergleich zweier Wahrscheinlichkeitsverteilungen.', 'section', 17, 684, NULL, '\\mathbb R_{\\ge0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.9.', 'checked', 41),
(168, 'D_{JS}', 'D_{JS}', 'Jensen-Shannon-Divergenz', 'Symmetrischer Vergleich zweier Wahrscheinlichkeitsverteilungen.', 'section', 17, 688, NULL, '\\mathbb R_{\\ge0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.9.', 'checked', 41),
(176, 'G', 'G', 'Graph', 'Geordnetes Paar aus Knoten- und Kantenmenge.', 'section', 18, 706, NULL, NULL, NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.10.', 'checked', 47),
(177, 'V', 'V', 'Knotenmenge', 'Menge aller Knoten.', 'section', 18, 706, NULL, NULL, NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.10.', 'checked', 47),
(178, 'E', 'E', 'Kantenmenge', 'Menge aller Kanten.', 'section', 18, 706, NULL, NULL, NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.10.', 'checked', 47),
(179, 'A', 'A', 'Adjazenzmatrix', 'Binäre Matrixdarstellung eines endlichen Graphen.', 'section', 18, 712, NULL, '\\{0,1\\}^{n\\times n}', NULL, 0, 1, 0, 'Zentrales Symbol von Abschnitt 3.2.10.', 'checked', 47),
(180, 'd', 'd', 'Graphendistanz', 'Länge eines kürzesten Pfades zwischen zwei Knoten.', 'section', 18, 722, NULL, NULL, '\\mathbb N_0\\cup\\{\\infty\\}', 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.10.', 'checked', 47),
(181, 'w', 'W', 'gewichtete Adjazenzmatrix', 'Matrix der Kantengewichte.', 'section', 18, 726, NULL, '\\mathbb R^{n\\times n}', NULL, 0, 1, 0, 'Zentrales Symbol von Abschnitt 3.2.10.', 'checked', 47),
(183, 'C_D', 'C_D', 'Gradzentralität', 'Normierte lokale Vernetzung eines Knotens.', 'section', 19, 728, NULL, '[0,1]', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.11.', 'checked', 45),
(184, 'C_C', 'C_C', 'Closeness-Zentralität', 'Globale Erreichbarkeit eines Knotens.', 'section', 19, 729, NULL, '\\mathbb R_{\\ge0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.11.', 'checked', 45),
(185, 'C_B', 'C_B', 'Betweenness-Zentralität', 'Vermittlungsfunktion eines Knotens.', 'section', 19, 730, NULL, '\\mathbb R_{\\ge0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.11.', 'checked', 45),
(186, 'x', 'x', 'Eigenvektor-Zentralitätsvektor', 'Zentralitätswerte aller Knoten.', 'section', 19, 731, NULL, '\\mathbb R^n', NULL, 1, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.11.', 'checked', 45),
(187, 'C', 'C', 'Clusterkoeffizient', 'Lokale beziehungsweise globale Clusterung.', 'section', 19, 732, NULL, '[0,1]', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.11.', 'checked', 45),
(188, 'L', 'L', 'mittlere Weglänge', 'Durchschnitt der kürzesten Knotenabstände.', 'section', 19, 733, NULL, '\\mathbb R_{\\ge0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.11.', 'checked', 45),
(189, 'P(k)', 'P(k)', 'Gradverteilung', 'Wahrscheinlichkeitsverteilung der Knotengrade.', 'section', 19, 735, NULL, '[0,1]', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.11.', 'checked', 45),
(190, '\\gamma', '\\gamma', 'Skalierungsexponent', 'Exponent der potenzgesetzartigen Gradverteilung.', 'section', 19, 735, NULL, '\\mathbb R_{>0}', NULL, 0, 0, 0, 'Zentrales Symbol von Abschnitt 3.2.11.', 'checked', 45);
...
--
ALTER TABLE `annotations`
  MODIFY `annotation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
...
--
ALTER TABLE `authors`
  MODIFY `author_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
...
--
ALTER TABLE `definitions`
  MODIFY `definition_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=288;
...
--
ALTER TABLE `equations`
  MODIFY `equation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=736;
...
--
ALTER TABLE `equation_symbols`
  MODIFY `equation_symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=445;
...
--
ALTER TABLE `repository_revisions`
  MODIFY `revision_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `section_change_log`
  MODIFY `change_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=173;

--
-- AUTO_INCREMENT für Tabelle `sources`
--
ALTER TABLE `sources`
  MODIFY `source_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
...
--
ALTER TABLE `source_usage`
  MODIFY `usage_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=325;

--
-- AUTO_INCREMENT für Tabelle `symbols`
--
ALTER TABLE `symbols`
  MODIFY `symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=191;
