...
Repository-Update
Abschnitt 3.2.43.22
Wellengleichungen der elektromagnetischen Potentiale

Definitionen : 3.2.776–3.2.780
Sätze        : 3.2.230–3.2.235
Gleichungen  : (3.3575)–(3.3588)
Literatur    : [134]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.22-V1',NOW(),'subsection','3.2.43.22',
'3.2.43.22-v1-vollstaendig',
'Wellengleichungen der elektromagnetischen Potentiale einschließlich retardierter Potentiale und Kausalität.',
'Olaf Thiele / ChatGPT')
...
SELECT 134,'potential_wave_equations_134','book',
'Wellengleichungen der elektromagnetischen Potentiale',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=134);
...
'subsection',
'3.2.43.22',
'Wellengleichungen der elektromagnetischen Potentiale vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.776 D'Alembert-Operator
-- 3.2.777 Quellenfunktion
-- 3.2.778 Homogene Potentialgleichung
-- 3.2.779 Retardiertes Potential
-- 3.2.780 Kausalitätsprinzip

-- Sätze
-- 3.2.230 Wellengleichung des Skalarpotentials
-- 3.2.231 Wellengleichung des Vektorpotentials
-- 3.2.232 Wellenausbreitung der Potentiale
-- 3.2.233 Retardiertes Skalarpotential
-- 3.2.234 Retardiertes Vektorpotential
-- 3.2.235 Erhaltung der Kausalität
...
VALUES
('last_completed_section','3.2.43.22'),
('current_section','3.2.43.23'),
('last_definition_number','3.2.780'),
('next_definition_number','3.2.781'),
('last_theorem_number','3.2.235'),
('next_theorem_number','3.2.236'),
('last_equation_number','3.3588'),
('next_equation_number','3.3589'),
('last_citation_number','134'),
('next_citation_number','135')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.776–3.2.780' AS expected;
SELECT 'Sätze 3.2.230–3.2.235' AS expected;
SELECT 'Gleichungen (3.3575)–(3.3588)' AS expected;
