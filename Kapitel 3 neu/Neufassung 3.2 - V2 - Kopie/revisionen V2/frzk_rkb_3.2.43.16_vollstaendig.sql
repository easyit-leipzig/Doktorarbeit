...
Definitionen : 3.2.732–3.2.738
Sätze        : 3.2.197–3.2.202
Gleichungen  : (3.3469)–(3.3490)
Literatur    : [128]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.16-V1',NOW(),'subsection','3.2.43.16',
'3.2.43.16-v1-vollstaendig',
'Elektromagnetische Wellen im Vakuum, Wellengleichung, Lichtgeschwindigkeit und Poynting-Beziehungen.',
'Olaf Thiele / ChatGPT')
...
SELECT 128,'em_waves_vacuum_128','book',
'Elektromagnetische Wellen im Vakuum',
'de','pending'
WHERE NOT EXISTS(SELECT 1 FROM sources WHERE citation_number=128);
...
'subsection',
'3.2.43.16',
'Elektromagnetische Wellen im Vakuum vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.732 Elektromagnetische Welle
-- 3.2.733 Quellenfreier Raum
-- 3.2.734 Wellengeschwindigkeit
-- 3.2.735 Ebene Welle
-- 3.2.736 Dispersionsrelation
-- 3.2.737 Wellenimpedanz des Vakuums
-- 3.2.738 Intensität elektromagnetischer Wellen

-- Sätze
-- 3.2.197 Maxwell-Gleichungen im Vakuum
-- 3.2.198 Wellengleichung des elektrischen Feldes
-- 3.2.199 Wellengleichung des magnetischen Feldes
-- 3.2.200 Lichtgeschwindigkeit
-- 3.2.201 Orthogonalität der Felder
-- 3.2.202 Zusammenhang zwischen Feldstärken
...
VALUES
('last_completed_section','3.2.43.16'),
('current_section','3.2.43.17'),
('last_definition_number','3.2.738'),
('next_definition_number','3.2.739'),
('last_theorem_number','3.2.202'),
('next_theorem_number','3.2.203'),
('last_equation_number','3.3490'),
('next_equation_number','3.3491'),
('last_citation_number','128'),
('next_citation_number','129')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.732–3.2.738' AS expected;
SELECT 'Sätze 3.2.197–3.2.202' AS expected;
SELECT 'Gleichungen (3.3469)–(3.3490)' AS expected;
