...
Repository-Update
Abschnitt 3.2.43.26
Pfadintegralformulierung der Elektrodynamik

Definitionen : 3.2.797–3.2.802
Sätze        : 3.2.251–3.2.255
Gleichungen  : (3.3625)–(3.3636)
Literatur    : [138]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.26-V1',NOW(),'subsection','3.2.43.26',
'3.2.43.26-v1-vollstaendig',
'Pfadintegralformulierung der Elektrodynamik mit erzeugendem Funktional, Eichfixierung und klassischem Grenzfall.',
'Olaf Thiele / ChatGPT')
...
SELECT 138,'path_integral_em_138','book',
'Pfadintegralformulierung der Elektrodynamik',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=138);
...
'subsection',
'3.2.43.26',
'Pfadintegralformulierung der Elektrodynamik vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.797 Pfadintegral
-- 3.2.798 Funktionales Maß
-- 3.2.799 Erzeugendes Funktional
-- 3.2.800 Klassischer Grenzfall
-- 3.2.801 Eichfixierung
-- 3.2.802 Quantenfluktuation

-- Sätze
-- 3.2.251 Gewichtung durch die Wirkung
-- 3.2.252 Korrelationsfunktionen
-- 3.2.253 Prinzip der stationären Phase
-- 3.2.254 Faddeev-Popov-Konstruktion
-- 3.2.255 Stationäre Wirkung als klassischer Grenzfall
...
VALUES
('last_completed_section','3.2.43.26'),
('current_section','3.2.43.27'),
('last_definition_number','3.2.802'),
('next_definition_number','3.2.803'),
('last_theorem_number','3.2.255'),
('next_theorem_number','3.2.256'),
('last_equation_number','3.3636'),
('next_equation_number','3.3637'),
('last_citation_number','138'),
('next_citation_number','139')
