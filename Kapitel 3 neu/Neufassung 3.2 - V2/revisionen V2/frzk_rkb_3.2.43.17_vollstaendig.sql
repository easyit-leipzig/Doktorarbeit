...
Definitionen : 3.2.739–3.2.747
Sätze        : 3.2.203–3.2.208
Gleichungen  : (3.3491)–(3.3511)
Literatur    : [129]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.17-V1',NOW(),'subsection','3.2.43.17',
'3.2.43.17-v1-vollstaendig',
'Elektromagnetische Wellen in Materie, Materialgleichungen, Dispersion, Dämpfung und Polarisation.',
'Olaf Thiele / ChatGPT')
...
SELECT 129,'em_waves_matter_129','book',
'Elektromagnetische Wellen in Materie',
'de','pending'
WHERE NOT EXISTS(SELECT 1 FROM sources WHERE citation_number=129);
...
'subsection',
'3.2.43.17',
'Elektromagnetische Wellen in Materie vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.739 Lineares Medium
-- 3.2.740 Relative Permittivität
-- 3.2.741 Relative Permeabilität
-- 3.2.742 Brechungsindex
-- 3.2.743 Leitfähiges Medium
-- 3.2.744 Absorptionskoeffizient
-- 3.2.745 Dispersion
-- 3.2.746 Polarisierbares Medium
-- 3.2.747 Elektromagnetisches Materialmodell

-- Sätze
-- 3.2.203 Wellengeschwindigkeit im Medium
-- 3.2.204 Zusammenhang Brechungsindex/Materialkonstanten
-- 3.2.205 Gedämpfte Wellengleichung
-- 3.2.206 Lambert-Beer-Gesetz
-- 3.2.207 Frequenzabhängige Wellengeschwindigkeit
-- 3.2.208 Zusammenhang Polarisation und Flussdichte
...
VALUES
('last_completed_section','3.2.43.17'),
('current_section','3.2.43.18'),
('last_definition_number','3.2.747'),
('next_definition_number','3.2.748'),
('last_theorem_number','3.2.208'),
('next_theorem_number','3.2.209'),
('last_equation_number','3.3511'),
('next_equation_number','3.3512'),
('last_citation_number','129'),
('next_citation_number','130')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.739–3.2.747' AS expected;
SELECT 'Sätze 3.2.203–3.2.208' AS expected;
SELECT 'Gleichungen (3.3491)–(3.3511)' AS expected;
