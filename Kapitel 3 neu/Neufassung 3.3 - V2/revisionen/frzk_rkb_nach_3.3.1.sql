...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 19. Jul 2026 um 06:40
...
(26, NULL, '3.3', 'Axiomatische Grundlagen des Funktionalen Raum-Zeit-Kohärenzsystems', 3, 3.4000, 'draft', 1, 'Qualitative axiomatische Grundlegung des FRZK; die mathematische Rekonstruktion erfolgt in Kapitel 3.4.', '2026-07-19 04:35:26', '2026-07-19 04:35:26'),
(27, 26, '3.3.1', 'Übergang von den mathematischen Grundlagen zur FRZK-Axiomatik', 3, 3.4100, 'review', 1, 'Methodischer Übergang von den in Kapitel 3.2 untersuchten mathematischen Strukturen zur qualitativen axiomatischen Grundlegung des FRZK.', '2026-07-19 04:35:26', '2026-07-19 04:35:26');
...
(25, 'RKB-NEU-K3.3.1-V1', '2026-07-19 06:35:26', 'section', '3.3.1', '1.0', 'Neufassung von Abschnitt 3.3.1 als methodischer Übergang von den mathematischen Grundlagen zur qualitativen FRZK-Axiomatik.', 'Olaf Thiele / ChatGPT', 24);
...
(118, 25, 27, 'rewritten', 'section', '3.3.1', 'Abschnitt 3.3.1 wurde als methodischer Übergang von Kapitel 3.2 zur qualitativen FRZK-Axiomatik neu gefasst.', NULL, 'Übergang von den mathematischen Grundlagen zur FRZK-Axiomatik', '2026-07-19 04:35:26');
...
--
ALTER TABLE `authors`
  MODIFY `author_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `definitions`
  MODIFY `definition_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `equations`
  MODIFY `equation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=244;
...
--
ALTER TABLE `equation_symbols`
  MODIFY `equation_symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=206;
...
--
ALTER TABLE `repository_revisions`
  MODIFY `revision_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `section_change_log`
  MODIFY `change_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT für Tabelle `sources`
--
ALTER TABLE `sources`
  MODIFY `source_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
...
--
ALTER TABLE `source_usage`
  MODIFY `usage_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;
