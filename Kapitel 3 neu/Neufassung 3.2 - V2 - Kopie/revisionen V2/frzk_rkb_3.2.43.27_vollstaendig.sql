...
Repository-Update
Abschnitt 3.2.43.27
Eichsymmetrien und Noether-Theorem

Definitionen : 3.2.803–3.2.808
Sätze        : 3.2.256–3.2.260
Gleichungen  : (3.3637)–(3.3649)
Literatur    : [139]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.27-V1',NOW(),'subsection','3.2.43.27',
'3.2.43.27-v1-vollstaendig',
'Eichsymmetrien und Noether-Theorem einschließlich U(1)-Symmetrie, Kontinuitätsgleichung und Ladungserhaltung.',
'Olaf Thiele / ChatGPT')
...
SELECT 139,'gauge_symmetry_noether_139','book',
'Eichsymmetrien und Noether-Theorem',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=139);
...
'subsection',
'3.2.43.27',
'Eichsymmetrien und Noether-Theorem vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.803 Kontinuierliche Symmetrie
-- 3.2.804 Eichtransformation
-- 3.2.805 Noether-Strom
-- 3.2.806 Ladungserhaltung
-- 3.2.807 Globale Symmetrie
-- 3.2.808 Lokale Symmetrie

-- Sätze
-- 3.2.256 Eichinvarianz der Wirkung
-- 3.2.257 Noether-Theorem
-- 3.2.258 Kontinuitätsgleichung
-- 3.2.259 Lokale Eichsymmetrie der Elektrodynamik
-- 3.2.260 Symmetrie als Ursprung physikalischer Erhaltungssätze
...
VALUES
('last_completed_section','3.2.43.27'),
('current_section','3.2.43.28'),
('last_definition_number','3.2.808'),
('next_definition_number','3.2.809'),
('last_theorem_number','3.2.260'),
('next_theorem_number','3.2.261'),
('last_equation_number','3.3649'),
('next_equation_number','3.3650'),
('last_citation_number','139'),
('next_citation_number','140')
