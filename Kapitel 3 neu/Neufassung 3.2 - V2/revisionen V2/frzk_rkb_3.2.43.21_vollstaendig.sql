...
Repository-Update
Abschnitt 3.2.43.21
Elektromagnetische Potentiale und Eichfreiheit

Definitionen : 3.2.771–3.2.775
Sätze        : 3.2.225–3.2.229
Gleichungen  : (3.3559)–(3.3574)
Literatur    : [133]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.21-V1',NOW(),'subsection','3.2.43.21',
'3.2.43.21-v1-vollstaendig',
'Elektromagnetische Potentiale, Viererpotential und Eichfreiheit einschließlich Coulomb- und Lorenz-Eichung.',
'Olaf Thiele / ChatGPT')
...
SELECT 133,'gauge_potentials_133','book',
'Elektromagnetische Potentiale und Eichfreiheit',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=133);
...
'subsection',
'3.2.43.21',
'Elektromagnetische Potentiale und Eichfreiheit vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.771 Skalares Potential
-- 3.2.772 Vektorpotential
-- 3.2.773 Viererpotential
-- 3.2.774 Eichfunktion
-- 3.2.775 Eichäquivalenzklasse

-- Sätze
-- 3.2.225 Darstellung des Magnetfeldes
-- 3.2.226 Darstellung des elektrischen Feldes
-- 3.2.227 Eichtransformation
-- 3.2.228 Coulomb-Eichung
-- 3.2.229 Lorenz-Eichung
...
VALUES
('last_completed_section','3.2.43.21'),
('current_section','3.2.43.22'),
('last_definition_number','3.2.775'),
('next_definition_number','3.2.776'),
('last_theorem_number','3.2.229'),
('next_theorem_number','3.2.230'),
('last_equation_number','3.3574'),
('next_equation_number','3.3575'),
('last_citation_number','133'),
('next_citation_number','134')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.771–3.2.775' AS expected;
SELECT 'Sätze 3.2.225–3.2.229' AS expected;
SELECT 'Gleichungen (3.3559)–(3.3574)' AS expected;
