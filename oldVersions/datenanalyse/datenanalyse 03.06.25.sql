...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 03. Jun 2025 um 08:46
...
CREATE TABLE `ue_schueler` (
  `id` int(11) NOT NULL,
  `schueler_id` int(11) NOT NULL,
  `metrik_didaktik_id` int(11) NOT NULL,
  `metrik_emotionen_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ue_unterrichtseinheit` (
  ...
  `beschreibung` text DEFAULT NULL,
  `metrik_thema` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Tabellenstruktur für Tabelle `_lehrkraft_rolle`
--

CREATE TABLE `_lehrkraft_rolle` (
  `id` int(11) NOT NULL,
...
--
-- Daten für Tabelle `_lehrkraft_rolle`
--

INSERT INTO `_lehrkraft_rolle` (`id`, `bezeichnung`, `beschreibung`) VALUES
...
--
-- Indizes für die Tabelle `_lehrkraft_rolle`
--
ALTER TABLE `_lehrkraft_rolle`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT für Tabelle `_lehrkraft_rolle`
--
ALTER TABLE `_lehrkraft_rolle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
ALTER TABLE `ue_unterricht_lehrkraft`
  ...
  ADD CONSTRAINT `ue_unterricht_lehrkraft_ibfk_3` FOREIGN KEY (`rolle_id`) REFERENCES `_lehrkraft_rolle` (`id`);
COMMIT;
