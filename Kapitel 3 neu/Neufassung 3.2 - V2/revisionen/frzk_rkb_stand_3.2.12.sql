...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 18. Jul 2026 um 16:51
...
('last_completed_section', '3.2.12', '2026-07-18 14:51:07'),
('last_repository_revision', 'RKB-NEU-K3.2.12-V1', '2026-07-18 14:51:07'),
...
--
ALTER TABLE `dissertation_sections`
  MODIFY `section_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `repository_validation_results`
  MODIFY `validation_result_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;

--
-- AUTO_INCREMENT für Tabelle `section_change_log`
--
ALTER TABLE `section_change_log`
  MODIFY `change_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
