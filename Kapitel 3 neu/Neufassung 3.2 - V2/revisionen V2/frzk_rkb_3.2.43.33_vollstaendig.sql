...
Repository-Update
Abschnitt 3.2.43.33
Quantenchromodynamik und Farbladung

Definitionen : 3.2.839–3.2.844
Sätze        : 3.2.285–3.2.289
Gleichungen  : (3.3701)–(3.3710)
Literatur    : [145]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.33-V1',NOW(),'subsection','3.2.43.33',
'3.2.43.33-v1-vollstaendig',
'Quantenchromodynamik und Farbladung einschließlich SU(3)-Eichtheorie, Gluonen, Confinement und asymptotischer Freiheit.',
'Olaf Thiele / ChatGPT')
...
SELECT 145,'qcd_colour_145','book',
'Quantenchromodynamik und Farbladung',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=145);
...
SELECT
 ...
 'subsection',
 '3.2.43.33',
 'Quantenchromodynamik und Farbladung vollständig ergänzt.'
...
-- Definitionen
-- 3.2.839 Farbladung
-- 3.2.840 Eichgruppe der QCD
-- 3.2.841 Gluonenfeld
-- 3.2.842 Feldstärketensor der QCD
-- 3.2.843 Farbsingulett
-- 3.2.844 Asymptotische Freiheit

-- Sätze
-- 3.2.285 Acht Generatoren der Farbsymmetrie
-- 3.2.286 Kovariante Ableitung der QCD
-- 3.2.287 Selbstwechselwirkung der Gluonen
-- 3.2.288 Confinement
-- 3.2.289 Laufende starke Kopplung
...
VALUES
('last_completed_section','3.2.43.33'),
('current_section','3.2.43.34'),
('last_definition_number','3.2.844'),
('next_definition_number','3.2.845'),
('last_theorem_number','3.2.289'),
('next_theorem_number','3.2.290'),
('last_equation_number','3.3710'),
('next_equation_number','3.3711'),
('last_citation_number','145'),
('next_citation_number','146')
