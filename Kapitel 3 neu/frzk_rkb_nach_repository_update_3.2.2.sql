...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 14. Jul 2026 um 05:59
...
(11, 7, '3.2.3', 'Funktionen als mathematische Beschreibung gerichteter Transformationen', 3, 3.2300, 'review', 0, NULL, '2026-07-12 11:14:28', '2026-07-12 11:14:28'),
...
(10, '3.10', 10, 'Relation auf einer Menge', 'R\\subseteq A\\times A', 'R\\subseteq A\\times A', 'Binäre Relation auf derselben Grundmenge.', 'definition', 'literature', 27, NULL, NULL, 'checked', 6),
(11, '3.11', 10, 'Relationsnotation', 'aRb\\Longleftrightarrow(a,b)\\in R', 'aRb\\Longleftrightarrow(a,b)\\in R', 'Äquivalenz zwischen Kurznotation und geordnetem Paar.', 'definition', 'literature', 27, NULL, NULL, 'checked', 6),
(12, '3.12', 10, 'Reflexivität', '\\forall a\\in A:\\;aRa', '\\forall a\\in A:\\;aRa', 'Reflexivität einer Relation.', 'definition', 'literature', 28, NULL, NULL, 'checked', 6),
(13, '3.13', 10, 'Symmetrie', 'aRb\\Rightarrow bRa', 'aRb\\Rightarrow bRa', 'Symmetrie einer Relation.', 'definition', 'literature', 28, NULL, NULL, 'checked', 6),
(14, '3.14', 10, 'Transitivität', '(aRb)\\land(bRc)\\Rightarrow aRc', '(aRb)\\land(bRc)\\Rightarrow aRc', 'Transitivität einer Relation.', 'definition', 'literature', 28, NULL, NULL, 'checked', 6),
(15, '3.15', 10, 'Äquivalenzklasse', '[a]=\\{x\\in A\\mid x\\sim a\\}', '[a]=\\{x\\in A\\mid x\\sim a\\}', 'Äquivalenzklasse eines Elements.', 'definition', 'literature', 27, NULL, NULL, 'checked', 6),
(16, '3.16', 10, 'Halbordnungsrelation', 'a\\preceq b', 'a\\preceq b', 'Notation einer Halbordnung.', 'definition', 'literature', 28, NULL, NULL, 'checked', 6),
(17, '3.17', 11, 'Funktion', 'f:A\\rightarrow B', 'f:A\\rightarrow B', 'Abbildung von der Definitionsmenge in die Zielmenge.', 'definition', 'literature', 29, NULL, NULL, 'checked', 6),
(18, '3.18', 11, 'Eindeutige Zuordnung', '\\forall x\\in A\\;\\exists!\\,y\\in B:f(x)=y', '\\forall x\\in A\\;\\exists!\\,y\\in B:f(x)=y', 'Jedem Element wird genau ein Bild zugeordnet.', 'definition', 'literature', 29, NULL, NULL, 'checked', 6),
(19, '3.19', 11, 'Bildmenge', 'f(A)=\\{f(x)\\mid x\\in A\\}', 'f(A)=\\{f(x)\\mid x\\in A\\}', 'Bild einer Menge unter einer Funktion.', 'definition', 'literature', 29, NULL, NULL, 'checked', 6),
(20, '3.20', 11, 'Injektivität', 'f(x_1)=f(x_2)\\Rightarrow x_1=x_2', 'f(x_1)=f(x_2)\\Rightarrow x_1=x_2', 'Definition der Injektivität.', 'definition', 'literature', 30, NULL, NULL, 'checked', 6),
(21, '3.21', 11, 'Surjektivität', '\\forall y\\in B\\;\\exists x\\in A:f(x)=y', '\\forall y\\in B\\;\\exists x\\in A:f(x)=y', 'Definition der Surjektivität.', 'definition', 'literature', 30, NULL, NULL, 'checked', 6),
(22, '3.22', 11, 'Bijektion', 'f:A\\leftrightarrow B', 'f:A\\leftrightarrow B', 'Kurznotation einer bijektiven Abbildung.', 'definition', 'literature', 30, NULL, NULL, 'checked', 6),
(23, '3.23', 11, 'Funktionskomposition', '(g\\circ f)(x)=g(f(x))', '(g\\circ f)(x)=g(f(x))', 'Komposition zweier Funktionen.', 'definition', 'literature', 29, NULL, NULL, 'checked', 6),
(24, '3.24', 12, 'Innere Verknüpfung', '\\ast:A\\times A\\rightarrow A', '\\ast:A\\times A\\rightarrow A', 'Binäre algebraische Verknüpfung.', 'definition', 'literature', 31, NULL, NULL, 'checked', 6),
...
('last_edited_section', '3.2.2', '2026-07-12 13:10:09'),
('last_repository_revision', 'RKB-2026-07-12-K3.2.2-NEUFASSUNG-V1', '2026-07-12 13:10:09'),
('next_citation_number', '59', '2026-07-12 12:53:53'),
('next_equation_number', '3.10', '2026-07-12 13:10:09');
...
(41, 29, 11, 'first_citation', 'Verwendung von Quelle [29] im Abschnitt 3.2.3.', 'Abschnitt 3.2.3', 1, 0, 'Automatisch durch Kapitelabschluss-Revision registriert.', 6),
(42, 30, 11, 'first_citation', 'Verwendung von Quelle [30] im Abschnitt 3.2.3.', 'Abschnitt 3.2.3', 1, 0, 'Automatisch durch Kapitelabschluss-Revision registriert.', 6),
...
--
ALTER TABLE `equation_symbols`
  MODIFY `equation_symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `repository_revisions`
  MODIFY `revision_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `section_change_log`
  MODIFY `change_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
...
--
ALTER TABLE `source_usage`
  MODIFY `usage_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=209;
