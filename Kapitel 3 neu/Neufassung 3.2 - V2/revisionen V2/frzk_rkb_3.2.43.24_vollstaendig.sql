...
Repository-Update
Abschnitt 3.2.43.24
Hamilton-Formulierung der Elektrodynamik

Definitionen : 3.2.786–3.2.790
Sätze        : 3.2.241–3.2.245
Gleichungen  : (3.3602)–(3.3611)
Literatur    : [136]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.24-V1',NOW(),'subsection','3.2.43.24',
'3.2.43.24-v1-vollstaendig',
'Hamilton-Formulierung der Elektrodynamik einschließlich Phasenraum, Hamilton-Gleichungen und Poisson-Klammern.',
'Olaf Thiele / ChatGPT')
...
SELECT 136,'hamilton_electrodynamics_136','book',
'Hamilton-Formulierung der Elektrodynamik',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=136);
...
'subsection',
'3.2.43.24',
'Hamilton-Formulierung der Elektrodynamik vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.786 Kanonischer Impuls
-- 3.2.787 Hamilton-Dichte
-- 3.2.788 Kanonische Feldvariablen
-- 3.2.789 Phasenraum
-- 3.2.790 Poisson-Klammer

-- Sätze
-- 3.2.241 Legendre-Transformation
-- 3.2.242 Erste Hamilton-Gleichung
-- 3.2.243 Zweite Hamilton-Gleichung
-- 3.2.244 Zeitentwicklung im Phasenraum
-- 3.2.245 Erhaltung der Hamiltonfunktion
...
VALUES
('last_completed_section','3.2.43.24'),
('current_section','3.2.43.25'),
('last_definition_number','3.2.790'),
('next_definition_number','3.2.791'),
('last_theorem_number','3.2.245'),
('next_theorem_number','3.2.246'),
('last_equation_number','3.3611'),
('next_equation_number','3.3612'),
('last_citation_number','136'),
('next_citation_number','137')
