...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 07. Sep 2026 um 14:08
...
(1, 'M1', 'Mengentheoretische und funktionale Grundlagen', 'Mengen, Teilmengen, Mengenoperationen, Potenzmengen, geordnete Paare und Tupel, kartesische Produkte, Relationen, Funktionen, Bild und Urbild, Injektivität, Surjektivität, Bijektivität, Komposition sowie mehrstellige, parametrisierte und partielle Funktionen.', 1, 'draft', 13),
(2, 'M2', 'Algebraische Grundlagen des Vektorraums', 'Körper, Vektorraumaxiome, Nullvektor, additives Inverses, Unterräume, Linearkombination, Spannraum, lineare Abhängigkeit und Unabhängigkeit, Basis und Dimension.', 2, 'planned', 13),
...
(1, 1, NULL, 'M1.0', 'Gegenstand, methodischer Ausgangspunkt und Aufbau', 1.0000, 'draft', 'Erster inhaltlicher Abschnitt des mathematischen Anlagenaufbaus. Die Anlage wird vor dem späteren Haupttext erarbeitet; ihre Ergebnisse werden erst nach Abschluss in den Haupttext übernommen.', 13),
(2, 1, 1, 'M1.1', 'Mengen, Elemente und Mengengleichheit', 2.0000, 'draft', 'Erster mathematischer Einzelabschnitt des Reset-Neuaufbaus von M1. Aufbau ausschließlich aus etablierter Mengenlehre; Weitergabe an M1.2.', 14),
(3, 1, 1, 'M1.2', 'Teilmengen, echte Teilmengen und Potenzmengen', 3.0000, 'draft', 'Reset-Abschnitt von M1. Aufbau ausschließlich auf M1.1 und etablierter Mengenlehre; Weitergabe an M1.3 Mengenoperationen.', 15),
(4, 1, 1, 'M1.3', 'Mengenoperationen', 4.0000, 'draft', 'Reset-Abschnitt von M1. Aufbau auf M1.2; Vereinigung, Durchschnitt, Mengendifferenz, Komplement, De-Morgan-Beziehungen und Distributivität; Weitergabe an M1.4.', 16),
(5, 1, 1, 'M1.4', 'Geordnete Paare, Tupel und kartesische Produkte', 5.0000, 'draft', 'Reset-Abschnitt von M1. Aufbau auf M1.3; geordnete Paare, kartesische Produkte, Tupel und Projektionen; Weitergabe an M1.5.', 17),
(6, 1, 1, 'M1.5', 'Relationen und ihre grundlegenden Eigenschaften', 6.0000, 'draft', 'Reset-Abschnitt von M1. Aufbau auf M1.4; Relationseigenschaften, Äquivalenz- und Ordnungsrelationen, Umkehrung und Komposition; Weitergabe an M1.6.', 18),
(7, 1, 1, 'M1.6', 'Funktionen als eindeutig bestimmte Relationen', 7.0000, 'draft', 'Reset-Abschnitt von M1. Aufbau auf M1.5; Existenz und Eindeutigkeit, Funktionsgraph, Definitions-, Ziel- und Bildbereich, Einschränkung, Identität und Funktionsmengen; Weitergabe an M1.7.', 19),
(8, 1, 1, 'M1.7', 'Injektivität, Surjektivität und Bijektivität', 8.0000, 'draft', 'Reset-Abschnitt von M1. Aufbau auf M1.6; Injektivität, Surjektivität, Bijektivität, Umkehrfunktion und Komposition von Bijektionen; Weitergabe an M1.8.', 20),
(9, 1, 1, 'M1.8', 'Bilder und Urbilder von Mengen', 9.0000, 'draft', 'Reset-Abschnitt von M1. Aufbau auf M1.7; Bild- und Urbildbildung auf Teilmengen sowie deren Verträglichkeit mit Mengenoperationen; Weitergabe an M1.9.', 21),
(10, 1, 1, 'M1.9', 'Identität, Komposition und inverse Verkettung von Funktionen', 10.0000, 'draft', 'Reset-Abschnitt von M1. Aufbau auf M1.8; Funktionskomposition, Identität, Assoziativität, Eigenschaftserhaltung und inverse Verkettung; Weitergabe an M1.10.', 22);
...
--
ALTER TABLE `appendix_sections`
  MODIFY `appendix_section_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT für Tabelle `appendix_section_versions`
--
ALTER TABLE `appendix_section_versions`
  MODIFY `appendix_section_version_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT für Tabelle `appendix_source_usage`
--
ALTER TABLE `appendix_source_usage`
  MODIFY `appendix_usage_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `repository_validation_results`
  MODIFY `validation_result_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=162;
