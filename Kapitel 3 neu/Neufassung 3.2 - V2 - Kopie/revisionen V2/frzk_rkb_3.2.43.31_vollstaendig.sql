...
Definitionen : 3.2.827–3.2.832
Sätze        : 3.2.276–3.2.280
Gleichungen  : (3.3685)–(3.3691)
Literatur    : [143]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.31-V1',NOW(),'subsection','3.2.43.31',
'3.2.43.31-v1-vollstaendig',
'Spontane Symmetriebrechung und Higgs-Mechanismus einschließlich Higgs-Potential, Vakuumerwartungswert und Bosonenmassen.',
'Olaf Thiele / ChatGPT')
...
SELECT 143,'higgs_mechanism_143','book',
'Spontane Symmetriebrechung und Higgs-Mechanismus',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=143);
...
SELECT
 ...
 'subsection',
 '3.2.43.31',
 'Spontane Symmetriebrechung und Higgs-Mechanismus vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.827 Spontane Symmetriebrechung
-- 3.2.828 Higgs-Feld
-- 3.2.829 Vakuumerwartungswert
-- 3.2.830 Higgs-Boson
-- 3.2.831 Goldstone-Moden
-- 3.2.832 Higgs-Mechanismus

-- Sätze
-- 3.2.276 Higgs-Potential
-- 3.2.277 Erhaltung der Eichinvarianz
-- 3.2.278 Massenentstehung der Eichbosonen
-- 3.2.279 Anzahl physikalischer Freiheitsgrade
-- 3.2.280 Konsistenz der elektroschwachen Theorie
...
VALUES
('last_completed_section','3.2.43.31'),
('current_section','3.2.43.32'),
('last_definition_number','3.2.832'),
('next_definition_number','3.2.833'),
('last_theorem_number','3.2.280'),
('next_theorem_number','3.2.281'),
('last_equation_number','3.3691'),
('next_equation_number','3.3692'),
('last_citation_number','143'),
('next_citation_number','144')
