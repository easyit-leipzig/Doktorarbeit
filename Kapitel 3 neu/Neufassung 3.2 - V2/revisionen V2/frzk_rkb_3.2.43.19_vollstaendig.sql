...
Definitionen : 3.2.756–3.2.763
Sätze        : 3.2.215–3.2.219
Gleichungen  : (3.3528)–(3.3544)
Literatur    : [131]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.19-V1',NOW(),'subsection','3.2.43.19',
'3.2.43.19-v1-vollstaendig',
'Reflexion und Brechung elektromagnetischer Wellen einschließlich Snellius-, Fresnel- und Totalreflexionsbeziehungen.',
'Olaf Thiele / ChatGPT')
...
SELECT 131,'reflection_refraction_131','book',
'Reflexion und Brechung elektromagnetischer Wellen',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=131);
...
'subsection',
'3.2.43.19',
'Reflexion und Brechung elektromagnetischer Wellen vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.756 Einfallsebene
-- 3.2.757 Einfallswinkel
-- 3.2.758 Reflexionswinkel
-- 3.2.759 Brechungswinkel
-- 3.2.760 Totalreflexion
-- 3.2.761 Brewster-Winkel
-- 3.2.762 Fresnel-Koeffizienten
-- 3.2.763 Optische Grenzfläche

-- Sätze
-- 3.2.215 Reflexionsgesetz
-- 3.2.216 Snelliussches Brechungsgesetz
-- 3.2.217 Kritischer Winkel
-- 3.2.218 Energieerhaltung bei Reflexion und Brechung
-- 3.2.219 Fresnelsche Transmission
...
VALUES
('last_completed_section','3.2.43.19'),
('current_section','3.2.43.20'),
('last_definition_number','3.2.763'),
('next_definition_number','3.2.764'),
('last_theorem_number','3.2.219'),
('next_theorem_number','3.2.220'),
('last_equation_number','3.3544'),
('next_equation_number','3.3545'),
('last_citation_number','131'),
('next_citation_number','132')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.756–3.2.763' AS expected;
SELECT 'Sätze 3.2.215–3.2.219' AS expected;
SELECT 'Gleichungen (3.3528)–(3.3544)' AS expected;
