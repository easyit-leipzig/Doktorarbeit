...
Definitionen : 3.2.845–3.2.850
Sätze        : 3.2.290–3.2.294
Gleichungen  : (3.3711)–(3.3718)
Literatur    : [146]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.34-V1',NOW(),'subsection','3.2.43.34',
'3.2.43.34-v1-vollstaendig',
'Renormierung und laufende Kopplungskonstanten einschließlich Renormierungsgruppe, Betafunktion und effektiver Feldtheorien.',
'Olaf Thiele / ChatGPT')
...
SELECT 146,'renormalization_running_couplings_146','book',
'Renormierung und laufende Kopplungskonstanten',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=146);
...
SELECT
 ...
 'subsection',
 '3.2.43.34',
 'Renormierung und laufende Kopplungskonstanten vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.845 Renormierung
-- 3.2.846 Bare Parameter
-- 3.2.847 Renormierungsskala
-- 3.2.848 Betafunktion
-- 3.2.849 Fixpunkt
-- 3.2.850 Effektive Theorie

-- Sätze
-- 3.2.290 Renormierte Kopplung
-- 3.2.291 Laufende Kopplung
-- 3.2.292 Renormierungsgruppengleichung
-- 3.2.293 Asymptotische Freiheit der QCD
-- 3.2.294 Gültigkeitsbereich effektiver Theorien
...
VALUES
('last_completed_section','3.2.43.34'),
('current_section','3.2.43.35'),
('last_definition_number','3.2.850'),
('next_definition_number','3.2.851'),
('last_theorem_number','3.2.294'),
('next_theorem_number','3.2.295'),
('last_equation_number','3.3718'),
('next_equation_number','3.3719'),
('last_citation_number','146'),
('next_citation_number','147')
