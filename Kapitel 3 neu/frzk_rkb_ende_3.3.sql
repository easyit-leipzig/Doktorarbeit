...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 16. Jul 2026 um 20:22
...
(120, 147, 'Systematische Darstellung der formalen Logik und der Methodologie deduktiver Wissenschaften sowie der Trennung zwischen primitiven Grundannahmen und abgeleiteten Aussagen.', 'Begründet den methodischen Übergang von Kapitel 3.2 zur qualitativen Axiomatik des FRZK in Kapitel 3.3.', 'Die Quelle stützt die Forderung, Axiome, primitive Begriffe und ableitbare Aussagen einer Theorie klar voneinander zu unterscheiden.', 'Übernommen wird das methodische Prinzip einer expliziten deduktiven Grundlegung; nicht übernommen wird ein konkretes formales Axiomensystem.', 'Tarskis Werk entwickelt keine Theorie emergenter funktionaler Raum-, Zeit- oder Kohärenzstrukturen.', 'Die Quelle wird mit Euklid [7], Hilbert [8] und Zermelo [24] verglichen. Das FRZK übernimmt die axiomatische Methode, verlagert den Ausgangspunkt jedoch vor bereits etablierte mathematische Objekte.', 'reviewed', '2026-07-16 06:03:02'),
(122, 149, 'Systematische Einführung in formale Logik, primitive Begriffe, Axiome und deduktive Theoriebildung.', 'Begründet die methodische Rolle primitiver Begriffe im Übergang von einer qualitativen Grundlegung zu einer späteren mathematischen Rekonstruktion.', 'Stützt die Aussage, dass primitive Begriffe innerhalb derselben Theorie nicht vollständig durch andere Begriffe definiert werden können.', 'Übernommen wird die methodische Trennung zwischen primitiven Begriffen, Axiomen und abgeleiteten Aussagen.', 'Die Quelle entwickelt keine Theorie funktionaler Raum-, Zeit- oder Kohärenzgenese.', 'Suppes wird gemeinsam mit Tarski [82] zur methodischen Einordnung der axiomatischen Ebene verwendet. Der konkrete primitive Wortschatz des FRZK ist originär.', 'reviewed', '2026-07-16 07:29:53'),
(123, 150, 'Strukturelle Darstellung moderner Mathematik über Formen, Beziehungen, Funktionen und Transformationen.', 'Unterstützt die relationale Ausrichtung und die begriffliche Sparsamkeit des primitiven FRZK-Wortschatzes.', 'Stützt die methodische Entscheidung, den Theorieaufbau nicht über eine Vielzahl vorausgesetzter Grundobjekte zu beginnen.', 'Übernommen wird die allgemeine strukturelle Perspektive auf Beziehungen und Transformationen.', 'Mac Lane setzt etablierte mathematische Strukturen voraus und erklärt nicht deren qualitative Genese.', 'Das FRZK verlagert den strukturellen Gedanken auf eine vorgelagerte qualitative axiomatische Ebene.', 'reviewed', '2026-07-16 07:29:53'),
(124, 151, 'Formuliert die ontologischen Verpflichtungen, die aus der formalen Sprache und Quantifikation einer Theorie folgen.', 'Begründet den bewussten Ausschluss bereits stark strukturierter mathematischer Begriffe aus dem primitiven FRZK-Wortschatz.', 'Stützt die Aussage, dass jeder primitive Begriff eine Theorie auf bestimmte Grundstrukturen verpflichtet.', 'Übernommen wird das methodische Bewusstsein für ontologische Verpflichtungen formaler Theorien.', 'Die Quelle entwickelt keine eigenständige Theorie funktionaler Organisation.', 'Das FRZK überträgt Quines Problemstellung auf die Auswahl qualitativer primitiver Begriffe vor der mathematischen Rekonstruktion.', 'reviewed', '2026-07-16 07:29:53'),
(129, 156, 'Spencer-Brown entwickelt einen formalen Kalkül, dessen Ausgangspunkt der Vollzug einer Unterscheidung und die daraus entstehende Markierung ist.', 'Die Quelle bietet einen wichtigen wissenschaftshistorischen und begrifflichen Anschluss für die in Axiom A1 vorausgesetzte fundamentale Rolle funktionaler Unterscheidbarkeit.', 'Die Quelle wird verwendet, um zu zeigen, dass wissenschaftliche Ansätze existieren, die Formbildung nicht mit fertigen Objekten, sondern mit Unterscheidung beginnen.', 'Übernommen wird ausschließlich die allgemeine Einsicht, dass ohne Unterscheidung keine weitere Form- oder Strukturbildung möglich ist.', 'Nicht übernommen werden Spencer-Browns Kalkül, seine konkrete Markierungsoperation, seine Notation oder eine Gleichsetzung des FRZK mit Laws of Form.', 'Axiom A1 ist keine Adaptation des Kalküls. Das FRZK setzt nur die Möglichkeit funktionaler Unterscheidbarkeit voraus und vermeidet in Kapitel 3.3 bereits eine formale Operation, einen Wirkungsbereich oder ein Ergebnis zu postulieren.', 'reviewed', '2026-07-16 07:46:46'),
(130, 157, 'Entwicklung des Autopoiesisbegriffs zur Beschreibung von Systemen, deren Organisation durch ein Netzwerk wechselseitig erzeugender Prozesse reproduziert wird.', 'Bietet einen zentralen wissenschaftlichen Anschluss für die qualitative Möglichkeit des Erhalts und der Reproduktion funktionaler Organisationszusammenhänge unter fortlaufender Veränderung.', 'Die Quelle wird zitiert, um zu zeigen, dass organisatorische Reproduktion in der Systemtheorie bereits als eigenständige wissenschaftliche Problemstellung ausgearbeitet wurde.', 'Übernommen wird ausschließlich die allgemeine Einsicht, dass Organisation durch fortlaufende Prozesse erhalten und reproduziert werden kann.', 'Nicht übernommen werden eine biologische Definition des Lebendigen, konkrete autopoietische Mechanismen, Membranen, Stoffwechselprozesse oder eine Gleichsetzung des FRZK mit der Autopoiesistheorie.', 'Axiom A5 verallgemeinert die Möglichkeit funktionaler Erhaltung auf eine qualitative vor-mathematische Ebene und bleibt von der biologischen Spezialisierung der Quelle unabhängig.', 'reviewed', '2026-07-16 18:50:06'),
(131, 158, 'Systematische Einführung in formale Logik, Modelle, semantische Folgerung, Erfüllbarkeit und Konsistenz.', 'Bietet die methodische Grundlage zur Abgrenzung qualitativer Gegenmodelle von formalen modelltheoretischen Unabhängigkeitsbeweisen.', 'Die Quelle wird verwendet, um den Status der Prüfung in Abschnitt 3.3.8 wissenschaftlich einzuordnen.', 'Übernommen werden die allgemeinen Unterscheidungen zwischen Modell, Erfüllbarkeit, Folgerung und Konsistenz.', 'Der Abschnitt konstruiert noch keine vollständige formale Sprache und keine mathematisch präzise Modellklasse.', 'Enderton begründet den formalen Zielstandard; das FRZK verbleibt hier bewusst auf einer qualitativen Vorstufe.', 'reviewed', '2026-07-16 19:41:35'),
(132, 159, 'Darstellung mathematischer Logik mit besonderer Behandlung syntaktischer Konsistenz, semantischer Erfüllbarkeit und Axiomenunabhängigkeit.', 'Stützt die methodische Trennung zwischen qualitativer Widerspruchsfreiheit und formal bewiesener Konsistenz.', 'Die Quelle wird zur wissenschaftlichen Einordnung der Konsistenz- und Unabhängigkeitsprüfung verwendet.', 'Übernommen werden die allgemeinen methodischen Unterscheidungen, nicht ein spezieller Kalkül.', 'Die FRZK-Axiomatik ist in Kapitel 3.3 noch nicht formal genug für die vollständigen Beweismethoden der Quelle.', 'Mendelson dient als Referenzmaßstab für die spätere Formalisierung in Kapitel 3.4 und darüber hinaus.', 'reviewed', '2026-07-16 19:41:35'),
(133, 160, 'Lehrbuchdarstellung der klassischen linearen Algebra.', 'Dient der klaren Abgrenzung: Der klassische Nullvektor besitzt keine definierte Richtung.', 'Belegt, dass das FRZK nicht die klassische Vektoralgebra verändert.', 'Übernommen wird ausschließlich die klassische Nullvektorbehandlung.', 'Keine Aussage über erweiterte funktionale Zustände.', 'Die FRZK-Erweiterung betrifft den Zustandsbegriff und nicht den klassischen Vektor.', 'reviewed', '2026-07-16 20:13:18'),
(134, 161, 'Referenzwerk zur Matrix- und Vektorrechnung.', 'Zweite unabhängige mathematische Referenz für die klassische Nulloperation.', 'Stützt die Abgrenzung zur erweiterten FRZK-Zustandsoperation.', 'Übernommen wird die klassische Algebra.', 'Keine funktionale Persistenztheorie.', 'Die Quelle sichert die mathematische Anschlussfähigkeit.', 'reviewed', '2026-07-16 20:13:18'),
(135, 162, 'Systematische Behandlung von Konfigurationen und Planungsräumen in der Robotik.', 'Forschungsanschluss für getrennte Zustands-, Lage- und Bewegungsinformationen.', 'Zeigt technische Kontexte, in denen Orientierung unabhängig von momentaner translatorischer Geschwindigkeit repräsentiert wird.', 'Übernommen wird die allgemeine Trennung funktionaler Zustandskomponenten.', 'Keine Behauptung, der Nullvektor selbst besitze Richtung.', 'Das FRZK verallgemeinert die Zustandskomponententrennung.', 'reviewed', '2026-07-16 20:13:18'),
(136, 163, 'Robotikdarstellung von Lage, Transformationen, Geschwindigkeit und Steuerung.', 'Forschungsanschluss für die getrennte Repräsentation von Orientierung und Bewegung.', 'Stützt die technische Plausibilität latenter Orientierungsinformation.', 'Übernommen wird die getrennte Zustandsrepräsentation.', 'Keine allgemeine funktionale Theorie.', 'Das FRZK abstrahiert von der robotischen Spezialisierung.', 'reviewed', '2026-07-16 20:13:18'),
(137, 164, 'Grundlegung linearer Zustandsabschätzung und Prädiktion.', 'Forschungsanschluss für interne Zustände, Rekonstruierbarkeit und funktionales Gedächtnis.', 'Stützt die methodische Trennung beobachtbarer Aktivität und intern rekonstruierbarer Zustandsinformation.', 'Übernommen wird die allgemeine Idee interner Zustandsrekonstruktion.', 'Kein unmittelbarer Beleg für das FRZK-Axiom oder funktionales Gedächtnis.', 'Das FRZK verallgemeinert die technische Zustandsrekonstruktion qualitativ.', 'reviewed', '2026-07-16 20:13:18'),
(138, 165, 'Umfassende Darstellung moderner Zustandsabschätzungsverfahren.', 'Forschungsanschluss für persistente interne Zustandsinformationen.', 'Stützt die technische Plausibilität rekonstruktionsrelevanter Zustandskomponenten.', 'Übernommen wird die Trennung von Messwerten und internem Zustand.', 'Keine ontologische Theorie funktionaler Identität.', 'Das FRZK nutzt die Quelle als technischen Anschluss, nicht als direkte Ableitung.', 'reviewed', '2026-07-16 20:13:18');
...
(47, 'Mac Lane', 'Saunders', 'Mac Lane, Saunders', NULL, 1909, 2005, 'US-amerikanischer Mathematiker und Mitbegründer der Kategorientheorie. In Abschnitt 3.3.1 als Referenz zur strukturellen und relationalen Auffassung moderner Mathematik verwendet.'),
...
(87, 'Kalman', 'Rudolf E.', 'Kalman, Rudolf E.', NULL, 1930, 2016, 'Systemtheoretiker. Quelle [94] wird als Forschungsanschluss für interne Zustandsrekonstruktion und Zustandsabschätzung verwendet.'),
...
(145, 'Tarski', 'Alfred', 'tarski_alfred', NULL, 1901, 1983, 'Polnisch-amerikanischer Logiker und Mathematiker; zentrale Arbeiten zur formalen Semantik, Logik und Methodologie deduktiver Wissenschaften.'),
(147, 'Suppes', 'Patrick', 'Suppes, Patrick', NULL, 1922, 2014, 'US-amerikanischer Wissenschaftstheoretiker und Logiker. In Abschnitt 3.3.1 als Referenz zur methodischen Funktion primitiver Begriffe und axiomatischer Theoriebildung verwendet.'),
(149, 'Quine', 'Willard Van Orman', 'Quine, Willard Van Orman', NULL, 1908, 2000, 'US-amerikanischer Philosoph und Logiker. In Abschnitt 3.3.1 als Referenz zu ontologischen Verpflichtungen formaler Theorien verwendet.'),
(154, 'Spencer-Brown', 'George', 'Spencer-Brown, George', NULL, 1923, 2016, 'Britischer Logiker und Autor von Laws of Form. In Abschnitt 3.3.2 ausschließlich als wissenschaftshistorischer und begrifflicher Anschluss zur grundlegenden Rolle der Unterscheidung verwendet.'),
(155, 'Maturana', 'Humberto R.', 'Maturana, Humberto R.', NULL, 1928, 2021, 'Chilenischer Biologe und Systemtheoretiker. In Abschnitt 3.3.6 als Forschungsanschluss zur Reproduktion organisatorischer Zusammenhänge verwendet.'),
(156, 'Varela', 'Francisco J.', 'Varela, Francisco J.', NULL, 1946, 2001, 'Chilenischer Biologe, Neurowissenschaftler und Systemtheoretiker. In Abschnitt 3.3.6 als Forschungsanschluss zur Autopoiesis und organisatorischen Reproduktion verwendet.'),
(157, 'Enderton', 'Herbert B.', 'Enderton, Herbert B.', NULL, 1936, 2010, 'US-amerikanischer Logiker. In Abschnitt 3.3.8 als methodische Referenz für Modell, Erfüllbarkeit, semantische Folgerung und Konsistenz verwendet.'),
(158, 'Mendelson', 'Elliott', 'Mendelson, Elliott', NULL, 1924, 2020, 'US-amerikanischer Logiker. In Abschnitt 3.3.8 als methodische Referenz für syntaktische Konsistenz, semantische Erfüllbarkeit und Axiomenunabhängigkeit verwendet.'),
(159, 'Strang', 'Gilbert', 'Strang, Gilbert', NULL, 1934, NULL, 'Mathematiker. Quelle [90] wird zur klassischen Bedeutung der Multiplikation eines Vektors mit dem Skalar Null verwendet.'),
(160, 'Golub', 'Gene H.', 'Golub, Gene H.', NULL, 1932, 2007, 'Numerischer Mathematiker. Koautor der Quelle [91].'),
(161, 'Van Loan', 'Charles F.', 'Van Loan, Charles F.', NULL, 1947, NULL, 'Numerischer Mathematiker. Koautor der Quelle [91].'),
(162, 'LaValle', 'Steven M.', 'LaValle, Steven M.', NULL, 1968, NULL, 'Robotik- und Planungsforscher. Quelle [92] wird als technischer Forschungsanschluss für getrennte Zustands- und Orientierungsdarstellungen verwendet.'),
(163, 'Craig', 'John J.', 'Craig, John J.', NULL, NULL, NULL, 'Robotikautor. Quelle [93] wird als technischer Forschungsanschluss für Lage- und Bewegungsdarstellungen verwendet.'),
(164, 'Simon', 'Dan', 'Simon, Dan', NULL, NULL, NULL, 'Autor zu Zustandsabschätzung. Quelle [95] wird als Forschungsanschluss für beobachtbare und interne Zustandsinformationen verwendet.');
...
(27, 'A1', 51, 'Existenz funktionaler Zustände', 'Es existiert mindestens eine funktionale Konfiguration, die prinzipiell von einer anderen funktionalen Konfiguration unterscheidbar sein kann.', 'A_1:\\quad\\text{Mindestens ein funktional unterscheidbarer Zustand ist möglich.}', 'A_1:\\quad\\text{Mindestens ein funktional unterscheidbarer Zustand ist möglich.}', 'Ohne die Möglichkeit funktionaler Unterscheidbarkeit können weder Relationierbarkeit noch Transformation, Organisation oder Kohärenz sinnvoll formuliert werden. Das Axiom setzt weder materielle Existenz noch Raum, Zeit, Menge oder Zustandsraum voraus.', 'Axiom A1 besitzt keinen Rückgriff auf ein früheres FRZK-Axiom. Seine modelltheoretische Unabhängigkeit von A2 bis A5 wird erst in Abschnitt 3.3.8 geprüft. In Abschnitt 3.3.2 wird ausschließlich seine begriffliche Vorrangstellung behauptet.', 'Das Axiom enthält keine Existenzquantifizierung über einer bereits definierten Menge. Es postuliert eine qualitative Möglichkeit und vermeidet dadurch einen Zirkelschluss mit der späteren Konstruktion mathematischer Zustände.', 'In Kapitel 3.4 wird aus Axiom A1 zunächst eine funktionale Differenz- beziehungsweise Zustandsstruktur rekonstruiert. Die axiomatische Aussage selbst enthält keine Metrik, Koordinate, Dimension oder Zeitordnung.', NULL, 'review', 67),
(28, 'A2', 52, 'Funktionale Relationierbarkeit', 'Funktional unterscheidbare Zustände können miteinander in einen funktionalen Zusammenhang treten.', 'A_2:\\quad\\text{Funktional unterscheidbare Zustände sind prinzipiell relationierbar.}', 'A_2:\\quad\\text{Funktional unterscheidbare Zustände sind prinzipiell relationierbar.}', 'Axiom A1 erlaubt funktional unterscheidbare Zuständlichkeit, begründet jedoch noch keinen Zusammenhang. Axiom A2 ergänzt die eigenständige Möglichkeit funktionaler Verknüpfung, ohne bereits eine mathematische Relation oder deren Trägerstrukturen vorauszusetzen.', 'Axiom A2 benötigt die Anwendungsgrundlage von Axiom A1, ist aus Axiom A1 jedoch nicht ableitbar. Die modelltheoretische Prüfung dieser Nichtableitbarkeit erfolgt erst in Abschnitt 3.3.8.', 'Das Axiom ist mit Axiom A1 vereinbar, weil es die Möglichkeit funktionaler Verknüpfung ergänzt, ohne die Existenz bestimmter mathematischer Relationsformen zu fordern.', 'In Kapitel 3.4 wird aus Axiom A2 eine funktionale Relationsstruktur rekonstruiert. Eigenschaften wie Richtung, Reflexivität, Symmetrie, Transitivität, Gewichtung oder Dauer werden nicht axiomatisch vorweggenommen.', NULL, 'review', 68),
(29, 'A3', 53, 'Dynamische Zustandsänderung', 'Funktionale Zustände und ihre funktionalen Zusammenhänge können sich verändern.', 'A_3:\\quad\\text{Funktionale Zustände und Zusammenhänge sind prinzipiell transformierbar.}', 'A_3:\\quad\\text{Funktionale Zustände und Zusammenhänge sind prinzipiell transformierbar.}', 'Axiom A1 ermöglicht funktional unterscheidbare Zuständlichkeit und Axiom A2 funktionale Zusammenhänge. Beide Axiome begründen jedoch noch keine Veränderbarkeit. Axiom A3 ergänzt deshalb die eigenständige Möglichkeit qualitativer funktionaler Transformation.', 'Axiom A3 benötigt Axiom A1 und Axiom A2 als Anwendungsgrundlage, ist aus deren gemeinsamer Geltung jedoch nicht ableitbar. Ein vollständig statisches Modell mit unterscheidbaren und relationierbaren Zuständen bleibt begrifflich möglich.', 'Das Axiom ist mit Axiom A1 und Axiom A2 vereinbar, weil es ausschließlich Veränderbarkeit ergänzt und weder einen Zeitparameter noch einen mathematischen Operator voraussetzt.', 'In Kapitel 3.4 wird aus Axiom A3 eine funktionale Transformationsstruktur rekonstruiert. Erst aus geordneten und vergleichbaren Transformationen kann später eine funktionale Zeitstruktur hervorgehen.', NULL, 'review', 69),
(30, 'A4', 54, 'Funktionale Organisationsbildung', 'Relationierte und transformierbare funktionale Zustände können zusammenhängende und wiedererkennbare Organisationsmuster bilden.', 'A_4:\\quad\\text{Funktionale Relationierungen und Transformationen sind prinzipiell organisationsbildend.}', 'A_4:\\quad\\text{Funktionale Relationierungen und Transformationen sind prinzipiell organisationsbildend.}', 'Axiom A1 bis Axiom A3 ermöglichen Unterscheidbarkeit, Relationierbarkeit und Transformation, begründen jedoch noch keine übergeordnete Organisationsstruktur. Axiom A4 ergänzt die eigenständige Möglichkeit strukturierter Zusammenfassung.', 'Axiom A4 setzt Axiom A1, Axiom A2 und Axiom A3 voraus, ist aus deren gemeinsamer Geltung jedoch nicht ableitbar. Ein Modell ungeordneter, fortlaufend entstehender und zerfallender Relationen bleibt begrifflich möglich.', 'Das Axiom ist mit Axiom A1 bis Axiom A3 vereinbar, weil es lediglich die Möglichkeit organisationsbildender Muster ergänzt und keine konkrete Organisationsform fordert.', 'In Kapitel 3.4 wird aus Axiom A4 eine funktionale Organisationsstruktur rekonstruiert. Konnektivität, Topologie, Netzwerke, Attraktoren oder Hierarchien werden nicht axiomatisch vorweggenommen.', NULL, 'review', 70),
(31, 'A5', 55, 'Funktionale Kohärenz und Stabilisierung', 'Funktionale Organisationszusammenhänge können sich trotz weiterer Transformationen erhalten, erneuern oder in einer wiedererkennbaren Form reproduzieren.', 'A_5:\\quad\\text{Funktionale Organisation ist prinzipiell kohärenz- und stabilisierungsfähig.}', 'A_5:\\quad\\text{Funktionale Organisation ist prinzipiell kohärenz- und stabilisierungsfähig.}', 'Axiom A1 bis Axiom A4 ermöglichen funktionale Zustände, Relationierbarkeit, Transformation und Organisationsbildung, begründen jedoch noch keinen Erhalt unter weiterer Veränderung. Axiom A5 ergänzt die eigenständige Möglichkeit funktionaler Kohärenz und Stabilisierung.', 'Axiom A5 setzt Axiom A1 bis Axiom A4 voraus, ist aus deren gemeinsamer Geltung jedoch nicht ableitbar. Eine Organisation kann entstehen und unter jeder weiteren Transformation vollständig zerfallen.', 'Das Axiom ist mit Axiom A1 bis Axiom A4 vereinbar, weil es weder vollständige Unveränderlichkeit noch ein konkretes Kohärenzmaß fordert, sondern ausschließlich die Möglichkeit funktionalen Erhalts und funktionaler Reproduktion ergänzt.', 'In Kapitel 3.4 werden mathematische Kriterien funktionaler Kohärenz, Erhaltung und Stabilisierung rekonstruiert. Metriken, Korrelationen, Normen, Attraktoren, Fixpunkte oder Lyapunov-Funktionen werden nicht axiomatisch vorweggenommen.', NULL, 'review', 71);
...
(1, 28, 27, 'depends_on', 'Relationierbarkeit setzt funktional unterscheidbare Zuständlichkeit voraus. Axiom A1 allein impliziert Axiom A2 jedoch nicht.'),
(2, 29, 27, 'depends_on', 'Transformierbarkeit setzt funktional unterscheidbare Zuständlichkeit voraus.'),
(3, 29, 28, 'depends_on', 'Die Veränderung funktionaler Zusammenhänge setzt funktionale Relationierbarkeit voraus.'),
(4, 30, 27, 'depends_on', 'Organisationsbildung setzt funktional unterscheidbare Zuständlichkeit voraus.'),
(5, 30, 28, 'depends_on', 'Organisationsbildung setzt funktionale Relationierbarkeit voraus.'),
(6, 30, 29, 'depends_on', 'Organisationsbildung setzt Transformierbarkeit funktionaler Zustände und Zusammenhänge voraus.'),
(7, 31, 27, 'depends_on', 'Kohärenz und Stabilisierung setzen funktional unterscheidbare Zuständlichkeit voraus.'),
(8, 31, 28, 'depends_on', 'Kohärenz bezieht sich auf funktionale Zusammenhänge und setzt Relationierbarkeit voraus.'),
(9, 31, 29, 'depends_on', 'Kohärenz wird als Erhalt unter Transformation verstanden und setzt Transformierbarkeit voraus.'),
(10, 31, 30, 'depends_on', 'Kohärenz und Stabilisierung setzen eine funktionale Organisation voraus, deren Zusammenhang erhalten oder reproduziert werden kann.');
...
(398, 'Def. 3.3.1.1', 50, 'Funktionalität', 'Funktionalität bezeichnet im FRZK die prinzipielle Möglichkeit, dass eine Konfiguration innerhalb eines Organisationszusammenhangs Wirkungen hervorbringen oder Wirkungen anderer Konfigurationen aufnehmen kann. Der Begriff bezeichnet noch keine mathematische Funktion.', NULL, NULL, 'original', NULL, 'Keine Menge, Definitionsmenge, Zielmenge oder Zuordnungsvorschrift wird vorausgesetzt.', 'Primitiver qualitativer FRZK-Begriff.', 'checked', 65),
(399, 'Def. 3.3.1.2', 50, 'Unterscheidbarkeit', 'Unterscheidbarkeit bezeichnet die qualitative Möglichkeit, funktionale Konfigurationen voneinander abzugrenzen, ohne bereits einen Abstand, eine Ordnung, eine Metrik oder einen numerischen Differenzwert vorauszusetzen.', NULL, NULL, 'original', NULL, 'Funktionale Verschiedenheit wird ausschließlich als qualitative Möglichkeit angenommen.', 'Primitiver qualitativer FRZK-Begriff.', 'checked', 65),
(400, 'Def. 3.3.1.3', 50, 'Relationierbarkeit', 'Relationierbarkeit bezeichnet die prinzipielle Möglichkeit, funktional unterscheidbare Konfigurationen miteinander in Zusammenhang zu bringen. Der Begriff ist noch keine mathematische Relation als Teilmenge eines kartesischen Produkts.', NULL, NULL, 'original', NULL, 'Mengen, geordnete Paare und kartesische Produkte werden nicht vorausgesetzt.', 'Primitiver qualitativer FRZK-Begriff.', 'checked', 65),
(401, 'Def. 3.3.1.4', 50, 'Transformation', 'Transformation bezeichnet jede mögliche Veränderung funktionaler Konfigurationen oder ihrer Zusammenhänge, ohne bereits eine mathematische Funktion, einen Operator oder eine zeitliche Entwicklung vorauszusetzen.', NULL, NULL, 'original', NULL, 'Zeit, Funktionen und Operatoren sind noch nicht rekonstruiert.', 'Primitiver qualitativer FRZK-Begriff.', 'checked', 65),
(402, 'Def. 3.3.1.5', 50, 'Organisation', 'Organisation bezeichnet das Auftreten zusammenhängender und prinzipiell wiedererkennbarer funktionaler Muster, ohne bereits eine räumliche Anordnung, einen Zustandsraum oder eine feste Komponentenmenge vorauszusetzen.', NULL, NULL, 'original', NULL, 'Relationierbarkeit und Transformation sind qualitativ möglich.', 'Primitiver qualitativer FRZK-Begriff.', 'checked', 65),
(403, 'Def. 3.3.1.6', 50, 'Kohärenz', 'Kohärenz bezeichnet die qualitative Möglichkeit, dass sich funktionale Organisationszusammenhänge trotz Transformation erhalten, erneuern oder in wiedererkennbarer Form reproduzieren können. Der Begriff enthält noch kein mathematisches Kohärenzmaß.', NULL, NULL, 'original', NULL, 'Organisation und Transformation sind qualitativ möglich.', 'Primitiver qualitativer FRZK-Begriff.', 'checked', 65),
(411, 'Def. 3.3.2.1', 51, 'Funktionaler Zustand', 'Ein funktionaler Zustand ist in Kapitel 3.3 eine qualitative Konfiguration, die aufgrund ihrer möglichen Wirkungen prinzipiell von einer anderen funktionalen Konfiguration unterscheidbar sein kann. Er ist noch kein Element eines mathematischen Zustandsraumes und besitzt weder Koordinaten, Dimension, Metrik, räumliche Lage noch zeitliche Position.', NULL, NULL, 'original', NULL, 'Die primitiven Begriffe Funktionalität und Unterscheidbarkeit aus Abschnitt 3.3.1 sind vorausgesetzt.', 'Diese Definition präzisiert den Sprachgebrauch des Abschnitts, ohne die mathematische Rekonstruktion funktionaler Zustände in Kapitel 3.4 vorwegzunehmen.', 'checked', 67),
(412, 'Def. 3.3.3.1', 52, 'Funktionaler Zusammenhang', 'Ein funktionaler Zusammenhang bezeichnet in Kapitel 3.3 eine realisierte Form prinzipieller Relationierbarkeit zwischen mindestens zwei funktional unterscheidbaren Konfigurationen. Er ist noch keine mathematische Relation, keine Teilmenge eines kartesischen Produkts und enthält noch keine Festlegung von Richtung, Symmetrie, Transitivität, Dauer, Kausalität oder Informationsübertragung.', NULL, NULL, 'original', NULL, 'Axiom A1 und der primitive Begriff der Relationierbarkeit aus Abschnitt 3.3.1 werden vorausgesetzt.', 'Qualitative Sprachdefinition zur eindeutigen Abgrenzung von einer später mathematisch rekonstruierten Relation.', 'checked', 68),
(413, 'Def. 3.3.4.1', 53, 'Funktionale Transformation', 'Eine funktionale Transformation bezeichnet in Kapitel 3.3 eine qualitative Veränderung mindestens einer funktional bestimmbaren Eigenschaft eines Zustandes oder eines funktionalen Zusammenhangs, durch die eine prinzipiell unterscheidbare Konfiguration entsteht. Sie ist noch keine mathematische Funktion, kein Operator, keine Differentialgleichung und keine zeitparametrisierte Entwicklung.', NULL, NULL, 'original', NULL, 'Axiom A1, Axiom A2 sowie die primitiven Begriffe Unterscheidbarkeit, Relationierbarkeit und Transformation werden vorausgesetzt.', 'Qualitative Sprachdefinition zur eindeutigen Abgrenzung von einer später mathematisch rekonstruierten Transformationsabbildung oder einem Operator.', 'checked', 69),
(414, 'Def. 3.3.5.1', 54, 'Funktionale Organisation', 'Eine funktionale Organisation bezeichnet in Kapitel 3.3 einen übergeordneten, prinzipiell wiedererkennbaren Zusammenhang mehrerer funktionaler Zustände, Relationierungen oder Transformationen, der nicht vollständig auf eine einzelne isolierte Relation oder Veränderung reduziert werden kann. Sie ist noch keine mathematische Menge, kein Graph, kein Zustandsraum und keine topologische Struktur.', NULL, NULL, 'original', NULL, 'Axiom A1, Axiom A2 und Axiom A3 sowie die primitiven Begriffe Organisation, Relationierbarkeit und Transformation werden vorausgesetzt.', 'Qualitative Sprachdefinition. Stabilität oder Kohärenz werden noch nicht vorausgesetzt.', 'checked', 70),
(415, 'Def. 3.3.6.1', 55, 'Funktionale Kohärenz', 'Funktionale Kohärenz bezeichnet in Kapitel 3.3 die qualitative Möglichkeit, dass mehrere funktionale Zustände, Relationierungen und Transformationen trotz innerer Veränderungen als zusammengehöriger Organisationszusammenhang bestimmbar bleiben. Kohärenz bedeutet weder vollständige Gleichheit noch vollständige Unveränderlichkeit und enthält noch kein mathematisches Kohärenzmaß.', NULL, NULL, 'original', NULL, 'Axiom A1 bis Axiom A4 sowie die primitiven Begriffe Organisation, Transformation und Kohärenz werden vorausgesetzt.', 'Qualitative Definition vor jeder metrischen, statistischen, informationstheoretischen oder dynamischen Operationalisierung.', 'checked', 71),
(416, 'Def. 3.3.6.2', 55, 'Funktionale Stabilisierung', 'Funktionale Stabilisierung bezeichnet in Kapitel 3.3 die qualitative Möglichkeit, einen funktionalen Organisationszusammenhang gegenüber auflösenden Transformationen zu erhalten, zu erneuern oder wiederherzustellen. Sie ist noch kein Fixpunkt, Attraktor, Gleichgewicht, Lyapunov-Kriterium oder mathematisch definierter Regelungsprozess.', NULL, NULL, 'original', NULL, 'Axiom A1 bis Axiom A4 sowie die qualitative Definition funktionaler Organisation werden vorausgesetzt.', 'Stabilisierung bezeichnet die Möglichkeit des Erhalts oder der Wiederherstellung; Kohärenz bezeichnet den dabei erhaltenen funktionalen Zusammenhang.', 'checked', 71),
(417, 'Def. 3.3.7.1', 56, 'Vollständiges qualitatives FRZK-Axiomensystem', 'Das vollständige qualitative FRZK-Axiomensystem umfasst die fünf Axiome A1 bis A5: funktionale Unterscheidbarkeit, funktionale Relationierbarkeit, funktionale Transformierbarkeit, funktionale Organisationsbildung sowie funktionale Kohärenz und Stabilisierung. Die Zusammenfassung besitzt in Abschnitt 3.3.7 noch keinen vollständig formalisierten mengentheoretischen oder modelltheoretischen Status.', '\\mathcal{A}_{\\mathrm{FRZK}}=\\left\\{A_1,A_2,A_3,A_4,A_5\\right\\}', '\\mathcal{A}_{\\mathrm{FRZK}}=\\left\\{A_1,A_2,A_3,A_4,A_5\\right\\}', 'original', NULL, 'Die Axiome A1 bis A5 aus den Abschnitten 3.3.2 bis 3.3.6 werden vorausgesetzt.', 'Sammeldefinition zur Kennzeichnung des vollständigen qualitativen Axiomensystems.', 'checked', 72),
(418, 'Def. 3.3.8.1', 57, 'Qualitatives Gegenmodell', 'Ein qualitatives Gegenmodell ist eine begrifflich widerspruchsfreie Konfiguration, in der ausgewählte FRZK-Axiome gelten und mindestens ein zu prüfendes Axiom ausgeschlossen bleibt. Es ist noch kein Modell einer vollständig formalisierten Sprache.', NULL, NULL, 'original', NULL, 'Die qualitative Bedeutung der Axiome A1 bis A5 wird vorausgesetzt.', 'Methodische Hilfsdefinition für die schwache Unabhängigkeitsprüfung.', 'checked', 73),
(419, 'Def. 3.3.8.2', 57, 'Schwache qualitative Unabhängigkeit', 'Schwache qualitative Unabhängigkeit liegt vor, wenn ein Axiom eine funktionale Möglichkeit einführt, die begrifflich nicht bereits vollständig in den übrigen Axiomen enthalten ist.', NULL, NULL, 'original', NULL, 'Qualitative Gegenmodelle sind beschreibbar.', 'Keine formale modelltheoretische Unabhängigkeit.', 'checked', 73),
(420, 'Def. 3.3.8.3', 57, 'Starke formale Unabhängigkeit', 'Starke formale Unabhängigkeit liegt vor, wenn in einer präzise definierten Modellsprache für jedes Axiom ein Modell existiert, das alle übrigen Axiome erfüllt, das betreffende Axiom jedoch nicht.', NULL, NULL, 'adapted', 158, 'Eine formale Sprache, Semantik, Modellklasse und Erfüllungsrelation sind definiert.', 'Zielbegriff für spätere modelltheoretische Arbeiten; in Abschnitt 3.3.8 noch nicht nachgewiesen.', 'checked', 73),
(421, 'Def. 3.3.8.4', 57, 'Qualitative gemeinsame Erfüllbarkeit', 'Qualitative gemeinsame Erfüllbarkeit liegt vor, wenn eine begrifflich widerspruchsfreie Konfiguration beschrieben werden kann, in der die Axiome A1 bis A5 gemeinsam gelten.', NULL, NULL, 'original', NULL, 'Es wird noch keine formale semantische Erfüllungsrelation vorausgesetzt.', 'Vorstufe einer späteren formalen Erfüllbarkeits- und Konsistenzprüfung.', 'checked', 73),
(422, 'Def. 3.3.9.1', 58, 'Prinzip der Bedeutungsinvarianz', 'Das Prinzip der Bedeutungsinvarianz verlangt, dass jede mathematische Struktur ausschließlich den bereits qualitativ eingeführten semantischen Gehalt beschreibt und keine unbegründete zusätzliche ontologische oder funktionale Eigenschaft in die Theorie einführt.', '\\text{Semantik}\\longrightarrow\\text{Mathematik}', '\\text{Semantik}\\longrightarrow\\text{Mathematik}', 'original', NULL, 'Die qualitativen Begriffe und Axiome aus Kapitel 3.3 werden vorausgesetzt.', 'Verbindliche Übergangsregel für Kapitel 3.4.', 'checked', 75),
(423, 'Def. 3.3.9.2', 58, 'Relationales Rekonstruktionsprinzip', 'Das relationale Rekonstruktionsprinzip verlangt, dass funktionale Relationen und Transformationen vor geometrischen, räumlichen oder objekthaften Strukturen mathematisch eingeführt werden.', '\\text{Relation}\\prec\\text{Geometrie}', '\\text{Relation}\\prec\\text{Geometrie}', 'original', NULL, 'Axiom A2 und Axiom A3 werden vorausgesetzt.', 'Verhindert die zirkuläre Einführung bereits vorhandener Raum- oder Zeitstrukturen.', 'checked', 75),
(424, 'Def. 3.3.9.3', 58, 'Rekonstruktion statt Übersetzung', 'Mathematische Rekonstruktion bezeichnet die schrittweise Ableitung minimal erforderlicher Strukturen aus den qualitativen Axiomen. Sie ist keine bloße nachträgliche Interpretation bereits vorhandener Mathematik als FRZK.', '\\text{Axiome}\\Longrightarrow\\text{rekonstruierte Mathematik}', '\\text{Axiome}\\Longrightarrow\\text{rekonstruierte Mathematik}', 'original', NULL, 'Das vollständige Axiomensystem A1 bis A5 wird vorausgesetzt.', 'Grenzt die Theorie von einer rein interpretativen Umbenennung vorhandener Modelle ab.', 'checked', 75),
(425, 'Def. 3.3.9.4', 58, 'Mathematisches Minimalprinzip', 'Das mathematische Minimalprinzip verlangt, nur diejenigen mathematischen Strukturen einzuführen, die zur Rekonstruktion eines qualitativ bereits begründeten funktionalen Sachverhalts notwendig sind.', '\\text{so viel Mathematik wie notwendig, so wenig Mathematik wie möglich}', '\\text{so viel Mathematik wie notwendig, so wenig Mathematik wie möglich}', 'original', NULL, 'Die Prinzipien der Bedeutungsinvarianz und Rekonstruktion statt Übersetzung werden vorausgesetzt.', 'Dient der Vermeidung unnötiger ontologischer und formaler Vorannahmen.', 'checked', 75),
(430, 'Def. 3.3.9.5', 58, 'Latente funktionale Orientierung', 'Ein funktionaler Zustand kann neben seiner aktuellen quantitativen Ausprägung eine von dieser unabhängige funktionale Orientierungsinformation besitzen. Diese beschreibt keine Richtung des klassischen Nullvektors, sondern den funktionalen Zusammenhang, aus dem der Zustand hervorgegangen ist und in den er eingebettet bleibt.', NULL, NULL, 'original', NULL, 'Axiom A1, Axiom A3, Axiom A5 und das Prinzip der Bedeutungsinvarianz werden vorausgesetzt.', 'Abgrenzung zur klassischen Vektoralgebra ist verbindlich.', 'checked', 75),
(431, 'Def. 3.3.9.6', 58, 'Funktionale Persistenz', 'Funktionale Persistenz bezeichnet die Fähigkeit eines funktionalen Zustandes, strukturrelevante Identitäts- und Orientierungsinformation zu bewahren, wenn einzelne quantitative Zustandsgrößen vorübergehend verschwinden oder den Wert Null annehmen. Persistenz endet erst durch eine ausdrücklich definierte Vernichtungsoperation.', NULL, NULL, 'original', NULL, 'Latente funktionale Orientierung und Axiom A5 werden vorausgesetzt.', 'Persistenz bedeutet weder numerische Konstanz noch Unveränderlichkeit.', 'checked', 75),
(432, 'Def. 3.3.9.7', 58, 'Funktionales Gedächtnis', 'Funktionales Gedächtnis bezeichnet die Fähigkeit einer funktionalen Organisation, strukturrelevante Informationen über Identität und Entwicklungszusammenhang unabhängig von der momentanen quantitativen Aktivität zu bewahren und dadurch eine spätere Rekonstruktion zu ermöglichen.', NULL, NULL, 'original', NULL, 'Funktionale Persistenz, Organisationsbildung und Kohärenz werden vorausgesetzt.', 'Kein Speichermedium und keine konkrete informationstechnische Implementierung werden axiomatisch vorausgesetzt.', 'checked', 75);
...
(49, 22, '3.3.0', 'Einleitung', 3, 3.3001, '', 1, 'Übergang von der mathematischen Forschungslücke in Kapitel 3.2 zur qualitativen axiomatischen Grundlegung. Enthält noch keine mathematische Rekonstruktion.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
(50, 22, '3.3.1', 'Primitive Begriffe und wissenschaftstheoretische Ausgangspunkte', 3, 3.3002, '', 1, 'Der Abschnitt definiert den primitiven qualitativen Wortschatz des FRZK. Mengen, mathematische Relationen, Funktionen, Operatoren, Zustandsräume, Information, Raum und Zeit werden ausdrücklich nicht als primitive mathematische Objekte vorausgesetzt.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
(51, 22, '3.3.2', 'Axiom A1 – Existenz funktionaler Zustände', 3, 3.3003, '', 1, 'Erstes originäres FRZK-Axiom. Der funktionale Zustand ist in Kapitel 3.3 noch kein Element eines mathematischen Zustandsraumes, sondern eine qualitative, prinzipiell funktional unterscheidbare Konfiguration. Die mathematische Rekonstruktion erfolgt erst in Kapitel 3.4.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
(52, 22, '3.3.3', 'Axiom A2 – Funktionale Relationierbarkeit', 3, 3.3004, '', 1, 'Zweites originäres FRZK-Axiom. Relationierbarkeit wird qualitativ vor dem klassischen mathematischen Relationsbegriff eingeführt. Mengen, kartesische Produkte, geordnete Paare, Richtung, Symmetrie, Transitivität, Kausalität und Zeit werden nicht vorausgesetzt.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
(53, 22, '3.3.4', 'Axiom A3 – Dynamische Zustandsänderung', 3, 3.3005, '', 1, 'Drittes originäres FRZK-Axiom. Transformierbarkeit wird qualitativ vor mathematischen Operatoren, Zustandsräumen und Zeitparametern eingeführt. Zeit wird nicht vorausgesetzt, sondern erst später aus geordneten funktionalen Transformationen rekonstruiert.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
(54, 22, '3.3.5', 'Axiom A4 – Funktionale Organisationsbildung', 3, 3.3006, '', 1, 'Viertes originäres FRZK-Axiom. Organisationsbildung wird qualitativ vor Graphen, Zustandsräumen, Topologien und konkreten Emergenzmodellen eingeführt. Raum und Zeit werden nicht vorausgesetzt.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
(55, 22, '3.3.6', 'Axiom A5 – Funktionale Kohärenz und Stabilisierung', 3, 3.3007, '', 1, 'Fünftes originäres FRZK-Axiom. Kohärenz bezeichnet den funktionalen Erhalt von Zusammengehörigkeit unter Transformation, nicht vollständige Unveränderlichkeit. Mathematische Kohärenzmaße, Attraktoren, Fixpunkte oder Lyapunov-Funktionen werden nicht vorausgesetzt.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
(56, 22, '3.3.7', 'Qualitative Konsequenzen des vollständigen Axiomensystems', 3, 3.3008, '', 1, 'Der Abschnitt führt keine neuen Axiome ein. Er systematisiert die unmittelbaren qualitativen Konsequenzen der Axiome A1 bis A5 und grenzt sie ausdrücklich von mathematischen Beweisen und empirischen Realisierungen ab.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
(57, 22, '3.3.8', 'Minimalität, Unabhängigkeit und Konsistenz des Axiomensystems', 3, 3.3009, '', 1, 'Qualitative Vorprüfung des vollständigen FRZK-Axiomensystems. Es werden begriffliche Gegenmodelle und ein qualitatives Erfüllbarkeitsmodell verwendet. Eine starke formale Unabhängigkeit und ein formaler Konsistenzbeweis werden ausdrücklich noch nicht behauptet.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
(58, 22, '3.3.9', 'Übergangsregeln zur mathematischen Rekonstruktion', 3, 3.3010, '', 1, 'Abschluss der prämathematischen Ebene von Kapitel 3.3. Der Abschnitt enthält die Übergangsregeln zur mathematischen Rekonstruktion sowie die Ergänzungen zur latenten funktionalen Orientierung, funktionalen Persistenz und zum funktionalen Gedächtnis. Die klassische Vektoralgebra bleibt unverändert.', '2026-07-12 11:14:28', '2026-07-16 18:22:06'),
...
(1008, '3.275', 49, 'Konzeptionelle Entwicklungsrichtung der FRZK-Axiomatik', '\\text{Unterscheidbarkeit}\\;\\Longrightarrow\\;\\text{Relationierbarkeit}\\;\\Longrightarrow\\;\\text{Transformation}\\;\\Longrightarrow\\;\\text{Organisation}\\;\\Longrightarrow\\;\\text{Kohärenz}', '\\text{Unterscheidbarkeit}\\Longrightarrow\\text{Relationierbarkeit}\\Longrightarrow\\text{Transformation}\\Longrightarrow\\text{Organisation}\\Longrightarrow\\text{Kohärenz}', 'Qualitative Reihenfolge der Organisationsprinzipien, die in Kapitel 3.3 axiomatisch formuliert und in Kapitel 3.4 mathematisch rekonstruiert werden. Die Darstellung ist keine mathematische Herleitung und keine zeitliche Entwicklungsgleichung.', 'schema', 'original', NULL, 'Die Reihenfolge folgt aus der in Kapitel 3.2 identifizierten Forschungslücke: Zunächst muss Unterscheidbarkeit möglich sein; darauf können Relationierung, Transformation, Organisation und Kohärenz aufbauen.', 'Die Begriffe besitzen in Abschnitt 3.3.0 ausschließlich qualitative Bedeutung. Es werden weder Mengen, Funktionen, Operatoren noch Zeitparameter vorausgesetzt.', 'checked', 63),
(1010, '3.276', 50, 'Begriffliche Entwicklungsrichtung der primitiven FRZK-Begriffe', '\\text{Funktionalität}\\;\\Longrightarrow\\;\\text{Unterscheidbarkeit}\\;\\Longrightarrow\\;\\text{Relationierbarkeit}\\;\\Longrightarrow\\;\\text{Transformation}\\;\\Longrightarrow\\;\\text{Organisation}\\;\\Longrightarrow\\;\\text{Kohärenz}', '\\text{Funktionalität}\\Longrightarrow\\text{Unterscheidbarkeit}\\Longrightarrow\\text{Relationierbarkeit}\\Longrightarrow\\text{Transformation}\\Longrightarrow\\text{Organisation}\\Longrightarrow\\text{Kohärenz}', 'Qualitative Reihenfolge, in der die primitiven FRZK-Begriffe für den Aufbau der Axiomatik benötigt werden. Die Pfeile sind weder mathematische Implikationen noch Funktionen, Operatoren oder zeitliche Entwicklungen.', 'schema', 'original', NULL, 'Die Folge ordnet die primitiven Begriffe entsprechend ihrer methodischen Rolle im Theorieaufbau.', 'Sämtliche Begriffe besitzen in Abschnitt 3.3.1 ausschließlich qualitative Bedeutung.', 'checked', 65),
(1014, '3.277', 51, 'Axiom A1 – komprimierte axiomatische Schreibweise', 'A_1:\\quad\\text{Mindestens ein funktional unterscheidbarer Zustand ist möglich.}', 'A_1:\\quad\\text{Mindestens ein funktional unterscheidbarer Zustand ist möglich.}', 'Komprimierte qualitative Formulierung des ersten FRZK-Axioms. Sie ist keine Existenzquantifizierung über einer bereits definierten Menge und führt noch keinen mathematischen Zustandsraum ein.', 'axiom', 'original', NULL, 'Die Aussage folgt als originäre axiomatische Setzung aus der in Kapitel 3.2 identifizierten Notwendigkeit, die Entstehung funktionaler Zustände ohne deren primitive mathematische Voraussetzung zu erklären.', 'Funktionalität und Unterscheidbarkeit werden ausschließlich in der qualitativen Bedeutung aus Abschnitt 3.3.1 verwendet.', 'checked', 67),
(1015, '3.278', 51, 'Qualitative Abhängigkeit der späteren Axiome von Axiom A1', '\\neg A_1\\;\\Longrightarrow\\;\\neg\\!\\left(A_2\\lor A_3\\lor A_4\\lor A_5\\right)', '\\neg A_1\\Longrightarrow\\neg\\left(A_2\\lor A_3\\lor A_4\\lor A_5\\right)', 'Qualitative Abhängigkeitsaussage: Wird die Möglichkeit funktionaler Unterscheidbarkeit ausgeschlossen, fehlt den späteren Axiomen ihre Anwendungsgrundlage. Die Darstellung ist noch kein formal bewiesener Satz eines vollständig spezifizierten logischen Kalküls.', 'schema', 'original', NULL, 'Ohne funktional unterscheidbare Konfigurationen können Relationierbarkeit, Transformation, Organisation und Kohärenz nicht sinnvoll formuliert werden.', 'A1 bis A5 werden als Bezeichnungen der FRZK-Axiome verwendet; ihre formale Unabhängigkeit wird erst in Abschnitt 3.3.8 untersucht.', 'checked', 67),
(1016, '3.279', 52, 'Axiom A2 – komprimierte axiomatische Schreibweise', 'A_2:\\quad\\text{Funktional unterscheidbare Zustände sind prinzipiell relationierbar.}', 'A_2:\\quad\\text{Funktional unterscheidbare Zustände sind prinzipiell relationierbar.}', 'Komprimierte qualitative Formulierung des zweiten FRZK-Axioms. Sie führt weder Mengen noch kartesische Produkte oder mathematische Relationen ein.', 'axiom', 'original', NULL, 'Originäre axiomatische Setzung auf Grundlage der in Axiom A1 eröffneten funktionalen Unterscheidbarkeit.', 'Axiom A1 sowie die qualitativen Begriffe Zustand, Unterscheidbarkeit und Relationierbarkeit werden vorausgesetzt.', 'checked', 68),
(1017, '3.280', 52, 'Qualitative Abhängigkeit von Axiom A2 von Axiom A1', 'A_2\\;\\Longrightarrow\\;A_1', 'A_2\\Longrightarrow A_1', 'Qualitative axiomatische Abhängigkeit: Relationierbarkeit benötigt funktional unterscheidbare Zuständlichkeit.', 'schema', 'original', NULL, 'Axiom A2 kann nur auf funktional unterscheidbare Zustände angewendet werden.', 'Die Pfeilnotation dokumentiert eine axiomatische Voraussetzung und noch keinen vollständig formalisierten Beweis.', 'checked', 68),
(1018, '3.281', 52, 'Qualitative Nichtableitbarkeit von Axiom A2 aus Axiom A1', 'A_1\\;\\not\\Longrightarrow\\;A_2', 'A_1\\not\\Longrightarrow A_2', 'Qualitative Aussage, dass funktionale Unterscheidbarkeit allein noch keine Relationierbarkeit begründet.', 'schema', 'original', NULL, 'Ein begriffliches Modell mit unterscheidbaren, aber vollständig isolierten Konfigurationen zeigt die eigenständige Rolle von Axiom A2.', 'Die Aussage ist noch kein vollständiger modelltheoretischer Unabhängigkeitsbeweis.', 'checked', 68),
(1019, '3.282', 52, 'Gemeinsame qualitative Reichweite der Axiome A1 und A2', 'A_1\\land A_2\\;\\Longrightarrow\\;\\text{funktional unterscheidbare und relationierbare Zuständlichkeit}', 'A_1\\land A_2\\Longrightarrow\\text{funktional unterscheidbare und relationierbare Zuständlichkeit}', 'Qualitative Zusammenfassung: Axiom A1 ermöglicht funktionale Unterscheidbarkeit, Axiom A2 ergänzt die Möglichkeit funktionaler Zusammenhänge.', 'schema', 'original', NULL, 'Zusammenführung der qualitativen Reichweite der ersten beiden FRZK-Axiome.', 'Es wird noch keine mathematische Trägermenge oder Relationsstruktur behauptet.', 'checked', 68),
(1020, '3.283', 53, 'Axiom A3 – komprimierte axiomatische Schreibweise', 'A_3:\\quad\\text{Funktionale Zustände und Zusammenhänge sind prinzipiell transformierbar.}', 'A_3:\\quad\\text{Funktionale Zustände und Zusammenhänge sind prinzipiell transformierbar.}', 'Komprimierte qualitative Formulierung des dritten FRZK-Axioms. Sie führt weder mathematischen Operator noch Zustandsraum, Differentialgleichung oder Zeitparameter ein.', 'axiom', 'original', NULL, 'Originäre axiomatische Setzung auf Grundlage funktionaler Unterscheidbarkeit und Relationierbarkeit.', 'Axiom A1, Axiom A2 sowie die qualitativen Begriffe Zustand, Zusammenhang und Transformation werden vorausgesetzt.', 'checked', 69),
(1021, '3.284', 53, 'Qualitative Abhängigkeit von Axiom A3 von Axiom A1 und Axiom A2', 'A_3\\;\\Longrightarrow\\;A_1\\land A_2', 'A_3\\Longrightarrow A_1\\land A_2', 'Qualitative axiomatische Abhängigkeit: Transformierbarkeit benötigt funktional unterscheidbare und relationierbare Zuständlichkeit.', 'schema', 'original', NULL, 'Axiom A3 kann nur auf funktional unterscheidbare Zustände und funktionale Zusammenhänge angewendet werden.', 'Die Pfeilnotation dokumentiert eine axiomatische Voraussetzung und noch keinen vollständig formalisierten Beweis.', 'checked', 69),
(1022, '3.285', 53, 'Qualitative Nichtableitbarkeit von Axiom A3 aus Axiom A1 und Axiom A2', 'A_1\\land A_2\\;\\not\\Longrightarrow\\;A_3', 'A_1\\land A_2\\not\\Longrightarrow A_3', 'Qualitative Aussage, dass funktionale Unterscheidbarkeit und Relationierbarkeit allein noch keine Veränderbarkeit begründen.', 'schema', 'original', NULL, 'Ein begriffliches Modell mit unterscheidbaren und relationierbaren, aber vollständig starren Konfigurationen zeigt die eigenständige Rolle von Axiom A3.', 'Die Aussage ist noch kein vollständiger modelltheoretischer Unabhängigkeitsbeweis.', 'checked', 69),
(1023, '3.286', 53, 'Gemeinsame qualitative Reichweite der Axiome A1, A2 und A3', 'A_1\\land A_2\\land A_3\\;\\Longrightarrow\\;\\text{unterscheidbare, relationierbare und transformierbare Zuständlichkeit}', 'A_1\\land A_2\\land A_3\\Longrightarrow\\text{unterscheidbare, relationierbare und transformierbare Zuständlichkeit}', 'Qualitative Zusammenfassung der gemeinsamen Reichweite der ersten drei FRZK-Axiome.', 'schema', 'original', NULL, 'Zusammenführung der qualitativen Reichweite von Axiom A1, Axiom A2 und Axiom A3.', 'Es wird noch kein dynamischer Zustandsraum und keine zeitabhängige Entwicklungsgleichung behauptet.', 'checked', 69),
(1024, '3.287', 54, 'Axiom A4 – komprimierte axiomatische Schreibweise', 'A_4:\\quad\\text{Funktionale Relationierungen und Transformationen sind prinzipiell organisationsbildend.}', 'A_4:\\quad\\text{Funktionale Relationierungen und Transformationen sind prinzipiell organisationsbildend.}', 'Komprimierte qualitative Formulierung des vierten FRZK-Axioms. Sie führt weder Graph, Topologie, Zustandsraum noch konkrete Emergenzmechanismen ein.', 'axiom', 'original', NULL, 'Originäre axiomatische Setzung auf Grundlage funktionaler Unterscheidbarkeit, Relationierbarkeit und Transformierbarkeit.', 'Axiom A1, Axiom A2 und Axiom A3 werden vorausgesetzt.', 'checked', 70),
(1025, '3.288', 54, 'Qualitative Abhängigkeit von Axiom A4 von Axiom A1 bis Axiom A3', 'A_4\\;\\Longrightarrow\\;A_1\\land A_2\\land A_3', 'A_4\\Longrightarrow A_1\\land A_2\\land A_3', 'Qualitative axiomatische Abhängigkeit: Organisationsbildung benötigt unterscheidbare, relationierbare und transformierbare Zuständlichkeit.', 'schema', 'original', NULL, 'Axiom A4 kann nur auf den durch Axiom A1 bis Axiom A3 eröffneten qualitativen Strukturen angewendet werden.', 'Noch kein vollständig formalisierter Beweis.', 'checked', 70),
(1026, '3.289', 54, 'Qualitative Nichtableitbarkeit von Axiom A4 aus Axiom A1 bis Axiom A3', 'A_1\\land A_2\\land A_3\\;\\not\\Longrightarrow\\;A_4', 'A_1\\land A_2\\land A_3\\not\\Longrightarrow A_4', 'Qualitative Aussage, dass Unterscheidbarkeit, Relationierbarkeit und Transformierbarkeit allein noch keine Organisationsbildung begründen.', 'schema', 'original', NULL, 'Ein begriffliches Modell ungeordneter und fortlaufend zerfallender funktionaler Verknüpfungen zeigt die eigenständige Rolle von Axiom A4.', 'Noch kein vollständiger modelltheoretischer Unabhängigkeitsbeweis.', 'checked', 70),
(1027, '3.290', 54, 'Gemeinsame qualitative Reichweite der Axiome A1 bis A4', 'A_1\\land A_2\\land A_3\\land A_4\\;\\Longrightarrow\\;\\text{funktional unterscheidbare, relationierbare, transformierbare und organisationsbildende Zuständlichkeit}', 'A_1\\land A_2\\land A_3\\land A_4\\Longrightarrow\\text{funktional unterscheidbare, relationierbare, transformierbare und organisationsbildende Zuständlichkeit}', 'Qualitative Zusammenfassung der gemeinsamen Reichweite der ersten vier FRZK-Axiome.', 'schema', 'original', NULL, 'Zusammenführung der qualitativen Reichweite von Axiom A1 bis Axiom A4.', 'Es wird noch keine mathematisch vollständig rekonstruierte Organisation behauptet.', 'checked', 70),
(1028, '3.291', 55, 'Axiom A5 – komprimierte axiomatische Schreibweise', 'A_5:\\quad\\text{Funktionale Organisation ist prinzipiell kohärenz- und stabilisierungsfähig.}', 'A_5:\\quad\\text{Funktionale Organisation ist prinzipiell kohärenz- und stabilisierungsfähig.}', 'Komprimierte qualitative Formulierung des fünften FRZK-Axioms. Sie führt kein mathematisches Kohärenzmaß und kein konkretes Stabilitätskriterium ein.', 'axiom', 'original', NULL, 'Originäre axiomatische Setzung auf Grundlage funktionaler Organisationsbildung.', 'Axiom A1 bis Axiom A4 werden vorausgesetzt.', 'checked', 71),
(1029, '3.292', 55, 'Qualitative Abhängigkeit von Axiom A5 von Axiom A1 bis Axiom A4', 'A_5\\;\\Longrightarrow\\;A_1\\land A_2\\land A_3\\land A_4', 'A_5\\Longrightarrow A_1\\land A_2\\land A_3\\land A_4', 'Qualitative axiomatische Abhängigkeit: Kohärenz und Stabilisierung benötigen unterscheidbare, relationierbare, transformierbare und organisationsbildende Zuständlichkeit.', 'schema', 'original', NULL, 'Axiom A5 kann nur auf bereits gebildete funktionale Organisation angewendet werden.', 'Die Darstellung ist noch kein vollständig formalisierter Beweis.', 'checked', 71),
(1030, '3.293', 55, 'Qualitative Nichtableitbarkeit von Axiom A5 aus Axiom A1 bis Axiom A4', 'A_1\\land A_2\\land A_3\\land A_4\\;\\not\\Longrightarrow\\;A_5', 'A_1\\land A_2\\land A_3\\land A_4\\not\\Longrightarrow A_5', 'Qualitative Aussage, dass Organisationsbildung allein noch keinen Erhalt oder keine Reproduktion unter weiterer Transformation begründet.', 'schema', 'original', NULL, 'Ein begriffliches Modell mit Organisationsmustern, die unter jeder weiteren Transformation vollständig zerfallen, zeigt die eigenständige Rolle von Axiom A5.', 'Die Aussage ist noch kein vollständiger modelltheoretischer Unabhängigkeitsbeweis.', 'checked', 71),
(1031, '3.294', 55, 'Gemeinsame qualitative Reichweite der Axiome A1 bis A5', 'A_1\\land A_2\\land A_3\\land A_4\\land A_5\\;\\Longrightarrow\\;\\text{unterscheidbare, relationierbare, transformierbare, organisations- und kohärenzfähige Zuständlichkeit}', 'A_1\\land A_2\\land A_3\\land A_4\\land A_5\\Longrightarrow\\text{unterscheidbare, relationierbare, transformierbare, organisations- und kohärenzfähige Zuständlichkeit}', 'Qualitative Zusammenfassung der gemeinsamen Reichweite des vollständigen FRZK-Axiomensystems.', 'schema', 'original', NULL, 'Zusammenführung der qualitativen Reichweite von Axiom A1 bis Axiom A5.', 'Es wird noch keine mathematische Gesamttheorie oder konkrete Raum-Zeit-Struktur behauptet.', 'checked', 71),
(1032, '3.295', 56, 'Vollständiges qualitatives FRZK-Axiomensystem', '\\mathcal{A}_{\\mathrm{FRZK}}=\\left\\{A_1,A_2,A_3,A_4,A_5\\right\\}', '\\mathcal{A}_{\\mathrm{FRZK}}=\\left\\{A_1,A_2,A_3,A_4,A_5\\right\\}', 'Zusammenfassende Bezeichnung des vollständigen qualitativen FRZK-Axiomensystems.', 'definition', 'original', NULL, 'Zusammenführung der Axiome A1 bis A5.', 'Noch kein vollständig formalisiertes mengentheoretisches oder modelltheoretisches System.', 'checked', 72),
(1033, '3.296', 56, 'Relationale Bestimmbarkeit funktionaler Zuständlichkeit', 'A_1\\land A_2\\Longrightarrow\\text{relationale Bestimmbarkeit funktionaler Zuständlichkeit}', 'A_1\\land A_2\\Longrightarrow\\text{relationale Bestimmbarkeit funktionaler Zuständlichkeit}', 'Qualitative Konsequenz aus Axiom A1 und Axiom A2.', 'schema', 'original', NULL, 'Unterscheidbare funktionale Zustände können innerhalb funktionaler Zusammenhänge bestimmt werden.', 'Keine mathematische Relation wird eingeführt.', 'checked', 72),
(1034, '3.297', 56, 'Bestimmbare funktionale Veränderung ohne vorausgesetzte Zeit', 'A_1\\land A_2\\land A_3\\Longrightarrow\\text{bestimmbare funktionale Veränderung ohne vorausgesetzte Zeit}', 'A_1\\land A_2\\land A_3\\Longrightarrow\\text{bestimmbare funktionale Veränderung ohne vorausgesetzte Zeit}', 'Qualitative Konsequenz der Trennung von Veränderung und bereits vorausgesetzter Zeit.', 'schema', 'original', NULL, 'Axiom A3 erlaubt funktionale Veränderung, ohne eine Zeitachse oder einen Zeitparameter einzuführen.', 'Noch keine Zeitrekonstruktion.', 'checked', 72),
(1035, '3.298', 56, 'Mögliche funktionale Selbstorganisation', 'A_1\\land A_2\\land A_3\\land A_4\\Longrightarrow\\text{mögliche funktionale Selbstorganisation}', 'A_1\\land A_2\\land A_3\\land A_4\\Longrightarrow\\text{mögliche funktionale Selbstorganisation}', 'Qualitative Konsequenz, dass Organisationsbildung nicht zwingend eine vollständige äußere Vorgabe benötigt.', 'schema', 'original', NULL, 'Axiom A4 eröffnet organisationsbildende Strukturbildung aus funktionalen Zusammenhängen und Transformationen.', 'Nicht jede funktionale Organisation ist notwendig selbstorganisiert.', 'checked', 72),
(1036, '3.299', 56, 'Mögliche prozessuale funktionale Identität', 'A_4\\land A_5\\Longrightarrow\\text{mögliche prozessuale funktionale Identität}', 'A_4\\land A_5\\Longrightarrow\\text{mögliche prozessuale funktionale Identität}', 'Qualitative Konsequenz, dass funktionale Identität im Erhalt organisatorischer Zusammenhänge trotz innerer Veränderung liegen kann.', 'schema', 'original', NULL, 'Axiom A5 erlaubt Erhalt und Reproduktion funktionaler Organisation.', 'Noch kein mathematisches Identitätskriterium.', 'checked', 72),
(1037, '3.300', 56, 'Kohärenz als Erhalt unter Transformation', 'A_3\\land A_5\\Longrightarrow\\text{Kohärenz als Erhalt unter Transformation}', 'A_3\\land A_5\\Longrightarrow\\text{Kohärenz als Erhalt unter Transformation}', 'Qualitative Konsequenz, dass Kohärenz nicht mit Starrheit gleichgesetzt wird.', 'schema', 'original', NULL, 'Axiom A3 erlaubt Transformation, Axiom A5 funktionalen Erhalt und Reproduktion.', 'Kein mathematisches Kohärenzmaß.', 'checked', 72),
(1038, '3.301', 56, 'Möglichkeit einer funktionalen Raumrekonstruktion', 'A_1\\land A_2\\land A_4\\Longrightarrow\\text{Möglichkeit einer funktionalen Raumrekonstruktion}', 'A_1\\land A_2\\land A_4\\Longrightarrow\\text{Möglichkeit einer funktionalen Raumrekonstruktion}', 'Qualitative Voraussetzung für die spätere Rekonstruktion einer räumlich interpretierbaren Relations- und Organisationsstruktur.', 'schema', 'original', NULL, 'Unterscheidbarkeit, Relationierbarkeit und Organisationsbildung bilden eine qualitative Vorstruktur.', 'Noch kein geometrischer, topologischer oder metrischer Raum.', 'checked', 72),
(1039, '3.302', 56, 'Möglichkeit einer funktionalen Zeitrekonstruktion', 'A_1\\land A_2\\land A_3\\land A_4\\land A_5\\Longrightarrow\\text{Möglichkeit einer funktionalen Zeitrekonstruktion}', 'A_1\\land A_2\\land A_3\\land A_4\\land A_5\\Longrightarrow\\text{Möglichkeit einer funktionalen Zeitrekonstruktion}', 'Qualitative Voraussetzung für die spätere Rekonstruktion einer geordneten und kohärenten Transformationsstruktur.', 'schema', 'original', NULL, 'Das vollständige Axiomensystem eröffnet die Möglichkeit geordneter, relationierter und kohärent rekonstruierbarer Transformation.', 'Noch kein Zeitparameter und keine Zeitrichtung.', 'checked', 72),
(1040, '3.303', 56, 'Notwendige Kohärenzbedingungen für Raum- und Zeitrekonstruktion', '\\text{Raumrekonstruktion}\\land\\text{Zeitrekonstruktion}\\Longrightarrow\\text{notwendige Kohärenzbedingungen}', '\\text{Raumrekonstruktion}\\land\\text{Zeitrekonstruktion}\\Longrightarrow\\text{notwendige Kohärenzbedingungen}', 'Qualitative Theorieabsicht, Raum und Zeit als kohärent bestimmbare Organisationsformen zu rekonstruieren.', 'schema', 'original', NULL, 'Relationale und dynamische Organisationsformen müssen über Transformationen hinweg bestimmbar bleiben.', 'Noch kein mathematischer Notwendigkeitsbeweis.', 'checked', 72),
(1041, '3.304', 56, 'Mögliche Modellpluralität', '\\mathcal{A}_{\\mathrm{FRZK}}\\Longrightarrow\\text{mögliche Modellpluralität}', '\\mathcal{A}_{\\mathrm{FRZK}}\\Longrightarrow\\text{mögliche Modellpluralität}', 'Qualitative Konsequenz, dass verschiedene mathematische Modelle dieselben qualitativen Axiome realisieren können.', 'schema', 'original', NULL, 'Die Axiome legen noch keine eindeutige mathematische Realisierung fest.', 'Die Auswahl konkreter mathematischer Strukturen erfolgt erst in Kapitel 3.4.', 'checked', 72),
(1042, '3.305', 56, 'Trennung axiomatischer Möglichkeit und empirischer Realisierung', '\\text{axiomatische Möglichkeit}\\neq\\text{empirische Realisierung}', '\\text{axiomatische Möglichkeit}\\neq\\text{empirische Realisierung}', 'Grundlegende Trennung zwischen theoretischem Möglichkeitsraum und empirischer Beobachtung.', '', 'original', NULL, 'Die Axiome formulieren Möglichkeiten und keine universellen empirischen Tatsachen.', 'Empirische Realisierung muss gesondert operationalisiert und geprüft werden.', 'checked', 72),
(1043, '3.306', 56, 'Zusammenfassung der qualitativen Konsequenzen', '\\mathcal{A}_{\\mathrm{FRZK}}\\Longrightarrow\\left\\{\\begin{array}{l}\\text{relationale Bestimmbarkeit},\\\\\\text{Veränderbarkeit ohne vorausgesetzte Zeit},\\\\\\text{Organisationsbildung},\\\\\\text{prozessuale funktionale Identität},\\\\\\text{dynamische Kohärenz},\\\\\\text{Möglichkeit funktionaler Raumrekonstruktion},\\\\\\text{Möglichkeit funktionaler Zeitrekonstruktion},\\\\\\text{Modellpluralität}\\end{array}\\right\\}', '\\mathcal{A}_{\\mathrm{FRZK}}\\Longrightarrow\\left\\{\\begin{array}{l}\\text{relationale Bestimmbarkeit},\\\\\\text{Veränderbarkeit ohne vorausgesetzte Zeit},\\\\\\text{Organisationsbildung},\\\\\\text{prozessuale funktionale Identität},\\\\\\text{dynamische Kohärenz},\\\\\\text{Möglichkeit funktionaler Raumrekonstruktion},\\\\\\text{Möglichkeit funktionaler Zeitrekonstruktion},\\\\\\text{Modellpluralität}\\end{array}\\right\\}', 'Qualitative Zusammenfassung der unmittelbaren Konsequenzen des vollständigen FRZK-Axiomensystems.', 'schema', 'original', NULL, 'Zusammenführung der in Abschnitt 3.3.7 entwickelten Konsequenzen.', 'Noch keine mathematisch bewiesene Satzsammlung.', 'checked', 72),
(1044, '3.307', 57, 'Vollständiges FRZK-Axiomensystem', '\\mathcal{A}_{\\mathrm{FRZK}}=\\left\\{A_1,A_2,A_3,A_4,A_5\\right\\}', '\\mathcal{A}_{\\mathrm{FRZK}}=\\left\\{A_1,A_2,A_3,A_4,A_5\\right\\}', 'Zusammenfassende Bezeichnung des vollständigen Axiomensystems.', 'definition', 'original', NULL, 'Wiederaufnahme der Sammelbezeichnung aus Abschnitt 3.3.7.', 'Qualitative Axiomatik.', 'checked', 73),
(1045, '3.308', 57, 'Qualitatives Minimalitätskriterium', '\\forall A_i\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad\\mathcal{A}_{\\mathrm{FRZK}}\\setminus\\left\\{A_i\\right\\}\\text{ besitzt eine geringere funktionale Reichweite als }\\mathcal{A}_{\\mathrm{FRZK}}', '\\forall A_i\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad\\mathcal{A}_{\\mathrm{FRZK}}\\setminus\\left\\{A_i\\right\\}\\text{ besitzt eine geringere funktionale Reichweite als }\\mathcal{A}_{\\mathrm{FRZK}}', 'Qualitatives Kriterium funktionaler Minimalität.', 'schema', 'original', NULL, 'Für jedes entfernte Axiom muss ein eigenständiger Funktionsverlust angegeben werden.', 'Noch kein formaler Minimalitätsbeweis.', 'checked', 73),
(1046, '3.309', 57, 'Qualitatives Gegenmodell zu Axiom A1', '\\mathfrak{M}_{\\neg A_1}:\\quad\\neg A_1\\land\\neg A_2\\land\\neg A_3\\land\\neg A_4\\land\\neg A_5', '\\mathfrak{M}_{\\neg A_1}:\\quad\\neg A_1\\land\\neg A_2\\land\\neg A_3\\land\\neg A_4\\land\\neg A_5', 'Vollständig unbestimmte Konfiguration ohne funktionale Unterscheidbarkeit.', 'model', 'original', NULL, 'Ohne A1 fehlt den übrigen Axiomen ihre Anwendungsgrundlage.', 'Qualitatives Gegenmodell.', 'checked', 73),
(1047, '3.310', 57, 'Qualitatives Gegenmodell zu Axiom A2', '\\mathfrak{M}_{\\neg A_2}:\\quad A_1\\land\\neg A_2', '\\mathfrak{M}_{\\neg A_2}:\\quad A_1\\land\\neg A_2', 'Unterscheidbare, aber vollständig isolierte funktionale Zustände.', 'model', 'original', NULL, 'Unterscheidbarkeit impliziert keine Relationierbarkeit.', 'Qualitatives Gegenmodell.', 'checked', 73),
(1048, '3.311', 57, 'Qualitatives Gegenmodell zu Axiom A3', '\\mathfrak{M}_{\\neg A_3}:\\quad A_1\\land A_2\\land\\neg A_3', '\\mathfrak{M}_{\\neg A_3}:\\quad A_1\\land A_2\\land\\neg A_3', 'Statische relationale Struktur ohne Transformierbarkeit.', 'model', 'original', NULL, 'Unterscheidbarkeit und Relationierbarkeit implizieren keine Veränderbarkeit.', 'Qualitatives Gegenmodell.', 'checked', 73),
(1049, '3.312', 57, 'Qualitatives Gegenmodell zu Axiom A4', '\\mathfrak{M}_{\\neg A_4}:\\quad A_1\\land A_2\\land A_3\\land\\neg A_4', '\\mathfrak{M}_{\\neg A_4}:\\quad A_1\\land A_2\\land A_3\\land\\neg A_4', 'Ungeordnete Transformationen ohne übergeordnetes Organisationsmuster.', 'model', 'original', NULL, 'Dynamik impliziert keine Organisationsbildung.', 'Qualitatives Gegenmodell.', 'checked', 73),
(1050, '3.313', 57, 'Qualitatives Gegenmodell zu Axiom A5', '\\mathfrak{M}_{\\neg A_5}:\\quad A_1\\land A_2\\land A_3\\land A_4\\land\\neg A_5', '\\mathfrak{M}_{\\neg A_5}:\\quad A_1\\land A_2\\land A_3\\land A_4\\land\\neg A_5', 'Organisationsbildung ohne Erhalt oder Reproduktion unter weiterer Transformation.', 'model', 'original', NULL, 'Organisation impliziert keine Kohärenz.', 'Qualitatives Gegenmodell.', 'checked', 73),
(1051, '3.314', 57, 'Qualitative Nichtfolgerung der Einzelaxiome', '\\forall A_i\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad\\mathcal{A}_{\\mathrm{FRZK}}\\setminus\\left\\{A_i\\right\\}\\not\\models_{\\mathrm{qual}}A_i', '\\forall A_i\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad\\mathcal{A}_{\\mathrm{FRZK}}\\setminus\\left\\{A_i\\right\\}\\not\\models_{\\mathrm{qual}}A_i', 'Qualitative Unabhängigkeitsvermutung auf Grundlage begrifflicher Gegenmodelle.', 'schema', 'original', NULL, 'Für jedes Axiom wird ein eigenständiger Funktionsverlust beschrieben.', 'Keine formale Erfüllungsrelation.', 'checked', 73),
(1052, '3.315', 57, 'Begriffliche Aufbauordnung der Axiome', 'A_1\\prec A_2\\prec A_3\\prec A_4\\prec A_5', 'A_1\\prec A_2\\prec A_3\\prec A_4\\prec A_5', 'Gerichtete begriffliche Vorrang- und Aufbauordnung ohne logische Implikation.', 'schema', 'original', NULL, 'Jedes spätere Axiom benötigt die funktionale Anwendungsgrundlage der vorausgehenden Stufen.', 'Keine deduktive Äquivalenz.', 'checked', 73),
(1053, '3.316', 57, 'Qualitative Gegenmodelle und schwache Unabhängigkeit', '\\text{qualitative Gegenmodelle}\\Longrightarrow\\text{schwache Unabhängigkeit}', '\\text{qualitative Gegenmodelle}\\Longrightarrow\\text{schwache Unabhängigkeit}', 'Methodische Einordnung des in Abschnitt 3.3.8 erreichten Prüfstatus.', 'schema', 'original', NULL, 'Begriffliche Gegenmodelle zeigen eigenständigen funktionalen Gehalt.', 'Noch keine starke formale Unabhängigkeit.', 'checked', 73),
(1054, '3.317', 57, 'Voraussetzungen starker formaler Unabhängigkeit', '\\text{formale Modelle}+\\text{präzise Semantik}\\Longrightarrow\\text{prüfbare starke Unabhängigkeit}', '\\text{formale Modelle}+\\text{präzise Semantik}\\Longrightarrow\\text{prüfbare starke Unabhängigkeit}', 'Abgrenzung des später erforderlichen formalen Prüfstandards.', 'schema', 'adapted', 158, 'Formale Unabhängigkeit benötigt Sprache, Semantik, Modellklasse und Erfüllungsrelation.', 'Methodische Zielaussage.', 'checked', 73),
(1055, '3.318', 57, 'Qualitative Konsistenzforderung', '\\neg\\exists A_i,A_j\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad A_i\\Longrightarrow\\neg A_j', '\\neg\\exists A_i,A_j\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad A_i\\Longrightarrow\\neg A_j', 'Kein Axiom soll auf qualitativer Ebene unmittelbar die Negation eines anderen erzwingen.', 'schema', 'original', NULL, 'Prüfung auf offensichtliche begriffliche Widersprüche.', 'Keine syntaktische Konsistenzprüfung.', 'checked', 73),
(1056, '3.319', 57, 'Qualitatives Erfüllbarkeitsmodell', '\\mathfrak{M}_{\\mathrm{FRZK}}\\models_{\\mathrm{qual}}A_1\\land A_2\\land A_3\\land A_4\\land A_5', '\\mathfrak{M}_{\\mathrm{FRZK}}\\models_{\\mathrm{qual}}A_1\\land A_2\\land A_3\\land A_4\\land A_5', 'Qualitative gemeinsame Interpretation aller fünf Axiome.', 'model', 'original', NULL, 'Begrifflich widerspruchsfreie Konfiguration mit allen fünf funktionalen Möglichkeiten.', 'Keine formale Modellrelation.', 'checked', 73),
(1057, '3.320', 57, 'Qualitative Existenz eines Erfüllbarkeitsmodells', '\\exists\\mathfrak{M}_{\\mathrm{FRZK}}:\\quad\\mathfrak{M}_{\\mathrm{FRZK}}\\models_{\\mathrm{qual}}\\mathcal{A}_{\\mathrm{FRZK}}', '\\exists\\mathfrak{M}_{\\mathrm{FRZK}}:\\quad\\mathfrak{M}_{\\mathrm{FRZK}}\\models_{\\mathrm{qual}}\\mathcal{A}_{\\mathrm{FRZK}}', 'Qualitative Plausibilität gemeinsamer Erfüllbarkeit.', 'model', 'original', NULL, 'Ein begriffliches Erfüllbarkeitsmodell kann beschrieben werden.', 'Kein formaler Existenzbeweis.', 'checked', 73),
(1058, '3.321', 57, 'Abgrenzung qualitativer und formaler Konsistenz', '\\text{qualitative Widerspruchsfreiheit}\\neq\\text{formal bewiesene Konsistenz}', '\\text{qualitative Widerspruchsfreiheit}\\neq\\text{formal bewiesene Konsistenz}', 'Wissenschaftstheoretische Abgrenzung des erreichten Prüfstatus.', '', 'original', NULL, 'Qualitative Vereinbarkeit ersetzt keinen formalen Konsistenzbeweis.', 'Methodische Begrenzung.', 'checked', 73),
(1059, '3.322', 57, 'Funktionsverlust bei Entfernung eines Axioms', '\\begin{array}{c|l}\\text{entferntes Axiom}&\\text{verlorene funktionale Möglichkeit}\\\\\\hline A_1&\\text{funktionale Unterscheidbarkeit}\\\\A_2&\\text{funktionale Relationierbarkeit}\\\\A_3&\\text{funktionale Transformierbarkeit}\\\\A_4&\\text{funktionale Organisationsbildung}\\\\A_5&\\text{funktionale Kohärenz und Stabilisierung}\\end{array}', '\\begin{array}{c|l}\\text{entferntes Axiom}&\\text{verlorene funktionale Möglichkeit}\\\\\\hline A_1&\\text{funktionale Unterscheidbarkeit}\\\\A_2&\\text{funktionale Relationierbarkeit}\\\\A_3&\\text{funktionale Transformierbarkeit}\\\\A_4&\\text{funktionale Organisationsbildung}\\\\A_5&\\text{funktionale Kohärenz und Stabilisierung}\\end{array}', 'Tabellarische Zusammenfassung des Funktionsverlustes bei Entfernung jedes Axioms.', 'schema', 'original', NULL, 'Ergebnis der qualitativen Gegenmodellprüfung.', 'Qualitative Zusammenfassung.', 'checked', 73),
(1060, '3.323', 57, 'Ergebnis der Minimalitätsprüfung', '\\mathcal{A}_{\\mathrm{FRZK}}\\text{ ist qualitativ funktional minimal.}', '\\mathcal{A}_{\\mathrm{FRZK}}\\text{ ist qualitativ funktional minimal.}', 'Qualitatives Ergebnis der Minimalitätsprüfung.', 'derived', 'original', NULL, 'Folgt auf qualitativer Ebene aus den fünf Gegenmodellbetrachtungen.', 'Keine formale Minimalität.', 'checked', 73);
INSERT INTO `equations` (`equation_id`, `equation_number`, `section_id`, `title`, `equation_latex`, `word_latex`, `plain_description`, `equation_type`, `provenance`, `source_id`, `derivation`, `assumptions`, `validation_status`, `created_revision_id`) VALUES
(1061, '3.324', 57, 'Ergebnis der Unabhängigkeitsprüfung', '\\forall A_i\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad A_i\\text{ besitzt einen eigenständigen funktionalen Gehalt.}', '\\forall A_i\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad A_i\\text{ besitzt einen eigenständigen funktionalen Gehalt.}', 'Qualitatives Ergebnis der schwachen Unabhängigkeitsprüfung.', 'derived', 'original', NULL, 'Jedes Axiom ergänzt eine nicht vollständig ersetzbare funktionale Möglichkeit.', 'Keine starke formale Unabhängigkeit.', 'checked', 73),
(1062, '3.325', 57, 'Ergebnis der qualitativen Erfüllbarkeitsprüfung', '\\mathcal{A}_{\\mathrm{FRZK}}\\text{ ist qualitativ gemeinsam erfüllbar.}', '\\mathcal{A}_{\\mathrm{FRZK}}\\text{ ist qualitativ gemeinsam erfüllbar.}', 'Qualitatives Ergebnis der Konsistenzvorprüfung.', 'derived', 'original', NULL, 'Ein begrifflich widerspruchsfreies Erfüllbarkeitsmodell kann beschrieben werden.', 'Keine formal bewiesene Konsistenz.', 'checked', 73),
(1063, '3.326', 57, 'Gesamtbewertung der qualitativen Axiomenprüfung', '\\mathcal{A}_{\\mathrm{FRZK}}\\Longrightarrow\\left\\{\\begin{array}{l}\\text{qualitative funktionale Minimalität},\\\\\\text{schwache qualitative Unabhängigkeit},\\\\\\text{qualitative gemeinsame Erfüllbarkeit}\\end{array}\\right\\}', '\\mathcal{A}_{\\mathrm{FRZK}}\\Longrightarrow\\left\\{\\begin{array}{l}\\text{qualitative funktionale Minimalität},\\\\\\text{schwache qualitative Unabhängigkeit},\\\\\\text{qualitative gemeinsame Erfüllbarkeit}\\end{array}\\right\\}', 'Zusammenfassung der drei vorläufigen Prüfergebnisse.', 'schema', 'original', NULL, 'Zusammenführung von Minimalitäts-, Unabhängigkeits- und Erfüllbarkeitsprüfung.', 'Qualitative Vorprüfung.', 'checked', 73),
(1064, '3.327', 58, 'Prinzip der Bedeutungsinvarianz', '\\text{Semantik}\\longrightarrow\\text{Mathematik},\\qquad\\text{nicht umgekehrt.}', '\\text{Semantik}\\longrightarrow\\text{Mathematik},\\qquad\\text{nicht umgekehrt.}', 'Mathematik rekonstruiert einen bereits qualitativ begründeten Bedeutungsgehalt und erzeugt ihn nicht nachträglich.', '', 'original', NULL, 'Abgeleitet aus der Trennung zwischen qualitativer Axiomatik und mathematischer Rekonstruktion.', 'Kapitel 3.3 ist semantisch abgeschlossen.', 'checked', 75),
(1065, '3.328', 58, 'Vorrang der Relation vor Geometrie', '\\text{Relation}\\prec\\text{Geometrie}', '\\text{Relation}\\prec\\text{Geometrie}', 'Funktionale Relationen müssen vor geometrischen Strukturen rekonstruiert werden.', '', 'original', NULL, 'Axiom A2 führt Relationierbarkeit ohne Raum vorauszusetzen ein.', 'Keine Punkte, Koordinaten oder Metriken werden vorausgesetzt.', 'checked', 75),
(1066, '3.329', 58, 'Vorrang der Transformation vor dem Zeitparameter', '\\text{Transformation}\\prec\\text{Zeitparameter}', '\\text{Transformation}\\prec\\text{Zeitparameter}', 'Funktionale Transformationen müssen vor einer mathematischen Zeitvariablen rekonstruiert werden.', '', 'original', NULL, 'Axiom A3 führt Transformierbarkeit ohne Zeit vorauszusetzen ein.', 'Kein Zeitparameter wird vorausgesetzt.', 'checked', 75),
(1067, '3.330', 58, 'Relationale Rekonstruktionshierarchie', '\\text{Relationen}\\longrightarrow\\text{Strukturen}\\longrightarrow\\text{Objekte}', '\\text{Relationen}\\longrightarrow\\text{Strukturen}\\longrightarrow\\text{Objekte}', 'Objekte werden als stabile Träger wiederkehrender relationaler Strukturen rekonstruiert.', 'schema', 'original', NULL, 'Folgt aus dem relationalen Ausgangspunkt des FRZK.', 'Keine objektontologische Priorität.', 'checked', 75),
(1068, '3.331', 58, 'Rekonstruktion aus den Axiomen', '\\text{Axiome}\\Longrightarrow\\text{rekonstruierte Mathematik}', '\\text{Axiome}\\Longrightarrow\\text{rekonstruierte Mathematik}', 'Zulässige Richtung der mathematischen Entwicklung.', '', 'original', NULL, 'Mathematische Strukturen werden aus dem qualitativen Funktionsbedarf entwickelt.', 'Das vollständige Axiomensystem wird vorausgesetzt.', 'checked', 75),
(1069, '3.332', 58, 'Unzulässige nachträgliche FRZK-Interpretation', '\\text{vorhandene Mathematik}\\Longrightarrow\\text{Interpretation als FRZK}', '\\text{vorhandene Mathematik}\\Longrightarrow\\text{Interpretation als FRZK}', 'Kennzeichnet die methodisch unzulässige bloße Umdeutung bereits vorhandener Mathematik als FRZK.', '', 'original', NULL, 'Dient als negative Übergangsregel.', 'Keine Aussage, dass vorhandene Mathematik nicht später als Modell verwendet werden darf.', 'checked', 75),
(1070, '3.333', 58, 'Mathematisches Minimalprinzip', '\\text{so viel Mathematik wie notwendig, so wenig Mathematik wie möglich.}', '\\text{so viel Mathematik wie notwendig, so wenig Mathematik wie möglich.}', 'Minimalprinzip für die schrittweise mathematische Rekonstruktion.', '', 'original', NULL, 'Folgt aus Bedeutungsinvarianz und ontologischer Zurückhaltung.', 'Jede mathematische Struktur muss funktional motiviert sein.', 'checked', 75),
(1078, '3.334', 58, 'Quantitative Auslöschung ist keine funktionale Vernichtung', '\\text{quantitative Auslöschung}\\not\\Longrightarrow\\text{funktionale Vernichtung}', '\\text{quantitative Auslöschung}\\not\\Longrightarrow\\text{funktionale Vernichtung}', 'Übergangsregel zur Trennung quantitativer Nullsetzung und funktionaler Identitätsvernichtung.', '', 'original', NULL, 'Folgt aus der Einführung latenter funktionaler Orientierung.', 'Erweiterter FRZK-Zustandsbegriff; keine Änderung klassischer Vektoralgebra.', 'checked', 75),
(1079, '3.335', 58, 'Klassische Multiplikation eines Vektors mit Null', '0\\cdot\\mathbf{v}=\\mathbf{0}', '0\\cdot\\mathbf{v}=\\mathbf{0}', 'Klassische Skalarmultiplikation: Der Ergebnisvektor ist der Nullvektor.', '', '', 160, 'Standardergebnis der linearen Algebra.', 'Klassischer Vektorraum über einem Körper.', 'checked', 75),
(1080, '3.336', 58, 'Orientierung ermöglicht funktionale Persistenz', '\\text{funktionale Orientierung}\\Longrightarrow\\text{funktionale Persistenz}', '\\text{funktionale Orientierung}\\Longrightarrow\\text{funktionale Persistenz}', 'Qualitative Folgerung von erhaltener Orientierungsinformation zu funktionaler Persistenz.', 'schema', 'original', NULL, 'Eine erhaltene funktionale Orientierungsinformation trägt strukturrelevante Identität.', 'Latente funktionale Orientierung.', 'checked', 75),
(1081, '3.337', 58, 'Persistenz impliziert keinen konstanten Betrag', '\\text{Persistenz}\\not\\Longrightarrow\\text{konstanter Betrag}', '\\text{Persistenz}\\not\\Longrightarrow\\text{konstanter Betrag}', 'Funktionale Persistenz ist keine numerische Konstanzforderung.', '', 'original', NULL, 'Folgt aus der Trennung quantitativer und funktionaler Zustandskomponenten.', 'Funktionale Persistenz.', 'checked', 75),
(1082, '3.338', 58, 'Aktivität ist nicht identisch mit Existenz', '\\text{Aktivität}\\neq\\text{Existenz}', '\\text{Aktivität}\\neq\\text{Existenz}', 'Unterscheidung zwischen momentaner quantitativer Aktivität und funktionaler Existenz.', '', 'original', NULL, 'Folgt aus funktionaler Persistenz und funktionalem Gedächtnis.', 'Erweiterter funktionaler Zustandsbegriff.', 'checked', 75),
(1083, '3.339', 58, 'Nullaktivität impliziert keine funktionale Nichtexistenz', '\\text{quantitative Nullaktivität}\\not\\Longrightarrow\\text{funktionale Nichtexistenz}', '\\text{quantitative Nullaktivität}\\not\\Longrightarrow\\text{funktionale Nichtexistenz}', 'Qualitative Folgerung für persistente funktionale Zustände.', '', 'original', NULL, 'Folgt aus der Unterscheidung von Aktivität, Existenz und Gedächtnis.', 'Funktionale Persistenz und funktionales Gedächtnis.', 'checked', 75);
...
(670, 1008, '\\Longrightarrow', 'konzeptioneller Folgerungspfeil', 'Kennzeichnet in Gleichung (3.275) ausschließlich die qualitative Reihenfolge der Organisationsprinzipien; keine Funktion, kein Operator und keine zeitliche Entwicklung.', NULL, 'qualitative axiomatische Abhängigkeit', 1),
(672, 1010, '\\Longrightarrow', 'qualitativer Folgerungs- und Ordnungspfeil', 'Kennzeichnet in Gleichung (3.276) ausschließlich die begriffliche Reihenfolge der primitiven FRZK-Begriffe. Er ist weder logische Implikation noch Operator.', NULL, 'qualitative axiomatische Begriffsordnung', 1),
(673, 1014, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms: Existenz mindestens eines prinzipiell funktional unterscheidbaren Zustandes.', NULL, 'qualitative FRZK-Axiomatik', 1),
(674, 1015, '\\neg', 'Negation', 'Logisches Negationszeichen. In Gleichung (3.278) kennzeichnet es das Ausschließen der jeweils bezeichneten axiomatischen Möglichkeit.', NULL, 'qualitative logische Abhängigkeitsaussage', 1),
(675, 1015, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative axiomatische Abhängigkeit, noch keinen formal bewiesenen Satz.', NULL, 'qualitative logische Abhängigkeitsaussage', 2),
(676, 1015, '\\lor', 'logische Disjunktion', 'Verknüpft die späteren Axiombezeichnungen A2 bis A5 im Sinne einer qualitativen Alternativenmenge.', NULL, 'qualitative logische Abhängigkeitsaussage', 3),
(677, 1015, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 4),
(678, 1015, 'A_2', 'Axiom A2', 'Bezeichnung des nachfolgenden Axioms der funktionalen Relationierbarkeit.', NULL, 'qualitative FRZK-Axiomatik', 5),
(679, 1015, 'A_3', 'Axiom A3', 'Bezeichnung des späteren Axioms der Transformation.', NULL, 'qualitative FRZK-Axiomatik', 6),
(680, 1015, 'A_4', 'Axiom A4', 'Bezeichnung des späteren Axioms der funktionalen Organisation beziehungsweise Kohärenzbildung.', NULL, 'qualitative FRZK-Axiomatik', 7),
(681, 1015, 'A_5', 'Axiom A5', 'Bezeichnung des späteren Axioms der Emergenz funktionaler Organisation.', NULL, 'qualitative FRZK-Axiomatik', 8),
(682, 1016, 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms der funktionalen Relationierbarkeit.', NULL, 'qualitative FRZK-Axiomatik', 1),
(683, 1017, 'A_2', 'Axiom A2', 'Bezeichnung des Axioms der funktionalen Relationierbarkeit.', NULL, 'qualitative FRZK-Axiomatik', 1),
(684, 1017, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative axiomatische Voraussetzung.', NULL, 'qualitative axiomatische Abhängigkeit', 2),
(685, 1017, 'A_1', 'Axiom A1', 'Bezeichnung des Axioms der Existenz funktionaler Zustände.', NULL, 'qualitative FRZK-Axiomatik', 3),
(686, 1018, 'A_1', 'Axiom A1', 'Bezeichnung des Axioms der Existenz funktionaler Zustände.', NULL, 'qualitative FRZK-Axiomatik', 1),
...
(688, 1018, 'A_2', 'Axiom A2', 'Bezeichnung des Axioms der funktionalen Relationierbarkeit.', NULL, 'qualitative FRZK-Axiomatik', 3),
(689, 1019, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 1),
(690, 1019, '\\land', 'logische Konjunktion', 'Verknüpft Axiom A1 und Axiom A2 in der qualitativen Zusammenfassung.', NULL, 'qualitative logische Verknüpfung', 2),
(691, 1019, 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 3),
(692, 1019, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet die gemeinsame qualitative Reichweite beider Axiome.', NULL, 'qualitative axiomatische Zusammenfassung', 4),
(693, 1020, 'A_3', 'Axiom A3', 'Bezeichnung des dritten FRZK-Axioms der dynamischen Zustandsänderung.', NULL, 'qualitative FRZK-Axiomatik', 1),
(694, 1021, 'A_3', 'Axiom A3', 'Bezeichnung des Axioms der dynamischen Zustandsänderung.', NULL, 'qualitative FRZK-Axiomatik', 1),
(695, 1021, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative axiomatische Voraussetzung.', NULL, 'qualitative axiomatische Abhängigkeit', 2),
(696, 1021, 'A_1', 'Axiom A1', 'Bezeichnung des Axioms der Existenz funktionaler Zustände.', NULL, 'qualitative FRZK-Axiomatik', 3),
(697, 1021, '\\land', 'logische Konjunktion', 'Verknüpft Axiom A1 und Axiom A2.', NULL, 'qualitative logische Verknüpfung', 4),
(698, 1021, 'A_2', 'Axiom A2', 'Bezeichnung des Axioms der funktionalen Relationierbarkeit.', NULL, 'qualitative FRZK-Axiomatik', 5),
(699, 1022, 'A_1', 'Axiom A1', 'Bezeichnung des Axioms der Existenz funktionaler Zustände.', NULL, 'qualitative FRZK-Axiomatik', 1),
(700, 1022, '\\land', 'logische Konjunktion', 'Verknüpft Axiom A1 und Axiom A2.', NULL, 'qualitative logische Verknüpfung', 2),
(701, 1022, 'A_2', 'Axiom A2', 'Bezeichnung des Axioms der funktionalen Relationierbarkeit.', NULL, 'qualitative FRZK-Axiomatik', 3),
...
(703, 1022, 'A_3', 'Axiom A3', 'Bezeichnung des Axioms der dynamischen Zustandsänderung.', NULL, 'qualitative FRZK-Axiomatik', 5),
(704, 1023, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 1),
(705, 1023, '\\land', 'logische Konjunktion', 'Verknüpft die Axiome in der qualitativen Zusammenfassung.', NULL, 'qualitative logische Verknüpfung', 2),
(706, 1023, 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 3),
(707, 1023, 'A_3', 'Axiom A3', 'Bezeichnung des dritten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 4),
(708, 1023, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet die gemeinsame qualitative Reichweite der Axiome A1 bis A3.', NULL, 'qualitative axiomatische Zusammenfassung', 5),
(709, 1024, 'A_4', 'Axiom A4', 'Bezeichnung des vierten FRZK-Axioms der funktionalen Organisationsbildung.', NULL, 'qualitative FRZK-Axiomatik', 1),
(710, 1025, 'A_4', 'Axiom A4', 'Bezeichnung des Axioms der funktionalen Organisationsbildung.', NULL, 'qualitative FRZK-Axiomatik', 1),
(711, 1025, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative axiomatische Voraussetzung.', NULL, 'qualitative axiomatische Abhängigkeit', 2),
(712, 1025, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 3),
(713, 1025, '\\land', 'logische Konjunktion', 'Verknüpft die vorausgesetzten Axiome.', NULL, 'qualitative logische Verknüpfung', 4),
(714, 1025, 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 5),
(715, 1025, 'A_3', 'Axiom A3', 'Bezeichnung des dritten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 6),
(716, 1026, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 1),
(717, 1026, '\\land', 'logische Konjunktion', 'Verknüpft die vorausgesetzten Axiome.', NULL, 'qualitative logische Verknüpfung', 2),
(718, 1026, 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 3),
(719, 1026, 'A_3', 'Axiom A3', 'Bezeichnung des dritten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 4),
...
(721, 1026, 'A_4', 'Axiom A4', 'Bezeichnung des vierten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 6),
(722, 1027, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 1),
(723, 1027, '\\land', 'logische Konjunktion', 'Verknüpft Axiom A1 bis Axiom A4.', NULL, 'qualitative logische Verknüpfung', 2),
(724, 1027, 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 3),
(725, 1027, 'A_3', 'Axiom A3', 'Bezeichnung des dritten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 4),
(726, 1027, 'A_4', 'Axiom A4', 'Bezeichnung des vierten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 5),
(727, 1027, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet die gemeinsame qualitative Reichweite der Axiome.', NULL, 'qualitative axiomatische Zusammenfassung', 6),
(728, 1028, 'A_5', 'Axiom A5', 'Bezeichnung des fünften FRZK-Axioms der funktionalen Kohärenz und Stabilisierung.', NULL, 'qualitative FRZK-Axiomatik', 1),
(729, 1029, 'A_5', 'Axiom A5', 'Bezeichnung des Axioms der funktionalen Kohärenz und Stabilisierung.', NULL, 'qualitative FRZK-Axiomatik', 1),
(730, 1029, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet die qualitative axiomatische Abhängigkeit von A5.', NULL, 'qualitative axiomatische Abhängigkeit', 2),
(731, 1029, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 3),
(732, 1029, '\\land', 'logische Konjunktion', 'Verknüpft die vorausgesetzten Axiome.', NULL, 'qualitative logische Verknüpfung', 4),
(733, 1029, 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 5),
(734, 1029, 'A_3', 'Axiom A3', 'Bezeichnung des dritten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 6),
(735, 1029, 'A_4', 'Axiom A4', 'Bezeichnung des vierten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 7),
(736, 1030, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 1),
(737, 1030, '\\land', 'logische Konjunktion', 'Verknüpft die Axiome A1 bis A4.', NULL, 'qualitative logische Verknüpfung', 2),
(738, 1030, 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 3),
(739, 1030, 'A_3', 'Axiom A3', 'Bezeichnung des dritten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 4),
(740, 1030, 'A_4', 'Axiom A4', 'Bezeichnung des vierten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 5),
...
(742, 1030, 'A_5', 'Axiom A5', 'Bezeichnung des fünften FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 7),
(743, 1031, 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 1),
(744, 1031, '\\land', 'logische Konjunktion', 'Verknüpft Axiom A1 bis Axiom A5.', NULL, 'qualitative logische Verknüpfung', 2),
(745, 1031, 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 3),
(746, 1031, 'A_3', 'Axiom A3', 'Bezeichnung des dritten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 4),
(747, 1031, 'A_4', 'Axiom A4', 'Bezeichnung des vierten FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 5),
(748, 1031, 'A_5', 'Axiom A5', 'Bezeichnung des fünften FRZK-Axioms.', NULL, 'qualitative FRZK-Axiomatik', 6),
(749, 1031, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet die gemeinsame qualitative Reichweite des vollständigen Axiomensystems.', NULL, 'qualitative axiomatische Zusammenfassung', 7),
(750, 1032, '\\mathcal{A}_{\\mathrm{FRZK}}', 'vollständiges FRZK-Axiomensystem', 'Zusammenfassende Bezeichnung der Axiome A1 bis A5.', NULL, 'qualitative FRZK-Axiomatik', 1),
(751, 1033, 'A_1', 'Axiom A1', 'Erstes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 1),
(752, 1033, '\\land', 'logische Konjunktion', 'Verknüpft mehrere axiomatische Voraussetzungen.', NULL, 'qualitative Logik', 2),
(753, 1033, 'A_2', 'Axiom A2', 'Zweites FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 3),
(754, 1033, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative Konsequenz.', NULL, 'qualitative Folgerung', 4),
(755, 1034, 'A_1', 'Axiom A1', 'Erstes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 1),
(756, 1034, '\\land', 'logische Konjunktion', 'Verknüpft mehrere axiomatische Voraussetzungen.', NULL, 'qualitative Logik', 2),
(757, 1034, 'A_2', 'Axiom A2', 'Zweites FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 3),
(758, 1034, 'A_3', 'Axiom A3', 'Drittes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 4),
(759, 1034, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative Konsequenz.', NULL, 'qualitative Folgerung', 5),
(760, 1035, 'A_1', 'Axiom A1', 'Erstes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 1),
(761, 1035, '\\land', 'logische Konjunktion', 'Verknüpft mehrere axiomatische Voraussetzungen.', NULL, 'qualitative Logik', 2),
(762, 1035, 'A_2', 'Axiom A2', 'Zweites FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 3),
(763, 1035, 'A_3', 'Axiom A3', 'Drittes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 4),
(764, 1035, 'A_4', 'Axiom A4', 'Viertes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 5),
(765, 1035, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative Konsequenz.', NULL, 'qualitative Folgerung', 6),
(766, 1036, 'A_4', 'Axiom A4', 'Viertes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 1),
(767, 1036, '\\land', 'logische Konjunktion', 'Verknüpft mehrere axiomatische Voraussetzungen.', NULL, 'qualitative Logik', 2),
(768, 1036, 'A_5', 'Axiom A5', 'Fünftes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 3),
(769, 1036, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative Konsequenz.', NULL, 'qualitative Folgerung', 4),
(770, 1037, 'A_3', 'Axiom A3', 'Drittes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 1),
(771, 1037, '\\land', 'logische Konjunktion', 'Verknüpft mehrere axiomatische Voraussetzungen.', NULL, 'qualitative Logik', 2),
(772, 1037, 'A_5', 'Axiom A5', 'Fünftes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 3),
(773, 1037, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative Konsequenz.', NULL, 'qualitative Folgerung', 4),
(774, 1038, 'A_1', 'Axiom A1', 'Erstes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 1),
(775, 1038, '\\land', 'logische Konjunktion', 'Verknüpft mehrere axiomatische Voraussetzungen.', NULL, 'qualitative Logik', 2),
(776, 1038, 'A_2', 'Axiom A2', 'Zweites FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 3),
(777, 1038, 'A_4', 'Axiom A4', 'Viertes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 4),
(778, 1038, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative Konsequenz.', NULL, 'qualitative Folgerung', 5),
(779, 1039, 'A_1', 'Axiom A1', 'Erstes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 1),
(780, 1039, '\\land', 'logische Konjunktion', 'Verknüpft mehrere axiomatische Voraussetzungen.', NULL, 'qualitative Logik', 2),
(781, 1039, 'A_2', 'Axiom A2', 'Zweites FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 3),
(782, 1039, 'A_3', 'Axiom A3', 'Drittes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 4),
(783, 1039, 'A_4', 'Axiom A4', 'Viertes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 5),
(784, 1039, 'A_5', 'Axiom A5', 'Fünftes FRZK-Axiom.', NULL, 'qualitative FRZK-Axiomatik', 6),
(785, 1039, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative Konsequenz.', NULL, 'qualitative Folgerung', 7),
(786, 1040, '\\land', 'logische Konjunktion', 'Verknüpft Raum- und Zeitrekonstruktion.', NULL, 'qualitative Logik', 1),
(787, 1040, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative Konsequenz.', NULL, 'qualitative Folgerung', 2),
(788, 1041, '\\mathcal{A}_{\\mathrm{FRZK}}', 'vollständiges FRZK-Axiomensystem', 'Zusammenfassende Bezeichnung der Axiome A1 bis A5.', NULL, 'qualitative FRZK-Axiomatik', 1),
(789, 1041, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet eine qualitative Konsequenz.', NULL, 'qualitative Folgerung', 2),
...
(791, 1043, '\\mathcal{A}_{\\mathrm{FRZK}}', 'vollständiges FRZK-Axiomensystem', 'Zusammenfassende Bezeichnung der Axiome A1 bis A5.', NULL, 'qualitative FRZK-Axiomatik', 1),
(792, 1043, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet die qualitative Zusammenfassung der Konsequenzen.', NULL, 'qualitative Folgerung', 2),
(793, 1044, '\\mathcal{A}_{\\mathrm{FRZK}}', 'FRZK-Axiomensystem', 'Zusammenfassende Bezeichnung der Axiome A1 bis A5.', NULL, 'qualitative FRZK-Axiomatik', 1),
(794, 1045, '\\forall', 'Allquantor', 'Bezieht die Minimalitätsforderung auf jedes Axiom des Systems.', NULL, 'qualitative Logik', 1),
(795, 1045, 'A_i', 'beliebiges FRZK-Axiom', 'Beliebiges Axiom aus dem vollständigen Axiomensystem.', NULL, 'qualitative FRZK-Axiomatik', 2),
(796, 1045, '\\setminus', 'Mengendifferenzzeichen', 'Kennzeichnet das qualitative Entfernen eines Axioms aus der Sammelbezeichnung.', NULL, 'qualitative Metasprache', 3),
(797, 1046, '\\mathfrak{M}_{\\neg A_1}', 'Gegenmodell zu A1', 'Qualitative Konfiguration ohne Axiom A1.', NULL, 'qualitative Modellbetrachtung', 1),
(798, 1047, '\\mathfrak{M}_{\\neg A_2}', 'Gegenmodell zu A2', 'Qualitative Konfiguration ohne Axiom A2.', NULL, 'qualitative Modellbetrachtung', 1),
(799, 1048, '\\mathfrak{M}_{\\neg A_3}', 'Gegenmodell zu A3', 'Qualitative Konfiguration ohne Axiom A3.', NULL, 'qualitative Modellbetrachtung', 1),
(800, 1049, '\\mathfrak{M}_{\\neg A_4}', 'Gegenmodell zu A4', 'Qualitative Konfiguration ohne Axiom A4.', NULL, 'qualitative Modellbetrachtung', 1),
(801, 1050, '\\mathfrak{M}_{\\neg A_5}', 'Gegenmodell zu A5', 'Qualitative Konfiguration ohne Axiom A5.', NULL, 'qualitative Modellbetrachtung', 1),
...
(803, 1052, '\\prec', 'begriffliche Aufbauordnung', 'Kennzeichnet Vorrang und Aufbauordnung ohne logische Implikation.', NULL, 'qualitative Theoriearchitektur', 1),
(804, 1053, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet die methodische Konsequenz qualitativer Gegenmodelle.', NULL, 'qualitative Metasprache', 1),
(805, 1054, '+', 'methodische Kombination', 'Verknüpft formale Modelle und präzise Semantik als Voraussetzungen.', NULL, 'qualitative Metasprache', 1),
(806, 1055, '\\exists', 'Existenzquantor', 'Bezeichnet die qualitative Forderung, dass kein widersprechendes Axiompaar existiert.', NULL, 'qualitative Logik', 1),
(807, 1056, '\\models_{\\mathrm{qual}}', 'qualitative Erfüllungsrelation', 'Kennzeichnet qualitative gemeinsame Interpretierbarkeit.', NULL, 'qualitative Modellbetrachtung', 1),
(808, 1057, '\\exists', 'Existenzquantor', 'Kennzeichnet die qualitative Existenz eines Erfüllbarkeitsmodells.', NULL, 'qualitative Modellbetrachtung', 1),
...
(810, 1059, '\\begin{array}{c|l}', 'tabellarische Darstellung', 'Ordnet jedem entfernten Axiom den Funktionsverlust zu.', NULL, 'qualitative Axiomenprüfung', 1),
(811, 1060, '\\mathcal{A}_{\\mathrm{FRZK}}', 'FRZK-Axiomensystem', 'Vollständiges qualitatives Axiomensystem.', NULL, 'qualitative FRZK-Axiomatik', 1),
(812, 1061, '\\forall', 'Allquantor', 'Bezieht die Aussage auf jedes Axiom.', NULL, 'qualitative Logik', 1),
(813, 1062, '\\mathcal{A}_{\\mathrm{FRZK}}', 'FRZK-Axiomensystem', 'Vollständiges qualitatives Axiomensystem.', NULL, 'qualitative FRZK-Axiomatik', 1),
(814, 1063, '\\mathcal{A}_{\\mathrm{FRZK}}', 'FRZK-Axiomensystem', 'Vollständiges qualitatives Axiomensystem.', NULL, 'qualitative FRZK-Axiomatik', 1),
(815, 1063, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet die zusammenfassende qualitative Bewertung.', NULL, 'qualitative Folgerung', 2),
(823, 1064, '\\longrightarrow', 'gerichteter Rekonstruktionspfeil', 'Kennzeichnet die zulässige Richtung vom qualitativen Bedeutungsgehalt zur mathematischen Darstellung.', NULL, 'wissenschaftstheoretische Übergangsregel', 1),
(824, 1065, '\\prec', 'begriffliche Vorrangordnung', 'Kennzeichnet den Vorrang funktionaler Relation vor geometrischer Struktur.', NULL, 'qualitative Rekonstruktionsordnung', 1),
(825, 1066, '\\prec', 'begriffliche Vorrangordnung', 'Kennzeichnet den Vorrang funktionaler Transformation vor einem Zeitparameter.', NULL, 'qualitative Rekonstruktionsordnung', 1),
(826, 1067, '\\longrightarrow', 'gerichteter Rekonstruktionspfeil', 'Kennzeichnet die schrittweise Rekonstruktion von Relationen über Strukturen zu Objekten.', NULL, 'qualitative Rekonstruktionsordnung', 1),
(827, 1068, '\\Longrightarrow', 'qualitativer Rekonstruktionspfeil', 'Kennzeichnet die Ableitungsrichtung von den Axiomen zur rekonstruierten Mathematik.', NULL, 'wissenschaftstheoretische Übergangsregel', 1),
(828, 1069, '\\Longrightarrow', 'kritisch markierte Interpretationsrichtung', 'Kennzeichnet eine methodisch nicht hinreichende bloße Interpretation vorhandener Mathematik als FRZK.', NULL, 'wissenschaftstheoretische Negativregel', 1),
(829, 1070, '\\text{so viel Mathematik wie notwendig, so wenig Mathematik wie möglich.}', 'mathematisches Minimalprinzip', 'Verbindliches Prinzip zur Begrenzung mathematischer Vorannahmen.', NULL, 'wissenschaftstheoretische Übergangsregel', 1),
(830, 1078, '\\not\\Longrightarrow', 'qualitativer Nichtfolgerungspfeil', 'Kennzeichnet, dass quantitative Nullsetzung keine funktionale Vernichtung erzwingt.', NULL, 'qualitative FRZK-Rekonstruktion', 1),
(831, 1079, '0', 'Nullskalar', 'Additives neutrales Element des Skalarkörpers.', NULL, 'Skalarkörper', 1),
(832, 1079, '\\mathbf{v}', 'Vektor', 'Beliebiger klassischer Vektor.', NULL, 'klassischer Vektorraum', 2),
(833, 1079, '\\mathbf{0}', 'Nullvektor', 'Additives neutrales Element des Vektorraums ohne definierte Richtung.', NULL, 'klassischer Vektorraum', 3),
(834, 1080, '\\Longrightarrow', 'qualitativer Folgerungspfeil', 'Kennzeichnet die qualitative Beziehung zwischen Orientierung und Persistenz.', NULL, 'qualitative FRZK-Rekonstruktion', 1),
(835, 1081, '\\not\\Longrightarrow', 'qualitativer Nichtfolgerungspfeil', 'Kennzeichnet, dass Persistenz keinen konstanten Betrag erzwingt.', NULL, 'qualitative FRZK-Rekonstruktion', 1),
(836, 1082, '\\neq', 'Ungleichheitszeichen', 'Kennzeichnet die Nichtidentität von Aktivität und funktionaler Existenz.', NULL, 'qualitative FRZK-Rekonstruktion', 1),
(837, 1083, '\\not\\Longrightarrow', 'qualitativer Nichtfolgerungspfeil', 'Kennzeichnet, dass Nullaktivität keine funktionale Nichtexistenz erzwingt.', NULL, 'qualitative FRZK-Rekonstruktion', 1);
...
(1, 'definition', 398, 150, '', 'Mac Lane dient als struktureller Forschungsanschluss. Die qualitative Definition von Funktionalität ist originäre FRZK-Eigenleistung.'),
(2, 'definition', 399, 149, '', 'Suppes stützt die methodische Rolle primitiver Begriffe. Die konkrete Definition von Unterscheidbarkeit ist originär.'),
(3, 'definition', 400, 150, '', 'Mac Lane dient als Anschluss zur relationalen und strukturellen Perspektive moderner Mathematik.'),
(4, 'definition', 401, 150, '', 'Mac Lane dient als Anschluss zur Rolle von Transformationen; die vor-mathematische qualitative Definition ist originär.'),
(5, 'definition', 402, 151, '', 'Quines Begriff ontologischer Verpflichtung stützt den bewussten Ausschluss räumlicher und objekthafter Voraussetzungen.'),
(6, 'definition', 403, 151, '', 'Quine stützt die methodische Zurückhaltung gegenüber bereits mathematisch reichhaltigen Grundbegriffen.'),
(7, 'axiom', 27, 156, 'historical_context', 'Spencer-Brown dient als Forschungsanschluss für die grundlegende Rolle der Unterscheidung. Axiom A1 bleibt eine originäre FRZK-Setzung und übernimmt weder Kalkül noch Markierungsoperation.'),
(8, 'axiom', 28, 150, 'supporting_source', 'Mac Lane dient als struktureller Forschungsanschluss für die Bedeutung von Beziehungen. Axiom A2 ist keine Übernahme kategorialer Mathematik, sondern eine originäre qualitative FRZK-Setzung.'),
(9, 'definition', 412, 150, 'supporting_source', 'Die Quelle stützt den strukturellen Kontext. Die qualitative Definition des funktionalen Zusammenhangs ist originäre FRZK-Eigenleistung.'),
(10, 'axiom', 30, 12, 'supporting_source', 'Haken dient als Forschungsanschluss für emergente Ordnungsbildung. Axiom A4 übernimmt kein konkretes synergetisches Modell.'),
(11, 'axiom', 30, 13, 'supporting_source', 'Prigogine und Stengers dienen als Forschungsanschluss für dissipative Strukturbildung. Axiom A4 setzt keine Thermodynamik voraus.'),
(12, 'axiom', 30, 14, 'supporting_source', 'Holland dient als Forschungsanschluss für globale Muster aus lokalen Interaktionen. Axiom A4 setzt keine Agentenpopulation voraus.'),
(13, 'definition', 414, 12, 'supporting_source', 'Forschungsanschluss zur Möglichkeit emergenter Organisationsformen. Die Definition ist originäre FRZK-Eigenleistung.'),
(14, 'definition', 414, 13, 'supporting_source', 'Forschungsanschluss zur Strukturbildung unter Dynamik. Keine thermodynamische Definition wird übernommen.'),
(15, 'definition', 414, 14, 'supporting_source', 'Forschungsanschluss zu komplexer adaptiver Organisationsbildung. Die qualitative Definition bleibt allgemeiner.'),
(16, 'axiom', 31, 12, 'supporting_source', 'Haken dient als Forschungsanschluss für dynamische Ordnungsbildung und Stabilisierung. Axiom A5 übernimmt kein konkretes synergetisches Modell.'),
(17, 'axiom', 31, 13, 'supporting_source', 'Prigogine und Stengers dienen als Forschungsanschluss für den Erhalt dissipativer Strukturen. Axiom A5 setzt keine thermodynamischen Randbedingungen voraus.'),
(18, 'axiom', 31, 157, 'supporting_source', 'Maturana und Varela dienen als Forschungsanschluss für organisatorische Reproduktion. Axiom A5 übernimmt keine biologische Autopoiesisdefinition.'),
(19, 'definition', 415, 157, 'supporting_source', 'Forschungsanschluss zur Reproduktion organisatorischer Zusammenhänge. Die qualitative FRZK-Definition funktionaler Kohärenz ist originär.'),
(20, 'definition', 416, 12, 'supporting_source', 'Forschungsanschluss zu dynamischer Stabilisierung. Die qualitative Definition funktionaler Stabilisierung bleibt allgemeiner als konkrete synergetische Stabilitätsmodelle.'),
(21, 'definition', 416, 13, 'supporting_source', 'Forschungsanschluss zur Aufrechterhaltung geordneter Strukturen unter fortlaufenden Prozessen. Keine thermodynamische Definition wird übernommen.'),
(22, 'definition', 417, 12, 'supporting_source', 'Haken dient als Forschungsanschluss für Selbstorganisation und dynamische Ordnungsbildung. Die FRZK-Sammeldefinition ist originär.'),
(23, 'definition', 417, 13, 'supporting_source', 'Prigogine und Stengers dienen als Forschungsanschluss für dynamische Strukturbildung. Die FRZK-Sammeldefinition bleibt allgemeiner.'),
(24, 'definition', 417, 157, 'supporting_source', 'Maturana und Varela dienen als Forschungsanschluss für prozessuale Identität und organisatorische Reproduktion. Die FRZK-Sammeldefinition ist keine Autopoiesisdefinition.'),
(25, 'definition', 418, 158, 'supporting_source', 'Enderton dient als formaler Referenzrahmen für Modelle und Gegenmodelle. Die qualitative Hilfsdefinition ist originär.'),
(26, 'definition', 419, 149, 'supporting_source', 'Suppes dient als methodischer Anschluss zur axiomatischen Theoriebildung.'),
(27, 'definition', 420, 158, 'supporting_source', 'Enderton stützt den formalen Zielbegriff modelltheoretischer Unabhängigkeit.'),
(28, 'definition', 420, 159, 'supporting_source', 'Mendelson stützt die Abgrenzung formaler Unabhängigkeit von qualitativer Vorprüfung.'),
(29, 'definition', 421, 158, 'supporting_source', 'Enderton stützt die semantische Einordnung von Erfüllbarkeit.'),
(30, 'proposition', 21, 149, 'supporting_source', 'Suppes dient als methodischer Anschluss zur Prüfung axiomatischer Grundannahmen.'),
(31, 'proposition', 22, 158, 'supporting_source', 'Enderton dient als formaler Referenzrahmen für Unabhängigkeitsprüfungen.'),
(32, 'proposition', 22, 159, 'supporting_source', 'Mendelson dient als zusätzlicher Referenzrahmen zur Axiomenunabhängigkeit.'),
(33, 'proposition', 23, 158, 'supporting_source', 'Enderton stützt die Unterscheidung zwischen qualitativer und formaler Erfüllbarkeit.'),
(34, 'proposition', 23, 159, 'supporting_source', 'Mendelson stützt die Abgrenzung semantischer Erfüllbarkeit und syntaktischer Konsistenz.'),
(45, 'definition', 422, 147, 'supporting_source', 'Tarski dient als methodischer Anschluss für die Trennung semantischer und formaler Ebenen.'),
(46, 'definition', 422, 151, 'supporting_source', 'Quine dient als Anschluss für die ontologischen Verpflichtungen formaler Sprachen.'),
(47, 'definition', 423, 150, 'supporting_source', 'Mac Lane dient als struktureller Forschungsanschluss für den Vorrang von Relationen und Transformationen.'),
(48, 'definition', 424, 149, 'supporting_source', 'Suppes dient als methodischer Anschluss für den schrittweisen Aufbau axiomatischer Theorien.'),
(49, 'definition', 424, 158, 'supporting_source', 'Enderton dient als Referenzrahmen für den späteren Übergang zu formaler Sprache und Semantik.'),
(50, 'definition', 425, 151, 'supporting_source', 'Quine stützt die Zurückhaltung gegenüber unnötigen ontologischen Verpflichtungen.'),
(51, 'proposition', 24, 147, 'supporting_source', 'Tarski dient als methodischer Referenzrahmen für den Vorrang präziser Semantik.'),
(52, 'proposition', 25, 150, 'supporting_source', 'Mac Lane dient als Forschungsanschluss für relationale und strukturelle Mathematik.'),
(53, 'proposition', 26, 151, 'supporting_source', 'Quine stützt das Prinzip ontologischer Sparsamkeit.'),
(54, 'proposition', 26, 159, 'supporting_source', 'Mendelson dient als Referenzmaßstab für die spätere formale Präzision.'),
(55, 'definition', 430, 160, 'supporting_source', 'Strang stützt die Abgrenzung zur klassischen Nullvektorbehandlung.'),
(56, 'definition', 430, 161, 'supporting_source', 'Golub und Van Loan stützen die klassische mathematische Abgrenzung.'),
(57, 'definition', 430, 162, 'supporting_source', 'LaValle dient als technischer Anschluss für getrennte Zustands- und Orientierungsinformation.'),
(58, 'definition', 430, 163, 'supporting_source', 'Craig dient als technischer Anschluss für getrennte Lage- und Bewegungsgrößen.'),
(59, 'definition', 432, 164, 'supporting_source', 'Kalman dient als Forschungsanschluss für interne Zustandsrekonstruktion.'),
(60, 'definition', 432, 165, 'supporting_source', 'Simon dient als Forschungsanschluss für Zustandsabschätzung und interne Zustandsinformation.'),
(61, 'proposition', 30, 160, 'supporting_source', 'Die klassische Mathematik bleibt unverändert; die Proposition betrifft einen erweiterten FRZK-Zustand.'),
(62, 'proposition', 30, 162, 'supporting_source', 'Technischer Anschluss für getrennte Zustandskomponenten.'),
(63, 'proposition', 32, 164, 'supporting_source', 'Kalman dient als methodischer Anschluss für nicht unmittelbar beobachtbare interne Zustände.'),
(64, 'proposition', 32, 165, 'supporting_source', 'Simon dient als technischer Anschluss für rekonstruierbare Zustandsinformationen.');
...
(21, 'Prop. 3.3.8.1', 57, 'Qualitative funktionale Minimalität', 'Das Axiomensystem A1 bis A5 ist auf der qualitativen Ebene funktional minimal, weil die Entfernung jedes einzelnen Axioms eine eigenständige funktionale Möglichkeit beseitigt.', '\\mathcal{A}_{\\mathrm{FRZK}}\\text{ ist qualitativ funktional minimal.}', '\\mathcal{A}_{\\mathrm{FRZK}}\\text{ ist qualitativ funktional minimal.}', 'Die qualitativen Gegenmodelle zu A1 bis A5 zeigen jeweils den Verlust von Unterscheidbarkeit, Relationierbarkeit, Transformierbarkeit, Organisationsbildung beziehungsweise Kohärenz und Stabilisierung.', 'A1,A2,A3,A4,A5', 'review', 73),
(22, 'Prop. 3.3.8.2', 57, 'Schwache qualitative Unabhängigkeit', 'Jedes Axiom A1 bis A5 besitzt einen eigenständigen funktionalen Gehalt, der durch die übrigen Axiome auf der qualitativen Ebene nicht vollständig ersetzt wird.', '\\forall A_i\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad A_i\\text{ besitzt einen eigenständigen funktionalen Gehalt.}', '\\forall A_i\\in\\mathcal{A}_{\\mathrm{FRZK}}:\\quad A_i\\text{ besitzt einen eigenständigen funktionalen Gehalt.}', 'Für jedes Axiom wird ein qualitatives Gegenmodell beziehungsweise ein spezifischer Funktionsverlust bei seiner Entfernung beschrieben.', 'A1,A2,A3,A4,A5', 'review', 73),
(23, 'Prop. 3.3.8.3', 57, 'Qualitative gemeinsame Erfüllbarkeit', 'Das vollständige FRZK-Axiomensystem ist qualitativ gemeinsam erfüllbar, weil eine begrifflich widerspruchsfreie Konfiguration beschrieben werden kann, in der alle fünf Axiome gelten.', '\\mathcal{A}_{\\mathrm{FRZK}}\\text{ ist qualitativ gemeinsam erfüllbar.}', '\\mathcal{A}_{\\mathrm{FRZK}}\\text{ ist qualitativ gemeinsam erfüllbar.}', 'Ein qualitatives Modell mit unterscheidbaren, relationierbaren und transformierbaren Konfigurationen, organisationsbildenden Mustern und deren Erhalt unter weiterer Transformation erfüllt alle fünf Axiome.', 'A1,A2,A3,A4,A5', 'review', 73),
(24, 'Prop. 3.3.9.1', 58, 'Vorrang der qualitativen Semantik', 'Die mathematische Rekonstruktion des FRZK ist nur dann zulässig, wenn der qualitative Bedeutungsgehalt der Axiome und Definitionen erhalten bleibt.', '\\text{Semantik}\\longrightarrow\\text{Mathematik}', '\\text{Semantik}\\longrightarrow\\text{Mathematik}', 'Die mathematische Ebene besitzt beschreibende und rekonstruierende, aber keine unbegründet ontologieerzeugende Funktion.', 'A1,A2,A3,A4,A5', 'review', 75),
(25, 'Prop. 3.3.9.2', 58, 'Vorrang relationaler und transformatorischer Strukturen', 'Relationen und Transformationen müssen mathematisch vor Geometrie, Raumkoordinaten und Zeitparametern rekonstruiert werden.', '\\text{Relation}\\prec\\text{Geometrie}\\quad\\land\\quad\\text{Transformation}\\prec\\text{Zeitparameter}', '\\text{Relation}\\prec\\text{Geometrie}\\quad\\land\\quad\\text{Transformation}\\prec\\text{Zeitparameter}', 'Axiom A2 und Axiom A3 führen qualitative Relationierbarkeit und Transformierbarkeit ein, ohne Raum oder Zeit vorauszusetzen.', 'A2,A3', 'review', 75),
(26, 'Prop. 3.3.9.3', 58, 'Minimalität der mathematischen Einführung', 'Jede mathematische Struktur in Kapitel 3.4 muss durch einen expliziten funktionalen Rekonstruktionsbedarf begründet sein.', '\\text{so viel Mathematik wie notwendig, so wenig Mathematik wie möglich}', '\\text{so viel Mathematik wie notwendig, so wenig Mathematik wie möglich}', 'Folgt aus Bedeutungsinvarianz, ontologischer Zurückhaltung und dem Rekonstruktionsprinzip.', 'A1,A2,A3,A4,A5', 'review', 75),
(30, 'Prop. 3.3.9.4', 58, 'Quantitative Nullsetzung ist keine funktionale Vernichtung', 'Die Nullsetzung der quantitativen Zustandskomponente löscht eine davon getrennt gespeicherte funktionale Orientierung nicht notwendig.', '\\text{quantitative Auslöschung}\\not\\Longrightarrow\\text{funktionale Vernichtung}', '\\text{quantitative Auslöschung}\\not\\Longrightarrow\\text{funktionale Vernichtung}', 'Folgt aus der Trennung von quantitativer Repräsentation und funktionaler Zustandsidentität.', 'A1,A3,A5', 'review', 75),
(31, 'Prop. 3.3.9.5', 58, 'Persistenz ohne konstanten Betrag', 'Funktionale Persistenz kann bestehen, obwohl der quantitative Betrag eines Zustandes variiert oder vorübergehend Null ist.', '\\text{Persistenz}\\not\\Longrightarrow\\text{konstanter Betrag}', '\\text{Persistenz}\\not\\Longrightarrow\\text{konstanter Betrag}', 'Folgt aus der Definition funktionaler Persistenz.', 'A3,A5', 'review', 75),
(32, 'Prop. 3.3.9.6', 58, 'Nullaktivität ist keine funktionale Nichtexistenz', 'Eine quantitative Nullaktivität impliziert nicht notwendig die funktionale Nichtexistenz eines persistenten Zustandes.', '\\text{quantitative Nullaktivität}\\not\\Longrightarrow\\text{funktionale Nichtexistenz}', '\\text{quantitative Nullaktivität}\\not\\Longrightarrow\\text{funktionale Nichtexistenz}', 'Folgt aus funktionaler Persistenz und funktionalem Gedächtnis.', 'A1,A4,A5', 'review', 75),
(33, 'Prop. 3.3.A', 22, 'Redaktioneller Abschluss von Kapitel 3.3', 'Die prämathematische FRZK-Axiomatik ist abgeschlossen. Jede mathematische Struktur in Kapitel 3.4 muss aus den in Kapitel 3.3 eingeführten funktionalen Begriffen, Axiomen und Übergangsregeln rekonstruiert werden. Die klassische Vektoralgebra bleibt unverändert; latente Orientierung, Persistenz und funktionales Gedächtnis gehören zum erweiterten funktionalen Zustandsbegriff.', '\\text{Abschluss Kapitel 3.3}\\Longrightarrow\\text{mathematische Rekonstruktion ab Kapitel 3.4}', '\\text{Abschluss Kapitel 3.3}\\Longrightarrow\\text{mathematische Rekonstruktion ab Kapitel 3.4}', 'Zusammenfassung der in Abschnitt 3.3.9 formulierten Übergangsregeln und der redaktionellen Schlussfolgerung für Kapitel 3.4.', 'A1,A2,A3,A4,A5', '', 76);
...
('last_completed_chapter', '3.3', '2026-07-16 18:22:06'),
('last_completed_section', '3.4', '2026-07-12 11:14:28'),
('last_edited_section', '3.3', '2026-07-16 18:22:06'),
('last_repository_revision', 'RKB-2026-07-16-K3.3-FINAL-V1', '2026-07-16 18:22:06'),
('next_chapter', '3.4', '2026-07-16 18:22:06'),
('next_citation_number', '96', '2026-07-16 18:13:18'),
('next_equation_number', '3.340', '2026-07-16 18:13:18');
...
(46, 63, 'K3.3.0_PARENT_REVISION', 'passed', 'RKB-2026-07-15-K3.2.12-NEUFASSUNG-V5', 'RKB-2026-07-15-K3.2.12-NEUFASSUNG-V5', 'Die verbindliche Parent-Revision für Abschnitt 3.3.0 ist vorhanden.', '2026-07-16 04:03:02');
...
(237, 63, 49, 'rewritten', 'section', '3.3.0', 'Abschnitt 3.3.0 wurde vollständig als Einleitung zur qualitativen FRZK-Axiomatik neu gefasst.', 'Frühere oder abweichende Fassungen von Kapitel 3.3.', 'Klare Trennung zwischen mathematischem Forschungsstand in 3.2, qualitativer Axiomatik in 3.3 und mathematischer Rekonstruktion in 3.4.', '2026-07-16 04:03:02'),
(238, 63, 49, 'source_added', 'sources', '[82]', 'Alfred Tarskis Werk zur Logik und Methodologie deduktiver Wissenschaften wurde als neue Quelle [82] registriert.', NULL, 'Quelle [82] einschließlich Autor, Annotation und erster Quellenverwendung.', '2026-07-16 04:03:02'),
(239, 63, 49, 'source_reused', 'source_usage', '[7], [8], [24]', 'Die bestehenden Quellen Euklid [7], Hilbert [8] und Zermelo [24] wurden für die historische und methodische Einordnung der Axiomatik wiederverwendet.', NULL, 'Drei geprüfte Wiederverwendungen in source_usage.', '2026-07-16 04:03:02'),
(240, 63, 49, 'equation_added', 'equations', '(3.275)', 'Die konzeptionelle Entwicklungsrichtung der FRZK-Axiomatik wurde als Gleichung (3.275) mit vollständigem Word-LaTeX registriert.', NULL, 'Unterscheidbarkeit → Relationierbarkeit → Transformation → Organisation → Kohärenz.', '2026-07-16 04:03:02'),
(241, 63, 49, 'symbol_added', 'symbols', '\\Longrightarrow', 'Der qualitative Folgerungspfeil wurde für Abschnitt 3.3.0 im Symbolregister registriert.', NULL, 'Abschnittssymbol mit Bezug zu Gleichung (3.275).', '2026-07-16 04:03:02'),
(242, 63, 49, 'status_changed', 'section', '3.3.0', 'Der Abschnitt wurde nach der Neufassung auf den Status review gesetzt.', 'planned/draft oder früherer Status', 'review', '2026-07-16 04:03:02'),
(243, 64, 50, 'created', 'section', '3.3.1', 'Abschnitt 3.3.1 wurde als wissenschaftstheoretische Bestimmung der primitiven FRZK-Begriffe neu angelegt.', NULL, 'Primitive Begriffe und wissenschaftstheoretische Ausgangspunkte.', '2026-07-16 04:48:15'),
(244, 64, 50, 'source_reused', 'source_usage', '[82]', 'Tarski [82] wurde zur methodischen Einordnung primitiver Ausdrücke wiederverwendet.', NULL, 'Eine geprüfte Wiederverwendung.', '2026-07-16 04:48:15'),
(245, 64, 50, 'source_added', 'sources', '[83]–[85]', 'Suppes [83], Mac Lane [84] und Quine [85] wurden als neue Quellen registriert.', NULL, 'Drei neue Quellen einschließlich Autoren, Annotationen und source_usage.', '2026-07-16 04:48:15'),
(246, 64, 50, 'definition_added', 'definitions', 'Def. 3.3.1.1–Def. 3.3.1.6', 'Die sechs primitiven qualitativen FRZK-Begriffe wurden vollständig registriert.', NULL, 'Funktionalität, Unterscheidbarkeit, Relationierbarkeit, Transformation, Organisation und Kohärenz.', '2026-07-16 04:48:15'),
(247, 64, 50, 'equation_added', 'equations', '(3.276)', 'Die begriffliche Entwicklungsrichtung der primitiven FRZK-Begriffe wurde als Gleichung (3.276) registriert.', NULL, 'Funktionalität → Unterscheidbarkeit → Relationierbarkeit → Transformation → Organisation → Kohärenz.', '2026-07-16 04:48:15'),
(248, 64, 50, 'symbol_added', 'symbols', '\\Longrightarrow', 'Der qualitative Folgerungs- und Ordnungspfeil wurde abschnittsspezifisch registriert.', NULL, 'Symbolbezug zu Gleichung (3.276).', '2026-07-16 04:48:15'),
(249, 64, 50, 'status_changed', 'section', '3.3.1', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned oder nicht vorhanden', 'review', '2026-07-16 04:48:15'),
(250, 65, 50, 'rewritten', 'section', '3.3.1', 'Abschnitt 3.3.1 wurde vollständig als wissenschaftstheoretische Bestimmung der primitiven FRZK-Begriffe neu gefasst.', 'Frühere oder unvollständige Repository-Fassung.', 'Primitive Begriffe und wissenschaftstheoretische Ausgangspunkte.', '2026-07-16 05:29:53'),
(251, 65, 50, 'source_reused', 'source_usage', '[82]', 'Tarski [82] wurde zur methodischen Einordnung primitiver Ausdrücke wiederverwendet.', NULL, 'Eine geprüfte Wiederverwendung.', '2026-07-16 05:29:53'),
(252, 65, 50, 'source_added', 'sources', '[83]–[85]', 'Suppes [83], Mac Lane [84] und Quine [85] wurden einschließlich Autoren, Annotationen und Quellenverwendungen registriert.', NULL, 'Drei neue Quellen.', '2026-07-16 05:29:53'),
(253, 65, 50, 'definition_added', 'definitions', 'Def. 3.3.1.1–Def. 3.3.1.6', 'Die sechs primitiven qualitativen FRZK-Begriffe wurden vollständig registriert.', NULL, 'Funktionalität, Unterscheidbarkeit, Relationierbarkeit, Transformation, Organisation und Kohärenz.', '2026-07-16 05:29:53'),
(254, 65, 50, '', 'object_source_links', 'Definitionen 3.3.1', 'Die Definitionsobjekte wurden mit ihren methodischen und theoretischen Forschungsanschlüssen verknüpft.', NULL, 'Sechs Definition-Quelle-Verknüpfungen.', '2026-07-16 05:29:53'),
(255, 65, 50, 'equation_added', 'equations', '(3.276)', 'Die begriffliche Entwicklungsrichtung der primitiven FRZK-Begriffe wurde als Gleichung (3.276) registriert.', NULL, 'Funktionalität → Unterscheidbarkeit → Relationierbarkeit → Transformation → Organisation → Kohärenz.', '2026-07-16 05:29:53'),
(256, 65, 50, 'symbol_added', 'symbols', '\\Longrightarrow', 'Der qualitative Folgerungs- und Ordnungspfeil wurde abschnittsspezifisch registriert.', NULL, 'Symbolbezug zu Gleichung (3.276).', '2026-07-16 05:29:53'),
(257, 65, 50, 'status_changed', 'section', '3.3.1', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned, draft oder frühere Fassung', 'review', '2026-07-16 05:29:53'),
(258, 67, 51, 'rewritten', 'section', '3.3.2', 'Abschnitt 3.3.2 wurde vollständig als originäre Formulierung und wissenschaftstheoretische Begründung von Axiom A1 neu gefasst.', 'Frühere Abschnittsstruktur beziehungsweise geplanter Altinhalt.', 'Axiom A1 – Existenz funktionaler Zustände.', '2026-07-16 05:46:46'),
(259, 67, 51, 'source_added', 'sources', '[86]', 'George Spencer-Brown: Laws of Form wurde als neue Quelle [86] einschließlich Autor, Annotation und Erstverwendung registriert.', NULL, 'Quelle [86], Autorverknüpfung, Annotation, source_usage und object_source_link.', '2026-07-16 05:46:46'),
(260, 67, 51, 'definition_added', 'definitions', 'Def. 3.3.2.1', 'Der qualitative Begriff des funktionalen Zustandes wurde klar von einem mathematischen Zustand beziehungsweise Zustandsraumelement abgegrenzt.', NULL, 'Def. 3.3.2.1 Funktionaler Zustand.', '2026-07-16 05:46:46'),
(261, 67, 51, 'axiom_added', 'axioms', 'A1', 'Axiom A1 wurde als originäres FRZK-Axiom einschließlich Motivation, Konsistenzhinweis, Unabhängigkeitshinweis und Operationalisierungsnotiz registriert.', NULL, 'A1 – Existenz funktionaler Zustände.', '2026-07-16 05:46:46'),
(262, 67, 51, 'equation_added', 'equations', '(3.277)', 'Die komprimierte axiomatische Schreibweise von Axiom A1 wurde als Gleichung (3.277) registriert.', NULL, 'A_1: Mindestens ein funktional unterscheidbarer Zustand ist möglich.', '2026-07-16 05:46:46'),
(263, 67, 51, 'equation_added', 'equations', '(3.278)', 'Die qualitative Abhängigkeit der späteren Axiome von Axiom A1 wurde als Gleichung (3.278) registriert.', NULL, 'Negation von A1 impliziert qualitativ den Entfall der Anwendungsgrundlage von A2 bis A5.', '2026-07-16 05:46:46'),
(264, 67, 51, 'symbol_added', 'symbols', 'A_1, \\neg, \\lor', 'Die abschnittsspezifischen Symbole wurden einschließlich Definitionen und Gleichungsbezügen registriert.', NULL, 'Drei Abschnittssymbole und acht Gleichungssymbol-Zuordnungen.', '2026-07-16 05:46:46'),
(265, 67, 51, 'status_changed', 'section', '3.3.2', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned oder früherer Status', 'review', '2026-07-16 05:46:46'),
(266, 68, 52, 'rewritten', 'section', '3.3.3', 'Abschnitt 3.3.3 wurde vollständig als Formulierung und Begründung von Axiom A2 neu gefasst.', 'Axiom A1 – Prinzip der funktionalen Unterscheidbarkeit beziehungsweise älterer Planungsstand.', 'Axiom A2 – Funktionale Relationierbarkeit.', '2026-07-16 05:55:42'),
(267, 68, 52, 'source_reused', 'source_usage', '[84]', 'Mac Lane [84] wurde als struktureller Forschungsanschluss wiederverwendet.', NULL, 'Eine geprüfte Wiederverwendung; keine neue Quelle.', '2026-07-16 05:55:42'),
(268, 68, 52, 'definition_added', 'definitions', 'Def. 3.3.3.1', 'Der qualitative Begriff des funktionalen Zusammenhangs wurde registriert und vom mathematischen Relationsbegriff abgegrenzt.', NULL, 'Def. 3.3.3.1 Funktionaler Zusammenhang.', '2026-07-16 05:55:42'),
(269, 68, 52, 'axiom_added', 'axioms', 'A2', 'Axiom A2 wurde einschließlich Motivation, Konsistenz-, Unabhängigkeits- und Operationalisierungshinweis registriert.', NULL, 'A2 – Funktionale Relationierbarkeit.', '2026-07-16 05:55:42'),
(270, 68, 52, 'equation_added', 'equations', '(3.279)–(3.282)', 'Vier qualitative axiomatische Darstellungen wurden vollständig registriert.', NULL, 'Axiom A2, Abhängigkeit von A1, Nichtableitbarkeit aus A1 und gemeinsame Reichweite von A1 und A2.', '2026-07-16 05:55:42'),
(271, 68, 52, 'symbol_added', 'symbols', 'A_2, \\not\\Longrightarrow, \\land', 'Die neuen abschnittsspezifischen Symbole wurden einschließlich Gleichungsbezügen registriert.', NULL, 'Drei Abschnittssymbole.', '2026-07-16 05:55:42'),
(272, 68, 52, 'status_changed', 'section', '3.3.3', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned', 'review', '2026-07-16 05:55:42'),
(273, 69, 53, 'rewritten', 'section', '3.3.4', 'Abschnitt 3.3.4 wurde vollständig als Formulierung und Begründung von Axiom A3 neu gefasst.', 'Axiom A2 – Prinzip der funktionalen Relationierbarkeit beziehungsweise älterer Planungsstand.', 'Axiom A3 – Dynamische Zustandsänderung.', '2026-07-16 08:39:54'),
(274, 69, 53, 'definition_added', 'definitions', 'Def. 3.3.4.1', 'Der qualitative Begriff der funktionalen Transformation wurde registriert und von mathematischen Operatoren sowie Zeitentwicklungen abgegrenzt.', NULL, 'Def. 3.3.4.1 Funktionale Transformation.', '2026-07-16 08:39:54'),
(275, 69, 53, 'axiom_added', 'axioms', 'A3', 'Axiom A3 wurde einschließlich Motivation, Konsistenz-, Unabhängigkeits- und Operationalisierungshinweis registriert.', NULL, 'A3 – Dynamische Zustandsänderung.', '2026-07-16 08:39:54'),
(276, 69, 53, 'equation_added', 'equations', '(3.283)–(3.286)', 'Vier qualitative axiomatische Darstellungen wurden vollständig registriert.', NULL, 'Axiom A3, Abhängigkeit von A1 und A2, Nichtableitbarkeit sowie gemeinsame Reichweite von A1 bis A3.', '2026-07-16 08:39:54'),
(277, 69, 53, 'symbol_added', 'symbols', 'A_3, \\not\\Longrightarrow, \\land', 'Die neuen abschnittsspezifischen Symbole wurden einschließlich Gleichungsbezügen registriert.', NULL, 'Drei Abschnittssymbole.', '2026-07-16 08:39:54'),
(278, 69, 53, 'status_changed', 'section', '3.3.4', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned', 'review', '2026-07-16 08:39:54'),
(279, 70, 54, 'rewritten', 'section', '3.3.5', 'Abschnitt 3.3.5 wurde vollständig als Formulierung und Begründung von Axiom A4 neu gefasst.', 'Älterer Planungsstand.', 'Axiom A4 – Funktionale Organisationsbildung.', '2026-07-16 16:30:04'),
(280, 70, 54, 'source_reused', 'source_usage', '[12], [13], [14]', 'Haken, Prigogine/Stengers und Holland wurden als Forschungsanschlüsse wiederverwendet.', NULL, 'Drei geprüfte Wiederverwendungen.', '2026-07-16 16:30:04'),
(281, 70, 54, 'definition_added', 'definitions', 'Def. 3.3.5.1', 'Der qualitative Begriff funktionaler Organisation wurde registriert und von mathematischen Strukturen abgegrenzt.', NULL, 'Def. 3.3.5.1 Funktionale Organisation.', '2026-07-16 16:30:04'),
(282, 70, 54, 'axiom_added', 'axioms', 'A4', 'Axiom A4 wurde einschließlich Motivation, Konsistenz-, Unabhängigkeits- und Operationalisierungshinweis registriert.', NULL, 'A4 – Funktionale Organisationsbildung.', '2026-07-16 16:30:04'),
(283, 70, 54, 'equation_added', 'equations', '(3.287)–(3.290)', 'Vier qualitative axiomatische Darstellungen wurden vollständig registriert.', NULL, 'Axiom A4, Abhängigkeit, Nichtableitbarkeit und gemeinsame Reichweite von A1 bis A4.', '2026-07-16 16:30:04'),
(284, 70, 54, 'symbol_added', 'symbols', 'A_4, \\not\\Longrightarrow, \\land', 'Die neuen abschnittsspezifischen Symbole wurden registriert.', NULL, 'Drei Abschnittssymbole.', '2026-07-16 16:30:04'),
(285, 70, 54, 'status_changed', 'section', '3.3.5', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned', 'review', '2026-07-16 16:30:04'),
(286, 71, 55, 'rewritten', 'section', '3.3.6', 'Abschnitt 3.3.6 wurde vollständig als Formulierung und Begründung von Axiom A5 neu gefasst.', 'Älterer Planungsstand.', 'Axiom A5 – Funktionale Kohärenz und Stabilisierung.', '2026-07-16 16:50:06'),
(287, 71, 55, 'source_added', 'sources', '[87]', 'Maturana und Varela wurden mit Autopoiesis and Cognition als neue Quelle [87] registriert.', NULL, 'Neue Quelle einschließlich Autoren, Annotation, Erstverwendung und Objektverknüpfung.', '2026-07-16 16:50:06'),
(288, 71, 55, 'source_reused', 'source_usage', '[12], [13]', 'Haken sowie Prigogine und Stengers wurden als Forschungsanschlüsse wiederverwendet.', NULL, 'Zwei geprüfte Wiederverwendungen.', '2026-07-16 16:50:06'),
(289, 71, 55, 'definition_added', 'definitions', 'Def. 3.3.6.1–Def. 3.3.6.2', 'Die qualitativen Begriffe funktionale Kohärenz und funktionale Stabilisierung wurden registriert.', NULL, 'Zwei originäre FRZK-Definitionen.', '2026-07-16 16:50:06'),
(290, 71, 55, 'axiom_added', 'axioms', 'A5', 'Axiom A5 wurde einschließlich Motivation, Konsistenz-, Unabhängigkeits- und Operationalisierungshinweis registriert.', NULL, 'A5 – Funktionale Kohärenz und Stabilisierung.', '2026-07-16 16:50:06'),
(291, 71, 55, 'equation_added', 'equations', '(3.291)–(3.294)', 'Vier qualitative axiomatische Darstellungen wurden vollständig registriert.', NULL, 'Axiom A5, Abhängigkeit, Nichtableitbarkeit und gemeinsame Reichweite von A1 bis A5.', '2026-07-16 16:50:06'),
(292, 71, 55, 'symbol_added', 'symbols', 'A_5, \\not\\Longrightarrow, \\land', 'Die neuen abschnittsspezifischen Symbole wurden registriert.', NULL, 'Drei Abschnittssymbole.', '2026-07-16 16:50:06'),
(293, 71, 55, 'status_changed', 'section', '3.3.6', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned', 'review', '2026-07-16 16:50:06'),
(294, 72, 56, 'rewritten', 'section', '3.3.7', 'Abschnitt 3.3.7 wurde vollständig als systematische Darstellung der qualitativen Konsequenzen des Axiomensystems neu gefasst.', 'Älterer Planungsstand.', 'Qualitative Konsequenzen des vollständigen Axiomensystems.', '2026-07-16 17:10:30'),
(295, 72, 56, 'source_reused', 'source_usage', '[12], [13], [87]', 'Haken, Prigogine/Stengers sowie Maturana/Varela wurden als wissenschaftliche Forschungsanschlüsse wiederverwendet.', NULL, 'Drei geprüfte Wiederverwendungen.', '2026-07-16 17:10:30'),
(296, 72, 56, 'definition_added', 'definitions', 'Def. 3.3.7.1', 'Das vollständige qualitative FRZK-Axiomensystem wurde als Sammeldefinition registriert.', NULL, 'Def. 3.3.7.1.', '2026-07-16 17:10:30'),
(297, 72, 56, 'equation_added', 'equations', '(3.295)–(3.306)', 'Zwölf qualitative Darstellungen zu Axiomensystem, Konsequenzen, Raum- und Zeitrekonstruktion, Modellpluralität und empirischer Abgrenzung wurden registriert.', NULL, 'Gleichungen (3.295) bis (3.306).', '2026-07-16 17:10:30'),
(298, 72, 56, 'symbol_added', 'symbols', '\\mathcal{A}_{\\mathrm{FRZK}}, \\neq, \\land', 'Die neuen abschnittsspezifischen Symbole wurden registriert.', NULL, 'Drei Abschnittssymbole.', '2026-07-16 17:10:30'),
(299, 72, 56, 'status_changed', 'section', '3.3.7', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned', 'review', '2026-07-16 17:10:30'),
(300, 73, 57, 'rewritten', 'section', '3.3.8', 'Abschnitt 3.3.8 wurde vollständig als qualitative Prüfung von Minimalität, Unabhängigkeit und Konsistenz des Axiomensystems neu gefasst.', 'Älterer Planungsstand.', 'Minimalität, Unabhängigkeit und Konsistenz des Axiomensystems.', '2026-07-16 17:41:35'),
(301, 73, 57, 'source_added', 'sources', '[88], [89]', 'Enderton und Mendelson wurden als neue methodische Quellen registriert.', NULL, 'Zwei neue Quellen einschließlich Autoren, Annotationen und Erstverwendungen.', '2026-07-16 17:41:35'),
(302, 73, 57, 'source_reused', 'source_usage', '[82], [83]', 'Tarski und Suppes wurden als methodische Forschungsanschlüsse wiederverwendet.', NULL, 'Zwei geprüfte Wiederverwendungen.', '2026-07-16 17:41:35'),
(303, 73, 57, 'definition_added', 'definitions', 'Def. 3.3.8.1–Def. 3.3.8.4', 'Vier methodische Definitionen wurden registriert.', NULL, 'Qualitatives Gegenmodell, schwache qualitative Unabhängigkeit, starke formale Unabhängigkeit und qualitative gemeinsame Erfüllbarkeit.', '2026-07-16 17:41:35'),
(304, 73, 57, 'proposition_added', 'propositions', 'Prop. 3.3.8.1–Prop. 3.3.8.3', 'Drei Ergebnispropositionen wurden registriert.', NULL, 'Qualitative Minimalität, schwache Unabhängigkeit und gemeinsame Erfüllbarkeit.', '2026-07-16 17:41:35'),
(305, 73, 57, 'equation_added', 'equations', '(3.307)–(3.326)', 'Zwanzig Gleichungen und qualitative Modelldarstellungen wurden registriert.', NULL, 'Axiomensystem, Minimalitätskriterium, Gegenmodelle, Unabhängigkeit, Konsistenz und Gesamtbewertung.', '2026-07-16 17:41:35'),
(306, 73, 57, 'symbol_added', 'symbols', 'Gegenmodell- und Erfüllungsnotation', 'Die abschnittsspezifischen Symbole für qualitative Gegenmodelle, Erfüllung, Nichtfolgerung und Aufbauordnung wurden registriert.', NULL, 'Vier Abschnittssymbole.', '2026-07-16 17:41:35'),
(307, 73, 57, 'status_changed', 'section', '3.3.8', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned', 'review', '2026-07-16 17:41:35'),
(308, 74, 58, 'rewritten', 'section', '3.3.9', 'Abschnitt 3.3.9 wurde vollständig als verbindliche Übergangsordnung zur mathematischen Rekonstruktion neu gefasst.', 'Älterer Planungsstand.', 'Übergangsregeln zur mathematischen Rekonstruktion.', '2026-07-16 17:50:08'),
(309, 74, 58, 'source_reused', 'source_usage', '[82], [83], [84], [85], [88], [89]', 'Sechs bereits eingeführte Quellen wurden als methodische und wissenschaftstheoretische Forschungsanschlüsse wiederverwendet.', NULL, 'Sechs geprüfte Wiederverwendungen; keine neue Quelle.', '2026-07-16 17:50:08'),
(310, 74, 58, 'definition_added', 'definitions', 'Def. 3.3.9.1–Def. 3.3.9.4', 'Vier verbindliche Übergangsdefinitionen wurden registriert.', NULL, 'Bedeutungsinvarianz, relationales Rekonstruktionsprinzip, Rekonstruktion statt Übersetzung und mathematisches Minimalprinzip.', '2026-07-16 17:50:08'),
(311, 74, 58, 'proposition_added', 'propositions', 'Prop. 3.3.9.1–Prop. 3.3.9.3', 'Drei methodische Propositionen wurden registriert.', NULL, 'Vorrang der Semantik, Vorrang relationaler Strukturen und mathematische Minimalität.', '2026-07-16 17:50:08'),
(312, 74, 58, 'equation_added', 'equations', '(3.327)–(3.333)', 'Sieben Übergangs- und Rekonstruktionsregeln wurden als Gleichungen registriert.', NULL, 'Gleichungen (3.327) bis (3.333).', '2026-07-16 17:50:08'),
(313, 74, 58, 'symbol_added', 'symbols', '\\prec, \\longrightarrow, \\Longrightarrow', 'Die abschnittsspezifischen Rekonstruktionssymbole wurden registriert.', NULL, 'Drei Abschnittssymbole.', '2026-07-16 17:50:08'),
(314, 74, 58, 'status_changed', 'section', '3.3.9', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned', 'review', '2026-07-16 17:50:08'),
(315, 75, 58, 'rewritten', 'section', '3.3.9', 'Abschnitt 3.3.9 wurde vollständig als verbindliche Übergangsordnung zur mathematischen Rekonstruktion neu gefasst.', 'Älterer Planungsstand.', 'Übergangsregeln zur mathematischen Rekonstruktion.', '2026-07-16 18:13:18'),
(316, 75, 58, 'source_reused', 'source_usage', '[82], [83], [84], [85], [88], [89]', 'Sechs bereits eingeführte Quellen wurden als methodische und wissenschaftstheoretische Forschungsanschlüsse wiederverwendet.', NULL, 'Sechs geprüfte Wiederverwendungen; keine neue Quelle.', '2026-07-16 18:13:18'),
(317, 75, 58, 'definition_added', 'definitions', 'Def. 3.3.9.1–Def. 3.3.9.4', 'Vier verbindliche Übergangsdefinitionen wurden registriert.', NULL, 'Bedeutungsinvarianz, relationales Rekonstruktionsprinzip, Rekonstruktion statt Übersetzung und mathematisches Minimalprinzip.', '2026-07-16 18:13:18'),
(318, 75, 58, 'proposition_added', 'propositions', 'Prop. 3.3.9.1–Prop. 3.3.9.3', 'Drei methodische Propositionen wurden registriert.', NULL, 'Vorrang der Semantik, Vorrang relationaler Strukturen und mathematische Minimalität.', '2026-07-16 18:13:18'),
(319, 75, 58, 'equation_added', 'equations', '(3.327)–(3.333)', 'Sieben Übergangs- und Rekonstruktionsregeln wurden als Gleichungen registriert.', NULL, 'Gleichungen (3.327) bis (3.333).', '2026-07-16 18:13:18'),
(320, 75, 58, 'symbol_added', 'symbols', '\\prec, \\longrightarrow, \\Longrightarrow', 'Die abschnittsspezifischen Rekonstruktionssymbole wurden registriert.', NULL, 'Drei Abschnittssymbole.', '2026-07-16 18:13:18'),
(321, 75, 58, 'status_changed', 'section', '3.3.9', 'Der Abschnitt wurde nach vollständiger Neufassung auf review gesetzt.', 'planned', 'review', '2026-07-16 18:13:18'),
(322, 75, 58, 'source_added', 'sources', '[90]–[95]', 'Sechs neue Literaturquellen für lineare Algebra, Robotik, Zustandsrekonstruktion und Zustandsabschätzung wurden ergänzt.', NULL, 'Quellen [90] bis [95] einschließlich Autoren, Annotationen und Erstverwendungen.', '2026-07-16 18:13:19'),
(323, 75, 58, 'definition_added', 'definitions', 'Def. 3.3.9.5–Def. 3.3.9.7', 'Latente funktionale Orientierung, funktionale Persistenz und funktionales Gedächtnis wurden definiert.', NULL, 'Drei neue originäre FRZK-Definitionen.', '2026-07-16 18:13:19'),
(324, 75, 58, 'proposition_added', 'propositions', 'Prop. 3.3.9.4–Prop. 3.3.9.6', 'Drei Propositionen zur Nullsetzung, Persistenz und funktionalen Existenz wurden registriert.', NULL, 'Drei neue methodische Propositionen.', '2026-07-16 18:13:19'),
(325, 75, 58, 'equation_added', 'equations', '(3.334)–(3.339)', 'Sechs Gleichungen zur latenten Orientierung, klassischen Nullmultiplikation, Persistenz, Aktivität und Existenz wurden registriert.', NULL, 'Gleichungen (3.334) bis (3.339).', '2026-07-16 18:13:19'),
(326, 75, 58, 'symbol_added', 'symbols', '\\mathbf{v}, \\mathbf{0}, \\not\\Longrightarrow', 'Die zusätzlichen abschnittsspezifischen Symbole wurden registriert.', NULL, 'Drei zusätzliche Abschnittssymbole.', '2026-07-16 18:13:19'),
(327, 75, 58, 'rewritten', 'section', '3.3.9.8–3.3.9.10', 'Die Übergangsregeln wurden um latente funktionale Orientierung, funktionale Persistenz und funktionales Gedächtnis erweitert.', NULL, 'Vollständige Endfassung von Abschnitt 3.3.9.', '2026-07-16 18:13:19'),
(328, 76, 22, 'status_changed', 'section', '3.3', 'Kapitel 3.3 wurde nach vollständiger inhaltlicher und redaktioneller Bearbeitung formal abgeschlossen.', 'review', 'completed', '2026-07-16 18:22:06'),
(329, 76, 22, 'proposition_added', 'propositions', 'Prop. 3.3.A', 'Der redaktionelle Abschluss und der verbindliche Übergang zur mathematischen Rekonstruktion in Kapitel 3.4 wurden dokumentiert.', NULL, 'Redaktioneller Abschluss von Kapitel 3.3', '2026-07-16 18:22:06'),
(330, 76, 22, '', 'repository_counters', 'next_citation_number / next_equation_number', 'Die nächsten freien Nummern für Kapitel 3.4 wurden festgeschrieben.', 'Quelle [96], Gleichung (3.340) gemäß Stand 3.3.9 V2', 'Quelle [96], Gleichung (3.340) bestätigt', '2026-07-16 18:22:06'),
(331, 76, 22, '', 'chapter', '3.3', 'Die qualitative FRZK-Axiomatik und ihre Übergangsregeln sind vollständig abgeschlossen.', NULL, 'Kapitel 3.3 abgeschlossen', '2026-07-16 18:22:06');
...
(147, 82, 'tarski_1941_introduction_logic_methodology', 'book', 'Introduction to Logic and to the Methodology of Deductive Sciences', NULL, 1936, 1941, NULL, 'Oxford University Press', 'Oxford', NULL, NULL, NULL, 'English edition', NULL, NULL, NULL, 'en', 1, 'primary', 9, 'verified', '3.3.0', 'Erstnennung zur methodischen Begründung deduktiver und axiomatischer Theoriebildung.', 'Tarski, Alfred: Introduction to Logic and to the Methodology of Deductive Sciences. Oxford: Oxford University Press, 1941.', 'Tarski 1941', 'Verwendet zur Einordnung der strikten Trennung zwischen Grundannahmen, formaler Sprache und ableitbaren Aussagen.', 63, '2026-07-16 03:59:36', '2026-07-16 04:03:02'),
(149, 83, 'suppes_introduction_logic_1957', 'book', 'Introduction to Logic', NULL, 1957, 1957, NULL, 'D. Van Nostrand Company', 'Princeton, New Jersey', NULL, NULL, NULL, 'First edition', NULL, NULL, NULL, 'en', 1, 'reference', 8, 'verified', '3.3.1', 'Erstnennung zur methodischen Funktion primitiver Begriffe, Axiome und abgeleiteter Aussagen in deduktiven Theorien.', 'Suppes, Patrick: Introduction to Logic. Princeton, New Jersey: D. Van Nostrand Company, 1957.', 'Suppes [83]', 'Wissenschaftstheoretische Referenz zur axiomatischen Methode. Die primitiven FRZK-Begriffe und ihre konkrete Auswahl sind originäre Eigenleistung.', 65, '2026-07-16 04:48:15', '2026-07-16 05:29:53'),
(150, 84, 'mac_lane_mathematics_form_function_1986', 'book', 'Mathematics: Form and Function', NULL, 1986, 1986, NULL, 'Springer', 'New York', NULL, NULL, NULL, 'First edition', NULL, NULL, NULL, 'en', 1, 'reference', 8, 'verified', '3.3.1', 'Erstnennung zur strukturellen Auffassung moderner Mathematik und zur begrifflichen Sparsamkeit.', 'Mac Lane, Saunders: Mathematics: Form and Function. New York: Springer, 1986.', 'Mac Lane [84]', 'Dient zur Einordnung von Formen, Beziehungen und Transformationen als zentrale Strukturprinzipien moderner Mathematik. Die qualitative Vorverlagerung dieser Prinzipien ist originäre FRZK-Eigenleistung.', 65, '2026-07-16 04:48:15', '2026-07-16 05:29:53'),
(151, 85, 'quine_logical_point_view_1953', 'book', 'From a Logical Point of View', NULL, 1953, 1953, NULL, 'Harvard University Press', 'Cambridge, Massachusetts', NULL, NULL, NULL, 'First edition', NULL, NULL, NULL, 'en', 1, 'primary', 8, 'verified', '3.3.1', 'Erstnennung zur ontologischen Verpflichtung formaler Theorien.', 'Quine, Willard Van Orman: From a Logical Point of View. Cambridge, Massachusetts: Harvard University Press, 1953.', 'Quine [85]', 'Dient zur Begründung, warum die Auswahl primitiver Begriffe eine Theorie auf bestimmte Grundstrukturen verpflichtet.', 65, '2026-07-16 04:48:15', '2026-07-16 05:29:53'),
(156, 86, 'spencer_brown_laws_form_1969', 'book', 'Laws of Form', NULL, 1969, 1969, NULL, 'George Allen & Unwin', 'London', NULL, NULL, NULL, 'First edition', NULL, NULL, NULL, 'en', 1, 'primary', 8, 'verified', '3.3.2', 'Erstnennung zur erkenntnistheoretischen und formalen Bedeutung eines ursprünglichen Unterscheidungsvollzugs. Das FRZK übernimmt weder den Kalkül noch Spencer-Browns konkrete Markierungsform.', 'Spencer-Brown, George: Laws of Form. London: George Allen & Unwin, 1969.', 'Spencer-Brown [86]', 'Die Quelle dient der wissenschaftlichen Einordnung der Unterscheidung als notwendiger Voraussetzung weiterer Formbildung. Axiom A1 bleibt eine originäre FRZK-Setzung.', 67, '2026-07-16 05:46:46', '2026-07-16 05:46:46'),
(157, 87, 'maturana_varela_autopoiesis_cognition_1980', 'book', 'Autopoiesis and Cognition', 'The Realization of the Living', 1972, 1980, NULL, 'D. Reidel Publishing Company', 'Dordrecht', NULL, NULL, NULL, NULL, '10.1007/978-94-009-8947-4', NULL, 'https://doi.org/10.1007/978-94-009-8947-4', 'en', 1, 'primary', 9, 'verified', '3.3.6', 'Erstnennung als Forschungsanschluss zur fortlaufenden Reproduktion organisatorischer Zusammenhänge. Das FRZK übernimmt keine biologische Definition des Lebendigen und keine vollständige Autopoiesistheorie.', 'Maturana, Humberto R.; Varela, Francisco J.: Autopoiesis and Cognition: The Realization of the Living. Dordrecht: D. Reidel Publishing Company, 1980.', 'Maturana und Varela [87]', 'Die Quelle dient zur wissenschaftlichen Einordnung der Möglichkeit, dass Organisation durch fortlaufende Prozesse erhalten und reproduziert werden kann. Axiom A5 bleibt eine originäre FRZK-Setzung.', 71, '2026-07-16 16:50:06', '2026-07-16 16:50:06'),
(158, 88, 'enderton_mathematical_introduction_logic_2001', 'book', 'A Mathematical Introduction to Logic', NULL, 1972, 2001, NULL, 'Academic Press', 'San Diego', NULL, NULL, NULL, '2nd Edition', NULL, NULL, NULL, 'en', 1, 'reference', 9, 'verified', '3.3.8', 'Erstnennung zur modelltheoretischen Untersuchung von Erfüllbarkeit, semantischer Folgerung, Konsistenz und Unabhängigkeit.', 'Enderton, Herbert B.: A Mathematical Introduction to Logic. 2nd Edition. San Diego: Academic Press, 2001.', 'Enderton [88]', 'Methodische Referenz. Die qualitativen Gegenmodelle des FRZK sind noch keine vollständigen Modelle im formal-logischen Sinn.', 73, '2026-07-16 17:41:35', '2026-07-16 17:41:35'),
(159, 89, 'mendelson_introduction_mathematical_logic_2015', 'book', 'Introduction to Mathematical Logic', NULL, 1964, 2015, NULL, 'CRC Press', 'Boca Raton', NULL, NULL, NULL, '6th Edition', NULL, NULL, NULL, 'en', 1, 'reference', 9, 'verified', '3.3.8', 'Erstnennung zur Beziehung zwischen syntaktischer Konsistenz, semantischer Erfüllbarkeit und Unabhängigkeit axiomatischer Systeme.', 'Mendelson, Elliott: Introduction to Mathematical Logic. 6th Edition. Boca Raton: CRC Press, 2015.', 'Mendelson [89]', 'Methodische Referenz. Der Abschnitt beansprucht nur qualitative Vorprüfungen.', 73, '2026-07-16 17:41:35', '2026-07-16 17:41:35'),
(160, 90, 'strang_linear_algebra_applications_2006', 'book', 'Linear Algebra and Its Applications', NULL, 1976, 2006, NULL, 'Brooks/Cole', 'Belmont', NULL, NULL, NULL, '4th Edition', NULL, NULL, NULL, 'en', 1, 'reference', 8, 'verified', '3.3.9', 'Erstnennung in 3.3.9.8 zur klassischen Skalarmultiplikation und zum Nullvektor.', 'Strang, Gilbert: Linear Algebra and Its Applications. 4th Edition. Belmont: Brooks/Cole, 2006.', 'Strang [90]', 'Dient zur Abgrenzung der klassischen linearen Algebra von der erweiterten FRZK-Zustandsbeschreibung.', 75, '2026-07-16 18:13:18', '2026-07-16 18:13:18'),
(161, 91, 'golub_vanloan_matrix_computations_2013', 'book', 'Matrix Computations', NULL, 1983, 2013, NULL, 'Johns Hopkins University Press', 'Baltimore', NULL, NULL, NULL, '4th Edition', NULL, NULL, NULL, 'en', 1, 'reference', 8, 'verified', '3.3.9', 'Erstnennung in 3.3.9.8 zur klassischen Matrix- und Vektorrechnung.', 'Golub, Gene H.; Van Loan, Charles F.: Matrix Computations. 4th Edition. Baltimore: Johns Hopkins University Press, 2013.', 'Golub und Van Loan [91]', 'Dient als zweite Referenz für die unveränderte klassische Nullvektorbehandlung.', 75, '2026-07-16 18:13:18', '2026-07-16 18:13:18'),
(162, 92, 'lavalle_planning_algorithms_2006', 'book', 'Planning Algorithms', NULL, 2006, 2006, NULL, 'Cambridge University Press', 'Cambridge', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'en', 1, 'reference', 8, 'verified', '3.3.9', 'Erstnennung in 3.3.9.8 als Forschungsanschluss für Robotik, Konfiguration und Orientierung.', 'LaValle, Steven M.: Planning Algorithms. Cambridge: Cambridge University Press, 2006.', 'LaValle [92]', 'Technischer Forschungsanschluss; keine Gleichsetzung von Orientierung und Richtung des Nullvektors.', 75, '2026-07-16 18:13:18', '2026-07-16 18:13:18'),
(163, 93, 'craig_robotics_mechanics_control_2004', 'book', 'Introduction to Robotics: Mechanics and Control', NULL, 1986, 2004, NULL, 'Pearson Prentice Hall', 'Upper Saddle River', NULL, NULL, NULL, '3rd Edition', NULL, NULL, NULL, 'en', 1, 'reference', 8, 'verified', '3.3.9', 'Erstnennung in 3.3.9.8 als Forschungsanschluss für getrennte Lage- und Bewegungsgrößen.', 'Craig, John J.: Introduction to Robotics: Mechanics and Control. 3rd Edition. Upper Saddle River: Pearson Prentice Hall, 2004.', 'Craig [93]', 'Technischer Forschungsanschluss für die getrennte Speicherung funktional verschiedener Zustandskomponenten.', 75, '2026-07-16 18:13:18', '2026-07-16 18:13:18'),
(164, 94, 'kalman_new_approach_filtering_prediction_1960', '', 'A New Approach to Linear Filtering and Prediction Problems', NULL, 1960, 1960, 'Journal of Basic Engineering', 'ASME', NULL, '82', '1', '35–45', NULL, '10.1115/1.3662552', NULL, 'https://doi.org/10.1115/1.3662552', 'en', 1, 'primary', 9, 'verified', '3.3.9', 'Erstnennung in 3.3.9.10 als Forschungsanschluss für interne Zustandsrekonstruktion.', 'Kalman, Rudolf E.: A New Approach to Linear Filtering and Prediction Problems. Journal of Basic Engineering 82(1), 1960, S. 35–45.', 'Kalman [94]', 'Methodischer Forschungsanschluss für die Unterscheidung zwischen unmittelbar beobachtbaren und intern rekonstruierten Zustandsinformationen.', 75, '2026-07-16 18:13:18', '2026-07-16 18:13:18'),
(165, 95, 'simon_optimal_state_estimation_2006', 'book', 'Optimal State Estimation', 'Kalman, H Infinity, and Nonlinear Approaches', 2006, 2006, NULL, 'John Wiley & Sons', 'Hoboken', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'en', 1, 'reference', 8, 'verified', '3.3.9', 'Erstnennung in 3.3.9.10 als Forschungsanschluss für Zustandsabschätzung und interne Zustandsinformation.', 'Simon, Dan: Optimal State Estimation: Kalman, H Infinity, and Nonlinear Approaches. Hoboken: John Wiley & Sons, 2006.', 'Simon [95]', 'Technischer Forschungsanschluss für Rekonstruierbarkeit und Zustandsinformationen.', 75, '2026-07-16 18:13:18', '2026-07-16 18:13:18');
...
(387, 8, 49, 'background', 'Hilberts axiomatische Methode belegt, dass mathematische Theorien auf explizit gewählten primitiven Begriffen und Grundannahmen aufbauen.', '3.3.0, Absätze 2 und 4', 0, 1, 'Wiederverwendung der bereits eingeführten Quelle [8].', 63),
(388, 24, 49, 'comparison', 'Die axiomatische Mengenlehre dient als Vergleich dafür, dass leistungsfähige formale Theorien ihre Ausgangsobjekte voraussetzen und anschließend deren Konsequenzen entwickeln.', '3.3.0, Absatz 2', 0, 1, 'Wiederverwendung der bereits eingeführten Quelle [24].', 63),
(389, 7, 49, 'historical_context', 'Euklids Elemente werden als historischer Ausgangspunkt der axiomatischen Theoriebildung und der Trennung zwischen Postulaten und abgeleiteten Aussagen herangezogen.', '3.3.0, Absatz 4', 0, 1, 'Wiederverwendung der bereits eingeführten Quelle [7].', 63),
(390, 147, 49, 'first_citation', 'Tarski wird zur methodischen Begründung deduktiver Theorien und der strikten Trennung zwischen Grundannahmen und ableitbaren Aussagen erstmals eingeführt.', '3.3.0, Absatz 4', 1, 1, 'Erstnennung der neuen Quelle [82].', 63),
(395, 147, 50, 'method', 'Tarski stützt die Trennung zwischen primitiven Ausdrücken, Grundannahmen und abgeleiteten Aussagen deduktiver Theorien.', '3.3.1, Einleitung und wissenschaftstheoretischer Ausgangspunkt', 0, 1, 'Wiederverwendung nach Erstnennung in Abschnitt 3.3.0.', 65),
(396, 149, 50, 'first_citation', 'Suppes begründet die methodische Funktion primitiver Begriffe und axiomatischer Darstellungen wissenschaftlicher Theorien.', '3.3.1, Absatz zur Rolle primitiver Begriffe', 1, 1, 'Erstnennung der Quelle [83].', 65),
(397, 150, 50, 'first_citation', 'Mac Lane stützt die strukturelle und relationale Ausrichtung sowie die begriffliche Sparsamkeit des Theorieaufbaus.', '3.3.1, Absatz zur begrifflichen Sparsamkeit', 1, 1, 'Erstnennung der Quelle [84].', 65),
(398, 151, 50, 'first_citation', 'Quine begründet die Aussage, dass primitive Begriffe eine Theorie auf bestimmte ontologische Grundstrukturen verpflichten.', '3.3.1, Abschnitt zum Ausschluss bereits strukturhaltiger Grundbegriffe', 1, 1, 'Erstnennung der Quelle [85].', 65),
(400, 156, 51, 'first_citation', 'Spencer-Brown wird zur wissenschaftlichen Einordnung der Unterscheidung als Ausgangspunkt von Formbildung herangezogen. Der Text grenzt das FRZK ausdrücklich von Spencer-Browns Kalkül und konkreter Markierungsoperation ab.', '3.3.2, Absatz unmittelbar vor der Formulierung von Axiom A1', 1, 1, 'Erstnennung der Quelle [86]. Die Quelle begründet nicht das originäre Axiom, sondern dokumentiert einen relevanten Forschungsanschluss.', 67),
(401, 150, 52, 'background', 'Mac Lane wird als Forschungsanschluss für die strukturelle Bedeutung von Beziehungen und strukturerhaltenden Transformationen verwendet. Das FRZK übernimmt keine kategoriale oder algebraische Struktur, sondern verlagert Relationierbarkeit auf eine qualitative axiomatische Ausgangsebene.', '3.3.3, Absatz zur strukturellen Bedeutung von Beziehungen', 0, 1, 'Wiederverwendung der bereits in Abschnitt 3.3.1 erstmals zitierten Quelle [84].', 68),
(402, 12, 54, 'background', 'Haken wird als Forschungsanschluss für die Möglichkeit makroskopischer Ordnungsstrukturen aus dem Zusammenwirken vieler Freiheitsgrade verwendet.', '3.3.5, Absatz zum wissenschaftlichen Forschungsstand der Organisationsbildung', 0, 1, 'Wiederverwendung der bereits in Kapitel 3.1 eingeführten Quelle [12]. Keine Übernahme eines konkreten synergetischen Modells.', 70),
(403, 13, 54, 'background', 'Prigogine und Stengers werden als Forschungsanschluss für dissipative Strukturbildung in offenen nichtlinearen Systemen verwendet.', '3.3.5, Absatz zum wissenschaftlichen Forschungsstand der Organisationsbildung', 0, 1, 'Wiederverwendung der bereits in Kapitel 3.1 eingeführten Quelle [13]. Keine thermodynamischen Voraussetzungen im Axiom.', 70),
(404, 14, 54, 'background', 'Holland wird als Forschungsanschluss für globale Muster aus lokalen Interaktionen in komplexen adaptiven Systemen verwendet.', '3.3.5, Absatz zum wissenschaftlichen Forschungsstand der Organisationsbildung', 0, 1, 'Wiederverwendung der bereits in Kapitel 3.1 eingeführten Quelle [14]. Keine Agentenpopulation wird axiomatisch vorausgesetzt.', 70),
(405, 12, 55, 'background', 'Haken wird als Forschungsanschluss für den Erhalt und die Veränderung makroskopischer Ordnungsformen in synergetischen Systemen verwendet.', '3.3.6, Absatz zum wissenschaftlichen Forschungsstand', 0, 1, 'Wiederverwendung der bereits eingeführten Quelle [12]. Kein konkretes synergetisches Modell wird in Axiom A5 übernommen.', 71),
(406, 13, 55, 'background', 'Prigogine und Stengers werden als Forschungsanschluss für die Aufrechterhaltung dissipativer Strukturen in offenen Systemen verwendet.', '3.3.6, Absatz zum wissenschaftlichen Forschungsstand', 0, 1, 'Wiederverwendung der bereits eingeführten Quelle [13]. Axiom A5 setzt keine thermodynamischen Bedingungen voraus.', 71),
(407, 157, 55, 'first_citation', 'Maturana und Varela werden als Forschungsanschluss für die fortlaufende Reproduktion organisatorischer Zusammenhänge durch wechselseitig erzeugende Prozesse erstmals eingeführt.', '3.3.6, Absatz zum wissenschaftlichen Forschungsstand', 1, 1, 'Erstnennung der Quelle [87]. Die biologische Autopoiesistheorie wird nicht als FRZK-Axiom übernommen.', 71),
(408, 12, 56, 'background', 'Haken wird als wissenschaftlicher Hintergrund für dynamische Ordnungsbildung, Selbstorganisation und den Erhalt makroskopischer Organisationsformen verwendet.', '3.3.7, Konsequenzen zur Selbstorganisation und dynamischen Kohärenz', 0, 1, 'Wiederverwendung der Quelle [12]. Keine neue theoretische Übernahme und kein neues Axiom.', 72),
(409, 13, 56, 'background', 'Prigogine und Stengers werden als wissenschaftlicher Hintergrund für dynamische Strukturbildung und Erhalt unter fortlaufender Veränderung verwendet.', '3.3.7, Konsequenzen zur Organisationsbildung und dynamischen Kohärenz', 0, 1, 'Wiederverwendung der Quelle [13]. Keine thermodynamischen Spezialbedingungen werden vorausgesetzt.', 72),
(410, 157, 56, 'background', 'Maturana und Varela werden als wissenschaftlicher Hintergrund für prozessuale funktionale Identität und organisatorische Reproduktion verwendet.', '3.3.7, Konsequenz zur prozessualen funktionalen Identität', 0, 1, 'Wiederverwendung der Quelle [87]. Keine biologische Autopoiesisdefinition wird übernommen.', 72),
(411, 147, 57, 'background', 'Tarski wird als methodischer Forschungsanschluss für semantische Modellbetrachtungen und die Untersuchung deduktiver Systeme wiederverwendet.', '3.3.8, Einleitung zur Unabhängigkeitsprüfung', 0, 1, 'Wiederverwendung der Quelle [82].', 73),
(412, 149, 57, 'background', 'Suppes wird als methodischer Forschungsanschluss für axiomatische Theorien und die Bedeutung erfüllender Strukturen wiederverwendet.', '3.3.8, Einleitung zur Unabhängigkeitsprüfung', 0, 1, 'Wiederverwendung der Quelle [83].', 73),
(413, 158, 57, 'first_citation', 'Enderton wird zur formalen Einordnung der Begriffe Modell, Erfüllbarkeit, Folgerung und Konsistenz erstmals eingeführt.', '3.3.8, Absatz zur modelltheoretischen Methode', 1, 1, 'Erstnennung der Quelle [88].', 73),
(414, 159, 57, 'first_citation', 'Mendelson wird zur Einordnung syntaktischer Konsistenz, semantischer Erfüllbarkeit und Axiomenunabhängigkeit erstmals eingeführt.', '3.3.8, Absatz zur modelltheoretischen Methode und qualitative Konsistenz', 1, 1, 'Erstnennung der Quelle [89].', 73),
(421, 147, 58, 'background', 'Tarski wird als methodischer Hintergrund für die strikte Trennung zwischen primitiven Ausdrücken, Semantik, formaler Sprache und späterer Ableitung verwendet.', '3.3.9, Einleitung und Bedeutungsinvarianz', 0, 1, 'Wiederverwendung der Quelle [82].', 75),
(422, 149, 58, 'background', 'Suppes wird als methodischer Hintergrund für den schrittweisen Aufbau axiomatischer und mathematischer Theorien verwendet.', '3.3.9, Rekonstruktion statt Übersetzung', 0, 1, 'Wiederverwendung der Quelle [83].', 75),
(423, 150, 58, 'background', 'Mac Lane wird als struktureller Forschungsanschluss für den Vorrang von Relationen, Strukturen und Transformationen gegenüber isolierten Objekten verwendet.', '3.3.9, Vorrang funktionaler Relationen', 0, 1, 'Wiederverwendung der Quelle [84].', 75),
(424, 151, 58, 'background', 'Quine wird als wissenschaftstheoretischer Hintergrund für die ontologischen Verpflichtungen mathematischer Formalisierungen verwendet.', '3.3.9, Bedeutungsinvarianz und Minimalprinzip', 0, 1, 'Wiederverwendung der Quelle [85].', 75),
(425, 158, 58, 'background', 'Enderton wird als methodischer Referenzrahmen für die spätere Präzisierung von Sprache, Semantik, Modellen und Folgerungsbeziehungen verwendet.', '3.3.9, Übergang zur mathematischen Rekonstruktion', 0, 1, 'Wiederverwendung der Quelle [88].', 75),
(426, 159, 58, 'background', 'Mendelson wird als methodischer Referenzrahmen für die spätere formale Prüfung von Konsistenz, Unabhängigkeit und Modellstruktur verwendet.', '3.3.9, Übergang zur mathematischen Rekonstruktion', 0, 1, 'Wiederverwendung der Quelle [89].', 75),
(427, 160, 58, 'first_citation', 'Strang wird zur klassischen Skalarmultiplikation und zur Richtungslosigkeit des Nullvektors erstmals eingeführt.', '3.3.9.8, Abgrenzung zur klassischen linearen Algebra', 1, 1, 'Erstnennung [90].', 75),
(428, 161, 58, 'first_citation', 'Golub und Van Loan werden als zweite mathematische Referenz zur klassischen Vektor- und Matrixrechnung eingeführt.', '3.3.9.8, Abgrenzung zur klassischen linearen Algebra', 1, 1, 'Erstnennung [91].', 75),
(429, 162, 58, 'first_citation', 'LaValle wird als technischer Forschungsanschluss für getrennte Konfigurations- und Orientierungsinformationen eingeführt.', '3.3.9.8, technische Anwendungen', 1, 1, 'Erstnennung [92].', 75),
(430, 163, 58, 'first_citation', 'Craig wird als technischer Forschungsanschluss für Lage- und Bewegungsrepräsentationen eingeführt.', '3.3.9.8, technische Anwendungen', 1, 1, 'Erstnennung [93].', 75),
(431, 164, 58, 'first_citation', 'Kalman wird als Forschungsanschluss für interne Zustandsrekonstruktion und Rekonstruierbarkeit eingeführt.', '3.3.9.10, funktionales Gedächtnis', 1, 1, 'Erstnennung [94].', 75),
(432, 165, 58, 'first_citation', 'Simon wird als Forschungsanschluss für beobachtbare und interne Zustandsinformationen eingeführt.', '3.3.9.10, funktionales Gedächtnis', 1, 1, 'Erstnennung [95].', 75);
...
(262, '\\Longrightarrow', '\\Longrightarrow', 'konzeptioneller Folgerungspfeil', 'Qualitativer Folgerungs- und Abhängigkeitspfeil in der FRZK-Axiomatik. Er besitzt in Kapitel 3.3 noch keine operatorische oder zeitliche Bedeutung.', 'section', 49, 1008, NULL, 'qualitative axiomatische Aussagen', 'qualitative axiomatische Aussagen', 0, 0, 0, 'Erstverwendung in Gleichung (3.275); mathematische Präzisierung erst in Kapitel 3.4.', 'checked', 63),
(264, '\\Longrightarrow', '\\Longrightarrow', 'qualitativer Folgerungs- und Ordnungspfeil', 'Qualitativer Pfeil zur Kennzeichnung der begrifflichen Reihenfolge in Abschnitt 3.3.1; keine formale Implikation.', 'section', 50, 1010, NULL, 'qualitative axiomatische Begriffsordnung', 'qualitative axiomatische Begriffsordnung', 0, 0, 0, 'Abschnittsspezifische Verwendung in Gleichung (3.276). Die mathematische Präzisierung erfolgt erst in Kapitel 3.4.', 'checked', 65),
(266, 'A_1', 'A_1', 'Axiom A1', 'Bezeichnung des ersten FRZK-Axioms zur Existenz mindestens eines prinzipiell funktional unterscheidbaren Zustandes.', 'section', 51, 1014, NULL, 'qualitative FRZK-Axiomatik', 'qualitative FRZK-Axiomatik', 0, 0, 0, 'Kein mathematisches Objekt und keine Variable eines Zustandsraumes.', 'checked', 67),
(267, '\\neg', '\\neg', 'Negation', 'Logisches Negationszeichen in der qualitativen Abhängigkeitsaussage (3.278).', 'section', 51, 1015, NULL, 'qualitative logische Aussagen', 'qualitative logische Aussagen', 0, 0, 0, 'Die mathematische Logik wird nicht als zusätzliche FRZK-Struktur rekonstruiert; die Notation dient der komprimierten Darstellung.', 'checked', 67),
(268, '\\lor', '\\lor', 'logische Disjunktion', 'Logisches Oder in der qualitativen Abhängigkeitsaussage (3.278).', 'section', 51, 1015, NULL, 'qualitative logische Aussagen', 'qualitative logische Aussagen', 0, 0, 0, 'Verknüpft die Axiombezeichnungen A2 bis A5; keine mengen- oder algebraische Operation.', 'checked', 67),
(269, 'A_2', 'A_2', 'Axiom A2', 'Bezeichnung des zweiten FRZK-Axioms der funktionalen Relationierbarkeit.', 'section', 52, 1016, NULL, 'qualitative FRZK-Axiomatik', 'qualitative FRZK-Axiomatik', 0, 0, 0, 'Kein mathematisches Objekt und keine Variable eines Zustandsraumes.', 'checked', 68),
(270, '\\not\\Longrightarrow', '\\not\\Longrightarrow', 'qualitativer Nichtableitungspfeil', 'Kennzeichnet in Abschnitt 3.3.3 die behauptete qualitative Nichtableitbarkeit von Axiom A2 aus Axiom A1.', 'section', 52, 1018, NULL, 'qualitative axiomatische Nichtableitbarkeit', 'qualitative axiomatische Nichtableitbarkeit', 0, 0, 0, 'Kein abgeschlossener modelltheoretischer Unabhängigkeitsbeweis.', 'checked', 68),
(271, '\\land', '\\land', 'logische Konjunktion', 'Logisches Und zur qualitativen Verknüpfung der Axiome A1 und A2 in Gleichung (3.282).', 'section', 52, 1019, NULL, 'qualitative logische Aussagen', 'qualitative logische Aussagen', 0, 0, 0, 'Dient ausschließlich der komprimierten Darstellung.', 'checked', 68),
(272, 'A_3', 'A_3', 'Axiom A3', 'Bezeichnung des dritten FRZK-Axioms der dynamischen Zustandsänderung.', 'section', 53, 1020, NULL, 'qualitative FRZK-Axiomatik', 'qualitative FRZK-Axiomatik', 0, 0, 0, 'Kein mathematisches Objekt und keine Variable eines Zustandsraumes.', 'checked', 69),
(273, '\\not\\Longrightarrow', '\\not\\Longrightarrow', 'qualitativer Nichtableitungspfeil', 'Kennzeichnet in Abschnitt 3.3.4 die behauptete qualitative Nichtableitbarkeit von Axiom A3 aus Axiom A1 und Axiom A2.', 'section', 53, 1022, NULL, 'qualitative axiomatische Nichtableitbarkeit', 'qualitative axiomatische Nichtableitbarkeit', 0, 0, 0, 'Kein abgeschlossener modelltheoretischer Unabhängigkeitsbeweis.', 'checked', 69),
(274, '\\land', '\\land', 'logische Konjunktion', 'Logisches Und zur qualitativen Verknüpfung der Axiome A1, A2 und A3.', 'section', 53, 1021, NULL, 'qualitative logische Aussagen', 'qualitative logische Aussagen', 0, 0, 0, 'Dient ausschließlich der komprimierten Darstellung.', 'checked', 69),
(275, 'A_4', 'A_4', 'Axiom A4', 'Bezeichnung des vierten FRZK-Axioms der funktionalen Organisationsbildung.', 'section', 54, 1024, NULL, 'qualitative FRZK-Axiomatik', 'qualitative FRZK-Axiomatik', 0, 0, 0, 'Kein mathematisches Objekt.', 'checked', 70),
(276, '\\not\\Longrightarrow', '\\not\\Longrightarrow', 'qualitativer Nichtableitungspfeil', 'Kennzeichnet die qualitative Nichtableitbarkeit von Axiom A4 aus Axiom A1 bis Axiom A3.', 'section', 54, 1026, NULL, 'qualitative axiomatische Nichtableitbarkeit', 'qualitative axiomatische Nichtableitbarkeit', 0, 0, 0, 'Kein abgeschlossener modelltheoretischer Unabhängigkeitsbeweis.', 'checked', 70),
(277, '\\land', '\\land', 'logische Konjunktion', 'Logisches Und zur qualitativen Verknüpfung der Axiome A1 bis A4.', 'section', 54, 1025, NULL, 'qualitative logische Aussagen', 'qualitative logische Aussagen', 0, 0, 0, 'Dient ausschließlich der komprimierten Darstellung.', 'checked', 70),
(278, 'A_5', 'A_5', 'Axiom A5', 'Bezeichnung des fünften FRZK-Axioms der funktionalen Kohärenz und Stabilisierung.', 'section', 55, 1028, NULL, 'qualitative FRZK-Axiomatik', 'qualitative FRZK-Axiomatik', 0, 0, 0, 'Kein mathematisches Objekt und kein Kohärenzmaß.', 'checked', 71),
(279, '\\not\\Longrightarrow', '\\not\\Longrightarrow', 'qualitativer Nichtableitungspfeil', 'Kennzeichnet die qualitative Nichtableitbarkeit von Axiom A5 aus Axiom A1 bis Axiom A4.', 'section', 55, 1030, NULL, 'qualitative axiomatische Nichtableitbarkeit', 'qualitative axiomatische Nichtableitbarkeit', 0, 0, 0, 'Kein abgeschlossener modelltheoretischer Unabhängigkeitsbeweis.', 'checked', 71),
(280, '\\land', '\\land', 'logische Konjunktion', 'Logisches Und zur qualitativen Verknüpfung der Axiome A1 bis A5.', 'section', 55, 1029, NULL, 'qualitative logische Aussagen', 'qualitative logische Aussagen', 0, 0, 0, 'Dient ausschließlich der komprimierten Darstellung.', 'checked', 71),
(281, '\\mathcal{A}_{\\mathrm{FRZK}}', '\\mathcal{A}_{\\mathrm{FRZK}}', 'vollständiges qualitatives FRZK-Axiomensystem', 'Zusammenfassende Bezeichnung der Axiome A1 bis A5.', 'section', 56, 1032, NULL, 'qualitative FRZK-Axiomatik', 'qualitative FRZK-Axiomatik', 0, 0, 0, 'Noch keine vollständig formalisierte mathematische Menge.', 'checked', 72),
(282, '\\neq', '\\neq', 'Ungleichheitszeichen', 'Kennzeichnet die wissenschaftstheoretische Trennung zwischen axiomatischer Möglichkeit und empirischer Realisierung.', 'section', 56, 1042, NULL, 'qualitative Wissenschaftstheorie', 'qualitative Wissenschaftstheorie', 0, 0, 0, 'Kein numerischer Vergleich.', 'checked', 72),
(283, '\\land', '\\land', 'logische Konjunktion', 'Logisches Und zur qualitativen Verknüpfung mehrerer Axiome oder Rekonstruktionsbedingungen.', 'section', 56, 1033, NULL, 'qualitative Logik', 'qualitative Logik', 0, 0, 0, 'Dient ausschließlich der komprimierten Darstellung.', 'checked', 72),
(284, '\\mathfrak{M}_{\\neg A_i}', '\\mathfrak{M}_{\\neg A_i}', 'qualitatives Gegenmodell zu Axiom Ai', 'Sammelnotation für ein qualitatives Gegenmodell, in dem das jeweils betrachtete Axiom ausgeschlossen bleibt.', 'section', 57, 1046, NULL, 'qualitative Modellbetrachtung', 'qualitative Modellbetrachtung', 0, 0, 0, 'Keine formale Modellstruktur.', 'checked', 73),
(285, '\\models_{\\mathrm{qual}}', '\\models_{\\mathrm{qual}}', 'qualitative Erfüllungsrelation', 'Kennzeichnet begriffliche gemeinsame Interpretierbarkeit ohne vollständig definierte formale Semantik.', 'section', 57, 1056, NULL, 'qualitative Modellbetrachtung', 'qualitative Modellbetrachtung', 0, 0, 0, 'Abgrenzung zur formalen semantischen Erfüllungsrelation.', 'checked', 73),
(286, '\\not\\models_{\\mathrm{qual}}', '\\not\\models_{\\mathrm{qual}}', 'qualitative Nichtfolgerung', 'Kennzeichnet qualitative Nichtableitbarkeit ohne formale Modellsprache.', 'section', 57, 1051, NULL, 'qualitative Modellbetrachtung', 'qualitative Modellbetrachtung', 0, 0, 0, 'Abgrenzung zur formalen semantischen Nichtfolgerung.', 'checked', 73),
(287, '\\prec', '\\prec', 'begriffliche Aufbauordnung', 'Kennzeichnet den funktionalen Vorrang eines Axioms gegenüber dem jeweils folgenden Axiom.', 'section', 57, 1052, NULL, 'qualitative Theoriearchitektur', 'qualitative Theoriearchitektur', 0, 0, 0, 'Keine logische Implikation und keine numerische Ordnung.', 'checked', 73),
(288, '\\prec', '\\prec', 'begriffliche Vorrangordnung', 'Kennzeichnet in Abschnitt 3.3.9 eine qualitative Rekonstruktionsreihenfolge und keine numerische Ordnung.', 'section', 58, 1065, NULL, 'wissenschaftstheoretische Rekonstruktionsordnung', 'wissenschaftstheoretische Rekonstruktionsordnung', 0, 0, 0, 'Wird für Relation vor Geometrie und Transformation vor Zeitparameter verwendet.', 'checked', 75),
(289, '\\longrightarrow', '\\Longrightarrow', 'qualitativer Rekonstruktionspfeil', 'Kennzeichnet eine qualitative methodische Folgerungs- oder Rekonstruktionsrichtung.', 'section', 58, 1068, NULL, 'wissenschaftstheoretische Rekonstruktion', 'wissenschaftstheoretische Rekonstruktion', 0, 0, 0, 'Noch keine formale Ableitungsrelation.', 'checked', 75),
(294, '\\mathbf{v}', '\\mathbf{v}', 'klassischer Vektor', 'Beliebiger klassischer Vektor in der Abgrenzungsgleichung (3.335).', 'section', 58, 1079, NULL, 'klassischer Vektorraum', 'klassischer Vektorraum', 1, 0, 0, 'Nicht identisch mit dem späteren erweiterten FRZK-Zustand.', 'checked', 75),
(295, '\\mathbf{0}', '\\mathbf{0}', 'klassischer Nullvektor', 'Additives neutrales Element eines klassischen Vektorraums; besitzt keine definierte Richtung.', 'section', 58, 1079, NULL, 'klassischer Vektorraum', 'klassischer Vektorraum', 1, 0, 0, 'Die funktionale Orientierungsinformation gehört nicht zum Nullvektor selbst.', 'checked', 75),
(296, '\\not\\Longrightarrow', '\\not\\Longrightarrow', 'qualitativer Nichtfolgerungspfeil', 'Kennzeichnet in den Ergänzungen 3.3.9.8 bis 3.3.9.10 eine qualitative Nichtfolgerung.', 'section', 58, 1078, NULL, 'qualitative FRZK-Rekonstruktion', 'qualitative FRZK-Rekonstruktion', 0, 0, 0, 'Keine vollständig formalisierte semantische Nichtfolgerung.', 'checked', 75);
...
--
ALTER TABLE `annotations`
  MODIFY `annotation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=139;
...
--
ALTER TABLE `authors`
  MODIFY `author_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;

--
-- AUTO_INCREMENT für Tabelle `axioms`
--
ALTER TABLE `axioms`
  MODIFY `axiom_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `definitions`
  MODIFY `definition_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=433;

--
-- AUTO_INCREMENT für Tabelle `dissertation_sections`
--
ALTER TABLE `dissertation_sections`
  MODIFY `section_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
...
--
ALTER TABLE `equations`
  MODIFY `equation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1084;
...
--
ALTER TABLE `equation_symbols`
  MODIFY `equation_symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=838;
...
--
ALTER TABLE `object_source_links`
  MODIFY `object_source_link_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `propositions`
  MODIFY `proposition_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `repository_validation_results`
  MODIFY `validation_result_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT für Tabelle `section_change_log`
--
ALTER TABLE `section_change_log`
  MODIFY `change_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=332;

--
-- AUTO_INCREMENT für Tabelle `sources`
--
ALTER TABLE `sources`
  MODIFY `source_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=166;
...
--
ALTER TABLE `source_usage`
  MODIFY `usage_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=433;

--
-- AUTO_INCREMENT für Tabelle `symbols`
--
ALTER TABLE `symbols`
  MODIFY `symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=297;
