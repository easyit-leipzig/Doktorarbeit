...
Definitionen : 3.2.821–3.2.826
Sätze        : 3.2.271–3.2.275
Gleichungen  : (3.3674)–(3.3684)
Literatur    : [142]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.30-V1',NOW(),'subsection','3.2.43.30',
'3.2.43.30-v1-vollstaendig',
'Elektroschwache Vereinheitlichung einschließlich SU(2)L x U(1)Y, Weinberg-Winkel und Eichbosonen.',
'Olaf Thiele / ChatGPT')
...
SELECT 142,'electroweak_unification_142','book',
'Elektroschwache Vereinheitlichung',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=142);
...
SELECT
 ...
 'subsection',
 '3.2.43.30',
 'Elektroschwache Vereinheitlichung vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.821 Elektroschwache Eichgruppe
-- 3.2.822 Schwacher Isospin
-- 3.2.823 Gell-Mann–Nishijima-Beziehung
-- 3.2.824 Elektroschwache Eichfelder
-- 3.2.825 Weinberg-Winkel
-- 3.2.826 Elektroschwache Kopplung

-- Sätze
-- 3.2.271 Hyperladung
-- 3.2.272 Vereinheitlichung der Wechselwirkungen
-- 3.2.273 Physikalische Eichbosonen
-- 3.2.274 Mischung der neutralen Eichfelder
-- 3.2.275 Elektromagnetische Kopplung
...
VALUES
('last_completed_section','3.2.43.30'),
('current_section','3.2.43.31'),
('last_definition_number','3.2.826'),
('next_definition_number','3.2.827'),
('last_theorem_number','3.2.275'),
('next_theorem_number','3.2.276'),
('last_equation_number','3.3684'),
('next_equation_number','3.3685'),
('last_citation_number','142'),
('next_citation_number','143')
