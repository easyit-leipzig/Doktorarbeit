...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 16. Jul 2026 um 07:32
...
(22, NULL, '3.3', 'Axiomatische Grundlagen des Funktionalen Raum-Zeit-Kohärenzsystems', 3, 3.3000, 'review', 1, 'Kapitel 3.3 formuliert die qualitative FRZK-Axiomatik. Die mathematische Rekonstruktion bleibt Kapitel 3.4 vorbehalten.', '2026-07-12 11:14:28', '2026-07-16 03:59:36'),
...
(49, 22, '3.3.0', 'Einleitung', 3, 3.3001, 'review', 1, 'Übergang von der mathematischen Forschungslücke in Kapitel 3.2 zur qualitativen axiomatischen Grundlegung. Enthält noch keine mathematische Rekonstruktion.', '2026-07-12 11:14:28', '2026-07-16 03:59:36'),
(50, 22, '3.3.1', 'Primitive Begriffe und wissenschaftstheoretische Ausgangspunkte', 3, 3.3002, 'review', 1, 'Der Abschnitt definiert den primitiven qualitativen Wortschatz des FRZK. Mengen, mathematische Relationen, Funktionen, Operatoren, Zustandsräume, Information, Raum und Zeit werden ausdrücklich nicht als primitive mathematische Objekte vorausgesetzt.', '2026-07-12 11:14:28', '2026-07-16 05:29:53'),
...
('last_edited_section', '3.3.1', '2026-07-16 04:48:15'),
('last_repository_revision', 'RKB-2026-07-16-K3.3.1-NEUFASSUNG-V2', '2026-07-16 05:29:53'),
('next_citation_number', '86', '2026-07-16 04:48:15'),
('next_equation_number', '3.277', '2026-07-16 04:48:15');
...
--
ALTER TABLE `annotations`
  MODIFY `annotation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;
...
--
ALTER TABLE `authors`
  MODIFY `author_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;

--
-- AUTO_INCREMENT für Tabelle `axioms`
--
ALTER TABLE `axioms`
  MODIFY `axiom_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `definitions`
  MODIFY `definition_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=411;
...
--
ALTER TABLE `equations`
  MODIFY `equation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1014;
...
--
ALTER TABLE `equation_symbols`
  MODIFY `equation_symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=673;
...
--
ALTER TABLE `object_source_links`
  MODIFY `object_source_link_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `repository_revisions`
  MODIFY `revision_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `sources`
  MODIFY `source_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
...
--
ALTER TABLE `source_usage`
  MODIFY `usage_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=400;

--
-- AUTO_INCREMENT für Tabelle `symbols`
--
ALTER TABLE `symbols`
  MODIFY `symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=266;
