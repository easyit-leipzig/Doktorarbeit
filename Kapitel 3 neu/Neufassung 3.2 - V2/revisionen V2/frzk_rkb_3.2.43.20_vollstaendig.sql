...
Definitionen : 3.2.764–3.2.770
Sätze        : 3.2.220–3.2.224
Gleichungen  : (3.3545)–(3.3558)
Literatur    : [132]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.20-V1',NOW(),'subsection','3.2.43.20',
'3.2.43.20-v1-vollstaendig',
'Polarisation elektromagnetischer Wellen einschließlich Jones-Vektor und Stokes-Parameter.',
'Olaf Thiele / ChatGPT')
...
SELECT 132,'polarisation_132','book',
'Polarisation elektromagnetischer Wellen',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=132);
...
'subsection',
'3.2.43.20',
'Polarisation elektromagnetischer Wellen vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.764 Polarisation
-- 3.2.765 Linear polarisierte Welle
-- 3.2.766 Zirkular polarisierte Welle
-- 3.2.767 Elliptische Polarisation
-- 3.2.768 Polarisationszustand
-- 3.2.769 Polarisationsfilter
-- 3.2.770 Stokes-Parameter

-- Sätze
-- 3.2.220 Transversalität elektromagnetischer Wellen
-- 3.2.221 Orthogonales Feldsystem
-- 3.2.222 Jones-Vektor
-- 3.2.223 Gesetz von Malus
-- 3.2.224 Vollständige Beschreibung der Polarisation
...
VALUES
('last_completed_section','3.2.43.20'),
('current_section','3.2.43.21'),
('last_definition_number','3.2.770'),
('next_definition_number','3.2.771'),
('last_theorem_number','3.2.224'),
('next_theorem_number','3.2.225'),
('last_equation_number','3.3558'),
('next_equation_number','3.3559'),
('last_citation_number','132'),
('next_citation_number','133')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.764–3.2.770' AS expected;
SELECT 'Sätze 3.2.220–3.2.224' AS expected;
SELECT 'Gleichungen (3.3545)–(3.3558)' AS expected;
