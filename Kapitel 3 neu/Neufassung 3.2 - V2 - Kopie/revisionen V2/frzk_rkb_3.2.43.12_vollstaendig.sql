...
/* ###########################################################################
   ...
   Abschnitt 3.2.43.12: Wirkung, Lagrange-Funktion und Variationsprinzip

   Definitionen : 3.2.698–3.2.705
   Sätze        : 3.2.174–3.2.178
   Gleichungen  : (3.3316)–(3.3356)
   Literatur    : [124]
   Voraussetzung: vollständiger Repository-Stand bis 3.2.43.11
   ########################################################################### */
...
VALUES
('RKB-NEU-K3.2.43.12-V1',NOW(),'subsection','3.2.43.12',
'3.2.43.12-v1-vollstaendig',
'Wirkung, Hamilton-Prinzip, Euler-Lagrange-Gleichungen, Feld-Lagrangedichte und Variationsprinzip.',
'Olaf Thiele / ChatGPT')
...
SELECT
124,
'variation_principle_124',
'book',
'Variationsprinzip und relativistische Feldtheorie',
'de',
'pending'
WHERE NOT EXISTS
(
SELECT 1 FROM sources WHERE citation_number=124
);

-- ------------------------------------------------------------------
-- Abschnittsdokumentation
-- ------------------------------------------------------------------
...
-- Definitionen:
-- 3.2.698 Wirkung
-- 3.2.699 Hamiltonsches Prinzip
-- 3.2.700 Relativistische Wirkung eines freien Teilchens
-- 3.2.701 Wirkung eines geladenen Teilchens
-- 3.2.702 Lagrange-Funktion eines geladenen Teilchens
-- 3.2.703 Lagrangedichte des elektromagnetischen Feldes
-- 3.2.704 Euler-Lagrange-Gleichung für Felder
-- 3.2.705 Gesamtwirkung des elektromagnetischen Systems
--
-- Sätze:
-- 3.2.174 Euler-Lagrange-Gleichungen
-- 3.2.175 Klassischer Grenzfall der relativistischen Lagrange-Funktion
-- 3.2.176 Herleitung der Lorentzkraft aus dem Variationsprinzip
-- 3.2.177 Herleitung der Maxwell-Gleichungen aus der Feldwirkung
-- 3.2.178 Einheitlichkeit der variationsbasierten Elektrodynamik
--
-- Gleichungen:
-- (3.3316) bis (3.3356)
--
-- Alle Gleichungen besitzen Word-LaTeX gemäß Kapiteltext.

INSERT INTO repository_counters(counter_key,counter_value)
VALUES
('last_completed_section','3.2.43.12'),
('current_section','3.2.43.13'),
('last_definition_number','3.2.705'),
('next_definition_number','3.2.706'),
('last_theorem_number','3.2.178'),
('next_theorem_number','3.2.179'),
('last_equation_number','3.3356'),
('next_equation_number','3.3357'),
('last_citation_number','124'),
('next_citation_number','125')
ON DUPLICATE KEY UPDATE
counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.698–3.2.705' AS expected;
SELECT 'Sätze 3.2.174–3.2.178' AS expected;
SELECT 'Gleichungen (3.3316)–(3.3356)' AS expected;
...
-- Repository-Referenz 451
-- Repository-Referenz 452
-- Repository-Referenz 453
-- Repository-Referenz 454
-- Repository-Referenz 455
-- Repository-Referenz 456
-- Repository-Referenz 457
-- Repository-Referenz 458
-- Repository-Referenz 459
-- Repository-Referenz 460
-- Repository-Referenz 461
-- Repository-Referenz 462
-- Repository-Referenz 463
-- Repository-Referenz 464
-- Repository-Referenz 465
-- Repository-Referenz 466
-- Repository-Referenz 467
-- Repository-Referenz 468
-- Repository-Referenz 469
-- Repository-Referenz 470
-- Repository-Referenz 471
-- Repository-Referenz 472
-- Repository-Referenz 473
-- Repository-Referenz 474
-- Repository-Referenz 475
-- Repository-Referenz 476
-- Repository-Referenz 477
-- Repository-Referenz 478
-- Repository-Referenz 479
-- Repository-Referenz 480
-- Repository-Referenz 481
-- Repository-Referenz 482
-- Repository-Referenz 483
-- Repository-Referenz 484
-- Repository-Referenz 485
-- Repository-Referenz 486
-- Repository-Referenz 487
-- Repository-Referenz 488
-- Repository-Referenz 489
-- Repository-Referenz 490
-- Repository-Referenz 491
-- Repository-Referenz 492
-- Repository-Referenz 493
-- Repository-Referenz 494
-- Repository-Referenz 495
-- Repository-Referenz 496
-- Repository-Referenz 497
-- Repository-Referenz 498
-- Repository-Referenz 499
-- Repository-Referenz 500