...
Repository-Update
Abschnitt 3.2.43.37
Dunkle Materie, Gravitation und funktionale Erweiterungsmöglichkeiten

Definitionen : 3.2.863–3.2.867
Sätze        : 3.2.306–3.2.310
Gleichungen  : (3.3725)–(3.3726)
Literatur    : [149]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.37-V1',NOW(),'subsection','3.2.43.37',
'3.2.43.37-v1-vollstaendig',
'Dunkle Materie, Gravitation und funktionale Erweiterungsmöglichkeiten einschließlich funktionaler Kohärenz und Vereinheitlichung.',
'Olaf Thiele / ChatGPT')
...
SELECT 149,'functional_extensions_149','book',
'Dunkle Materie, Gravitation und funktionale Erweiterungsmöglichkeiten',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=149);
...
-- Definitionen
-- 3.2.863 Funktionale Beschreibungsebene
-- 3.2.864 Funktionale Kohärenz
-- 3.2.865 Funktionale Erweiterung
-- 3.2.866 Mehrskalige Kohärenz
-- 3.2.867 Funktionale Vereinheitlichung

-- Sätze
-- 3.2.306 Unabhängigkeit von der physikalischen Interpretation
-- 3.2.307 Operatorerhaltung
-- 3.2.308 Erweiterbarkeit funktionaler Systeme
-- 3.2.309 Hierarchische Konsistenz
-- 3.2.310 Methodischer Charakter des FRZK
...
VALUES
('last_completed_section','3.2.43.37'),
('current_section','3.2.43.38'),
('last_definition_number','3.2.867'),
('next_definition_number','3.2.868'),
('last_theorem_number','3.2.310'),
('next_theorem_number','3.2.311'),
('last_equation_number','3.3726'),
('next_equation_number','3.3727'),
('last_citation_number','149'),
('next_citation_number','150')
