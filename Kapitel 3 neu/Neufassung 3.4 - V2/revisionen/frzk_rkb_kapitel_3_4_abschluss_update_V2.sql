/* ============================================================
   FRZK-RKB Abschlussupdate Kapitel 3.4 V2

   Korrektur:
   section_change_log ohne Feld description
...
SET @revision_code='RKB-REV-K3.4-ABSCHLUSS-V2';
...
SELECT
 ...
 '3.4',
 '1.0-final',
 'Abschlussrevision Kapitel 3.4 nach Schema-Korrektur.',
 'Olaf Thiele / ChatGPT',
 NULL
WHERE NOT EXISTS
(
...
('last_repository_revision','RKB-REV-K3.4-ABSCHLUSS-V2'),
