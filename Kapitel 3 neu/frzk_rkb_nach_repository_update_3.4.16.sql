...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 13. Jul 2026 um 19:57
...
(60, 'Def. 3.4.17', 69, 'Funktionale Invariante', 'Eine Größe heißt funktionale Invariante, wenn ihr Wert unter jeder zulässigen funktionalen Transformation unverändert bleibt.', 'I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)', 'I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)', 'original', NULL, 'Def. 3.4.6 und Def. 3.4.8 gelten; I_F ist wohldefiniert.', 'Die Invariante kann skalar, vektoriell oder strukturell sein.', 'checked', 53),
(61, 'Def. 3.4.18', 69, 'Menge funktionaler Invarianten', 'Die Menge funktionaler Invarianten umfasst alle wohldefinierten Größen, die unter jeder zulässigen funktionalen Transformation unverändert bleiben.', '\\mathcal{I}_F=\\left\\{I_F\\mid I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)\\right\\}', '\\mathcal{I}_F=\\left\\{I_F\\mid I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)\\right\\}', 'original', NULL, 'Def. 3.4.17 gilt.', 'Die Invariantenmenge charakterisiert die erhaltenen funktionalen Eigenschaften.', 'checked', 53),
(62, 'Def. 3.4.19', 70, 'Funktionales Erhaltungsgesetz', 'Ein funktionales Erhaltungsgesetz liegt vor, wenn eine funktionale Invariante unter jeder zulässigen funktionalen Transformation erhalten bleibt.', '\\forall\\,\\mathcal{T}_F\\in\\mathfrak{T}:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)', '\\forall\\,\\mathcal{T}_F\\in\\mathfrak{T}:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)', 'original', NULL, 'Def. 3.4.17 gilt; die Transformationsklasse \\mathfrak{T} ist wohldefiniert.', 'Erhaltung gegenüber jeder zulässigen Transformation.', 'checked', 54),
(63, 'Def. 3.4.20', 70, 'Klasse funktionaler Erhaltungsgesetze', 'Die Klasse funktionaler Erhaltungsgesetze umfasst alle funktionalen Invarianten, die unter jeder zulässigen funktionalen Transformation erhalten bleiben.', '\\mathcal{E}_F=\\left\\{I_F\\mid\\forall\\mathcal{T}_F\\in\\mathfrak{T}:I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)\\right\\}', '\\mathcal{E}_F=\\left\\{I_F\\mid\\forall\\mathcal{T}_F\\in\\mathfrak{T}:I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)\\right\\}', 'original', NULL, 'Def. 3.4.19 gilt.', 'Klasse aller universell erhaltenen funktionalen Invarianten.', 'checked', 54),
(64, 'Def. 3.4.21', 84, 'Funktionale Symmetrie', 'Eine zulässige funktionale Transformation heißt funktionale Symmetrie bezüglich der Klasse funktionaler Erhaltungsgesetze, wenn sie den Wert jedes Elements dieser Klasse erhält.', '\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{S}_F(\\mathfrak{O})\\right)', '\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{S}_F(\\mathfrak{O})\\right)', 'original', NULL, 'Def. 3.4.19 und Def. 3.4.20 gelten; S_F ist eine zulässige funktionale Transformation.', 'Die Symmetrie ist funktional und setzt keine geometrische Raumstruktur voraus.', 'checked', 55),
(65, 'Def. 3.4.22', 84, 'Klasse funktionaler Symmetrien', 'Die Klasse funktionaler Symmetrien umfasst alle zulässigen funktionalen Transformationen, die sämtliche funktionalen Erhaltungsgesetze erhalten.', '\\mathfrak{S}_F=\\left\\{\\mathcal{S}_F\\mid\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{S}_F(\\mathfrak{O})\\right)\\right\\}', '\\mathfrak{S}_F=\\left\\{\\mathcal{S}_F\\mid\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{S}_F(\\mathfrak{O})\\right)\\right\\}', 'original', NULL, 'Def. 3.4.21 gilt.', 'Eine Gruppenstruktur wird erst nach zusätzlichem Nachweis von Identität und Inversen behauptet.', 'checked', 55),
(66, 'Def. 3.4.23', 85, 'Identische funktionale Symmetrie', 'Die identische funktionale Symmetrie ist die Transformation, die jeden funktionalen Organisationsraum auf sich selbst abbildet.', '\\operatorname{id}_F(\\mathfrak{O})=\\mathfrak{O}', '\\operatorname{id}_F(\\mathfrak{O})=\\mathfrak{O}', 'original', NULL, 'Def. 3.4.21 und Def. 3.4.22 gelten.', 'Die identische funktionale Symmetrie ist das neutrale Element der Komposition.', 'checked', 56),
(67, 'Def. 3.4.24', 85, 'Inverse funktionale Symmetrie', 'Zu einer funktionalen Symmetrie heißt eine funktionale Transformation inverse funktionale Symmetrie, wenn beide Kompositionsrichtungen die identische funktionale Symmetrie ergeben.', '\\mathcal{S}_F^{-1}\\circ\\mathcal{S}_F=\\mathcal{S}_F\\circ\\mathcal{S}_F^{-1}=\\operatorname{id}_F', '\\mathcal{S}_F^{-1}\\circ\\mathcal{S}_F=\\mathcal{S}_F\\circ\\mathcal{S}_F^{-1}=\\operatorname{id}_F', 'original', NULL, 'Def. 3.4.21 bis Def. 3.4.23 gelten; S_F ist bijektiv.', 'Nicht jede funktionale Transformation ist invertierbar. Die Definition gilt nur für reversible Symmetrien.', 'checked', 56),
(68, 'Def. 3.4.25', 86, 'Funktionaler Symmetrieorbit', 'Der funktionale Symmetrieorbit eines Organisationsraums ist die Menge aller Organisationsräume, die durch Anwendung funktionaler Symmetrien aus ihm hervorgehen.', '\\operatorname{Orb}_F(\\mathfrak{O})=\\left\\{\\mathcal{S}_F(\\mathfrak{O})\\mid\\mathcal{S}_F\\in\\mathfrak{S}_F\\right\\}', '\\operatorname{Orb}_F(\\mathfrak{O})=\\left\\{\\mathcal{S}_F(\\mathfrak{O})\\mid\\mathcal{S}_F\\in\\mathfrak{S}_F\\right\\}', 'original', NULL, 'Satz 3.4.12 gilt.', 'Alle Elemente eines Orbits sind durch funktionale Symmetrien miteinander verbunden.', 'checked', 57),
(69, 'Def. 3.4.26', 86, 'Funktionale Quotientenstruktur', 'Die funktionale Quotientenstruktur ist die Menge der Äquivalenzklassen funktionaler Organisationsräume bezüglich ihrer Zugehörigkeit zum selben Symmetrieorbit.', '\\mathfrak{Q}_F=\\mathfrak{O}_F/\\!\\sim_S', '\\mathfrak{Q}_F=\\mathfrak{O}_F/\\!\\sim_S', 'original', NULL, 'Def. 3.4.25 gilt und die Orbitrelation ist eine Äquivalenzrelation.', 'Jedes Element der Quotientenstruktur repräsentiert einen vollständigen Symmetrieorbit.', 'checked', 57),
(70, 'Def. 3.4.27', 87, 'Funktionale Metrik', 'Eine funktionale Metrik ist eine Abbildung auf der funktionalen Quotientenstruktur, die Nichtnegativität, Identität der Ununterscheidbaren, Symmetrie und Dreiecksungleichung erfüllt.', 'd_F:\\mathfrak{Q}_F\\times\\mathfrak{Q}_F\\rightarrow\\mathbb{R}_{\\ge0}', 'd_F:\\mathfrak{Q}_F\\times\\mathfrak{Q}_F\\rightarrow\\mathbb{R}_{\\ge0}', 'original', NULL, 'Def. 3.4.26 und Satz 3.4.13 gelten.', 'Die Metrik wird auf Quotientenklassen und nicht auf beliebigen Repräsentanten definiert.', 'checked', 58),
(71, 'Def. 3.4.28', 88, 'Funktionale offene Umgebung', 'Für eine funktionale Quotientenklasse A und einen Radius epsilon größer null ist die funktionale offene Umgebung die Menge aller Quotientenklassen mit funktionalem Abstand kleiner epsilon zu A.', 'U_{\\varepsilon}(A)=\\left\\{B\\in\\mathfrak{Q}_F\\mid d_F(A,B)<\\varepsilon\\right\\}', 'U_{\\varepsilon}(A)=\\left\\{B\\in\\mathfrak{Q}_F\\mid d_F(A,B)<\\varepsilon\\right\\}', 'original', NULL, 'Def. 3.4.27 und Satz 3.4.14 gelten; epsilon ist positiv.', 'Die offene Umgebung wird durch die funktionale Metrik auf der Quotientenstruktur erzeugt.', 'checked', 59),
(72, 'Def. 3.4.29', 88, 'Funktionale Topologie', 'Die funktionale Topologie ist die durch alle Vereinigungen funktionaler offener Umgebungen erzeugte Teilmenge der Potenzmenge der funktionalen Quotientenstruktur.', '\\mathcal{T}_F\\subseteq\\mathcal{P}(\\mathfrak{Q}_F)', '\\mathcal{T}_F\\subseteq\\mathcal{P}(\\mathfrak{Q}_F)', 'original', NULL, 'Def. 3.4.28 gilt.', 'Die Topologie enthält die leere Menge und den gesamten Raum, ist unter beliebigen Vereinigungen und endlichen Schnitten abgeschlossen.', 'checked', 59),
(73, 'Def. 3.4.30', 89, 'Funktionale Cauchy-Folge', 'Eine Folge funktionaler Quotientenklassen heißt funktionale Cauchy-Folge, wenn ihre Folgenglieder ab einem hinreichend großen Index paarweise beliebig kleine funktionale Abstände besitzen.', '\\forall\\varepsilon>0\\;\\exists N\\in\\mathbb{N}:\\;m,n\\ge N\\Longrightarrow d_F(A_m,A_n)<\\varepsilon', '\\forall\\varepsilon>0\\;\\exists N\\in\\mathbb{N}:\\;m,n\\ge N\\Longrightarrow d_F(A_m,A_n)<\\varepsilon', 'original', NULL, 'Def. 3.4.27 und Satz 3.4.14 gelten.', 'Die Definition setzt keinen Grenzwert voraus, sondern nur die innere Annäherung der Folge.', 'checked', 60),
(74, 'Def. 3.4.31', 89, 'Funktionale Vollständigkeit', 'Ein funktionaler metrischer Raum heißt funktional vollständig, wenn jede funktionale Cauchy-Folge gegen eine Quotientenklasse desselben Raumes konvergiert.', '(A_n)\\text{ Cauchy}\\Longrightarrow\\exists A\\in\\mathfrak{Q}_F:\\;A_n\\rightarrow A', '(A_n)\\text{ Cauchy}\\Longrightarrow\\exists A\\in\\mathfrak{Q}_F:\\;A_n\\rightarrow A', 'original', NULL, 'Def. 3.4.30 und Gleichung (3.135) gelten.', 'Vollständigkeit stellt sicher, dass funktionale Grenzprozesse den betrachteten Raum nicht verlassen.', 'checked', 60);
...
(69, 23, '3.4.9', 'Mathematische Rekonstruktion funktionaler Invarianten', 3, 3.5900, 'review', 1, 'Am 13.07.2026 vollständig neu gefasst. Enthält Def. 3.4.17, Def. 3.4.18, Lemma 3.4.7, Satz 3.4.9 und die Gleichungen (3.102) bis (3.105).', '2026-07-12 11:14:28', '2026-07-13 14:24:50'),
(70, 23, '3.4.10', 'Mathematische Rekonstruktion funktionaler Erhaltungsgesetze', 3, 3.5910, 'review', 1, 'Am 13.07.2026 vollständig neu gefasst. Enthält Def. 3.4.19, Def. 3.4.20, Lemma 3.4.8, Satz 3.4.10 und die Gleichungen (3.106) bis (3.109).', '2026-07-12 11:14:28', '2026-07-13 14:24:56'),
...
(84, 23, '3.4.11', 'Mathematische Rekonstruktion funktionaler Symmetrien', 3, 3.5920, 'review', 1, 'Am 13.07.2026 vollständig neu gefasst. Enthält Def. 3.4.21, Def. 3.4.22, Lemma 3.4.9, Satz 3.4.11 und die Gleichungen (3.110) bis (3.113).', '2026-07-13 14:25:04', '2026-07-13 14:25:04'),
(85, 23, '3.4.12', 'Gruppenstruktur funktionaler Symmetrien', 3, 3.5930, 'review', 1, 'Am 13.07.2026 vollständig neu gefasst. Enthält Def. 3.4.23, Def. 3.4.24, Lemma 3.4.10, Satz 3.4.12 und die Gleichungen (3.114) bis (3.119).', '2026-07-13 15:22:28', '2026-07-13 15:22:28'),
(86, 23, '3.4.13', 'Orbits und Quotientenstrukturen funktionaler Symmetrien', 3, 3.5940, 'review', 1, 'Am 13.07.2026 vollständig neu gefasst. Enthält Def. 3.4.25, Def. 3.4.26, Lemma 3.4.11, Satz 3.4.13 und die Gleichungen (3.120) bis (3.125).', '2026-07-13 15:22:36', '2026-07-13 15:22:36'),
(87, 23, '3.4.14', 'Funktionale Metrik auf der Quotientenstruktur', 3, 3.5950, 'review', 1, 'Am 13.07.2026 vollständig neu gefasst. Enthält Def. 3.4.27, Lemma 3.4.12, Satz 3.4.14 und die Gleichungen (3.126) bis (3.131).', '2026-07-13 15:54:05', '2026-07-13 15:54:05'),
(88, 23, '3.4.15', 'Topologie funktionaler Organisationsräume', 3, 3.5960, 'review', 1, 'Am 13.07.2026 vollständig neu gefasst. Enthält Def. 3.4.28, Def. 3.4.29, Lemma 3.4.13, Satz 3.4.15 und die Gleichungen (3.132) bis (3.136).', '2026-07-13 17:57:35', '2026-07-13 17:57:35'),
(89, 23, '3.4.16', 'Vollständigkeit funktionaler Räume', 3, 3.5970, 'review', 1, 'Am 13.07.2026 vollständig neu gefasst. Enthält Def. 3.4.30, Def. 3.4.31, Lemma 3.4.14, Satz 3.4.16 und die Gleichungen (3.137) bis (3.139).', '2026-07-13 17:57:42', '2026-07-13 17:57:42');
...
(326, '3.102', 69, 'Funktionale Invariante', 'I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)', 'I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)', 'Eine funktionale Invariante besitzt vor und nach einer zulässigen Transformation denselben Wert.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.17.', 'Def. 3.4.6 und Def. 3.4.8 gelten.', 'checked', 53),
(327, '3.103', 69, 'Menge funktionaler Invarianten', '\\mathcal{I}_F=\\left\\{I_F\\mid I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)\\right\\}', '\\mathcal{I}_F=\\left\\{I_F\\mid I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)\\right\\}', 'Die Invariantenmenge enthält alle unter zulässigen Transformationen erhaltenen funktionalen Größen.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.18.', 'Def. 3.4.17 gilt.', 'checked', 53),
(328, '3.104', 69, 'Invarianz entlang einer Entwicklungsbahn', 'I_F(\\mathfrak{O}_0)=I_F(\\mathfrak{O}_1)=\\cdots=I_F(\\mathfrak{O}_n)', 'I_F(\\mathfrak{O}_0)=I_F(\\mathfrak{O}_1)=\\cdots=I_F(\\mathfrak{O}_n)', 'Der Wert einer funktionalen Invarianten bleibt entlang einer zulässigen Entwicklungsbahn konstant.', 'lemma', 'original', NULL, 'Formale Darstellung von Lemma 3.4.7.', 'Def. 3.4.14 und Def. 3.4.17 gelten.', 'checked', 53),
(329, '3.105', 69, 'Invariantenäquivalenz funktionaler Entwicklungsbahnen', '\\mathcal{I}_F(\\Gamma_1)=\\mathcal{I}_F(\\Gamma_2)\\Longrightarrow\\Gamma_1\\sim_I\\Gamma_2', '\\mathcal{I}_F(\\Gamma_1)=\\mathcal{I}_F(\\Gamma_2)\\Longrightarrow\\Gamma_1\\sim_I\\Gamma_2', 'Zwei Entwicklungsbahnen werden als invariantengleich klassifiziert, wenn ihre Invariantenmengen übereinstimmen.', 'theorem', 'original', NULL, 'Formale Darstellung von Satz 3.4.9; ~_I ist durch Gleichheit der Invariantenmengen definiert.', 'Def. 3.4.14 und Def. 3.4.18 gelten.', 'checked', 53),
(330, '3.106', 70, 'Funktionales Erhaltungsgesetz', '\\forall\\,\\mathcal{T}_F\\in\\mathfrak{T}:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)', '\\forall\\,\\mathcal{T}_F\\in\\mathfrak{T}:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)', 'Eine funktionale Invariante bleibt unter jeder zulässigen funktionalen Transformation erhalten.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.19.', 'Def. 3.4.17 gilt.', 'checked', 54),
(331, '3.107', 70, 'Klasse funktionaler Erhaltungsgesetze', '\\mathcal{E}_F=\\left\\{I_F\\mid\\forall\\mathcal{T}_F\\in\\mathfrak{T}:I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)\\right\\}', '\\mathcal{E}_F=\\left\\{I_F\\mid\\forall\\mathcal{T}_F\\in\\mathfrak{T}:I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{T}_F(\\mathfrak{O})\\right)\\right\\}', 'Die Klasse enthält alle gegenüber der gesamten Transformationsklasse invarianten Größen.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.20.', 'Def. 3.4.19 gilt.', 'checked', 54),
(332, '3.108', 70, 'Kompositionserhaltung', 'I_F\\!\\left((\\mathcal{T}_{F,2}\\circ\\mathcal{T}_{F,1})(\\mathfrak{O})\\right)=I_F(\\mathfrak{O})', 'I_F\\!\\left((\\mathcal{T}_{F,2}\\circ\\mathcal{T}_{F,1})(\\mathfrak{O})\\right)=I_F(\\mathfrak{O})', 'Die Komposition zweier bezüglich derselben Invarianten erhaltender Transformationen ist erhaltend.', 'lemma', 'original', NULL, 'Formale Darstellung von Lemma 3.4.8.', 'Beide Transformationen erhalten I_F.', 'checked', 54),
(333, '3.109', 70, 'Stabilität funktionaler Erhaltungsgesetze', '\\left(\\forall i\\in\\{1,\\ldots,n\\}:I_F\\circ\\mathcal{T}_{F,i}=I_F\\right)\\Longrightarrow I_F\\circ\\left(\\mathcal{T}_{F,n}\\circ\\cdots\\circ\\mathcal{T}_{F,1}\\right)=I_F', '\\left(\\forall i\\in\\{1,\\ldots,n\\}:I_F\\circ\\mathcal{T}_{F,i}=I_F\\right)\\Longrightarrow I_F\\circ\\left(\\mathcal{T}_{F,n}\\circ\\cdots\\circ\\mathcal{T}_{F,1}\\right)=I_F', 'Erhaltung in jedem Einzelschritt impliziert Erhaltung unter jeder endlichen Komposition.', 'theorem', 'original', NULL, 'Formale Darstellung von Satz 3.4.10.', 'Def. 3.4.19, Def. 3.4.20 und Lemma 3.4.8 gelten.', 'checked', 54),
(334, '3.110', 84, 'Funktionale Symmetrie', '\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{S}_F(\\mathfrak{O})\\right)', '\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{S}_F(\\mathfrak{O})\\right)', 'Eine funktionale Symmetrie erhält jedes funktionale Erhaltungsgesetz.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.21.', 'Def. 3.4.20 gilt; S_F ist zulässig.', 'checked', 55),
(335, '3.111', 84, 'Klasse funktionaler Symmetrien', '\\mathfrak{S}_F=\\left\\{\\mathcal{S}_F\\mid\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{S}_F(\\mathfrak{O})\\right)\\right\\}', '\\mathfrak{S}_F=\\left\\{\\mathcal{S}_F\\mid\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O})=I_F\\!\\left(\\mathcal{S}_F(\\mathfrak{O})\\right)\\right\\}', 'Die Klasse funktionaler Symmetrien enthält alle erhaltungsgesetzerhaltenden Transformationen.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.22.', 'Def. 3.4.21 gilt.', 'checked', 55),
(336, '3.112', 84, 'Abschluss funktionaler Symmetrien unter Komposition', '\\mathcal{S}_{F,1},\\mathcal{S}_{F,2}\\in\\mathfrak{S}_F\\Longrightarrow\\mathcal{S}_{F,2}\\circ\\mathcal{S}_{F,1}\\in\\mathfrak{S}_F', '\\mathcal{S}_{F,1},\\mathcal{S}_{F,2}\\in\\mathfrak{S}_F\\Longrightarrow\\mathcal{S}_{F,2}\\circ\\mathcal{S}_{F,1}\\in\\mathfrak{S}_F', 'Die wohldefinierte Komposition zweier funktionaler Symmetrien ist wieder eine funktionale Symmetrie.', 'lemma', 'original', NULL, 'Formale Darstellung von Lemma 3.4.9.', 'Def. 3.4.21 und Def. 3.4.22 gelten.', 'checked', 55),
(337, '3.113', 84, 'Erhaltungsgesetze unter funktionalen Symmetrien', '\\mathcal{S}_F\\in\\mathfrak{S}_F\\Longrightarrow\\forall I_F\\in\\mathcal{E}_F:\\;I_F\\circ\\mathcal{S}_F=I_F', '\\mathcal{S}_F\\in\\mathfrak{S}_F\\Longrightarrow\\forall I_F\\in\\mathcal{E}_F:\\;I_F\\circ\\mathcal{S}_F=I_F', 'Jede funktionale Symmetrie erhält jedes bereits definierte funktionale Erhaltungsgesetz.', 'theorem', 'original', NULL, 'Formale Darstellung von Satz 3.4.11.', 'Def. 3.4.20 bis Def. 3.4.22 gelten.', 'checked', 55),
(338, '3.114', 85, 'Identische funktionale Symmetrie', '\\operatorname{id}_F(\\mathfrak{O})=\\mathfrak{O}', '\\operatorname{id}_F(\\mathfrak{O})=\\mathfrak{O}', 'Die identische funktionale Symmetrie bildet jeden funktionalen Organisationsraum auf sich selbst ab.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.23.', 'Def. 3.4.21 und Def. 3.4.22 gelten.', 'checked', 56),
(339, '3.115', 85, 'Neutralität der identischen Symmetrie', '\\operatorname{id}_F\\circ\\mathcal{S}_F=\\mathcal{S}_F\\circ\\operatorname{id}_F=\\mathcal{S}_F', '\\operatorname{id}_F\\circ\\mathcal{S}_F=\\mathcal{S}_F\\circ\\operatorname{id}_F=\\mathcal{S}_F', 'Die identische funktionale Symmetrie ist neutrales Element der Komposition.', 'definition', 'original', NULL, 'Folgerung aus Def. 3.4.23.', 'Def. 3.4.23 gilt.', 'checked', 56),
(340, '3.116', 85, 'Inverse funktionale Symmetrie', '\\mathcal{S}_F^{-1}\\circ\\mathcal{S}_F=\\mathcal{S}_F\\circ\\mathcal{S}_F^{-1}=\\operatorname{id}_F', '\\mathcal{S}_F^{-1}\\circ\\mathcal{S}_F=\\mathcal{S}_F\\circ\\mathcal{S}_F^{-1}=\\operatorname{id}_F', 'Die inverse funktionale Symmetrie macht die Wirkung der ursprünglichen Symmetrie rückgängig.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.24.', 'Def. 3.4.23 gilt; S_F ist bijektiv.', 'checked', 56);
INSERT INTO `equations` (`equation_id`, `equation_number`, `section_id`, `title`, `equation_latex`, `word_latex`, `plain_description`, `equation_type`, `provenance`, `source_id`, `derivation`, `assumptions`, `validation_status`, `created_revision_id`) VALUES
(341, '3.117', 85, 'Erhaltung durch inverse Symmetrien', '\\forall I_F\\in\\mathcal{E}_F:\\;I_F\\circ\\mathcal{S}_F^{-1}=I_F', '\\forall I_F\\in\\mathcal{E}_F:\\;I_F\\circ\\mathcal{S}_F^{-1}=I_F', 'Auch die inverse funktionale Symmetrie erhält jedes funktionale Erhaltungsgesetz.', 'lemma', 'original', NULL, 'Formale Darstellung von Lemma 3.4.10.', 'Def. 3.4.24 gilt.', 'checked', 56),
(342, '3.118', 85, 'Gruppe funktionaler Symmetrien', '\\left(\\mathfrak{S}_F,\\circ\\right)', '\\left(\\mathfrak{S}_F,\\circ\\right)', 'Die Klasse funktionaler Symmetrien bildet zusammen mit der Komposition die betrachtete algebraische Struktur.', 'theorem', 'original', NULL, 'Formale Kurzbezeichnung von Satz 3.4.12.', 'Die Gruppenaxiome sind erfüllt.', 'checked', 56),
(343, '3.119', 85, 'Gruppenaxiome funktionaler Symmetrien', '\\begin{aligned}\\mathcal{S}_{F,1},\\mathcal{S}_{F,2}\\in\\mathfrak{S}_F&\\Longrightarrow\\mathcal{S}_{F,2}\\circ\\mathcal{S}_{F,1}\\in\\mathfrak{S}_F,\\\\\\left(\\mathcal{S}_{F,3}\\circ\\mathcal{S}_{F,2}\\right)\\circ\\mathcal{S}_{F,1}&=\\mathcal{S}_{F,3}\\circ\\left(\\mathcal{S}_{F,2}\\circ\\mathcal{S}_{F,1}\\right),\\\\\\operatorname{id}_F\\circ\\mathcal{S}_F&=\\mathcal{S}_F\\circ\\operatorname{id}_F=\\mathcal{S}_F,\\\\\\mathcal{S}_F^{-1}\\circ\\mathcal{S}_F&=\\mathcal{S}_F\\circ\\mathcal{S}_F^{-1}=\\operatorname{id}_F\\end{aligned}', '\\begin{aligned}\\mathcal{S}_{F,1},\\mathcal{S}_{F,2}\\in\\mathfrak{S}_F&\\Longrightarrow\\mathcal{S}_{F,2}\\circ\\mathcal{S}_{F,1}\\in\\mathfrak{S}_F,\\\\\\left(\\mathcal{S}_{F,3}\\circ\\mathcal{S}_{F,2}\\right)\\circ\\mathcal{S}_{F,1}&=\\mathcal{S}_{F,3}\\circ\\left(\\mathcal{S}_{F,2}\\circ\\mathcal{S}_{F,1}\\right),\\\\\\operatorname{id}_F\\circ\\mathcal{S}_F&=\\mathcal{S}_F\\circ\\operatorname{id}_F=\\mathcal{S}_F,\\\\\\mathcal{S}_F^{-1}\\circ\\mathcal{S}_F&=\\mathcal{S}_F\\circ\\mathcal{S}_F^{-1}=\\operatorname{id}_F\\end{aligned}', 'Die funktionalen Symmetrien erfüllen Abschluss, Assoziativität, Identität und Invertierbarkeit.', 'theorem', 'original', NULL, 'Ausführliche formale Darstellung von Satz 3.4.12.', 'Def. 3.4.22 bis Def. 3.4.24 und Lemma 3.4.9 bis Lemma 3.4.10 gelten.', 'checked', 56),
(344, '3.120', 86, 'Funktionaler Symmetrieorbit', '\\operatorname{Orb}_F(\\mathfrak{O})=\\left\\{\\mathcal{S}_F(\\mathfrak{O})\\mid\\mathcal{S}_F\\in\\mathfrak{S}_F\\right\\}', '\\operatorname{Orb}_F(\\mathfrak{O})=\\left\\{\\mathcal{S}_F(\\mathfrak{O})\\mid\\mathcal{S}_F\\in\\mathfrak{S}_F\\right\\}', 'Der Symmetrieorbit enthält alle durch funktionale Symmetrien erreichbaren Organisationsräume.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.25.', 'Satz 3.4.12 gilt.', 'checked', 57),
(345, '3.121', 86, 'Orbitäquivalenz', '\\mathfrak{O}_1\\sim_S\\mathfrak{O}_2\\Longleftrightarrow\\exists\\,\\mathcal{S}_F\\in\\mathfrak{S}_F:\\;\\mathfrak{O}_2=\\mathcal{S}_F(\\mathfrak{O}_1)', '\\mathfrak{O}_1\\sim_S\\mathfrak{O}_2\\Longleftrightarrow\\exists\\,\\mathcal{S}_F\\in\\mathfrak{S}_F:\\;\\mathfrak{O}_2=\\mathcal{S}_F(\\mathfrak{O}_1)', 'Zwei Organisationsräume sind orbitäquivalent, wenn eine funktionale Symmetrie den einen in den anderen überführt.', 'definition', 'original', NULL, 'Äquivalenzrelation auf Basis von Def. 3.4.25.', 'Satz 3.4.12 gilt.', 'checked', 57),
(346, '3.122', 86, 'Funktionale Quotientenstruktur', '\\mathfrak{Q}_F=\\mathfrak{O}_F/\\!\\sim_S', '\\mathfrak{Q}_F=\\mathfrak{O}_F/\\!\\sim_S', 'Die Quotientenstruktur enthält die Äquivalenzklassen der Orbitrelation.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.26.', 'Die Orbitrelation ist eine Äquivalenzrelation.', 'checked', 57),
(347, '3.123', 86, 'Projektion auf die Quotientenstruktur', '\\pi_F:\\mathfrak{O}_F\\rightarrow\\mathfrak{Q}_F,\\qquad\\pi_F(\\mathfrak{O})=[\\mathfrak{O}]_{\\sim_S}', '\\pi_F:\\mathfrak{O}_F\\rightarrow\\mathfrak{Q}_F,\\qquad\\pi_F(\\mathfrak{O})=[\\mathfrak{O}]_{\\sim_S}', 'Die kanonische Projektion ordnet jedem Organisationsraum seine Orbitklasse zu.', 'theorem', 'original', NULL, 'Bestandteil von Satz 3.4.13.', 'Def. 3.4.26 gilt.', 'checked', 57),
(348, '3.124', 86, 'Invarianz auf Symmetrieorbits', '\\mathfrak{O}_1\\sim_S\\mathfrak{O}_2\\Longrightarrow\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O}_1)=I_F(\\mathfrak{O}_2)', '\\mathfrak{O}_1\\sim_S\\mathfrak{O}_2\\Longrightarrow\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O}_1)=I_F(\\mathfrak{O}_2)', 'Funktionale Erhaltungsgesetze sind auf jedem Symmetrieorbit konstant.', 'lemma', 'original', NULL, 'Formale Darstellung von Lemma 3.4.11.', 'Def. 3.4.21 und Def. 3.4.25 gelten.', 'checked', 57),
(349, '3.125', 86, 'Wohldefiniertheit der Quotientenabbildung', '\\pi_F(\\mathfrak{O}_1)=\\pi_F(\\mathfrak{O}_2)\\Longleftrightarrow\\mathfrak{O}_1\\sim_S\\mathfrak{O}_2', '\\pi_F(\\mathfrak{O}_1)=\\pi_F(\\mathfrak{O}_2)\\Longleftrightarrow\\mathfrak{O}_1\\sim_S\\mathfrak{O}_2', 'Zwei Organisationsräume besitzen genau dann dasselbe Quotientenbild, wenn sie orbitäquivalent sind.', 'theorem', 'original', NULL, 'Folgerung aus Satz 3.4.13.', 'Die Orbitrelation ist eine Äquivalenzrelation.', 'checked', 57),
(350, '3.126', 87, 'Funktionale Metrik', 'd_F:\\mathfrak{Q}_F\\times\\mathfrak{Q}_F\\rightarrow\\mathbb{R}_{\\ge0}', 'd_F:\\mathfrak{Q}_F\\times\\mathfrak{Q}_F\\rightarrow\\mathbb{R}_{\\ge0}', 'Die funktionale Metrik ordnet jedem Paar funktionaler Quotientenklassen einen nichtnegativen reellen Abstand zu.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.27.', 'Def. 3.4.26 gilt.', 'checked', 58),
(351, '3.127', 87, 'Nichtnegativität', 'd_F(A,B)\\ge0', 'd_F(A,B)\\ge0', 'Funktionale Abstände sind nichtnegativ.', 'axiom', 'original', NULL, 'Erstes Metrikaxiom.', 'A,B\\in\\mathfrak{Q}_F.', 'checked', 58),
(352, '3.128', 87, 'Identität der Ununterscheidbaren', 'd_F(A,B)=0\\Longleftrightarrow A=B', 'd_F(A,B)=0\\Longleftrightarrow A=B', 'Genau identische Quotientenklassen besitzen Abstand null.', 'axiom', 'original', NULL, 'Zweites Metrikaxiom.', 'A,B\\in\\mathfrak{Q}_F.', 'checked', 58),
(353, '3.129', 87, 'Symmetrie der funktionalen Metrik', 'd_F(A,B)=d_F(B,A)', 'd_F(A,B)=d_F(B,A)', 'Der funktionale Abstand ist unabhängig von der Reihenfolge der Quotientenklassen.', 'axiom', 'original', NULL, 'Drittes Metrikaxiom.', 'A,B\\in\\mathfrak{Q}_F.', 'checked', 58),
(354, '3.130', 87, 'Dreiecksungleichung', 'd_F(A,C)\\le d_F(A,B)+d_F(B,C)', 'd_F(A,C)\\le d_F(A,B)+d_F(B,C)', 'Der direkte funktionale Abstand ist höchstens so groß wie der Umweg über eine dritte Quotientenklasse.', 'axiom', 'original', NULL, 'Viertes Metrikaxiom.', 'A,B,C\\in\\mathfrak{Q}_F.', 'checked', 58),
(355, '3.131', 87, 'Funktionaler metrischer Raum', '\\left(\\mathfrak{Q}_F,d_F\\right)', '\\left(\\mathfrak{Q}_F,d_F\\right)', 'Die funktionale Quotientenstruktur bildet zusammen mit der funktionalen Metrik einen metrischen Raum.', 'theorem', 'original', NULL, 'Formale Kurzbezeichnung von Satz 3.4.14.', 'Die Gleichungen (3.127) bis (3.130) gelten.', 'checked', 58),
(356, '3.132', 88, 'Funktionale offene Umgebung', 'U_{\\varepsilon}(A)=\\left\\{B\\in\\mathfrak{Q}_F\\mid d_F(A,B)<\\varepsilon\\right\\}', 'U_{\\varepsilon}(A)=\\left\\{B\\in\\mathfrak{Q}_F\\mid d_F(A,B)<\\varepsilon\\right\\}', 'Die funktionale offene Umgebung enthält alle Quotientenklassen mit Abstand kleiner epsilon zu A.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.28.', 'Def. 3.4.27 gilt; epsilon ist positiv.', 'checked', 59),
(357, '3.133', 88, 'Funktionale Topologie', '\\mathcal{T}_F\\subseteq\\mathcal{P}(\\mathfrak{Q}_F)', '\\mathcal{T}_F\\subseteq\\mathcal{P}(\\mathfrak{Q}_F)', 'Die funktionale Topologie ist eine Familie offener Teilmengen der funktionalen Quotientenstruktur.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.29.', 'Def. 3.4.28 gilt.', 'checked', 59),
(358, '3.134', 88, 'Metrik erzeugt Topologie', 'd_F\\Longrightarrow\\mathcal{T}_F', 'd_F\\Longrightarrow\\mathcal{T}_F', 'Die funktionale Metrik erzeugt über ihre offenen Kugeln eine funktionale Topologie.', 'theorem', 'original', NULL, 'Formale Darstellung von Satz 3.4.15.', 'Def. 3.4.27 bis Def. 3.4.29 gelten.', 'checked', 59),
(359, '3.135', 88, 'Funktionale Konvergenz', '\\forall\\varepsilon>0\\;\\exists N\\in\\mathbb{N}:\\;n\\ge N\\Longrightarrow d_F(A_n,A)<\\varepsilon', '\\forall\\varepsilon>0\\;\\exists N\\in\\mathbb{N}:\\;n\\ge N\\Longrightarrow d_F(A_n,A)<\\varepsilon', 'Eine Folge funktionaler Quotientenklassen konvergiert gegen A, wenn sie schließlich in jeder offenen Umgebung von A liegt.', 'definition', 'original', NULL, 'Metrische Konvergenz auf dem funktionalen metrischen Raum.', 'Satz 3.4.14 gilt.', 'checked', 59),
(360, '3.136', 88, 'Funktionale Stetigkeit', 'A_n\\rightarrow A\\Longrightarrow F(A_n)\\rightarrow F(A)', 'A_n\\rightarrow A\\Longrightarrow F(A_n)\\rightarrow F(A)', 'Eine Abbildung ist funktional stetig, wenn sie konvergente Folgen in konvergente Bildfolgen überführt.', 'definition', 'original', NULL, 'Folgencharakterisierung funktionaler Stetigkeit.', 'Quell- und Zielraum sind funktionale metrische Räume.', 'checked', 59),
(361, '3.137', 89, 'Funktionale Cauchy-Folge', '\\forall\\varepsilon>0\\;\\exists N\\in\\mathbb{N}:\\;m,n\\ge N\\Longrightarrow d_F(A_m,A_n)<\\varepsilon', '\\forall\\varepsilon>0\\;\\exists N\\in\\mathbb{N}:\\;m,n\\ge N\\Longrightarrow d_F(A_m,A_n)<\\varepsilon', 'Die Folgenglieder einer funktionalen Cauchy-Folge besitzen ab einem hinreichend großen Index beliebig kleine paarweise Abstände.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.30.', 'Def. 3.4.27 gilt.', 'checked', 60),
(362, '3.138', 89, 'Funktionale Vollständigkeit', '(A_n)\\text{ Cauchy}\\Longrightarrow\\exists A\\in\\mathfrak{Q}_F:\\;A_n\\rightarrow A', '(A_n)\\text{ Cauchy}\\Longrightarrow\\exists A\\in\\mathfrak{Q}_F:\\;A_n\\rightarrow A', 'Jede funktionale Cauchy-Folge konvergiert in einem vollständigen funktionalen Raum gegen eine Quotientenklasse desselben Raumes.', 'definition', 'original', NULL, 'Formale Darstellung von Def. 3.4.31.', 'Def. 3.4.30 und Gleichung (3.135) gelten.', 'checked', 60),
(363, '3.139', 89, 'Vollständiger funktionaler Raum', '(A_n)\\text{ Cauchy}\\Longrightarrow\\exists!\\,A\\in\\mathfrak{Q}_F:\\;A_n\\rightarrow A', '(A_n)\\text{ Cauchy}\\Longrightarrow\\exists!\\,A\\in\\mathfrak{Q}_F:\\;A_n\\rightarrow A', 'Jede funktionale Cauchy-Folge besitzt in einem vollständigen funktionalen Raum einen eindeutig bestimmten Grenzwert.', 'theorem', 'original', NULL, 'Formale Darstellung von Satz 3.4.16.', 'Def. 3.4.31 und Lemma 3.4.14 gelten.', 'checked', 60);
...
(113, 326, 304, '', 'Die Invarianz verwendet die rekursive Transformation aus Gleichung (3.80).'),
(114, 326, 308, '', 'Die Invariante wird auf Organisationsräumen nach Gleichung (3.84) ausgewertet.'),
(115, 327, 326, '', 'Die Invariantenmenge wird aus der Invarianzbedingung gebildet.'),
(116, 328, 326, '', 'Die Bahnkonstanz folgt durch wiederholte Anwendung der Invarianzbedingung.'),
(117, 328, 319, '', 'Die Aussage wird entlang der Entwicklungsbahn aus Gleichung (3.95) formuliert.'),
(118, 329, 327, '', 'Die Äquivalenzklassifikation verwendet die Invariantenmengen.'),
(119, 329, 319, '', 'Die verglichenen Objekte sind funktionale Entwicklungsbahnen.'),
(120, 330, 326, '', 'Das Erhaltungsgesetz erweitert die Invarianzbedingung aus Gleichung (3.102) auf alle zulässigen Transformationen.'),
(121, 331, 330, '', 'Die Erhaltungsgesetzklasse wird aus der universellen Erhaltungsbedingung gebildet.'),
(122, 331, 327, '', 'Die Erhaltungsgesetzklasse ist eine Teilklasse der Invariantenmenge.'),
(123, 332, 330, '', 'Die Kompositionserhaltung folgt aus der Erhaltung durch beide Einzeltransformationen.'),
(124, 333, 332, '', 'Die Stabilität unter endlicher Komposition folgt induktiv aus dem Lemma.'),
(125, 333, 331, '', 'Der Satz bezieht sich auf die Klasse funktionaler Erhaltungsgesetze.'),
(126, 334, 331, '', 'Die Symmetriedefinition verwendet die in Gleichung (3.107) definierte Klasse funktionaler Erhaltungsgesetze.'),
(127, 334, 330, '', 'Die Symmetrie erhält die in Gleichung (3.106) formulierten Erhaltungsgesetze.'),
(128, 335, 334, '', 'Die Symmetrieklasse wird aus der Symmetriebedingung gebildet.'),
(129, 336, 335, '', 'Das Abschlusslemma wird auf der Klasse funktionaler Symmetrien formuliert.'),
(130, 336, 332, '', 'Die Kompositionserhaltung folgt derselben Kompositionslogik wie Gleichung (3.108).'),
(131, 337, 334, '', 'Die Erhaltungsaussage ist die Funktionsform der Symmetriedefinition.'),
(132, 337, 331, '', 'Der Satz quantifiziert über die Klasse funktionaler Erhaltungsgesetze.'),
(133, 338, 335, '', 'Die identische Symmetrie ist Element der in Gleichung (3.111) definierten Symmetrieklasse.'),
(134, 339, 338, '', 'Die Neutralität folgt aus der Definition der identischen Symmetrie.'),
(135, 340, 338, '', 'Die inverse Symmetrie wird über die Identität definiert.'),
(136, 340, 336, '', 'Die Inversenbedingung ergänzt den Kompositionsabschluss aus Gleichung (3.112).'),
(137, 341, 337, '', 'Die Erhaltung durch inverse Symmetrien baut auf der allgemeinen Symmetrieerhaltung auf.'),
(138, 341, 340, '', 'Die Inversenerhaltung folgt aus der Inversenbeziehung.'),
(139, 342, 335, '', 'Die Gruppe verwendet die Klasse funktionaler Symmetrien.'),
(140, 342, 336, '', 'Die Gruppe setzt Abschluss unter Komposition voraus.'),
(141, 343, 339, '', 'Die Gruppenaxiome enthalten das neutrale Element.'),
(142, 343, 340, '', 'Die Gruppenaxiome enthalten inverse Elemente.'),
(143, 343, 342, '', 'Die Gruppenaxiome entfalten die in Gleichung (3.118) bezeichnete Gruppenstruktur.'),
(144, 344, 342, '', 'Der Orbit wird durch die Symmetriegruppe aus Gleichung (3.118) erzeugt.'),
(145, 345, 344, '', 'Die Orbitäquivalenz folgt aus der Orbitdefinition.'),
(146, 345, 343, '', 'Reflexivität, Symmetrie und Transitivität verwenden die Gruppenaxiome.'),
(147, 346, 345, '', 'Die Quotientenstruktur wird aus der Orbitäquivalenz gebildet.'),
(148, 347, 346, '', 'Die Projektion bildet in die Quotientenstruktur ab.'),
(149, 348, 345, '', 'Die Invarianzaussage gilt für orbitäquivalente Organisationsräume.'),
(150, 349, 347, '', 'Die Wohldefiniertheit bezieht sich auf die kanonische Projektion.'),
(151, 349, 345, '', 'Gleiches Quotientenbild ist äquivalent zur Orbitäquivalenz.'),
(152, 350, 346, '', 'Die funktionale Metrik wird auf der Quotientenstruktur aus Gleichung (3.122) definiert.'),
(153, 350, 349, '', 'Die Wohldefiniertheit der Quotientenklassen wird durch Gleichung (3.125) gesichert.'),
(154, 351, 350, '', 'Nichtnegativität ist ein Metrikaxiom von d_F.'),
(155, 352, 350, '', 'Identität der Ununterscheidbaren ist ein Metrikaxiom von d_F.'),
(156, 353, 350, '', 'Symmetrie ist ein Metrikaxiom von d_F.'),
(157, 354, 350, '', 'Die Dreiecksungleichung ist ein Metrikaxiom von d_F.'),
(158, 355, 350, '', 'Der metrische Raum verwendet die funktionale Metrik.'),
(159, 355, 351, '', 'Der metrische Raum setzt Nichtnegativität voraus.'),
(160, 355, 352, '', 'Der metrische Raum setzt Identität der Ununterscheidbaren voraus.'),
(161, 355, 353, '', 'Der metrische Raum setzt Symmetrie voraus.'),
(162, 355, 354, '', 'Der metrische Raum setzt die Dreiecksungleichung voraus.'),
(163, 356, 350, '', 'Die offene Umgebung verwendet die funktionale Metrik aus Gleichung (3.126).'),
(164, 357, 356, '', 'Die funktionale Topologie wird durch Vereinigungen offener Umgebungen erzeugt.'),
(165, 358, 356, '', 'Die Topologieinduktion verwendet offene Kugeln.'),
(166, 358, 357, '', 'Die erzeugte Struktur ist die funktionale Topologie.'),
(167, 358, 354, '', 'Die Basiseigenschaft der offenen Kugeln verwendet die Dreiecksungleichung.'),
(168, 359, 350, '', 'Funktionale Konvergenz wird durch die funktionale Metrik definiert.'),
(169, 359, 356, '', 'Die Konvergenzbedingung entspricht dem schließlichen Eintritt in jede offene Umgebung.'),
(170, 360, 359, '', 'Die Folgenstetigkeit verwendet die funktionale Konvergenz.'),
(171, 360, 355, '', 'Quell- und Zielraum sind funktionale metrische Räume.'),
(172, 361, 355, '', 'Die Cauchy-Bedingung wird im funktionalen metrischen Raum formuliert.'),
(173, 362, 361, '', 'Funktionale Vollständigkeit quantifiziert über Cauchy-Folgen.'),
(174, 362, 359, '', 'Die Konvergenzaussage verwendet Gleichung (3.135).'),
(175, 363, 362, '', 'Die Existenz des Grenzwertes folgt aus Vollständigkeit.'),
(176, 363, 352, '', 'Die Eindeutigkeit verwendet die Identität der Ununterscheidbaren.'),
(177, 363, 354, '', 'Die Eindeutigkeit verwendet die Dreiecksungleichung.');
...
(308, 326, 'I_F', 'funktionale Invariante', 'Unter zulässigen Transformationen erhaltene funktionale Größe.', NULL, 'Abbildung auf Organisationsräumen', 1),
(309, 326, '\\mathfrak{O}', 'funktionaler Organisationsraum', 'Beliebiger funktionaler Organisationsraum.', NULL, 'Organisationsraum', 2),
(310, 326, '\\mathcal{T}_F', 'funktionale Transformation', 'Zulässige Transformation des Organisationsraums.', NULL, 'Abbildung', 3),
(311, 327, '\\mathcal{I}_F', 'Menge funktionaler Invarianten', 'Gesamtheit aller funktionalen Invarianten.', NULL, 'Menge', 1),
(312, 327, 'I_F', 'Element der Invariantenmenge', 'Eine die Invarianzbedingung erfüllende Größe.', NULL, 'I_F\\in\\mathcal{I}_F', 2),
(313, 328, '\\mathfrak{O}_i', 'i-ter Organisationsraum', 'Organisationsraum an Position i der Entwicklungsbahn.', NULL, 'Organisationsraum', 1),
(314, 328, 'I_F(\\mathfrak{O}_i)', 'Invariantenwert', 'Wert der Invarianten am i-ten Organisationsraum.', NULL, 'Wertebereich von I_F', 2),
(315, 329, '\\Gamma_1', 'erste Entwicklungsbahn', 'Erste zu vergleichende Entwicklungsbahn.', NULL, 'Entwicklungsbahn', 1),
(316, 329, '\\Gamma_2', 'zweite Entwicklungsbahn', 'Zweite zu vergleichende Entwicklungsbahn.', NULL, 'Entwicklungsbahn', 2),
(317, 329, '\\sim_I', 'Invariantenäquivalenz', 'Durch Gleichheit der Invariantenmengen definierte Äquivalenzrelation.', NULL, 'Äquivalenzrelation', 3),
(318, 330, '\\mathfrak{T}', 'Klasse zulässiger Transformationen', 'Gesamtheit aller zulässigen funktionalen Transformationen.', NULL, 'Transformationsklasse', 1),
(319, 330, 'I_F', 'funktionale Invariante', 'Unter jeder zulässigen Transformation erhaltene Größe.', NULL, 'Invariante', 2),
(320, 330, '\\mathfrak{O}', 'funktionaler Organisationsraum', 'Beliebiger funktionaler Organisationsraum.', NULL, 'Organisationsraum', 3),
(321, 331, '\\mathcal{E}_F', 'Klasse funktionaler Erhaltungsgesetze', 'Gesamtheit aller universell erhaltenen funktionalen Invarianten.', NULL, 'Menge', 1),
(322, 332, '\\mathcal{T}_{F,1}', 'erste erhaltende Transformation', 'Erste bezüglich I_F erhaltende Transformation.', NULL, 'Abbildung', 1),
(323, 332, '\\mathcal{T}_{F,2}', 'zweite erhaltende Transformation', 'Zweite bezüglich I_F erhaltende Transformation.', NULL, 'Abbildung', 2),
(324, 332, '\\circ', 'Kompositionsoperator', 'Hintereinanderausführung funktionaler Transformationen.', NULL, 'Abbildungsoperator', 3),
(325, 333, 'n', 'Anzahl der Transformationsschritte', 'Endliche Anzahl der komponierten Transformationen.', NULL, '\\mathbb{N}', 1),
(326, 333, '\\mathcal{T}_{F,i}', 'i-te erhaltende Transformation', 'i-te Transformation der endlichen Transformationsfolge.', NULL, 'Abbildung', 2),
(327, 334, '\\mathcal{S}_F', 'funktionale Symmetrie', 'Zulässige Transformation, die alle Elemente von E_F erhält.', NULL, 'funktionale Transformation', 1),
(328, 334, '\\mathcal{E}_F', 'Klasse funktionaler Erhaltungsgesetze', 'In Def. 3.4.20 definierte Klasse erhaltener Invarianten.', NULL, 'Menge', 2),
(329, 334, 'I_F', 'funktionales Erhaltungsgesetz', 'Ein Element der Klasse funktionaler Erhaltungsgesetze.', NULL, 'I_F\\in\\mathcal{E}_F', 3),
(330, 335, '\\mathfrak{S}_F', 'Klasse funktionaler Symmetrien', 'Gesamtheit aller erhaltungsgesetzerhaltenden Transformationen.', NULL, 'Transformationsklasse', 1),
(331, 335, '\\mathcal{S}_F', 'Element der Symmetrieklasse', 'Eine funktionale Symmetrie.', NULL, '\\mathcal{S}_F\\in\\mathfrak{S}_F', 2),
(332, 336, '\\mathcal{S}_{F,1}', 'erste funktionale Symmetrie', 'Erste zu komponierende funktionale Symmetrie.', NULL, 'Symmetrie', 1),
(333, 336, '\\mathcal{S}_{F,2}', 'zweite funktionale Symmetrie', 'Zweite zu komponierende funktionale Symmetrie.', NULL, 'Symmetrie', 2),
(334, 336, '\\circ', 'Kompositionsoperator', 'Hintereinanderausführung zweier funktionaler Symmetrien.', NULL, 'Abbildungsoperator', 3),
(335, 337, 'I_F\\circ\\mathcal{S}_F=I_F', 'Symmetrieerhaltung', 'Funktionsgleichheit der Invarianten vor und nach Symmetrietransformation.', NULL, 'Funktionsgleichheit', 1),
(336, 338, '\\operatorname{id}_F', 'identische funktionale Symmetrie', 'Neutrale Transformation auf funktionalen Organisationsräumen.', NULL, 'Abbildung', 1),
(337, 338, '\\mathfrak{O}', 'funktionaler Organisationsraum', 'Beliebiger funktionaler Organisationsraum.', NULL, 'Organisationsraum', 2),
(338, 339, '\\mathcal{S}_F', 'funktionale Symmetrie', 'Beliebige funktionale Symmetrie.', NULL, 'Symmetrie', 1),
(339, 339, '\\circ', 'Kompositionsoperator', 'Hintereinanderausführung funktionaler Symmetrien.', NULL, 'Abbildungsoperator', 2),
(340, 340, '\\mathcal{S}_F^{-1}', 'inverse funktionale Symmetrie', 'Inverse der funktionalen Symmetrie S_F.', NULL, 'inverse Abbildung', 1),
(341, 340, '\\operatorname{id}_F', 'identische funktionale Symmetrie', 'Neutrales Element der Komposition.', NULL, 'Abbildung', 2),
(342, 341, '\\mathcal{E}_F', 'Klasse funktionaler Erhaltungsgesetze', 'Gesamtheit der funktionalen Erhaltungsgesetze.', NULL, 'Menge', 1),
(343, 341, 'I_F', 'funktionales Erhaltungsgesetz', 'Beliebiges Element aus E_F.', NULL, 'I_F\\in\\mathcal{E}_F', 2),
(344, 342, '\\mathfrak{S}_F', 'Symmetrieklasse', 'Klasse funktionaler Symmetrien.', NULL, 'Menge', 1),
(345, 342, '\\circ', 'Gruppenoperation', 'Komposition funktionaler Symmetrien.', NULL, 'Operation', 2),
(346, 343, '\\mathcal{S}_{F,i}', 'i-te funktionale Symmetrie', 'Beliebiges Element der Symmetrieklasse.', NULL, '\\mathfrak{S}_F', 1),
(347, 344, '\\operatorname{Orb}_F(\\mathfrak{O})', 'funktionaler Symmetrieorbit', 'Menge aller aus O durch funktionale Symmetrien erzeugbaren Organisationsräume.', NULL, 'Menge', 1),
(348, 344, '\\mathfrak{S}_F', 'Gruppe funktionaler Symmetrien', 'In Satz 3.4.12 definierte Symmetriegruppe.', NULL, 'Gruppe', 2),
(349, 345, '\\sim_S', 'Orbitäquivalenz', 'Äquivalenzrelation der Zugehörigkeit zum selben Symmetrieorbit.', NULL, 'Relation', 1),
(350, 346, '\\mathfrak{Q}_F', 'funktionale Quotientenstruktur', 'Menge der Orbitäquivalenzklassen.', NULL, 'Quotientenmenge', 1),
(351, 347, '\\pi_F', 'kanonische Projektion', 'Ordnet einem Organisationsraum seine Orbitklasse zu.', NULL, 'Abbildung', 1),
(352, 348, '\\mathcal{E}_F', 'Klasse funktionaler Erhaltungsgesetze', 'Auf Symmetrieorbits konstante Invariantenklasse.', NULL, 'Menge', 1),
(353, 349, '[\\mathfrak{O}]_{\\sim_S}', 'Orbitklasse', 'Äquivalenzklasse eines Organisationsraums unter der Orbitrelation.', NULL, 'Äquivalenzklasse', 1),
(354, 350, 'd_F', 'funktionale Metrik', 'Abstandsfunktion auf der funktionalen Quotientenstruktur.', NULL, '\\mathfrak{Q}_F\\times\\mathfrak{Q}_F\\rightarrow\\mathbb{R}_{\\ge0}', 1),
(355, 350, '\\mathfrak{Q}_F', 'funktionale Quotientenstruktur', 'Menge funktionaler Symmetrieorbitklassen.', NULL, 'Quotientenmenge', 2),
(356, 351, 'A', 'erste Quotientenklasse', 'Erste funktionale Quotientenklasse.', NULL, 'A\\in\\mathfrak{Q}_F', 1),
(357, 351, 'B', 'zweite Quotientenklasse', 'Zweite funktionale Quotientenklasse.', NULL, 'B\\in\\mathfrak{Q}_F', 2),
(358, 352, '0', 'Nullabstand', 'Kennzeichnet Identität der beiden Quotientenklassen.', NULL, '\\mathbb{R}_{\\ge0}', 1),
(359, 353, 'd_F(A,B)', 'funktionaler Abstand', 'Abstand zwischen den Quotientenklassen A und B.', NULL, '\\mathbb{R}_{\\ge0}', 1),
(360, 354, 'C', 'dritte Quotientenklasse', 'Zwischenklasse der Dreiecksungleichung.', NULL, 'C\\in\\mathfrak{Q}_F', 1),
(361, 355, '\\left(\\mathfrak{Q}_F,d_F\\right)', 'funktionaler metrischer Raum', 'Paar aus Quotientenstruktur und funktionaler Metrik.', NULL, 'metrischer Raum', 1),
(362, 356, 'U_{\\varepsilon}(A)', 'funktionale offene Umgebung', 'Offene Kugel um A mit Radius epsilon.', NULL, 'Teilmenge von \\mathfrak{Q}_F', 1),
(363, 356, '\\varepsilon', 'Umgebungsradius', 'Positiver Radius der funktionalen offenen Umgebung.', NULL, '\\mathbb{R}_{>0}', 2),
(364, 356, 'd_F', 'funktionale Metrik', 'Abstandsfunktion auf der funktionalen Quotientenstruktur.', NULL, 'Metrik', 3),
(365, 357, '\\mathcal{T}_F', 'funktionale Topologie', 'Familie aller funktional offenen Mengen.', NULL, 'Teilmenge von \\mathcal{P}(\\mathfrak{Q}_F)', 1),
(366, 357, '\\mathcal{P}(\\mathfrak{Q}_F)', 'Potenzmenge', 'Menge aller Teilmengen der funktionalen Quotientenstruktur.', NULL, 'Menge', 2),
(367, 358, 'd_F\\Longrightarrow\\mathcal{T}_F', 'Topologieinduktion', 'Zuordnung der von der Metrik erzeugten Topologie.', NULL, 'strukturelle Folgerung', 1),
(368, 359, 'A_n', 'Folge funktionaler Quotientenklassen', 'n-tes Element einer Folge in der funktionalen Quotientenstruktur.', NULL, 'A_n\\in\\mathfrak{Q}_F', 1),
(369, 359, 'N', 'Konvergenzindex', 'Index, ab dem die Folge innerhalb der vorgegebenen Umgebung liegt.', NULL, '\\mathbb{N}', 2),
(370, 360, 'F', 'funktional stetige Abbildung', 'Abbildung zwischen funktionalen metrischen Räumen.', NULL, 'Abbildung', 1),
(371, 361, 'A_n', 'funktionale Folge', 'Folge funktionaler Quotientenklassen.', NULL, 'A_n\\in\\mathfrak{Q}_F', 1),
(372, 361, 'm,n', 'Folgenindizes', 'Indizes zweier Folgenglieder.', NULL, '\\mathbb{N}', 2),
(373, 361, 'N', 'Cauchy-Index', 'Index, ab dem alle Folgenglieder paarweise nahe beieinander liegen.', NULL, '\\mathbb{N}', 3),
(374, 361, '\\varepsilon', 'Abstandsschranke', 'Beliebige positive Schranke des funktionalen Abstands.', NULL, '\\mathbb{R}_{>0}', 4),
(375, 362, 'A', 'funktionaler Grenzwert', 'Grenzklasse der funktionalen Cauchy-Folge.', NULL, 'A\\in\\mathfrak{Q}_F', 1),
(376, 362, '\\mathfrak{Q}_F', 'funktionale Quotientenstruktur', 'Grundmenge des vollständigen funktionalen Raumes.', NULL, 'Quotientenmenge', 2),
(377, 363, '\\exists!', 'eindeutiger Existenzquantor', 'Kennzeichnet Existenz und Eindeutigkeit des Grenzwertes.', NULL, 'Logik', 1);
...
(23, 'Lemma 3.4.7', 69, 'Invarianz entlang funktionaler Entwicklungsbahnen', 'Ist I_F eine funktionale Invariante, dann besitzt sie entlang jeder durch zulässige Transformationen erzeugten funktionalen Entwicklungsbahn denselben Wert.', 'I_F(\\mathfrak{O}_0)=I_F(\\mathfrak{O}_1)=\\cdots=I_F(\\mathfrak{O}_n)', 'I_F(\\mathfrak{O}_0)=I_F(\\mathfrak{O}_1)=\\cdots=I_F(\\mathfrak{O}_n)', 'original', NULL, 'Def. 3.4.14 und Def. 3.4.17 gelten.', 'checked', 53),
(24, 'Lemma 3.4.8', 70, 'Kompositionserhaltung', 'Sind zwei zulässige funktionale Transformationen bezüglich derselben funktionalen Invarianten erhaltend, dann ist auch ihre Komposition erhaltend.', 'I_F\\!\\left((\\mathcal{T}_{F,2}\\circ\\mathcal{T}_{F,1})(\\mathfrak{O})\\right)=I_F(\\mathfrak{O})', 'I_F\\!\\left((\\mathcal{T}_{F,2}\\circ\\mathcal{T}_{F,1})(\\mathfrak{O})\\right)=I_F(\\mathfrak{O})', 'original', NULL, 'Def. 3.4.19 gilt; beide Transformationen erhalten I_F.', 'checked', 54),
(25, 'Lemma 3.4.9', 84, 'Abschluss funktionaler Symmetrien unter Komposition', 'Sind zwei funktionale Symmetrien bezüglich derselben Klasse funktionaler Erhaltungsgesetze gegeben, dann ist auch ihre wohldefinierte Komposition eine funktionale Symmetrie.', '\\mathcal{S}_{F,1},\\mathcal{S}_{F,2}\\in\\mathfrak{S}_F\\Longrightarrow\\mathcal{S}_{F,2}\\circ\\mathcal{S}_{F,1}\\in\\mathfrak{S}_F', '\\mathcal{S}_{F,1},\\mathcal{S}_{F,2}\\in\\mathfrak{S}_F\\Longrightarrow\\mathcal{S}_{F,2}\\circ\\mathcal{S}_{F,1}\\in\\mathfrak{S}_F', 'original', NULL, 'Def. 3.4.21 und Def. 3.4.22 gelten; die Komposition ist wohldefiniert.', 'checked', 55),
(26, 'Lemma 3.4.10', 85, 'Inversenerhaltung funktionaler Erhaltungsgesetze', 'Ist eine funktionale Symmetrie bijektiv und existiert ihre inverse Transformation, dann erhält auch die inverse Transformation jedes funktionale Erhaltungsgesetz.', '\\forall I_F\\in\\mathcal{E}_F:\\;I_F\\circ\\mathcal{S}_F^{-1}=I_F', '\\forall I_F\\in\\mathcal{E}_F:\\;I_F\\circ\\mathcal{S}_F^{-1}=I_F', 'original', NULL, 'Def. 3.4.21, Def. 3.4.22 und Def. 3.4.24 gelten.', 'checked', 56),
(27, 'Lemma 3.4.11', 86, 'Invarianz auf Symmetrieorbits', 'Jedes funktionale Erhaltungsgesetz besitzt auf einem funktionalen Symmetrieorbit einen konstanten Wert.', '\\mathfrak{O}_1\\sim_S\\mathfrak{O}_2\\Longrightarrow\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O}_1)=I_F(\\mathfrak{O}_2)', '\\mathfrak{O}_1\\sim_S\\mathfrak{O}_2\\Longrightarrow\\forall I_F\\in\\mathcal{E}_F:\\;I_F(\\mathfrak{O}_1)=I_F(\\mathfrak{O}_2)', 'original', NULL, 'Def. 3.4.21, Def. 3.4.25 und Satz 3.4.12 gelten.', 'checked', 57),
(28, 'Lemma 3.4.12', 87, 'Repräsentantenunabhängigkeit der funktionalen Metrik', 'Ist die funktionale Metrik auf Quotientenklassen definiert, dann ist ihr Wert unabhängig von der Wahl der Repräsentanten innerhalb derselben Symmetrieorbitklassen.', '\\mathfrak{O}_1\\sim_S\\mathfrak{O}_1\',\\;\\mathfrak{O}_2\\sim_S\\mathfrak{O}_2\'\\Longrightarrow d_F([\\mathfrak{O}_1],[\\mathfrak{O}_2])=d_F([\\mathfrak{O}_1\'],[\\mathfrak{O}_2\'])', '\\mathfrak{O}_1\\sim_S\\mathfrak{O}_1\',\\;\\mathfrak{O}_2\\sim_S\\mathfrak{O}_2\'\\Longrightarrow d_F([\\mathfrak{O}_1],[\\mathfrak{O}_2])=d_F([\\mathfrak{O}_1\'],[\\mathfrak{O}_2\'])', 'original', NULL, 'Def. 3.4.26, Def. 3.4.27 und Lemma 3.4.11 gelten.', 'checked', 58),
(29, 'Lemma 3.4.13', 88, 'Offene Kugeln bilden eine Basis', 'Die durch die funktionale Metrik erzeugten offenen Umgebungen bilden eine Basis der funktionalen Topologie.', '\\mathcal{B}_F=\\left\\{U_{\\varepsilon}(A)\\mid A\\in\\mathfrak{Q}_F,\\;\\varepsilon>0\\right\\}', '\\mathcal{B}_F=\\left\\{U_{\\varepsilon}(A)\\mid A\\in\\mathfrak{Q}_F,\\;\\varepsilon>0\\right\\}', 'original', NULL, 'Def. 3.4.27 bis Def. 3.4.29 gelten; die Dreiecksungleichung ist erfüllt.', 'checked', 59),
(30, 'Lemma 3.4.14', 89, 'Eindeutigkeit funktionaler Grenzwerte', 'Konvergiert eine Folge funktionaler Quotientenklassen, dann besitzt sie höchstens einen Grenzwert.', 'A_n\\rightarrow A\\;\\land\\;A_n\\rightarrow B\\Longrightarrow A=B', 'A_n\\rightarrow A\\;\\land\\;A_n\\rightarrow B\\Longrightarrow A=B', 'original', NULL, 'Gleichung (3.128), Gleichung (3.130) und Gleichung (3.135) gelten.', 'checked', 60),
...
(90, 'definition', 60, 'axiom', 4, 'derives_from', 'Funktionale Invarianten präzisieren die Erhaltung stabiler funktionaler Organisation nach A4.'),
(91, 'definition', 60, 'definition', 49, 'depends_on', 'Die Invarianz wird gegenüber rekursiven Transformationen definiert.'),
(92, 'definition', 60, 'definition', 51, 'depends_on', 'Die Invariante wird auf funktionalen Organisationsräumen ausgewertet.'),
(93, 'definition', 61, 'definition', 60, 'depends_on', 'Die Invariantenmenge setzt die funktionale Invariante voraus.'),
(94, 'lemma', 23, 'definition', 57, 'depends_on', 'Das Lemma wird entlang funktionaler Entwicklungsbahnen formuliert.'),
(95, 'lemma', 23, 'definition', 60, 'derives_from', 'Die Bahnkonstanz folgt aus der Invarianz jedes Transformationsschrittes.'),
(96, 'theorem', 17, 'axiom', 5, 'derives_from', 'Die Vergleichbarkeit konkretisiert reproduzierbare Organisationsmuster nach A5.'),
(97, 'theorem', 17, 'definition', 57, 'depends_on', 'Der Satz vergleicht funktionale Entwicklungsbahnen.'),
(98, 'theorem', 17, 'definition', 61, 'depends_on', 'Der Vergleich erfolgt über Invariantenmengen.'),
(99, 'equation', 326, 'definition', 60, 'derives_from', 'Gleichung (3.102) formalisiert Def. 3.4.17.'),
(100, 'equation', 327, 'definition', 61, 'derives_from', 'Gleichung (3.103) formalisiert Def. 3.4.18.'),
(101, 'equation', 328, 'lemma', 23, 'derives_from', 'Gleichung (3.104) formalisiert Lemma 3.4.7.'),
(102, 'equation', 329, 'theorem', 17, 'derives_from', 'Gleichung (3.105) formalisiert Satz 3.4.9.'),
(103, 'definition', 62, 'definition', 60, 'depends_on', 'Das Erhaltungsgesetz setzt die funktionale Invariante voraus.'),
(104, 'definition', 63, 'definition', 62, 'depends_on', 'Die Erhaltungsgesetzklasse setzt das einzelne Erhaltungsgesetz voraus.'),
(105, 'lemma', 24, 'definition', 62, 'derives_from', 'Die Kompositionserhaltung folgt aus der schrittweisen Erhaltungsbedingung.'),
(106, 'theorem', 18, 'definition', 63, 'depends_on', 'Der Satz verwendet die Klasse funktionaler Erhaltungsgesetze.'),
(107, 'theorem', 18, 'lemma', 24, 'derives_from', 'Der Satz folgt induktiv aus der Kompositionserhaltung.'),
(108, 'equation', 330, 'definition', 62, 'derives_from', 'Gleichung (3.106) formalisiert Def. 3.4.19.'),
(109, 'equation', 331, 'definition', 63, 'derives_from', 'Gleichung (3.107) formalisiert Def. 3.4.20.'),
(110, 'equation', 332, 'lemma', 24, 'derives_from', 'Gleichung (3.108) formalisiert Lemma 3.4.8.'),
(111, 'equation', 333, 'theorem', 18, 'derives_from', 'Gleichung (3.109) formalisiert Satz 3.4.10.'),
(112, 'definition', 64, 'definition', 63, 'depends_on', 'Die funktionale Symmetrie wird relativ zur Klasse funktionaler Erhaltungsgesetze definiert.'),
(113, 'definition', 64, 'definition', 62, 'depends_on', 'Die Symmetriedefinition verwendet das einzelne funktionale Erhaltungsgesetz.'),
(114, 'definition', 65, 'definition', 64, 'depends_on', 'Die Symmetrieklasse setzt die Definition der funktionalen Symmetrie voraus.'),
(115, 'lemma', 25, 'definition', 65, 'depends_on', 'Das Abschlusslemma bezieht sich auf die Klasse funktionaler Symmetrien.'),
(116, 'theorem', 19, 'definition', 63, 'depends_on', 'Der Satz verwendet die Klasse funktionaler Erhaltungsgesetze.'),
(117, 'theorem', 19, 'definition', 64, 'derives_from', 'Die Erhaltungsaussage folgt unmittelbar aus der Symmetriedefinition.'),
(118, 'equation', 334, 'definition', 64, 'derives_from', 'Gleichung (3.110) formalisiert Def. 3.4.21.'),
(119, 'equation', 335, 'definition', 65, 'derives_from', 'Gleichung (3.111) formalisiert Def. 3.4.22.'),
(120, 'equation', 336, 'lemma', 25, 'derives_from', 'Gleichung (3.112) formalisiert Lemma 3.4.9.'),
(121, 'equation', 337, 'theorem', 19, 'derives_from', 'Gleichung (3.113) formalisiert Satz 3.4.11.'),
(122, 'definition', 66, 'definition', 64, 'depends_on', 'Die identische funktionale Symmetrie ist ein Spezialfall der funktionalen Symmetrie.'),
(123, 'definition', 66, 'definition', 65, 'depends_on', 'Die Identität gehört zur Klasse funktionaler Symmetrien.'),
(124, 'definition', 67, 'definition', 66, 'depends_on', 'Die inverse Symmetrie wird über die identische Symmetrie definiert.'),
(125, 'definition', 67, 'definition', 64, 'depends_on', 'Die inverse Abbildung bezieht sich auf eine funktionale Symmetrie.'),
(126, 'lemma', 26, 'definition', 67, 'derives_from', 'Die Inversenerhaltung folgt aus der Invertierbarkeit der Symmetrie.'),
(127, 'theorem', 20, 'definition', 65, 'depends_on', 'Der Gruppensatz verwendet die Klasse funktionaler Symmetrien.'),
(128, 'theorem', 20, 'definition', 66, 'depends_on', 'Der Gruppensatz setzt ein neutrales Element voraus.'),
(129, 'theorem', 20, 'definition', 67, 'depends_on', 'Der Gruppensatz setzt inverse Elemente voraus.'),
(130, 'theorem', 20, 'lemma', 26, 'depends_on', 'Die inverse Symmetrie bleibt innerhalb der Erhaltungsklasse.'),
(131, 'equation', 338, 'definition', 66, 'derives_from', 'Gleichung (3.114) formalisiert Def. 3.4.23.'),
(132, 'equation', 339, 'definition', 66, 'derives_from', 'Gleichung (3.115) beschreibt die Neutralität der Identität.'),
(133, 'equation', 340, 'definition', 67, 'derives_from', 'Gleichung (3.116) formalisiert Def. 3.4.24.'),
(134, 'equation', 341, 'lemma', 26, 'derives_from', 'Gleichung (3.117) formalisiert Lemma 3.4.10.'),
(135, 'equation', 342, 'theorem', 20, 'derives_from', 'Gleichung (3.118) bezeichnet die Gruppenstruktur.'),
(136, 'equation', 343, 'theorem', 20, 'derives_from', 'Gleichung (3.119) formalisiert die Gruppenaxiome.'),
(137, 'definition', 68, 'definition', 65, 'depends_on', 'Der Symmetrieorbit setzt die Symmetrieklasse voraus.'),
(138, 'definition', 69, 'definition', 68, 'depends_on', 'Die Quotientenstruktur wird aus Symmetrieorbits gebildet.'),
(139, 'lemma', 27, 'definition', 68, 'depends_on', 'Das Lemma wird auf Symmetrieorbits formuliert.'),
(140, 'theorem', 21, 'definition', 69, 'depends_on', 'Der Satz begründet die Wohldefiniertheit der Quotientenstruktur.'),
(141, 'equation', 344, 'definition', 68, 'derives_from', 'Gleichung (3.120) formalisiert Def. 3.4.25.'),
(142, 'equation', 346, 'definition', 69, 'derives_from', 'Gleichung (3.122) formalisiert Def. 3.4.26.'),
(143, 'equation', 348, 'lemma', 27, 'derives_from', 'Gleichung (3.124) formalisiert Lemma 3.4.11.'),
(144, 'equation', 347, 'theorem', 21, 'derives_from', 'Gleichung (3.123) ist Bestandteil von Satz 3.4.13.'),
(145, 'equation', 349, 'theorem', 21, 'derives_from', 'Gleichung (3.125) formalisiert die Wohldefiniertheit der Quotientenabbildung.'),
(146, 'definition', 70, 'definition', 69, 'depends_on', 'Die funktionale Metrik wird auf der funktionalen Quotientenstruktur definiert.'),
(147, 'lemma', 28, 'definition', 70, 'depends_on', 'Die Repräsentantenunabhängigkeit betrifft die funktionale Metrik.'),
(148, 'theorem', 22, 'definition', 70, 'depends_on', 'Der metrische Raum setzt die funktionale Metrik voraus.'),
(149, 'theorem', 22, 'lemma', 28, 'depends_on', 'Die Metrik muss auf Quotientenklassen wohldefiniert sein.'),
(150, 'equation', 350, 'definition', 70, 'derives_from', 'Gleichung (3.126) formalisiert Def. 3.4.27.'),
(151, 'equation', 355, 'theorem', 22, 'derives_from', 'Gleichung (3.131) formalisiert Satz 3.4.14.'),
(152, 'definition', 71, 'definition', 70, 'depends_on', 'Die offene Umgebung wird durch die funktionale Metrik definiert.'),
(153, 'definition', 72, 'definition', 71, 'depends_on', 'Die funktionale Topologie wird aus funktionalen offenen Umgebungen erzeugt.'),
(154, 'lemma', 29, 'definition', 71, 'depends_on', 'Das Basislemma verwendet die funktionalen offenen Umgebungen.'),
(155, 'lemma', 29, 'definition', 72, 'depends_on', 'Die offenen Kugeln bilden eine Basis der funktionalen Topologie.'),
(156, 'theorem', 23, 'definition', 70, 'depends_on', 'Der Satz setzt die funktionale Metrik voraus.'),
(157, 'theorem', 23, 'definition', 72, 'depends_on', 'Der Satz bestimmt die durch die Metrik erzeugte Topologie.'),
(158, 'theorem', 23, 'lemma', 29, 'derives_from', 'Die Topologieerzeugung folgt aus der Basiseigenschaft offener Kugeln.'),
(159, 'equation', 356, 'definition', 71, 'derives_from', 'Gleichung (3.132) formalisiert Def. 3.4.28.'),
(160, 'equation', 357, 'definition', 72, 'derives_from', 'Gleichung (3.133) formalisiert Def. 3.4.29.'),
(161, 'equation', 358, 'theorem', 23, 'derives_from', 'Gleichung (3.134) formalisiert Satz 3.4.15.'),
(162, 'definition', 73, 'definition', 70, 'depends_on', 'Die Cauchy-Folge wird durch die funktionale Metrik definiert.'),
(163, 'definition', 74, 'definition', 73, 'depends_on', 'Funktionale Vollständigkeit setzt funktionale Cauchy-Folgen voraus.'),
(164, 'lemma', 30, 'definition', 70, 'depends_on', 'Die Eindeutigkeit verwendet die Metrikaxiome.'),
(165, 'theorem', 24, 'definition', 74, 'depends_on', 'Die Existenz folgt aus funktionaler Vollständigkeit.'),
(166, 'theorem', 24, 'lemma', 30, 'depends_on', 'Die Eindeutigkeit folgt aus Lemma 3.4.14.'),
(167, 'equation', 361, 'definition', 73, 'derives_from', 'Gleichung (3.137) formalisiert Def. 3.4.30.'),
(168, 'equation', 362, 'definition', 74, 'derives_from', 'Gleichung (3.138) formalisiert Def. 3.4.31.'),
(169, 'equation', 363, 'theorem', 24, 'derives_from', 'Gleichung (3.139) formalisiert Satz 3.4.16.');
...
('last_edited_section', '3.4.16', '2026-07-13 17:57:42'),
('last_repository_revision', 'RKB-2026-07-13-K3.4.16-NEUFASSUNG-V1', '2026-07-13 17:57:42'),
('next_axiom_number', 'COMPLETE', '2026-07-12 15:50:40'),
('next_citation_number', '59', '2026-07-12 12:53:53'),
('next_definition_number', 'Def. 3.4.32', '2026-07-13 17:57:42'),
('next_equation_number', '3.140', '2026-07-13 17:57:42'),
('next_lemma_number', 'Lemma 3.4.15', '2026-07-13 17:57:42'),
('next_proposition_number', 'Prop. 3.2', '2026-07-12 16:06:46'),
('next_section', '3.4.1', '2026-07-12 16:17:33'),
('next_theorem_number', 'Satz 3.4.17', '2026-07-13 17:57:42');
...
(53, 'RKB-2026-07-13-K3.4.9-NEUFASSUNG-V1', '2026-07-13 16:24:50', 'section', '3.4.9', '1.0', 'Neufassung von Abschnitt 3.4.9 mit Def. 3.4.17, Def. 3.4.18, Lemma 3.4.7, Satz 3.4.9 und den Gleichungen (3.102) bis (3.105).', 'Olaf Thiele / ChatGPT', 52),
(54, 'RKB-2026-07-13-K3.4.10-NEUFASSUNG-V1', '2026-07-13 16:24:56', 'section', '3.4.10', '1.0', 'Neufassung von Abschnitt 3.4.10 mit Def. 3.4.19, Def. 3.4.20, Lemma 3.4.8, Satz 3.4.10 und den Gleichungen (3.106) bis (3.109).', 'Olaf Thiele / ChatGPT', 53),
(55, 'RKB-2026-07-13-K3.4.11-NEUFASSUNG-V1', '2026-07-13 16:25:04', 'section', '3.4.11', '1.0', 'Neufassung von Abschnitt 3.4.11 mit Def. 3.4.21, Def. 3.4.22, Lemma 3.4.9, Satz 3.4.11 und den Gleichungen (3.110) bis (3.113).', 'Olaf Thiele / ChatGPT', 54),
(56, 'RKB-2026-07-13-K3.4.12-NEUFASSUNG-V1', '2026-07-13 17:22:28', 'section', '3.4.12', '1.0', 'Neufassung von Abschnitt 3.4.12 mit Def. 3.4.23, Def. 3.4.24, Lemma 3.4.10, Satz 3.4.12 und den Gleichungen (3.114) bis (3.119).', 'Olaf Thiele / ChatGPT', 55),
(57, 'RKB-2026-07-13-K3.4.13-NEUFASSUNG-V1', '2026-07-13 17:22:36', 'section', '3.4.13', '1.0', 'Neufassung von Abschnitt 3.4.13 mit Def. 3.4.25, Def. 3.4.26, Lemma 3.4.11, Satz 3.4.13 und den Gleichungen (3.120) bis (3.125).', 'Olaf Thiele / ChatGPT', 56),
(58, 'RKB-2026-07-13-K3.4.14-NEUFASSUNG-V1', '2026-07-13 17:54:05', 'section', '3.4.14', '1.0', 'Neufassung von Abschnitt 3.4.14 mit Def. 3.4.27, Lemma 3.4.12, Satz 3.4.14 und den Gleichungen (3.126) bis (3.131).', 'Olaf Thiele / ChatGPT', 57),
(59, 'RKB-2026-07-13-K3.4.15-NEUFASSUNG-V1', '2026-07-13 19:57:34', 'section', '3.4.15', '1.0', 'Neufassung von Abschnitt 3.4.15 mit Def. 3.4.28, Def. 3.4.29, Lemma 3.4.13, Satz 3.4.15 und den Gleichungen (3.132) bis (3.136).', 'Olaf Thiele / ChatGPT', 58),
(60, 'RKB-2026-07-13-K3.4.16-NEUFASSUNG-V1', '2026-07-13 19:57:42', 'section', '3.4.16', '1.0', 'Neufassung von Abschnitt 3.4.16 mit Def. 3.4.30, Def. 3.4.31, Lemma 3.4.14, Satz 3.4.16 und den Gleichungen (3.137) bis (3.139).', 'Olaf Thiele / ChatGPT', 59);
...
(185, 53, 69, 'rewritten', 'section', '3.4.9', 'Abschnitt 3.4.9 wurde vollständig als mathematische Rekonstruktion funktionaler Invarianten neu gefasst.', 'Bisheriger Repository-Stand von Abschnitt 3.4.9.', 'Def. 3.4.17, Def. 3.4.18, Lemma 3.4.7, Satz 3.4.9 und Gleichungen (3.102) bis (3.105).', '2026-07-13 14:24:50'),
(186, 53, 69, 'definition_added', 'definition', 'Def. 3.4.17–Def. 3.4.18', 'Funktionale Invariante und Invariantenmenge wurden registriert.', NULL, '2 Definitionen', '2026-07-13 14:24:50'),
(187, 53, 69, 'statement_added', 'lemma', 'Lemma 3.4.7', 'Die Invarianz entlang funktionaler Entwicklungsbahnen wurde registriert.', NULL, 'Bahninvarianz', '2026-07-13 14:24:50'),
(188, 53, 69, 'statement_added', 'theorem', 'Satz 3.4.9', 'Die Invariantenäquivalenz wurde logisch präzisiert und registriert.', 'Nicht explizit definierte allgemeine funktionale Äquivalenz.', 'Äquivalenzrelation ~_I durch Gleichheit der Invariantenmengen.', '2026-07-13 14:24:50'),
(189, 53, 69, 'equation_added', 'equation', '(3.102)–(3.105)', 'Invarianzbedingung, Invariantenmenge, Bahnkonstanz und Invariantenäquivalenz wurden registriert.', NULL, '4 Gleichungen', '2026-07-13 14:24:50'),
(190, 54, 70, 'rewritten', 'section', '3.4.10', 'Abschnitt 3.4.10 wurde vollständig als mathematische Rekonstruktion funktionaler Erhaltungsgesetze neu gefasst.', 'Bisheriger Repository-Stand von Abschnitt 3.4.10.', 'Def. 3.4.19, Def. 3.4.20, Lemma 3.4.8, Satz 3.4.10 und Gleichungen (3.106) bis (3.109).', '2026-07-13 14:24:56'),
(191, 54, 70, 'definition_added', 'definition', 'Def. 3.4.19–Def. 3.4.20', 'Funktionales Erhaltungsgesetz und Erhaltungsgesetzklasse wurden registriert.', NULL, '2 Definitionen', '2026-07-13 14:24:56'),
(192, 54, 70, 'statement_added', 'lemma', 'Lemma 3.4.8', 'Die Kompositionserhaltung wurde registriert.', NULL, 'Kompositionserhaltung', '2026-07-13 14:24:56'),
(193, 54, 70, 'statement_added', 'theorem', 'Satz 3.4.10', 'Die Stabilität funktionaler Erhaltungsgesetze wurde registriert.', NULL, 'Erhaltung unter endlicher Komposition', '2026-07-13 14:24:56'),
(194, 54, 70, 'equation_added', 'equation', '(3.106)–(3.109)', 'Erhaltungsgesetz, Erhaltungsgesetzklasse, Kompositionserhaltung und Stabilität wurden formal registriert.', NULL, '4 Gleichungen', '2026-07-13 14:24:56'),
(195, 55, 84, 'rewritten', 'section', '3.4.11', 'Abschnitt 3.4.11 wurde vollständig als mathematische Rekonstruktion funktionaler Symmetrien neu gefasst.', 'Bisheriger Repository-Stand von Abschnitt 3.4.11.', 'Def. 3.4.21, Def. 3.4.22, Lemma 3.4.9, Satz 3.4.11 und Gleichungen (3.110) bis (3.113).', '2026-07-13 14:25:04'),
(196, 55, 84, 'definition_added', 'definition', 'Def. 3.4.21–Def. 3.4.22', 'Funktionale Symmetrie und Klasse funktionaler Symmetrien wurden registriert.', 'Bezeichnung als Gruppe ohne Nachweis aller Gruppenaxiome.', 'Zunächst unter Komposition abgeschlossene Symmetrieklasse.', '2026-07-13 14:25:04'),
(197, 55, 84, 'statement_added', 'lemma', 'Lemma 3.4.9', 'Der Abschluss funktionaler Symmetrien unter wohldefinierter Komposition wurde registriert.', NULL, 'Abschluss unter Komposition', '2026-07-13 14:25:04'),
(198, 55, 84, 'statement_added', 'theorem', 'Satz 3.4.11', 'Die Erhaltung bereits definierter funktionaler Erhaltungsgesetze unter Symmetrien wurde registriert.', 'Nicht begründete Behauptung, dass jede Symmetrie nichttriviale Erhaltungsgesetze erzeugt.', 'Korrekte Erhaltungsaussage für bereits definierte Elemente von E_F.', '2026-07-13 14:25:04'),
(199, 55, 84, 'equation_added', 'equation', '(3.110)–(3.113)', 'Symmetriebedingung, Symmetrieklasse, Kompositionsabschluss und Erhaltungssatz wurden formal registriert.', NULL, '4 Gleichungen', '2026-07-13 14:25:04'),
(200, 56, 85, 'rewritten', 'section', '3.4.12', 'Abschnitt 3.4.12 wurde vollständig als Gruppenstruktur funktionaler Symmetrien neu gefasst.', 'Bisheriger Repository-Stand von Abschnitt 3.4.12.', 'Def. 3.4.23, Def. 3.4.24, Lemma 3.4.10, Satz 3.4.12 und Gleichungen (3.114) bis (3.119).', '2026-07-13 15:22:28'),
(201, 56, 85, 'definition_added', 'definition', 'Def. 3.4.23–Def. 3.4.24', 'Identische und inverse funktionale Symmetrie wurden registriert.', NULL, '2 Definitionen', '2026-07-13 15:22:28'),
(202, 56, 85, 'statement_added', 'lemma', 'Lemma 3.4.10', 'Die Erhaltung funktionaler Erhaltungsgesetze unter inversen Symmetrien wurde registriert.', NULL, 'Inversenerhaltung', '2026-07-13 15:22:28'),
(203, 56, 85, 'statement_added', 'theorem', 'Satz 3.4.12', 'Die Gruppenstruktur funktionaler Symmetrien wurde registriert.', 'Symmetrieklasse ohne vollständigen Gruppennachweis.', 'Gruppenstruktur unter Abschluss, Assoziativität, Identität und Invertierbarkeit.', '2026-07-13 15:22:28'),
(204, 56, 85, 'equation_added', 'equation', '(3.114)–(3.119)', 'Identität, Neutralität, Inverse, Inversenerhaltung, Gruppenstruktur und Gruppenaxiome wurden formal registriert.', NULL, '6 Gleichungen', '2026-07-13 15:22:28'),
(205, 57, 86, 'rewritten', 'section', '3.4.13', 'Abschnitt 3.4.13 wurde vollständig als Rekonstruktion funktionaler Symmetrieorbits und Quotientenstrukturen neu gefasst.', 'Bisheriger Repository-Stand von Abschnitt 3.4.13.', 'Def. 3.4.25, Def. 3.4.26, Lemma 3.4.11, Satz 3.4.13 und Gleichungen (3.120) bis (3.125).', '2026-07-13 15:22:36'),
(206, 57, 86, 'definition_added', 'definition', 'Def. 3.4.25–Def. 3.4.26', 'Funktionaler Symmetrieorbit und funktionale Quotientenstruktur wurden registriert.', NULL, '2 Definitionen', '2026-07-13 15:22:36'),
(207, 57, 86, 'statement_added', 'lemma', 'Lemma 3.4.11', 'Die Invarianz funktionaler Erhaltungsgesetze auf Symmetrieorbits wurde registriert.', NULL, 'Orbitinvarianz', '2026-07-13 15:22:36'),
(208, 57, 86, 'statement_added', 'theorem', 'Satz 3.4.13', 'Die Wohldefiniertheit der funktionalen Quotientenstruktur wurde registriert.', NULL, 'Wohldefinierte Quotientenstruktur', '2026-07-13 15:22:36'),
(209, 57, 86, 'equation_added', 'equation', '(3.120)–(3.125)', 'Orbit, Orbitäquivalenz, Quotientenstruktur, Projektion, Invarianz und Wohldefiniertheit wurden formal registriert.', NULL, '6 Gleichungen', '2026-07-13 15:22:36'),
(210, 58, 87, 'rewritten', 'section', '3.4.14', 'Abschnitt 3.4.14 wurde vollständig als funktionale Metrik auf der Quotientenstruktur neu gefasst.', 'Bisheriger Repository-Stand von Abschnitt 3.4.14.', 'Def. 3.4.27, Lemma 3.4.12, Satz 3.4.14 und Gleichungen (3.126) bis (3.131).', '2026-07-13 15:54:05'),
(211, 58, 87, 'definition_added', 'definition', 'Def. 3.4.27', 'Die funktionale Metrik wurde registriert.', NULL, '1 Definition', '2026-07-13 15:54:05'),
(212, 58, 87, 'statement_added', 'lemma', 'Lemma 3.4.12', 'Die Repräsentantenunabhängigkeit der funktionalen Metrik wurde registriert.', NULL, 'Repräsentantenunabhängigkeit', '2026-07-13 15:54:05'),
(213, 58, 87, 'statement_added', 'theorem', 'Satz 3.4.14', 'Der funktionale metrische Raum wurde registriert.', NULL, 'Metrischer Raum auf der Quotientenstruktur', '2026-07-13 15:54:05'),
(214, 58, 87, 'equation_added', 'equation', '(3.126)–(3.131)', 'Funktionale Metrik, vier Metrikaxiome und funktionaler metrischer Raum wurden formal registriert.', NULL, '6 Gleichungen', '2026-07-13 15:54:05'),
(215, 59, 88, 'rewritten', 'section', '3.4.15', 'Abschnitt 3.4.15 wurde vollständig als Topologie funktionaler Organisationsräume neu gefasst.', 'Bisheriger Repository-Stand von Abschnitt 3.4.15.', 'Def. 3.4.28, Def. 3.4.29, Lemma 3.4.13, Satz 3.4.15 und Gleichungen (3.132) bis (3.136).', '2026-07-13 17:57:35'),
(216, 59, 88, 'definition_added', 'definition', 'Def. 3.4.28–Def. 3.4.29', 'Funktionale offene Umgebung und funktionale Topologie wurden registriert.', NULL, '2 Definitionen', '2026-07-13 17:57:35'),
(217, 59, 88, 'statement_added', 'lemma', 'Lemma 3.4.13', 'Die Basiseigenschaft funktionaler offener Kugeln wurde registriert.', NULL, 'Offene Kugeln bilden eine Basis', '2026-07-13 17:57:35'),
(218, 59, 88, 'statement_added', 'theorem', 'Satz 3.4.15', 'Die Erzeugung einer funktionalen Topologie durch die funktionale Metrik wurde registriert.', NULL, 'Metrikinduzierte funktionale Topologie', '2026-07-13 17:57:35'),
(219, 59, 88, 'equation_added', 'equation', '(3.132)–(3.136)', 'Offene Umgebung, Topologie, Topologieinduktion, Konvergenz und Stetigkeit wurden formal registriert.', NULL, '5 Gleichungen', '2026-07-13 17:57:35'),
(220, 60, 89, 'rewritten', 'section', '3.4.16', 'Abschnitt 3.4.16 wurde vollständig als Rekonstruktion funktionaler Vollständigkeit neu gefasst.', 'Bisheriger Repository-Stand von Abschnitt 3.4.16.', 'Def. 3.4.30, Def. 3.4.31, Lemma 3.4.14, Satz 3.4.16 und Gleichungen (3.137) bis (3.139).', '2026-07-13 17:57:42'),
(221, 60, 89, 'definition_added', 'definition', 'Def. 3.4.30–Def. 3.4.31', 'Funktionale Cauchy-Folge und funktionale Vollständigkeit wurden registriert.', NULL, '2 Definitionen', '2026-07-13 17:57:42'),
(222, 60, 89, 'statement_added', 'lemma', 'Lemma 3.4.14', 'Die Eindeutigkeit funktionaler Grenzwerte wurde registriert.', NULL, 'Eindeutigkeit funktionaler Grenzwerte', '2026-07-13 17:57:42'),
(223, 60, 89, 'statement_added', 'theorem', 'Satz 3.4.16', 'Der vollständige funktionale Raum wurde registriert.', NULL, 'Existenz und Eindeutigkeit funktionaler Grenzwerte', '2026-07-13 17:57:42'),
(224, 60, 89, 'equation_added', 'equation', '(3.137)–(3.139)', 'Cauchy-Bedingung, funktionale Vollständigkeit und eindeutiger Grenzwert wurden formal registriert.', NULL, '3 Gleichungen', '2026-07-13 17:57:42');
...
(63, '\\mathcal{R}_F', '\\mathcal{R}_F', 'Funktionale Relationsstruktur', 'Menge funktionaler Relationen.', 'chapter', 62, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 11),
(64, '\\mathcal{T}_F', '\\mathcal{T}_F', 'Funktionaler Transformationsoperator', 'Rekursiver Operator auf Relationen oder Zuständen.', 'chapter', 63, NULL, NULL, NULL, NULL, 0, 0, 1, NULL, 'checked', 11),
(65, '\\mathcal{O}', '\\mathcal{O}', 'Invariante Organisationsstruktur', 'Unter Transformationen invariante Teilstruktur.', 'chapter', 64, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 11),
(66, '\\mathfrak{O}_F', '\\mathfrak{O}_F', 'Funktionaler Organisationsraum', 'Paar aus Organisationsstruktur und Transformationsoperator.', 'chapter', 64, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 11),
(67, '\\mathcal{X}_F', '\\mathcal{X}_F', 'Funktionale Zustandsmenge', 'Menge aller funktionalen Zustände.', 'chapter', 65, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 11),
(68, '\\mathfrak{X}_F', '\\mathfrak{X}_F', 'Funktionaler Zustandsraum', 'Tripel aus Zuständen, Organisation und Transformation.', 'chapter', 65, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 11),
(69, '\\mathcal{K}', '\\mathcal{K}', 'Kohärente Zustandsmenge', 'Unter Transformationen invariante Zustandsmenge.', 'chapter', 66, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 11),
(70, '\\mathcal{K}_F', '\\mathcal{K}_F', 'Funktionale Kohärenzstruktur', 'Menge beziehungsweise Klasse funktional kohärenter Strukturen.', 'chapter', 66, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 11),
(71, '\\Psi_F', '\\Psi_F', 'Kohärenzoperator', 'Zuordnung von Zuständen zu Kohärenzstrukturen.', 'chapter', 66, NULL, NULL, NULL, NULL, 0, 0, 1, NULL, 'checked', 11),
(72, '\\leadsto', '\\leadsto', 'Funktionale Erreichbarkeitsrelation', 'Erreichbarkeit durch eine endliche Folge rekursiver Transformationen.', 'chapter', 67, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 11),
(73, '\\mathfrak{R}_F', '\\mathfrak{R}_F', 'Funktionale Raumstruktur', 'Paar aus Zustandsmenge und Erreichbarkeitsrelation.', 'chapter', 67, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 11),
...
(17, 'Satz 3.4.9', 69, 'Vergleichbarkeit funktionaler Entwicklungsbahnen', 'Zwei funktionale Entwicklungsbahnen heißen invariantengleich und werden als funktional äquivalent klassifiziert, wenn ihre Mengen funktionaler Invarianten übereinstimmen.', '\\mathcal{I}_F(\\Gamma_1)=\\mathcal{I}_F(\\Gamma_2)\\Longrightarrow\\Gamma_1\\sim_I\\Gamma_2', '\\mathcal{I}_F(\\Gamma_1)=\\mathcal{I}_F(\\Gamma_2)\\Longrightarrow\\Gamma_1\\sim_I\\Gamma_2', 'original', NULL, 'Def. 3.4.14 und Def. 3.4.18 gelten; ~_I ist durch Gleichheit der Invariantenmengen definiert.', 'checked', 53),
(18, 'Satz 3.4.10', 70, 'Stabilität funktionaler Erhaltungsgesetze', 'Ist eine funktionale Invariante unter jeder einzelnen Transformation einer endlichen Transformationsfolge erhalten, dann bleibt sie auch unter der gesamten Komposition erhalten.', '\\left(\\forall i\\in\\{1,\\ldots,n\\}:I_F\\circ\\mathcal{T}_{F,i}=I_F\\right)\\Longrightarrow I_F\\circ\\left(\\mathcal{T}_{F,n}\\circ\\cdots\\circ\\mathcal{T}_{F,1}\\right)=I_F', '\\left(\\forall i\\in\\{1,\\ldots,n\\}:I_F\\circ\\mathcal{T}_{F,i}=I_F\\right)\\Longrightarrow I_F\\circ\\left(\\mathcal{T}_{F,n}\\circ\\cdots\\circ\\mathcal{T}_{F,1}\\right)=I_F', 'original', NULL, 'Def. 3.4.19, Def. 3.4.20 und Lemma 3.4.8 gelten.', 'checked', 54),
(19, 'Satz 3.4.11', 84, 'Erhaltungsgesetze unter funktionalen Symmetrien', 'Für jede funktionale Symmetrie und jedes bereits definierte funktionale Erhaltungsgesetz bleibt der zugehörige Invariantenwert unter der Symmetrietransformation erhalten.', '\\mathcal{S}_F\\in\\mathfrak{S}_F\\Longrightarrow\\forall I_F\\in\\mathcal{E}_F:\\;I_F\\circ\\mathcal{S}_F=I_F', '\\mathcal{S}_F\\in\\mathfrak{S}_F\\Longrightarrow\\forall I_F\\in\\mathcal{E}_F:\\;I_F\\circ\\mathcal{S}_F=I_F', 'original', NULL, 'Def. 3.4.20 bis Def. 3.4.22 gelten.', 'checked', 55),
(20, 'Satz 3.4.12', 85, 'Gruppe funktionaler Symmetrien', 'Ist die Klasse funktionaler Symmetrien nichtleer, unter Komposition abgeschlossen und assoziativ, enthält sie die identische funktionale Symmetrie und zu jedem Element eine inverse funktionale Symmetrie, dann bildet sie mit der Komposition eine Gruppe.', '\\left(\\mathfrak{S}_F,\\circ\\right)\\text{ ist eine Gruppe}', '\\left(\\mathfrak{S}_F,\\circ\\right)\\text{ ist eine Gruppe}', 'original', NULL, 'Def. 3.4.22 bis Def. 3.4.24 und Lemma 3.4.9 sowie Lemma 3.4.10 gelten.', 'checked', 56),
(21, 'Satz 3.4.13', 86, 'Wohldefiniertheit der funktionalen Quotientenstruktur', 'Die Orbitrelation funktionaler Symmetrien ist reflexiv, symmetrisch und transitiv. Daher zerlegt sie die funktionalen Organisationsräume in disjunkte Äquivalenzklassen und definiert eine wohldefinierte Quotientenstruktur.', '\\pi_F:\\mathfrak{O}_F\\rightarrow\\mathfrak{Q}_F,\\qquad\\pi_F(\\mathfrak{O})=[\\mathfrak{O}]_{\\sim_S}', '\\pi_F:\\mathfrak{O}_F\\rightarrow\\mathfrak{Q}_F,\\qquad\\pi_F(\\mathfrak{O})=[\\mathfrak{O}]_{\\sim_S}', 'original', NULL, 'Satz 3.4.12 sowie Def. 3.4.25 und Def. 3.4.26 gelten.', 'checked', 57),
(22, 'Satz 3.4.14', 87, 'Funktionaler metrischer Raum', 'Erfüllt d_F auf der funktionalen Quotientenstruktur die vier Metrikaxiome, dann bildet das Paar aus Quotientenstruktur und funktionaler Metrik einen metrischen Raum.', '\\left(\\mathfrak{Q}_F,d_F\\right)\\text{ ist ein metrischer Raum}', '\\left(\\mathfrak{Q}_F,d_F\\right)\\text{ ist ein metrischer Raum}', 'original', NULL, 'Def. 3.4.27 und Lemma 3.4.12 gelten; die Metrikaxiome sind erfüllt.', 'checked', 58),
(23, 'Satz 3.4.15', 88, 'Die funktionale Metrik erzeugt eine Topologie', 'Jede funktionale Metrik auf der funktionalen Quotientenstruktur erzeugt über ihre offenen Kugeln eindeutig eine funktionale Topologie.', 'd_F\\Longrightarrow\\mathcal{T}_F', 'd_F\\Longrightarrow\\mathcal{T}_F', 'original', NULL, 'Def. 3.4.27 bis Def. 3.4.29 und Lemma 3.4.13 gelten.', 'checked', 59),
(24, 'Satz 3.4.16', 89, 'Vollständiger funktionaler Raum', 'In einem funktional vollständigen metrischen Raum besitzt jede funktionale Cauchy-Folge einen eindeutig bestimmten Grenzwert innerhalb der funktionalen Quotientenstruktur.', '(A_n)\\text{ Cauchy}\\Longrightarrow\\exists!\\,A\\in\\mathfrak{Q}_F:\\;A_n\\rightarrow A', '(A_n)\\text{ Cauchy}\\Longrightarrow\\exists!\\,A\\in\\mathfrak{Q}_F:\\;A_n\\rightarrow A', 'original', NULL, 'Def. 3.4.30, Def. 3.4.31 und Lemma 3.4.14 gelten.', 'checked', 60);
...
--
ALTER TABLE `definitions`
  MODIFY `definition_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=75;

--
-- AUTO_INCREMENT für Tabelle `dissertation_sections`
--
ALTER TABLE `dissertation_sections`
  MODIFY `section_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;
...
--
ALTER TABLE `equations`
  MODIFY `equation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=364;

--
-- AUTO_INCREMENT für Tabelle `equation_dependencies`
--
ALTER TABLE `equation_dependencies`
  MODIFY `dependency_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=178;

--
-- AUTO_INCREMENT für Tabelle `equation_symbols`
--
ALTER TABLE `equation_symbols`
  MODIFY `equation_symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=378;
...
--
ALTER TABLE `object_dependencies`
  MODIFY `object_dependency_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=170;
...
--
ALTER TABLE `repository_revisions`
  MODIFY `revision_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `section_change_log`
  MODIFY `change_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=225;
...
--
ALTER TABLE `theorems`
  MODIFY `theorem_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
