...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 12. Jul 2026 um 08:13
...
(1, 'A1', 50, 'Funktionale Unterscheidbarkeit', 'Es existiert mindestens eine funktionale Differenz zwischen möglichen funktionalen Konfigurationen.', '\\Delta_F:\\Omega\\longrightarrow\\{0,1\\},\\qquad\\exists\\,\\omega_i,\\omega_j\\in\\Omega:\\Delta_F(\\omega_i)\\neq\\Delta_F(\\omega_j)', '\\Delta_F:\\Omega\\longrightarrow\\{0,1\\},\\qquad\\exists\\,\\omega_i,\\omega_j\\in\\Omega:\\Delta_F(\\omega_i)\\neq\\Delta_F(\\omega_j)', 'Antwort auf A-3.2-1: Entstehung funktionaler Zustände.', NULL, NULL, NULL, 1, 'review', 9),
(2, 'A2', 51, 'Funktionale Relationierung', 'Funktionale Differenzen können miteinander in Beziehung treten und dadurch neue funktionale Zusammenhänge erzeugen.', '\\mathcal{R}_F:\\Omega\\times\\Omega\\longrightarrow\\mathbb{R}', '\\mathcal{R}_F:\\Omega\\times\\Omega\\longrightarrow\\mathbb{R}', 'Antwort auf A-3.2-2: Entstehung funktionaler Relationen.', NULL, NULL, NULL, 2, 'review', 9),
(3, 'A3', 52, 'Rekursive Operatorbildung', 'Wiederholt auftretende funktionale Relationen erzeugen rekursive Transformationsregeln, die als funktionale Operatoren beschrieben werden können.', '\\mathcal{O}_F:\\mathcal{R}_F\\longrightarrow\\mathcal{R}_F', '\\mathcal{O}_F:\\mathcal{R}_F\\longrightarrow\\mathcal{R}_F', 'Antwort auf A-3.2-3: rekursive Operatorbildung.', NULL, NULL, NULL, 3, 'review', 9),
(4, 'A4', 53, 'Dynamische Zustandsraumentstehung', 'Rekursive funktionale Operatoren erzeugen und erweitern den funktionalen Zustandsraum fortlaufend.', '\\Phi:\\mathcal{O}_F\\longrightarrow\\mathcal{X}_F', '\\Phi:\\mathcal{O}_F\\longrightarrow\\mathcal{X}_F', 'Antwort auf A-3.2-4: dynamische Zustandsraumentstehung.', NULL, NULL, NULL, 4, 'review', 9),
(5, 'A5', 54, 'Emergente Kohärenzbildung', 'Rekursive funktionale Operatoren erzeugen stabile Kohärenzstrukturen, welche die langfristige Organisation funktionaler Zustände bestimmen.', '\\Psi:\\mathcal{X}_F\\longrightarrow\\mathcal{K}_F', '\\Psi:\\mathcal{X}_F\\longrightarrow\\mathcal{K}_F', 'Antwort auf A-3.2-5: Kohärenz als emergente Eigenschaft.', NULL, NULL, NULL, 5, 'review', 9);
...
(22, NULL, '3.3', 'Mathematische Axiome des Funktionalen Raum-Zeit-Kohärenzsystems', 3, 3.4000, 'review', 1, NULL),
(23, NULL, '3.4', 'Mathematische Herleitung des Funktionalen Raum-Zeit-Kohärenzsystems', 3, 3.5000, 'planned', 1, NULL),
(49, 22, '3.3.0', 'Einleitung', 3, 3.4001, 'review', 1, NULL),
(50, 22, '3.3.1', 'Axiom der funktionalen Unterscheidbarkeit', 3, 3.4100, 'review', 1, NULL),
(51, 22, '3.3.2', 'Axiom der funktionalen Relationierung', 3, 3.4200, 'review', 1, NULL),
(52, 22, '3.3.3', 'Axiom der rekursiven Operatorbildung', 3, 3.4300, 'review', 1, NULL),
(53, 22, '3.3.4', 'Axiom der dynamischen Zustandsraumentstehung', 3, 3.4400, 'review', 1, NULL),
(54, 22, '3.3.5', 'Axiom der emergenten Kohärenzbildung', 3, 3.4500, 'review', 1, NULL),
(55, 22, '3.3.6', 'Logische Konsequenzen des Axiomensystems', 3, 3.4600, 'review', 1, NULL);
...
(87, '3.87', 49, 'Axiomatische Entwicklungsrichtung', '\\mathcal{A}_{F}\\Longrightarrow\\mathcal{D}_{F}\\Longrightarrow\\mathcal{R}_{F}\\Longrightarrow\\mathcal{O}_{F}\\Longrightarrow\\mathcal{K}_{F}\\Longrightarrow\\mathcal{X}_{F}', '\\mathcal{A}_{F}\\Longrightarrow\\mathcal{D}_{F}\\Longrightarrow\\mathcal{R}_{F}\\Longrightarrow\\mathcal{O}_{F}\\Longrightarrow\\mathcal{K}_{F}\\Longrightarrow\\mathcal{X}_{F}', 'Logische Entwicklungsfolge von der funktionalen Axiomatik zum funktionalen Zustandsraum.', 'schema', 'original', NULL, NULL, NULL, 'checked', 9),
(88, '3.88', 49, 'FRZK-Axiomensystem', '\\mathfrak{A}_{\\mathrm{FRZK}}=\\left\\{A_{1},A_{2},A_{3},A_{4},A_{5}\\right\\}', '\\mathfrak{A}_{\\mathrm{FRZK}}=\\left\\{A_{1},A_{2},A_{3},A_{4},A_{5}\\right\\}', 'Menge der fünf Grundaxiome des FRZK.', 'axiom', 'original', NULL, NULL, NULL, 'checked', 9),
(89, '3.89', 50, 'Funktionale Unterscheidungsabbildung', '\\Delta_F:\\Omega\\longrightarrow\\{0,1\\},\\qquad\\exists\\,\\omega_i,\\omega_j\\in\\Omega:\\Delta_F(\\omega_i)\\neq\\Delta_F(\\omega_j)', '\\Delta_F:\\Omega\\longrightarrow\\{0,1\\},\\qquad\\exists\\,\\omega_i,\\omega_j\\in\\Omega:\\Delta_F(\\omega_i)\\neq\\Delta_F(\\omega_j)', 'Formale Darstellung mindestens einer funktionalen Differenz.', 'axiom', 'original', NULL, NULL, NULL, 'checked', 9),
(90, '3.90', 50, 'Vollständige funktionale Homogenität', '\\forall\\,\\omega_i,\\omega_j\\in\\Omega:\\Delta_F(\\omega_i)=\\Delta_F(\\omega_j)', '\\forall\\,\\omega_i,\\omega_j\\in\\Omega:\\Delta_F(\\omega_i)=\\Delta_F(\\omega_j)', 'Gegenfall vollständiger funktionaler Ununterscheidbarkeit.', 'schema', 'original', NULL, NULL, NULL, 'checked', 9),
(91, '3.91', 50, 'Nichttriviale funktionale Differenz', '\\Delta_F\\neq0', '\\Delta_F\\neq0', 'Notwendige Bedingung einer nichttrivialen funktionalen Differenz.', 'derived', 'original', NULL, NULL, NULL, 'checked', 9),
(92, '3.92', 51, 'Funktionale Relationierungsabbildung', '\\mathcal{R}_F:\\Omega\\times\\Omega\\longrightarrow\\mathbb{R}', '\\mathcal{R}_F:\\Omega\\times\\Omega\\longrightarrow\\mathbb{R}', 'Allgemeine Abbildung zur Beschreibung funktionaler Beziehungen.', 'axiom', 'original', NULL, NULL, NULL, 'checked', 9),
(93, '3.93', 51, 'Möglichkeit funktionaler Relationierung', '\\Delta_F(\\omega_i)\\neq\\Delta_F(\\omega_j)\\Longrightarrow\\exists\\,\\mathcal{R}_F(\\omega_i,\\omega_j)', '\\Delta_F(\\omega_i)\\neq\\Delta_F(\\omega_j)\\Longrightarrow\\exists\\,\\mathcal{R}_F(\\omega_i,\\omega_j)', 'Funktionale Unterscheidbarkeit ermöglicht funktionale Relationierung.', 'derived', 'original', NULL, NULL, NULL, 'checked', 9),
(94, '3.94', 51, 'Gerichtete funktionale Relation', '\\mathcal{R}_F(\\omega_i,\\omega_j)\\neq\\mathcal{R}_F(\\omega_j,\\omega_i)', '\\mathcal{R}_F(\\omega_i,\\omega_j)\\neq\\mathcal{R}_F(\\omega_j,\\omega_i)', 'Zulässigkeit asymmetrischer funktionaler Relationen.', 'derived', 'original', NULL, NULL, NULL, 'checked', 9),
(95, '3.95', 51, 'Funktionale Relationsstruktur', '\\mathcal{G}_F=\\left(\\Omega,\\mathcal{R}_F\\right)', '\\mathcal{G}_F=\\left(\\Omega,\\mathcal{R}_F\\right)', 'Gesamtheit funktionaler Konfigurationen und Relationen.', 'definition', 'original', NULL, NULL, NULL, 'checked', 9),
(96, '3.96', 52, 'Funktionaler Operator', '\\mathcal{O}_F:\\mathcal{R}_F\\longrightarrow\\mathcal{R}_F', '\\mathcal{O}_F:\\mathcal{R}_F\\longrightarrow\\mathcal{R}_F', 'Operator auf funktionalen Relationierungsstrukturen.', 'axiom', 'original', NULL, NULL, NULL, 'checked', 9),
(97, '3.97', 52, 'Rekursive Relationsentwicklung', '\\mathcal{R}_F^{(n+1)}=\\mathcal{O}_F\\left(\\mathcal{R}_F^{(n)}\\right)', '\\mathcal{R}_F^{(n+1)}=\\mathcal{O}_F\\left(\\mathcal{R}_F^{(n)}\\right)', 'Rekursive Transformation funktionaler Relationen.', 'model', 'original', NULL, NULL, NULL, 'checked', 9),
(98, '3.98', 52, 'Iterierte Operatorwirkung', '\\mathcal{R}_F^{(n)}=\\mathcal{O}_F^{\\,n}\\left(\\mathcal{R}_F^{(0)}\\right)', '\\mathcal{R}_F^{(n)}=\\mathcal{O}_F^{\\,n}\\left(\\mathcal{R}_F^{(0)}\\right)', 'n-fache Anwendung des funktionalen Operators.', 'derived', 'original', NULL, NULL, NULL, 'checked', 9),
(99, '3.99', 52, 'Stabile Relationierungsstruktur', '\\lim_{n\\rightarrow\\infty}\\mathcal{R}_F^{(n)}=\\mathcal{R}_F^{\\,*}', '\\lim_{n\\rightarrow\\infty}\\mathcal{R}_F^{(n)}=\\mathcal{R}_F^{\\,*}', 'Konvergenz zu einer funktional stabilen Relationierungsstruktur.', 'derived', 'original', NULL, NULL, NULL, 'checked', 9),
(100, '3.100', 53, 'Klassische Entwicklungsrichtung', '\\mathcal{X}\\Longrightarrow\\mathcal{O}\\Longrightarrow\\mathcal{D}', '\\mathcal{X}\\Longrightarrow\\mathcal{O}\\Longrightarrow\\mathcal{D}', 'Klassische Reihenfolge aus Zustandsraum, Operator und Dynamik.', 'schema', 'original', NULL, NULL, NULL, 'checked', 9),
(101, '3.101', 53, 'FRZK-Zustandsraumentstehung', '\\mathcal{O}_F\\Longrightarrow\\mathcal{X}_F', '\\mathcal{O}_F\\Longrightarrow\\mathcal{X}_F', 'Funktionaler Zustandsraum als Ergebnis rekursiver Operatorbildung.', 'axiom', 'original', NULL, NULL, NULL, 'checked', 9),
(102, '3.102', 53, 'Zustandsraumentstehungsabbildung', '\\Phi:\\mathcal{O}_F\\longrightarrow\\mathcal{X}_F', '\\Phi:\\mathcal{O}_F\\longrightarrow\\mathcal{X}_F', 'Strukturelle Abbildung von Operatoren auf funktionale Zustandsräume.', 'axiom', 'original', NULL, NULL, NULL, 'checked', 9),
(103, '3.103', 53, 'Dynamische Zustandsraumerweiterung', '\\mathcal{X}_F^{(n+1)}=\\mathcal{X}_F^{(n)}\\cup\\Phi\\left(\\mathcal{O}_F^{(n)}\\right)', '\\mathcal{X}_F^{(n+1)}=\\mathcal{X}_F^{(n)}\\cup\\Phi\\left(\\mathcal{O}_F^{(n)}\\right)', 'Erweiterung des Zustandsraums durch neue Operatorstrukturen.', 'model', 'original', NULL, NULL, NULL, 'checked', 9),
(104, '3.104', 53, 'Nichtabnehmende Zustandsraumdimension', '\\dim\\left(\\mathcal{X}_F^{(n+1)}\\right)\\ge\\dim\\left(\\mathcal{X}_F^{(n)}\\right)', '\\dim\\left(\\mathcal{X}_F^{(n+1)}\\right)\\ge\\dim\\left(\\mathcal{X}_F^{(n)}\\right)', 'Zulässigkeit wachsender funktionaler Freiheitsgrade.', 'derived', 'original', NULL, NULL, NULL, 'checked', 9),
(105, '3.105', 53, 'Operator-Zustandsraum-Rückkopplung', '\\mathcal{O}_F^{(n)}\\Longrightarrow\\mathcal{X}_F^{(n+1)}\\Longrightarrow\\mathcal{O}_F^{(n+1)}', '\\mathcal{O}_F^{(n)}\\Longrightarrow\\mathcal{X}_F^{(n+1)}\\Longrightarrow\\mathcal{O}_F^{(n+1)}', 'Rekursive Rückkopplung zwischen Operatoren und Zustandsraum.', 'model', 'original', NULL, NULL, NULL, 'checked', 9),
(106, '3.106', 54, 'Kohärenzabbildung', '\\Psi:\\mathcal{X}_F\\longrightarrow\\mathcal{K}_F', '\\Psi:\\mathcal{X}_F\\longrightarrow\\mathcal{K}_F', 'Abbildung funktionaler Zustandsräume auf Kohärenzstrukturen.', 'axiom', 'original', NULL, NULL, NULL, 'checked', 9),
(107, '3.107', 54, 'Kohärenzbedingung', '\\lim_{n\\rightarrow\\infty}d\\left(\\mathcal{O}_F^{(n)},\\mathcal{O}_F^{(n+1)}\\right)=0', '\\lim_{n\\rightarrow\\infty}d\\left(\\mathcal{O}_F^{(n)},\\mathcal{O}_F^{(n+1)}\\right)=0', 'Langfristige Stabilisierung aufeinanderfolgender Operatorstrukturen.', 'derived', 'original', NULL, NULL, NULL, 'checked', 9),
(108, '3.108', 54, 'Funktionale Kohärenzstruktur', '\\mathcal{K}_F=\\Psi\\left(\\mathcal{X}_F\\right)', '\\mathcal{K}_F=\\Psi\\left(\\mathcal{X}_F\\right)', 'Funktionale Kohärenz als Ergebnis der Kohärenzabbildung.', 'definition', 'original', NULL, NULL, NULL, 'checked', 9),
(109, '3.109', 54, 'Erhalt oder Erweiterung funktionaler Kohärenz', '\\mathcal{K}_F^{(n+1)}\\ge\\mathcal{K}_F^{(n)}', '\\mathcal{K}_F^{(n+1)}\\ge\\mathcal{K}_F^{(n)}', 'Nichtnumerische Ordnungsrelation für Erhalt oder Erweiterung von Kohärenz.', 'derived', 'original', NULL, NULL, NULL, 'checked', 9),
(110, '3.110', 54, 'Gesamte axiomatische Entwicklungsfolge', '\\mathcal{A}_F\\Longrightarrow\\mathcal{D}_F\\Longrightarrow\\mathcal{R}_F\\Longrightarrow\\mathcal{O}_F\\Longrightarrow\\mathcal{X}_F\\Longrightarrow\\mathcal{K}_F', '\\mathcal{A}_F\\Longrightarrow\\mathcal{D}_F\\Longrightarrow\\mathcal{R}_F\\Longrightarrow\\mathcal{O}_F\\Longrightarrow\\mathcal{X}_F\\Longrightarrow\\mathcal{K}_F', 'Zusammenfassung der vollständigen funktionalen Entwicklungsfolge.', 'schema', 'original', NULL, NULL, NULL, 'checked', 9),
(111, '3.111', 55, 'Proposition 3.1', 'A_1\\land A_2\\Longrightarrow\\exists\\,\\mathcal{R}_F', 'A_1\\land A_2\\Longrightarrow\\exists\\,\\mathcal{R}_F', 'Logische Möglichkeit funktionaler Relationen.', 'theorem', 'original', NULL, NULL, NULL, 'checked', 9),
(112, '3.112', 55, 'Proposition 3.2', '\\exists\\mathcal{R}_F\\Longrightarrow\\exists\\mathcal{O}_F', '\\exists\\mathcal{R}_F\\Longrightarrow\\exists\\mathcal{O}_F', 'Logische Möglichkeit rekursiver Operatorbildung.', 'theorem', 'original', NULL, NULL, NULL, 'checked', 9),
(113, '3.113', 55, 'Proposition 3.3', '\\exists\\mathcal{O}_F\\Longrightarrow\\exists\\mathcal{X}_F', '\\exists\\mathcal{O}_F\\Longrightarrow\\exists\\mathcal{X}_F', 'Logische Möglichkeit funktionaler Zustandsraumentstehung.', 'theorem', 'original', NULL, NULL, NULL, 'checked', 9),
(114, '3.114', 55, 'Proposition 3.4', '\\exists\\mathcal{X}_F\\Longrightarrow\\exists\\mathcal{K}_F', '\\exists\\mathcal{X}_F\\Longrightarrow\\exists\\mathcal{K}_F', 'Logische Möglichkeit funktionaler Kohärenzbildung.', 'theorem', 'original', NULL, NULL, NULL, 'checked', 9),
(115, '3.115', 55, 'Proposition 3.5', 'A_1\\Longrightarrow A_2\\Longrightarrow A_3\\Longrightarrow A_4\\Longrightarrow A_5', 'A_1\\Longrightarrow A_2\\Longrightarrow A_3\\Longrightarrow A_4\\Longrightarrow A_5', 'Geschlossene axiomatische Entwicklungsrichtung.', 'theorem', 'original', NULL, NULL, NULL, 'checked', 9);
...
(16, 'Prop. 3.1', 55, 'Existenz funktionaler Relationen', 'Aus den Axiomen A1 und A2 folgt, dass funktionale Relationen prinzipiell entstehen können.', 'A_1\\land A_2\\Longrightarrow\\exists\\,\\mathcal{R}_F', 'A_1\\land A_2\\Longrightarrow\\exists\\,\\mathcal{R}_F', 'Axiom A1 führt funktionale Unterscheidbarkeit ein; Axiom A2 ermöglicht Relationierung. Gemeinsam begründen sie die Möglichkeit funktionaler Relationen.', 'A1,A2', 'review', 9),
(17, 'Prop. 3.2', 55, 'Existenz rekursiver Operatorbildung', 'Aus funktionalen Relationen folgt die Möglichkeit rekursiver Operatorbildung.', '\\exists\\mathcal{R}_F\\Longrightarrow\\exists\\mathcal{O}_F', '\\exists\\mathcal{R}_F\\Longrightarrow\\exists\\mathcal{O}_F', 'Axiom A3 beschreibt Operatoren als Folge wiederkehrender funktionaler Relationen.', 'A3', 'review', 9),
(18, 'Prop. 3.3', 55, 'Entstehung funktionaler Zustandsräume', 'Existieren rekursive Operatoren, so kann ein funktionaler Zustandsraum entstehen.', '\\exists\\mathcal{O}_F\\Longrightarrow\\exists\\mathcal{X}_F', '\\exists\\mathcal{O}_F\\Longrightarrow\\exists\\mathcal{X}_F', 'Axiom A4 ordnet der rekursiven Operatorentwicklung die Entstehung eines funktionalen Zustandsraums zu.', 'A4', 'review', 9),
(19, 'Prop. 3.4', 55, 'Entstehung funktionaler Kohärenz', 'Aus rekursiv entwickelten funktionalen Zustandsräumen kann funktionale Kohärenz entstehen.', '\\exists\\mathcal{X}_F\\Longrightarrow\\exists\\mathcal{K}_F', '\\exists\\mathcal{X}_F\\Longrightarrow\\exists\\mathcal{K}_F', 'Axiom A5 beschreibt Kohärenz als emergente Folge rekursiver funktionaler Entwicklungen.', 'A5', 'review', 9),
(20, 'Prop. 3.5', 55, 'Geschlossene Entwicklungsrichtung', 'Die fünf Axiome definieren gemeinsam eine funktionale Entwicklungsrichtung.', 'A_1\\Longrightarrow A_2\\Longrightarrow A_3\\Longrightarrow A_4\\Longrightarrow A_5', 'A_1\\Longrightarrow A_2\\Longrightarrow A_3\\Longrightarrow A_4\\Longrightarrow A_5', 'Jedes Axiom erweitert den durch die vorhergehenden Axiome bereitgestellten strukturellen Rahmen.', 'A1,A2,A3,A4,A5', 'review', 9);
...
(1, 16, 1, NULL, 'derived_from', 'Prop. 3.1 wird logisch aus A1 hergeleitet.'),
(2, 16, 2, NULL, 'derived_from', 'Prop. 3.1 wird logisch aus A2 hergeleitet.'),
(3, 17, 3, NULL, 'derived_from', 'Prop. 3.2 wird logisch aus A3 hergeleitet.'),
(4, 18, 4, NULL, 'derived_from', 'Prop. 3.3 wird logisch aus A4 hergeleitet.'),
(5, 19, 5, NULL, 'derived_from', 'Prop. 3.4 wird logisch aus A5 hergeleitet.'),
(6, 20, 1, NULL, 'derived_from', 'Prop. 3.5 wird logisch aus A1 hergeleitet.'),
(7, 20, 2, NULL, 'derived_from', 'Prop. 3.5 wird logisch aus A2 hergeleitet.'),
(8, 20, 3, NULL, 'derived_from', 'Prop. 3.5 wird logisch aus A3 hergeleitet.'),
(9, 20, 4, NULL, 'derived_from', 'Prop. 3.5 wird logisch aus A4 hergeleitet.'),
(10, 20, 5, NULL, 'derived_from', 'Prop. 3.5 wird logisch aus A5 hergeleitet.');
...
('last_completed_section', '3.3', '2026-07-12 06:12:55'),
('last_repository_revision', 'RKB-2026-07-12-K3.3-COMPLETE', '2026-07-12 06:12:55'),
('next_citation_number', '53', '2026-07-12 06:10:58'),
('next_equation_number', '3.116', '2026-07-12 06:12:55');
...
(87, 7, 49, 'background', 'Wiederverwendung von Quelle [7] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.0', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(88, 8, 49, 'background', 'Wiederverwendung von Quelle [8] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.0', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(89, 17, 49, 'background', 'Wiederverwendung von Quelle [17] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.0', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(90, 18, 49, 'background', 'Wiederverwendung von Quelle [18] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.0', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(91, 23, 50, 'background', 'Wiederverwendung von Quelle [23] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.1', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(92, 24, 50, 'background', 'Wiederverwendung von Quelle [24] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.1', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(93, 25, 50, 'background', 'Wiederverwendung von Quelle [25] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.1', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(94, 26, 50, 'background', 'Wiederverwendung von Quelle [26] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.1', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(95, 45, 50, 'background', 'Wiederverwendung von Quelle [45] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.1', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(96, 46, 50, 'background', 'Wiederverwendung von Quelle [46] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.1', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(97, 27, 51, 'background', 'Wiederverwendung von Quelle [27] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.2', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(98, 28, 51, 'background', 'Wiederverwendung von Quelle [28] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.2', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(99, 47, 51, 'background', 'Wiederverwendung von Quelle [47] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.2', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(100, 48, 51, 'background', 'Wiederverwendung von Quelle [48] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.2', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(101, 12, 52, 'background', 'Wiederverwendung von Quelle [12] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.3', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(102, 14, 52, 'background', 'Wiederverwendung von Quelle [14] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.3', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(103, 35, 52, 'background', 'Wiederverwendung von Quelle [35] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.3', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(104, 36, 52, 'background', 'Wiederverwendung von Quelle [36] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.3', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(105, 37, 52, 'background', 'Wiederverwendung von Quelle [37] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.3', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(106, 41, 52, 'background', 'Wiederverwendung von Quelle [41] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.3', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(107, 42, 52, 'background', 'Wiederverwendung von Quelle [42] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.3', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(108, 51, 52, 'background', 'Wiederverwendung von Quelle [51] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.3', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(109, 52, 52, 'background', 'Wiederverwendung von Quelle [52] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.3', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(110, 12, 53, 'background', 'Wiederverwendung von Quelle [12] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(111, 14, 53, 'background', 'Wiederverwendung von Quelle [14] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(112, 37, 53, 'background', 'Wiederverwendung von Quelle [37] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(113, 38, 53, 'background', 'Wiederverwendung von Quelle [38] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(114, 39, 53, 'background', 'Wiederverwendung von Quelle [39] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(115, 40, 53, 'background', 'Wiederverwendung von Quelle [40] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(116, 43, 53, 'background', 'Wiederverwendung von Quelle [43] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(117, 44, 53, 'background', 'Wiederverwendung von Quelle [44] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(118, 51, 53, 'background', 'Wiederverwendung von Quelle [51] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(119, 52, 53, 'background', 'Wiederverwendung von Quelle [52] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.4', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(120, 12, 54, 'background', 'Wiederverwendung von Quelle [12] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.5', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(121, 14, 54, 'background', 'Wiederverwendung von Quelle [14] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.5', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(122, 37, 54, 'background', 'Wiederverwendung von Quelle [37] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.5', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(123, 43, 54, 'background', 'Wiederverwendung von Quelle [43] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.5', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(124, 44, 54, 'background', 'Wiederverwendung von Quelle [44] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.5', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(125, 51, 54, 'background', 'Wiederverwendung von Quelle [51] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.5', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(126, 52, 54, 'background', 'Wiederverwendung von Quelle [52] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.5', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(127, 8, 55, 'background', 'Wiederverwendung von Quelle [8] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.6', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.'),
(128, 24, 55, 'background', 'Wiederverwendung von Quelle [24] zur Begründung oder Abgrenzung der FRZK-Axiomatik.', '3.3.6', 0, 0, 'Keine neue Literaturnummer; bestehende Masterquelle wiederverwendet.');
...
(22, '\\mathcal{A}_F', '\\mathcal{A}_F', 'funktionale Axiomatik', 'Gesamtheit der funktionalen Grundaxiome.', 'chapter', 49, 87, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9),
(23, '\\mathfrak{A}_{\\mathrm{FRZK}}', '\\mathfrak{A}_{\\mathrm{FRZK}}', 'FRZK-Axiomensystem', 'Menge der fünf FRZK-Axiome.', 'chapter', 49, 88, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9),
(24, '\\Omega', '\\Omega', 'funktionale Möglichkeitsgesamtheit', 'Noch nicht geometrisch interpretierte Gesamtheit möglicher funktionaler Konfigurationen.', 'chapter', 50, 89, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9),
(25, '\\omega_i', '\\omega_i', 'funktionale Konfiguration', 'Einzelne funktionale Konfiguration.', 'chapter', 50, 89, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9),
(26, '\\Delta_F', '\\Delta_F', 'funktionale Differenzabbildung', 'Abbildung zur Kennzeichnung funktionaler Unterscheidbarkeit.', 'chapter', 50, 89, NULL, NULL, NULL, 0, 0, 1, NULL, 'checked', 9),
(27, '\\mathcal{D}_F', '\\mathcal{D}_F', 'funktionale Unterscheidungen', 'Gesamtheit funktionaler Differenzen.', 'chapter', 49, 87, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9),
(28, '\\mathcal{R}_F', '\\mathcal{R}_F', 'funktionale Relation', 'Struktur funktionaler Beziehungen.', 'chapter', 51, 92, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9),
(29, '\\mathcal{G}_F', '\\mathcal{G}_F', 'funktionale Relationsstruktur', 'Gesamtheit funktionaler Konfigurationen und Beziehungen.', 'chapter', 51, 95, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9),
(30, '\\mathcal{O}_F', '\\mathcal{O}_F', 'funktionaler Operator', 'Rekursive Transformationsregel funktionaler Relationen.', 'chapter', 52, 96, NULL, NULL, NULL, 0, 0, 1, NULL, 'checked', 9),
(31, '\\mathcal{R}_F^{*}', '\\mathcal{R}_F^{*}', 'stabile Relationierungsstruktur', 'Grenz- oder Stabilitätsstruktur rekursiver Relationierung.', 'chapter', 52, 99, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9),
(32, '\\Phi', '\\Phi', 'Zustandsraumentstehungsabbildung', 'Strukturelle Abbildung von Operatoren auf Zustandsräume.', 'chapter', 53, 102, NULL, NULL, NULL, 0, 0, 1, NULL, 'checked', 9),
(33, '\\mathcal{X}_F', '\\mathcal{X}_F', 'funktionaler Zustandsraum', 'Aus rekursiven Operatoren hervorgehender Zustandsraum.', 'chapter', 53, 101, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9),
(34, '\\Psi', '\\Psi', 'Kohärenzabbildung', 'Abbildung funktionaler Zustandsräume auf Kohärenzstrukturen.', 'chapter', 54, 106, NULL, NULL, NULL, 0, 0, 1, NULL, 'checked', 9),
(35, '\\mathcal{K}_F', '\\mathcal{K}_F', 'funktionale Kohärenzstruktur', 'Stabilisierte funktionale Organisationsform.', 'chapter', 54, 106, NULL, NULL, NULL, 0, 0, 0, NULL, 'checked', 9);
...
--
ALTER TABLE `definitions`
  MODIFY `definition_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT für Tabelle `dissertation_sections`
--
ALTER TABLE `dissertation_sections`
  MODIFY `section_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `equations`
  MODIFY `equation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;
...
--
ALTER TABLE `proposition_dependencies`
  MODIFY `proposition_dependency_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `repository_validation_results`
  MODIFY `validation_result_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT für Tabelle `section_change_log`
--
ALTER TABLE `section_change_log`
  MODIFY `change_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `source_usage`
  MODIFY `usage_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT für Tabelle `symbols`
--
ALTER TABLE `symbols`
  MODIFY `symbol_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
-- ============================================================
-- AUTOMATISCH ANGEHÄNGTES UPDATE: NEUFASSUNG KAPITEL 3.3
-- ============================================================
...
-- ============================================================
-- AUTOMATISCH ANGEHÄNGTES UPDATE: KAPITEL 3.4
-- ============================================================
