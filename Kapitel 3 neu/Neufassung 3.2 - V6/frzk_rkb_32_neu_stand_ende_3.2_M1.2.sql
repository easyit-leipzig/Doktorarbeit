...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 07. Sep 2026 um 12:28
...
--
ALTER TABLE `appendix_sections`
  MODIFY `appendix_section_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT für Tabelle `appendix_section_versions`
--
ALTER TABLE `appendix_section_versions`
  MODIFY `appendix_section_version_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT für Tabelle `appendix_source_usage`
--
ALTER TABLE `appendix_source_usage`
  MODIFY `appendix_usage_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
