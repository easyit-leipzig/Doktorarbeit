...
Definitionen : 3.2.781–3.2.785
Sätze        : 3.2.236–3.2.240
Gleichungen  : (3.3589)–(3.3601)
Literatur    : [135]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.23-V1',NOW(),'subsection','3.2.43.23',
'3.2.43.23-v1-vollstaendig',
'Lagrange-Formulierung der Elektrodynamik einschließlich Wirkungsprinzip, Feldtensor und Euler-Lagrange-Gleichungen.',
'Olaf Thiele / ChatGPT')
...
SELECT 135,'lagrange_electrodynamics_135','book',
'Lagrange-Formulierung der Elektrodynamik',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=135);
...
'subsection',
'3.2.43.23',
'Lagrange-Formulierung der Elektrodynamik vollständig ergänzt.'
...
-- Definitionen
-- 3.2.781 Wirkung
-- 3.2.782 Lagrange-Dichte
-- 3.2.783 Elektromagnetischer Feldtensor
-- 3.2.784 Viererstrom
-- 3.2.785 Eichinvarianz der Wirkung

-- Sätze
-- 3.2.236 Hamiltonsches Variationsprinzip
-- 3.2.237 Lagrange-Dichte des elektromagnetischen Feldes
-- 3.2.238 Euler-Lagrange-Gleichungen
-- 3.2.239 Maxwell-Gleichungen aus dem Variationsprinzip
-- 3.2.240 Zusammenhang zwischen Eichsymmetrie und Ladungserhaltung
...
VALUES
('last_completed_section','3.2.43.23'),
('current_section','3.2.43.24'),
('last_definition_number','3.2.785'),
('next_definition_number','3.2.786'),
('last_theorem_number','3.2.240'),
('next_theorem_number','3.2.241'),
('last_equation_number','3.3601'),
('next_equation_number','3.3602'),
('last_citation_number','135'),
('next_citation_number','136')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.781–3.2.785' AS expected;
SELECT 'Sätze 3.2.236–3.2.240' AS expected;
SELECT 'Gleichungen (3.3589)–(3.3601)' AS expected;
