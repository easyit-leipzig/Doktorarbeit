...
authoring_state:
  ...
  chapter_3_2:
    ...
    master_sql: "Kapitel_3_2_MASTER_FINAL.sql"
    ...
    runtime_validation:
      ...
      requirement: >
        ...
        Kapitel_3_2_MASTER_FINAL.sql nach realem Import geprüft werden.
  chapter_3_3:
    status: noch_nicht_begonnen
    next_section: "3.3.1"
    next_section_title: "Einleitung und Funktion der axiomatischen Grundlegung"
  chapter_3_4:
    status: erst_nach_abschluss_von_3_3_fortsetzen
...
repository_workflow:
  ...
  current_master_file: "Kapitel_3_2_MASTER_FINAL.sql"
  chapter_3_3_target:
...
required_files_for_new_chat:
  ...
  preferred_database_file_for_3_3:
    ...
    suggested_filename: "frzk_rkb_nach_Kapitel_3_2_MASTER_FINAL.sql"
  ...
  tables:
    ...
    sources:
      ...
      critical_rules:
        ...
        - "Neue Quelle in Kapitel 3.3 beginnt bei [82]."
    ...
    equations:
      ...
      foreign_keys:
        ...
        created_revision_id:
          ...
          on_update: CASCADE
      critical_rules:
        - "Nächste Gleichung in Kapitel 3.3: 3.275."
