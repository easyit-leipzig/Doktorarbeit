...
Repository-Update
Abschnitt 3.2.43.32
Fermionmassen und Yukawa-Kopplungen

Definitionen : 3.2.833–3.2.838
Sätze        : 3.2.281–3.2.284
Gleichungen  : (3.3692)–(3.3700)
Literatur    : [144]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.32-V1',NOW(),'subsection','3.2.43.32',
'3.2.43.32-v1-vollstaendig',
'Fermionmassen und Yukawa-Kopplungen einschließlich Yukawa-Lagrange, Massenentstehung und Generationenmischung.',
'Olaf Thiele / ChatGPT')
...
SELECT 144,'yukawa_couplings_144','book',
'Fermionmassen und Yukawa-Kopplungen',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=144);
...
SELECT
 ...
 'subsection',
 '3.2.43.32',
 'Fermionmassen und Yukawa-Kopplungen vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.833 Yukawa-Kopplung
-- 3.2.834 Yukawa-Kopplungskonstante
-- 3.2.835 Higgs-Fermion-Wechselwirkung
-- 3.2.836 Massenhierarchie
-- 3.2.837 Yukawa-Matrix
-- 3.2.838 Ursprung der Fermionmassen

-- Sätze
-- 3.2.281 Entstehung der Fermionmasse
-- 3.2.282 Proportionalität der Higgs-Kopplung
-- 3.2.283 Freie Parameter des Standardmodells
-- 3.2.284 Generationenmischung
...
VALUES
('last_completed_section','3.2.43.32'),
('current_section','3.2.43.33'),
('last_definition_number','3.2.838'),
('next_definition_number','3.2.839'),
('last_theorem_number','3.2.284'),
('next_theorem_number','3.2.285'),
('last_equation_number','3.3700'),
('next_equation_number','3.3701'),
('last_citation_number','144'),
('next_citation_number','145')
