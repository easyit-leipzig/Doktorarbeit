...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 20. Jul 2026 um 15:06
...
(128, '3.4.15', 60, 'Funktionaler Übergang', 'Ein funktionaler Übergang ist ein geordnetes Tripel aus Ausgangszustand, wirkendem Operator und Zielzustand, wobei der Zielzustand das Bild des Ausgangszustands unter dem Operator ist.', '\\tau_F^{(k)}:=\\left(z_F^{(k)},O_F^{(k)},z_F^{(k+1)}\\right),\\qquad z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', '\\tau_F^{(k)}:=\\left(z_F^{(k)},O_F^{(k)},z_F^{(k+1)}\\right),\\qquad z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'original', NULL, 'Definitionen der funktionalen Zustände und Operatoren.', 'Der Index bezeichnet zunächst nur eine Ordnungsposition und noch keine physikalische Zeit.', 'checked', 57),
(129, '3.4.16', 60, 'Funktionale Übergangsmenge', 'Die Menge aller zulässigen funktionalen Übergänge einer Organisation heißt funktionale Übergangsmenge.', '\\mathcal{U}_F(\\mathcal{S}):=\\left\\{\\left(z_F,O_F,z_F^{\\prime}\\right)\\middle|z_F^{\\prime}=O_F(z_F)\\right\\}', '\\mathcal{U}_F(\\mathcal{S}):=\\left\\{\\left(z_F,O_F,z_F^{\\prime}\\right)\\middle|z_F^{\\prime}=O_F(z_F)\\right\\}', 'original', NULL, 'Definition 3.4.15.', 'Erfasst die elementaren Bausteine funktionaler Entwicklung.', 'checked', 57),
(130, '3.4.17', 60, 'Funktionale Operatorfolge', 'Eine endliche funktionale Operatorfolge ist ein geordnetes Tupel zulässiger funktionaler Operatoren.', '\\mathbf{O}_F^{[n]}:=\\left(O_F^{(0)},O_F^{(1)},\\dots,O_F^{(n-1)}\\right)', '\\mathbf{O}_F^{[n]}:=\\left(O_F^{(0)},O_F^{(1)},\\dots,O_F^{(n-1)}\\right)', 'original', NULL, 'Definition 3.4.12.', 'Die Reihenfolge der Operatoren ist wegen möglicher Nichtkommutativität strukturell relevant.', 'checked', 57),
(131, '3.4.18', 60, 'Funktionale Zustandsfolge', 'Eine funktionale Zustandsfolge ist ein geordnetes Tupel funktionaler Zustände, bei dem jeder nachfolgende Zustand durch einen zulässigen Operator aus seinem Vorgänger hervorgeht.', '\\mathbf{Z}_F^{[n]}:=\\left(z_F^{(0)},z_F^{(1)},\\dots,z_F^{(n)}\\right)', '\\mathbf{Z}_F^{[n]}:=\\left(z_F^{(0)},z_F^{(1)},\\dots,z_F^{(n)}\\right)', 'original', NULL, 'Definitionen 3.4.15 und 3.4.17.', 'Die Folge beschreibt geordnete funktionale Entwicklung.', 'checked', 57),
(132, '3.4.19', 60, 'Funktionaler Entwicklungspfad', 'Ein funktionaler Entwicklungspfad ist eine alternierende Folge aus Zuständen und Operatoren, in der jeder Zielzustand durch den unmittelbar vorangehenden Operator aus dem vorangehenden Zustand hervorgeht.', '\\Gamma_F^{[n]}:=\\left(z_F^{(0)},O_F^{(0)},z_F^{(1)},\\dots,O_F^{(n-1)},z_F^{(n)}\\right)', '\\Gamma_F^{[n]}:=\\left(z_F^{(0)},O_F^{(0)},z_F^{(1)},\\dots,O_F^{(n-1)},z_F^{(n)}\\right)', 'original', NULL, 'Definitionen 3.4.17 und 3.4.18.', 'Der Entwicklungspfad enthält sowohl Zustände als auch die erzeugenden Operatoren.', 'checked', 57),
(133, '3.4.20', 60, 'Funktionale Übergangsordnung', 'Innerhalb eines funktionalen Entwicklungspfads liegt ein Zustand funktional vor einem anderen, wenn seine Indexposition kleiner ist.', 'z_F^{(i)}\\prec_F z_F^{(j)}\\Longleftrightarrow i<j', 'z_F^{(i)}\\prec_F z_F^{(j)}\\Longleftrightarrow i<j', 'original', NULL, 'Definition 3.4.19 und natürliche Ordnung der Indizes.', 'Die Ordnung enthält noch keine metrische Dauer und keine physikalische Zeit.', 'checked', 57);
...
(60, 50, '3.4.6', 'Funktionale Übergänge und Operatorfolgen', 3, 3.4060, 'final', 1, 'Rekonstruktion elementarer Übergänge, endlicher Operator- und Zustandsfolgen, funktionaler Entwicklungspfade sowie einer strikten pfadbezogenen Übergangsordnung.', '2026-07-20 07:44:33', '2026-07-20 07:44:33');
...
(806, '3.771', 60, 'Funktionaler Zustand an Position k', 'z_F^{(k)}\\in\\Omega_F(\\mathcal{S})', 'z_F^{(k)}\\in\\Omega_F(\\mathcal{S})', 'Funktionaler Zustand an einer geordneten Position.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(807, '3.772', 60, 'Funktionaler Operator an Position k', 'O_F^{(k)}\\in\\mathcal{O}_F(\\mathcal{S})', 'O_F^{(k)}\\in\\mathcal{O}_F(\\mathcal{S})', 'Auf den Zustand wirkender funktionaler Operator.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(808, '3.773', 60, 'Elementarer Zustandsübergang', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'Bestimmung des nachfolgenden Zustands.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(809, '3.774', 60, 'Funktionaler Übergang', '\\tau_F^{(k)}:=\\left(z_F^{(k)},O_F^{(k)},z_F^{(k+1)}\\right)', '\\tau_F^{(k)}:=\\left(z_F^{(k)},O_F^{(k)},z_F^{(k+1)}\\right)', 'Geordnetes Tripel aus Ausgangszustand, Operator und Zielzustand.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(810, '3.775', 60, 'Übergangsbedingung', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'Konsistenzbedingung eines funktionalen Übergangs.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(811, '3.776', 60, 'Komponenten des Übergangs', '\\text{Ausgangszustand},\\qquad\\text{Wirkungsoperator},\\qquad\\text{Zielzustand}', '\\text{Ausgangszustand},\\qquad\\text{Wirkungsoperator},\\qquad\\text{Zielzustand}', 'Strukturelle Bestandteile eines Übergangs.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(812, '3.777', 60, 'Funktionale Übergangsmenge', '\\mathcal{U}_F(\\mathcal{S}):=\\left\\{\\left(z_F,O_F,z_F^{\\prime}\\right)\\middle|z_F^{\\prime}=O_F(z_F)\\right\\}', '\\mathcal{U}_F(\\mathcal{S}):=\\left\\{\\left(z_F,O_F,z_F^{\\prime}\\right)\\middle|z_F^{\\prime}=O_F(z_F)\\right\\}', 'Menge aller zulässigen funktionalen Übergänge.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(813, '3.778', 60, 'Einbettung der Übergangsmenge', '\\mathcal{U}_F(\\mathcal{S})\\subseteq\\Omega_F(\\mathcal{S})\\times\\mathcal{O}_F(\\mathcal{S})\\times\\Omega_F(\\mathcal{S})', '\\mathcal{U}_F(\\mathcal{S})\\subseteq\\Omega_F(\\mathcal{S})\\times\\mathcal{O}_F(\\mathcal{S})\\times\\Omega_F(\\mathcal{S})', 'Produktraum der Übergangskomponenten.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(814, '3.779', 60, 'Erster Übergang einer Folge', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'Erster Schritt zweier aufeinanderfolgender Übergänge.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(815, '3.780', 60, 'Zweiter Übergang einer Folge', 'z_F^{(k+2)}=O_F^{(k+1)}\\left(z_F^{(k+1)}\\right)', 'z_F^{(k+2)}=O_F^{(k+1)}\\left(z_F^{(k+1)}\\right)', 'Zweiter Schritt zweier aufeinanderfolgender Übergänge.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(816, '3.781', 60, 'Eingesetzte Übergangsfolge', 'z_F^{(k+2)}=O_F^{(k+1)}\\left(O_F^{(k)}\\left(z_F^{(k)}\\right)\\right)', 'z_F^{(k+2)}=O_F^{(k+1)}\\left(O_F^{(k)}\\left(z_F^{(k)}\\right)\\right)', 'Verschachtelte Wirkung zweier Operatoren.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(817, '3.782', 60, 'Komponierte Übergangsfolge', 'z_F^{(k+2)}=\\left(O_F^{(k+1)}\\circ O_F^{(k)}\\right)\\left(z_F^{(k)}\\right)', 'z_F^{(k+2)}=\\left(O_F^{(k+1)}\\circ O_F^{(k)}\\right)\\left(z_F^{(k)}\\right)', 'Darstellung durch Operatorkomposition.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(818, '3.783', 60, 'Funktionale Operatorfolge', '\\mathbf{O}_F^{[n]}:=\\left(O_F^{(0)},O_F^{(1)},\\dots,O_F^{(n-1)}\\right)', '\\mathbf{O}_F^{[n]}:=\\left(O_F^{(0)},O_F^{(1)},\\dots,O_F^{(n-1)}\\right)', 'Geordnetes Tupel funktionaler Operatoren.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(819, '3.784', 60, 'Zulässigkeit der Operatorfolgenkomponenten', 'O_F^{(k)}\\in\\mathcal{O}_F(\\mathcal{S})\\qquad\\text{für}\\qquad k=0,\\dots,n-1', 'O_F^{(k)}\\in\\mathcal{O}_F(\\mathcal{S})\\qquad\\text{für}\\qquad k=0,\\dots,n-1', 'Jedes Folgenelement gehört zum Operatorraum.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(820, '3.785', 60, 'Gesamttransformation einer Operatorfolge', '\\Phi_F^{[n]}:=O_F^{(n-1)}\\circ O_F^{(n-2)}\\circ\\dots\\circ O_F^{(0)}', '\\Phi_F^{[n]}:=O_F^{(n-1)}\\circ O_F^{(n-2)}\\circ\\dots\\circ O_F^{(0)}', 'Komposition aller Operatoren einer endlichen Folge.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(821, '3.786', 60, 'Endzustand einer Operatorfolge', 'z_F^{(n)}=\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)', 'z_F^{(n)}=\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)', 'Anwendung der Gesamttransformation auf den Anfangszustand.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(822, '3.787', 60, 'Unterschiedliche Gesamttransformationen', '\\Phi_F^{[n]}\\neq\\widetilde{\\Phi}_F^{[n]}', '\\Phi_F^{[n]}\\neq\\widetilde{\\Phi}_F^{[n]}', 'Verschiedene Operatorreihenfolgen können verschiedene Gesamttransformationen erzeugen.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(823, '3.788', 60, 'Pfadabhängige Endzustände', '\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)\\neq\\widetilde{\\Phi}_F^{[n]}\\left(z_F^{(0)}\\right)', '\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)\\neq\\widetilde{\\Phi}_F^{[n]}\\left(z_F^{(0)}\\right)', 'Unterschiedliche Operatorfolgen können aus demselben Anfangszustand verschiedene Endzustände erzeugen.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(824, '3.789', 60, 'Operatorfolge im Lemma', '\\mathbf{O}_F^{[n]}=\\left(O_F^{(0)},\\dots,O_F^{(n-1)}\\right)', '\\mathbf{O}_F^{[n]}=\\left(O_F^{(0)},\\dots,O_F^{(n-1)}\\right)', 'Voraussetzung von Lemma 3.4.6.', 'lemma', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(825, '3.790', 60, 'Von einer Operatorfolge erzeugte Transformation', '\\Phi_F^{[n]}\\in\\mathcal{T}_F(\\mathcal{S})', '\\Phi_F^{[n]}\\in\\mathcal{T}_F(\\mathcal{S})', 'Aussage von Lemma 3.4.6.', 'lemma', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(826, '3.791', 60, 'Komposition der Operatorfolge', 'O_F^{(n-1)}\\circ\\dots\\circ O_F^{(0)}', 'O_F^{(n-1)}\\circ\\dots\\circ O_F^{(0)}', 'Zusammengesetzter Operator im Beweis.', 'lemma', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(827, '3.792', 60, 'Funktionale Zustandsfolge', '\\mathbf{Z}_F^{[n]}:=\\left(z_F^{(0)},z_F^{(1)},\\dots,z_F^{(n)}\\right)', '\\mathbf{Z}_F^{[n]}:=\\left(z_F^{(0)},z_F^{(1)},\\dots,z_F^{(n)}\\right)', 'Geordnetes Tupel aufeinanderfolgender Zustände.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(828, '3.793', 60, 'Konsistenz einer Zustandsfolge', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'Jeder Folgezustand entsteht durch einen funktionalen Operator.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(829, '3.794', 60, 'Funktionaler Entwicklungspfad', '\\Gamma_F^{[n]}:=\\left(z_F^{(0)},O_F^{(0)},z_F^{(1)},O_F^{(1)},\\dots,O_F^{(n-1)},z_F^{(n)}\\right)', '\\Gamma_F^{[n]}:=\\left(z_F^{(0)},O_F^{(0)},z_F^{(1)},O_F^{(1)},\\dots,O_F^{(n-1)},z_F^{(n)}\\right)', 'Vollständige Folge aus Zuständen und Operatoren.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(830, '3.795', 60, 'Pfadbedingung', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'Konsistenzbedingung eines funktionalen Entwicklungspfads.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(831, '3.796', 60, 'Gleicher Anfang zweier Pfade', 'z_F^{(0)}=\\widetilde{z}_F^{(0)}', 'z_F^{(0)}=\\widetilde{z}_F^{(0)}', 'Zwei Pfade beginnen im selben Zustand.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(832, '3.797', 60, 'Gleiches Ende zweier Pfade', 'z_F^{(n)}=\\widetilde{z}_F^{(m)}', 'z_F^{(n)}=\\widetilde{z}_F^{(m)}', 'Zwei Pfade enden im selben Zustand.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(833, '3.798', 60, 'Verschiedene Entwicklungspfade', '\\Gamma_F^{[n]}\\neq\\widetilde{\\Gamma}_F^{[m]}', '\\Gamma_F^{[n]}\\neq\\widetilde{\\Gamma}_F^{[m]}', 'Strukturell verschiedene Pfade können gleiche Randzustände besitzen.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(834, '3.799', 60, 'Endzustandsabhängigkeit', 'z_F^{(n)}=\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)', 'z_F^{(n)}=\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)', 'Der Endzustand hängt von Gesamttransformation und Anfangszustand ab.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(835, '3.800', 60, 'Verschiedene Anfangszustände', 'z_F^{(0)}\\neq\\widetilde{z}_F^{(0)}', 'z_F^{(0)}\\neq\\widetilde{z}_F^{(0)}', 'Unterschiedliche Ausgangslagen.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(836, '3.801', 60, 'Anfangszustandsabhängige Ergebnisse', '\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)\\neq\\Phi_F^{[n]}\\left(\\widetilde{z}_F^{(0)}\\right)', '\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)\\neq\\Phi_F^{[n]}\\left(\\widetilde{z}_F^{(0)}\\right)', 'Gleiche Gesamttransformation kann unterschiedliche Endzustände erzeugen.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(837, '3.802', 60, 'Anfangszustand im Bestimmtheitssatz', 'z_F^{(0)}\\in\\Omega_F(\\mathcal{S})', 'z_F^{(0)}\\in\\Omega_F(\\mathcal{S})', 'Voraussetzung von Satz 3.4.7.', 'theorem', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(838, '3.803', 60, 'Operatorfolge im Bestimmtheitssatz', '\\mathbf{O}_F^{[n]}=\\left(O_F^{(0)},\\dots,O_F^{(n-1)}\\right)', '\\mathbf{O}_F^{[n]}=\\left(O_F^{(0)},\\dots,O_F^{(n-1)}\\right)', 'Zweite Voraussetzung von Satz 3.4.7.', 'theorem', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(839, '3.804', 60, 'Eindeutiger erster Folgezustand', 'z_F^{(1)}=O_F^{(0)}\\left(z_F^{(0)}\\right)', 'z_F^{(1)}=O_F^{(0)}\\left(z_F^{(0)}\\right)', 'Induktionsanfang des Bestimmtheitsbeweises.', 'theorem', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(840, '3.805', 60, 'Eindeutiger nächster Folgezustand', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'z_F^{(k+1)}=O_F^{(k)}\\left(z_F^{(k)}\\right)', 'Induktionsschritt des Bestimmtheitsbeweises.', 'theorem', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(841, '3.806', 60, 'Eindeutig bestimmte Zustände', 'z_F^{(1)},z_F^{(2)},\\dots,z_F^{(n)}', 'z_F^{(1)},z_F^{(2)},\\dots,z_F^{(n)}', 'Ergebnis der vollständigen Induktion.', 'theorem', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(842, '3.807', 60, 'Verschiedene Gesamttransformationen im Korollar', '\\Phi_F^{[n]}\\neq\\widetilde{\\Phi}_F^{[n]}', '\\Phi_F^{[n]}\\neq\\widetilde{\\Phi}_F^{[n]}', 'Unvollständige Operatorinformation erlaubt mehrere Entwicklungen.', '', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(843, '3.808', 60, 'Verschiedene Endzustände im Korollar', '\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)\\neq\\widetilde{\\Phi}_F^{[n]}\\left(z_F^{(0)}\\right)', '\\Phi_F^{[n]}\\left(z_F^{(0)}\\right)\\neq\\widetilde{\\Phi}_F^{[n]}\\left(z_F^{(0)}\\right)', 'Folgerung für denselben Anfangszustand.', '', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(844, '3.809', 60, 'Funktionale Vorordnungsschreibweise', 'z_F^{(i)}\\prec_F z_F^{(j)}', 'z_F^{(i)}\\prec_F z_F^{(j)}', 'Formale Schreibweise einer funktionalen Vorher-Nachher-Beziehung.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(845, '3.810', 60, 'Funktionale Übergangsordnung', 'z_F^{(i)}\\prec_F z_F^{(j)}', 'z_F^{(i)}\\prec_F z_F^{(j)}', 'Definition der pfadbezogenen Übergangsordnung.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(846, '3.811', 60, 'Indexbedingung der Übergangsordnung', 'i<j', 'i<j', 'Ordnungsbedingung für zwei Zustandspositionen.', 'definition', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(847, '3.812', 60, 'Erste Indexrelation', 'i<j', 'i<j', 'Erste Voraussetzung der Transitivität.', 'lemma', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(848, '3.813', 60, 'Zweite Indexrelation', 'j<k', 'j<k', 'Zweite Voraussetzung der Transitivität.', 'lemma', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(849, '3.814', 60, 'Transitive Indexrelation', 'i<k', 'i<k', 'Folgerung aus der Transitivität der natürlichen Ordnung.', 'lemma', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(850, '3.815', 60, 'Transitivität der Übergangsordnung', 'z_F^{(i)}\\prec_F z_F^{(j)}\\land z_F^{(j)}\\prec_F z_F^{(k)}\\Longrightarrow z_F^{(i)}\\prec_F z_F^{(k)}', 'z_F^{(i)}\\prec_F z_F^{(j)}\\land z_F^{(j)}\\prec_F z_F^{(k)}\\Longrightarrow z_F^{(i)}\\prec_F z_F^{(k)}', 'Aussage von Lemma 3.4.7.', 'lemma', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(851, '3.816', 60, 'Irreflexivität der Indexordnung', 'i\\nless i', 'i\\nless i', 'Kein Index liegt strikt vor sich selbst.', 'theorem', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(852, '3.817', 60, 'Irreflexivität der Übergangsordnung', 'z_F^{(i)}\\not\\prec_F z_F^{(i)}', 'z_F^{(i)}\\not\\prec_F z_F^{(i)}', 'Kein Zustand liegt im selben Pfad strikt vor sich selbst.', 'theorem', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(853, '3.818', 60, 'Asymmetrie der Übergangsordnung', 'z_F^{(i)}\\prec_F z_F^{(j)}\\Longrightarrow z_F^{(j)}\\not\\prec_F z_F^{(i)}', 'z_F^{(i)}\\prec_F z_F^{(j)}\\Longrightarrow z_F^{(j)}\\not\\prec_F z_F^{(i)}', 'Gerichtete Ordnung entlang eines Pfads.', 'theorem', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(854, '3.819', 60, 'Erste Unvergleichbarkeit', 'z_F\\not\\prec_F z_F^{\\prime}', 'z_F\\not\\prec_F z_F^{\\prime}', 'Keine gerichtete Ordnung vom ersten zum zweiten Zustand.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(855, '3.820', 60, 'Zweite Unvergleichbarkeit', 'z_F^{\\prime}\\not\\prec_F z_F', 'z_F^{\\prime}\\not\\prec_F z_F', 'Keine gerichtete Ordnung vom zweiten zum ersten Zustand.', 'derived', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57),
(856, '3.821', 60, 'Ordnung ohne Dauer', 'z_F^{(i)}\\prec_F z_F^{(j)}', 'z_F^{(i)}\\prec_F z_F^{(j)}', 'Die Übergangsordnung bestimmt Reihenfolge, aber keine metrische Dauer.', '', 'original', NULL, 'Eigene mathematische Rekonstruktion in Abschnitt 3.4.6.', 'Die Zustands-, Transformations- und Operatorstrukturen der Abschnitte 3.4.1 bis 3.4.5 werden vorausgesetzt.', 'checked', 57);
...
--
ALTER TABLE `corollaries`
  MODIFY `corollary_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT für Tabelle `definitions`
--
ALTER TABLE `definitions`
  MODIFY `definition_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;

--
-- AUTO_INCREMENT für Tabelle `dissertation_sections`
--
ALTER TABLE `dissertation_sections`
  MODIFY `section_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
...
--
ALTER TABLE `equations`
  MODIFY `equation_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=857;
...
--
ALTER TABLE `lemmas`
  MODIFY `lemma_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `proofs`
  MODIFY `proof_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `section_change_log`
  MODIFY `change_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=243;
...
--
ALTER TABLE `source_usage`
  MODIFY `usage_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=190;
...
--
ALTER TABLE `theorems`
  MODIFY `theorem_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
