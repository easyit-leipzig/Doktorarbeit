...
Repository-Update
Abschnitt 3.2.43.39
Methodische Gesamtsynthese der mathematischen Grundlagen

Definitionen : 3.2.873–3.2.878
Sätze        : 3.2.316–3.2.320
Gleichungen  : (3.3730)–(3.3731)
Literatur    : [151]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.39-V1',NOW(),'subsection','3.2.43.39',
'3.2.43.39-v1-vollstaendig',
'Methodische Gesamtsynthese der mathematischen Grundlagen und Übergang zur Axiomatik des FRZK.',
'Olaf Thiele / ChatGPT')
...
SELECT 151,'methodological_synthesis_151','book',
'Methodische Gesamtsynthese der mathematischen Grundlagen',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=151);
...
SELECT
 ...
 'subsection',
 '3.2.43.39',
 'Methodische Gesamtsynthese vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.873 Methodischer Bezugsrahmen
-- 3.2.874 Axiomatische Entwicklungsbasis
-- 3.2.875 Mathematische Konsistenz
-- 3.2.876 Funktionale Abstraktionsebene
-- 3.2.877 Wissenschaftlicher Entwicklungszyklus
-- 3.2.878 Übergangsprinzip

-- Sätze
-- 3.2.316 Voraussetzung der Axiomatik
-- 3.2.317 Konsistenz als Mindestanforderung
-- 3.2.318 Trennung von Mathematik und Interpretation
-- 3.2.319 Einordnung des FRZK
-- 3.2.320 Abschluss der mathematischen Grundlagen
...
VALUES
('last_completed_section','3.2.43.39'),
('current_section','3.2.43.40'),
('last_definition_number','3.2.878'),
('next_definition_number','3.2.879'),
('last_theorem_number','3.2.320'),
('next_theorem_number','3.2.321'),
('last_equation_number','3.3731'),
('next_equation_number','3.3732'),
('last_citation_number','151'),
('next_citation_number','152')
