...
/* =====================================================================
   ...
   Definitionen : 3.2.716–3.2.723
   Sätze        : 3.2.187–3.2.192
   Gleichungen  : (3.3426)–(3.3450)
   Literatur    : [126]
   ===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.14-V1',NOW(),'subsection','3.2.43.14',
 '3.2.43.14-v1-vollstaendig',
 'Noether-Theorem, kontinuierliche Symmetrien, Noether-Ströme und Erhaltungsgrößen.',
 'Olaf Thiele / ChatGPT')
...
'pending'
WHERE NOT EXISTS(
SELECT 1 FROM sources WHERE citation_number=126);
...
'subsection',
'3.2.43.14',
'Noether-Theorem vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.716 Kontinuierliche Symmetrie
-- 3.2.717 Invarianz der Wirkung
-- 3.2.718 Noether-Strom
-- 3.2.719 Zeittranslationssymmetrie
-- 3.2.720 Raumtranslationssymmetrie
-- 3.2.721 Rotationssymmetrie
-- 3.2.722 Innere Symmetrie
-- 3.2.723 Noether-Ladung

-- Sätze
-- 3.2.187 Noether-Theorem
-- 3.2.188 Erhaltung der Gesamtladung
-- 3.2.189 Energieerhaltung
-- 3.2.190 Impulserhaltung
-- 3.2.191 Drehimpulserhaltung
-- 3.2.192 Eichsymmetrie und Ladungserhaltung
...
VALUES
('last_completed_section','3.2.43.14'),
('current_section','3.2.43.15'),
('last_definition_number','3.2.723'),
('next_definition_number','3.2.724'),
('last_theorem_number','3.2.192'),
('next_theorem_number','3.2.193'),
('last_equation_number','3.3450'),
('next_equation_number','3.3451'),
('last_citation_number','126'),
('next_citation_number','127')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.716–3.2.723' AS expected;
SELECT 'Sätze 3.2.187–3.2.192' AS expected;
SELECT 'Gleichungen (3.3426)–(3.3450)' AS expected;
