...
Repository-Update
Abschnitt 3.2.43.29
Nichtabelsche Eichtheorien als Verallgemeinerung der Elektrodynamik

Definitionen : 3.2.815–3.2.820
Sätze        : 3.2.266–3.2.270
Gleichungen  : (3.3664)–(3.3673)
Literatur    : [141]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.29-V1',NOW(),'subsection','3.2.43.29',
'3.2.43.29-v1-vollstaendig',
'Nichtabelsche Eichtheorien als Verallgemeinerung der Elektrodynamik einschließlich Yang-Mills-Theorie und Standardmodell.',
'Olaf Thiele / ChatGPT')
...
SELECT 141,'yang_mills_141','book',
'Nichtabelsche Eichtheorien als Verallgemeinerung der Elektrodynamik',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=141);
...
SELECT
 ...
 'subsection',
 '3.2.43.29',
 'Nichtabelsche Eichtheorien vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.815 Nichtabelsche Lie-Gruppe
-- 3.2.816 Generatoren der Lie-Algebra
-- 3.2.817 Yang-Mills-Feld
-- 3.2.818 Nichtabelscher Feldstärketensor
-- 3.2.819 Yang-Mills-Wirkung
-- 3.2.820 Eichbosonen

-- Sätze
-- 3.2.266 Kommutatorrelation der Generatoren
-- 3.2.267 Kovariante Ableitung der Yang-Mills-Theorie
-- 3.2.268 Selbstwechselwirkung der Eichfelder
-- 3.2.269 Yang-Mills-Gleichungen
-- 3.2.270 Standardmodell als Yang-Mills-Theorie
...
VALUES
('last_completed_section','3.2.43.29'),
('current_section','3.2.43.30'),
('last_definition_number','3.2.820'),
('next_definition_number','3.2.821'),
('last_theorem_number','3.2.270'),
('next_theorem_number','3.2.271'),
('last_equation_number','3.3673'),
('next_equation_number','3.3674'),
('last_citation_number','141'),
('next_citation_number','142')
