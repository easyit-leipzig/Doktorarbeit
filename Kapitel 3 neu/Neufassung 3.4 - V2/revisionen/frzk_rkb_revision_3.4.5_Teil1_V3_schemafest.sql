...
SET @revision_code := 'RKB-REV-K3.4.5-P1-V3';
...
SET @source_rudin := NULL;
SET @source_dummit := NULL;
SET @source_conway := NULL;
...
VALUES
('last_repository_revision', 'RKB-REV-K3.4.5-P1-V3')
ON DUPLICATE KEY UPDATE
counter_value='RKB-REV-K3.4.5-P1-V3';
...
SELECT
    ...
    summary
FROM repository_revisions
WHERE revision_code='RKB-REV-K3.4.5-P1-V3';
