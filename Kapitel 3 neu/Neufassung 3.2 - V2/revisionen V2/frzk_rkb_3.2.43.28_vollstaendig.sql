...
Repository-Update
Abschnitt 3.2.43.28
Elektrodynamik als U(1)-Eichtheorie

Definitionen : 3.2.809–3.2.814
Sätze        : 3.2.261–3.2.265
Gleichungen  : (3.3650)–(3.3663)
Literatur    : [140]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.28-V1',NOW(),'subsection','3.2.43.28',
'3.2.43.28-v1-vollstaendig',
'Elektrodynamik als U(1)-Eichtheorie mit kovarianter Ableitung, Eichfeld und U(1)-Symmetrie.',
'Olaf Thiele / ChatGPT')
...
SELECT 140,'u1_gauge_theory_140','book',
'Elektrodynamik als U(1)-Eichtheorie',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=140);
...
'subsection',
'3.2.43.28',
'Elektrodynamik als U(1)-Eichtheorie vollständig ergänzt.'
...
-- Definitionen
-- 3.2.809 U(1)-Gruppe
-- 3.2.810 Lokale Phasentransformation
-- 3.2.811 Kovariante Ableitung
-- 3.2.812 Eichfeld
-- 3.2.813 Eichkopplung
-- 3.2.814 Abelsche Eichgruppe

-- Sätze
-- 3.2.261 Verletzung der lokalen Invarianz
-- 3.2.262 Eichinvarianz der kovarianten Ableitung
-- 3.2.263 Feldstärketensor
-- 3.2.264 Masselosigkeit des Photons
-- 3.2.265 Struktur der Quantenelektrodynamik
...
VALUES
('last_completed_section','3.2.43.28'),
('current_section','3.2.43.29'),
('last_definition_number','3.2.814'),
('next_definition_number','3.2.815'),
('last_theorem_number','3.2.265'),
('next_theorem_number','3.2.266'),
('last_equation_number','3.3663'),
('next_equation_number','3.3664'),
('last_citation_number','140'),
('next_citation_number','141')
