...
Repository-Update
Abschnitt 3.2.43.18
Randbedingungen elektromagnetischer Felder

Definitionen : 3.2.748–3.2.755
Sätze        : 3.2.209–3.2.214
Gleichungen  : (3.3512)–(3.3527)
Literatur    : [130]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.18-V1',NOW(),'subsection','3.2.43.18',
'3.2.43.18-v1-vollstaendig',
'Randbedingungen elektromagnetischer Felder einschließlich Reflexion, Transmission und Anschlussbedingungen.',
'Olaf Thiele / ChatGPT')
...
SELECT 130,'em_boundary_conditions_130','book',
'Randbedingungen elektromagnetischer Felder',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=130);
...
'subsection',
'3.2.43.18',
'Randbedingungen elektromagnetischer Felder vollständig ergänzt.'
...
-- Definitionen
-- 3.2.748 Grenzfläche
-- 3.2.749 Flächennormale
-- 3.2.750 Oberflächenstromdichte
-- 3.2.751 Oberflächenladungsdichte
-- 3.2.752 Idealer Leiter
-- 3.2.753 Reflexionskoeffizient
-- 3.2.754 Transmissionskoeffizient
-- 3.2.755 Impedanzsprung

-- Sätze
-- 3.2.209 Tangentiale Randbedingung des elektrischen Feldes
-- 3.2.210 Tangentiale Randbedingung des magnetischen Feldes
-- 3.2.211 Normale Randbedingung der elektrischen Flussdichte
-- 3.2.212 Normale Randbedingung des magnetischen Feldes
-- 3.2.213 Randbedingung am idealen Leiter
-- 3.2.214 Energieerhaltung an einer Grenzfläche

-- Gleichungen
-- (3.3512) bis (3.3527)
-- Alle Gleichungen mit Word-LaTeX vorhanden.

INSERT INTO repository_counters(counter_key,counter_value)
VALUES
('last_completed_section','3.2.43.18'),
('current_section','3.2.43.19'),
('last_definition_number','3.2.755'),
('next_definition_number','3.2.756'),
('last_theorem_number','3.2.214'),
('next_theorem_number','3.2.215'),
('last_equation_number','3.3527'),
('next_equation_number','3.3528'),
('last_citation_number','130'),
('next_citation_number','131')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.748–3.2.755' AS expected;
SELECT 'Sätze 3.2.209–3.2.214' AS expected;
SELECT 'Gleichungen (3.3512)–(3.3527)' AS expected;
