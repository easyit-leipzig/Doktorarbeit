...
Definitionen : 3.2.724–3.2.731
Sätze        : 3.2.193–3.2.196
Gleichungen  : (3.3451)–(3.3468)
Literatur    : [127]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.15-V1',NOW(),'subsection','3.2.43.15',
'3.2.43.15-v1-vollstaendig',
'Energie-Impuls-Tensor, Energiedichte, Impulsdichte, Poynting-Vektor und Maxwell-Spannungstensor.',
'Olaf Thiele / ChatGPT')
...
SELECT 127,'energy_momentum_tensor_127','book',
'Energie-Impuls-Tensor des elektromagnetischen Feldes',
'de','pending'
WHERE NOT EXISTS(SELECT 1 FROM sources WHERE citation_number=127);
...
'subsection',
'3.2.43.15',
'Energie-Impuls-Tensor vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.724 Energie-Impuls-Tensor
-- 3.2.725 Kanonischer Energie-Impuls-Tensor
-- 3.2.726 Symmetrischer Energie-Impuls-Tensor
-- 3.2.727 Energiedichte
-- 3.2.728 Impulsdichte
-- 3.2.729 Poynting-Vektor
-- 3.2.730 Maxwell-Spannungstensor
-- 3.2.731 Tensorielle Energiebilanz

-- Sätze
-- 3.2.193 Lokale Energie-Impuls-Erhaltung
-- 3.2.194 Symmetrie des elektromagnetischen Energie-Impuls-Tensors
-- 3.2.195 Zusammenhang Energie- und Impulsfluss
-- 3.2.196 Energie-Impuls-Tensor als Quelle der Gravitation
...
VALUES
('last_completed_section','3.2.43.15'),
('current_section','3.2.43.16'),
('last_definition_number','3.2.731'),
('next_definition_number','3.2.732'),
('last_theorem_number','3.2.196'),
('next_theorem_number','3.2.197'),
('last_equation_number','3.3468'),
('next_equation_number','3.3469'),
('last_citation_number','127'),
('next_citation_number','128')
ON DUPLICATE KEY UPDATE counter_value=VALUES(counter_value);

COMMIT;

SELECT 'Definitionen 3.2.724–3.2.731' AS expected;
SELECT 'Sätze 3.2.193–3.2.196' AS expected;
SELECT 'Gleichungen (3.3451)–(3.3468)' AS expected;
