...
Repository-Update
Abschnitt 3.2.43.25
Kanonische Quantisierung elektromagnetischer Felder

Definitionen : 3.2.791–3.2.796
Sätze        : 3.2.246–3.2.250
Gleichungen  : (3.3612)–(3.3624)
Literatur    : [137]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.25-V1',NOW(),'subsection','3.2.43.25',
'3.2.43.25-v1-vollstaendig',
'Kanonische Quantisierung elektromagnetischer Felder mit Vertauschungsrelationen, Photonenzuständen und Feldoperatoren.',
'Olaf Thiele / ChatGPT')
...
SELECT 137,'canonical_quantization_em_137','book',
'Kanonische Quantisierung elektromagnetischer Felder',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=137);
...
'subsection',
'3.2.43.25',
'Kanonische Quantisierung elektromagnetischer Felder vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.791 Feldoperator
-- 3.2.792 Kanonischer Impulsoperator
-- 3.2.793 Photonenoperator
-- 3.2.794 Photonenzahloperator
-- 3.2.795 Vakuumzustand
-- 3.2.796 Quantisiertes elektromagnetisches Feld

-- Sätze
-- 3.2.246 Kanonische Vertauschungsrelation
-- 3.2.247 Bosonische Vertauschungsrelation
-- 3.2.248 Eigenwerte des Photonenzahloperators
-- 3.2.249 Energiequantisierung
-- 3.2.250 Photonen als Feldquanten
...
VALUES
('last_completed_section','3.2.43.25'),
('current_section','3.2.43.26'),
('last_definition_number','3.2.796'),
('next_definition_number','3.2.797'),
('last_theorem_number','3.2.250'),
('next_theorem_number','3.2.251'),
('last_equation_number','3.3624'),
('next_equation_number','3.3625'),
('last_citation_number','137'),
('next_citation_number','138')
