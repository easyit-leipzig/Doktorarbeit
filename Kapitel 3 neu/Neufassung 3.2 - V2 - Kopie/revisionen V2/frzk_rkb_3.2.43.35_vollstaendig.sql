...
Repository-Update
Abschnitt 3.2.43.35
Effektive Feldtheorien und Niedrigenergiegrenzen

Definitionen : 3.2.851–3.2.856
Sätze        : 3.2.295–3.2.299
Gleichungen  : (3.3719)–(3.3723)
Literatur    : [147]
===================================================================== */
...
VALUES
('RKB-NEU-K3.2.43.35-V1',NOW(),'subsection','3.2.43.35',
'3.2.43.35-v1-vollstaendig',
'Effektive Feldtheorien und Niedrigenergiegrenzen einschließlich Cutoff, Matching und mehrskaliger Beschreibung.',
'Olaf Thiele / ChatGPT')
...
SELECT 147,'effective_field_theories_147','book',
'Effektive Feldtheorien und Niedrigenergiegrenzen',
'de','pending'
WHERE NOT EXISTS (SELECT 1 FROM sources WHERE citation_number=147);
...
SELECT
 ...
 'subsection',
 '3.2.43.35',
 'Effektive Feldtheorien und Niedrigenergiegrenzen vollständig ergänzt.'
FROM dissertation_sections
WHERE section_code='3.2.43'
LIMIT 1;

-- Definitionen
-- 3.2.851 Effektive Feldtheorie
-- 3.2.852 Cutoff-Energie
-- 3.2.853 Integrieren schwerer Freiheitsgrade
-- 3.2.854 Höherdimensionale Operatoren
-- 3.2.855 Matching
-- 3.2.856 Hierarchie der Beschreibungsebenen

-- Sätze
-- 3.2.295 Gültigkeitsbereich einer effektiven Theorie
-- 3.2.296 Effektive Lagrange-Dichte
-- 3.2.297 Unterdrückung hochenergetischer Beiträge
-- 3.2.298 Konsistenz zwischen fundamentaler und effektiver Theorie
-- 3.2.299 Mehrskalige Beschreibung physikalischer Systeme
...
VALUES
('last_completed_section','3.2.43.35'),
('current_section','3.2.43.36'),
('last_definition_number','3.2.856'),
('next_definition_number','3.2.857'),
('last_theorem_number','3.2.299'),
('next_theorem_number','3.2.300'),
('last_equation_number','3.3723'),
('next_equation_number','3.3724'),
('last_citation_number','147'),
('next_citation_number','148')
